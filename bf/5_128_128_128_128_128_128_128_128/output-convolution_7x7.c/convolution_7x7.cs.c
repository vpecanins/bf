  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
  ...
  sim_icache_fetch(32 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 20),0,4), 0); /* line 119 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 24),0,4), 0); /* line 120 */
  ...
  sim_icache_fetch(37 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 40),0,4), 0); /* line 125 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 44),0,4), 0); /* line 126 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 48),0,4), 0); /* line 127 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 52),0,4), 0); /* line 128 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 56),0,4), 0); /* line 129 */
} /* line 129 */
  sim_icache_fetch(42 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 60),0,4), 0); /* line 131 */
   __STW(mem_trace_st(reg_r0_4,0,4), 0); /* line 132 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), 0); /* line 133 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), 0); /* line 134 */
  ...
  sim_icache_fetch(47 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), 0); /* line 137 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), 0); /* line 138 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), 0); /* line 139 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), 0); /* line 140 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), 0); /* line 141 */
} /* line 141 */
  sim_icache_fetch(52 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), 0); /* line 143 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), 0); /* line 144 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), 0); /* line 145 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 44),0,4), 0); /* line 146 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 48),0,4), 0); /* line 147 */
} /* line 147 */
  sim_icache_fetch(57 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 52),0,4), 0); /* line 149 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 56),0,4), 0); /* line 150 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 60),0,4), 0); /* line 151 */
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_8, 0); /* line 156 */
   __MOV(reg_r0_3, 0); /* line 157 */
   __MOV(reg_r0_36, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 158 */
   __MOV(reg_r0_37, reg_r0_5); /* line 159 */
} /* line 159 */
l_L4X3: ;/* line 162 */
__LABEL(l_L4X3);
  sim_icache_fetch(66 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __CMPLT(reg_b0_0, reg_r0_3, (unsigned int) 58); /* line 163 */
   __MOV(reg_r0_4, (unsigned int) -58); /* line 164 */
   __MOV(reg_r0_7, 0); /* line 165 */
} /* line 165 */
...
l_L6X3: ;/* line 170 */
__LABEL(l_L6X3);
  sim_icache_fetch(70 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_4, 0); /* line 171 */
   __MOV(reg_r0_6, 0); /* line 172 */
   __MOV(reg_r0_5, reg_r0_7); /* line 173 */
   __MOV(reg_r0_12, 0); /* line 174 */
   __MOV(reg_r0_11, 0); /* line 175 */
} /* line 175 */
  sim_icache_fetch(75 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MOV(reg_r0_2, (unsigned int) -7); /* line 177 */
   __MOV(reg_r0_13, 0); /* line 178 */
   __MOV(reg_r0_34, reg_r0_4); /* line 179 */
   __MOV(reg_r0_35, reg_r0_7); /* line 180 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
...
l_L8X3: ;/* line 184 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_2, 0); /* line 185 */
   __SH2ADD(reg_r0_10, reg_r0_6, (unsigned int) filter7x7); /* line 186 */
   __ADD(reg_r0_9, reg_r0_5, reg_r0_8); /* line 187 */
  ...
  sim_icache_fetch(87 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __LDWs(reg_r0_10, mem_trace_ld(reg_r0_10,0,4)); /* line 191 */
   __SH2ADD(reg_r0_9, reg_r0_9, (unsigned int) conv7_image); /* line 192 */
   __SHL(reg_r0_4, reg_r0_4, (unsigned int) 6); /* line 193 */
   __LDWs(reg_r0_7, mem_trace_ld(reg_r0_7,0,4)); /* line 194 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(93 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 197 */
   __ADD(reg_r0_14, reg_r0_3, (unsigned int) 2); /* line 198 */
   __SH2ADD(reg_r0_15, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 8)); /* line 199 */
   __ADD(reg_r0_16, reg_r0_3, (unsigned int) 3); /* line 200 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 201 */
} /* line 201 */
  sim_icache_fetch(99 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHL(reg_r0_14, reg_r0_14, (unsigned int) 6); /* line 203 */
   __LDW(reg_r0_15, mem_trace_ld(reg_r0_15,0,4)); /* line 204 */
   __SHL(reg_r0_16, reg_r0_16, (unsigned int) 6); /* line 205 */
   __SH2ADD(reg_r0_17, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 12)); /* line 206 */
   __SH2ADD(reg_r0_4, reg_r0_4, (unsigned int) conv7_image); /* line 207 */
} /* line 207 */
  sim_icache_fetch(106 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHRU(reg_r0_18, reg_r0_9, (unsigned int) 8); /* line 209 */
   __ADD(reg_r0_14, reg_r0_5, reg_r0_14); /* line 210 */
   __ADD(reg_r0_16, reg_r0_5, reg_r0_16); /* line 211 */
   __LDW(reg_r0_17, mem_trace_ld(reg_r0_17,0,4)); /* line 212 */
   __LDW(reg_r0_4, mem_trace_ld(reg_r0_4,0,4)); /* line 213 */
} /* line 213 */
  sim_icache_fetch(111 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 215 */
   __SH2ADD(reg_r0_14, reg_r0_14, (unsigned int) conv7_image); /* line 216 */
   __SH2ADD(reg_r0_16, reg_r0_16, (unsigned int) conv7_image); /* line 217 */
   __ADD(reg_r0_19, reg_r0_3, (unsigned int) 5); /* line 218 */
   __SH2ADD(reg_r0_20, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 219 */
} /* line 219 */
  sim_icache_fetch(119 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULLU(reg_r0_22, reg_r0_10, reg_r0_18); /* line 221 */
   __MULHS(reg_r0_18, reg_r0_10, reg_r0_18); /* line 222 */
   __LDW(reg_r0_14, mem_trace_ld(reg_r0_14,0,4)); /* line 223 */
   __LDW(reg_r0_16, mem_trace_ld(reg_r0_16,0,4)); /* line 224 */
   __SHRU(reg_r0_21, reg_r0_4, (unsigned int) 8); /* line 225 */
} /* line 225 */
  sim_icache_fetch(124 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_23, reg_r0_3, (unsigned int) 1); /* line 227 */
   __SH2ADD(reg_r0_24, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 228 */
   __SHL(reg_r0_19, reg_r0_19, (unsigned int) 6); /* line 229 */
   __LDW(reg_r0_20, mem_trace_ld(reg_r0_20,0,4)); /* line 230 */
   __AND(reg_r0_21, reg_r0_21, (unsigned int) 255); /* line 231 */
} /* line 231 */
  sim_icache_fetch(130 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_22, reg_r0_22, reg_r0_18); /* line 233 */
   __SHRU(reg_r0_18, reg_r0_14, (unsigned int) 8); /* line 234 */
   __SHRU(reg_r0_26, reg_r0_16, (unsigned int) 8); /* line 235 */
   __MULLU(reg_r0_25, reg_r0_7, reg_r0_21); /* line 236 */
   __MULHS(reg_r0_21, reg_r0_7, reg_r0_21); /* line 237 */
} /* line 237 */
  sim_icache_fetch(135 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_22, 0); /* line 239 */
   __ADD(reg_r0_27, reg_r0_22, (unsigned int) 255); /* line 240 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 241 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 242 */
   __ADD(reg_r0_19, reg_r0_5, reg_r0_19); /* line 243 */
} /* line 243 */
  sim_icache_fetch(140 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_r0_21 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_27, reg_b0_0, reg_r0_27, reg_r0_22); /* line 245 */
   __MULLU(reg_r0_21, reg_r0_15, reg_r0_18); /* line 246 */
   __MULHS(reg_r0_18, reg_r0_15, reg_r0_18); /* line 247 */
   __MULLU(reg_r0_22, reg_r0_17, reg_r0_26); /* line 248 */
   __ADD(reg_r0_25, reg_r0_25, t__i32_0); /* line 249 */
} /* line 249 */
  sim_icache_fetch(145 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 251 */
   __MULHS(reg_r0_26, reg_r0_17, reg_r0_26); /* line 252 */
   __SH2ADD(reg_r0_19, reg_r0_19, (unsigned int) conv7_image); /* line 253 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 254 */
   __ADD(reg_r0_28, reg_r0_25, (unsigned int) 255); /* line 255 */
} /* line 255 */
  sim_icache_fetch(151 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __LDW(reg_r0_24, mem_trace_ld(reg_r0_24,0,4)); /* line 257 */
   __SHL(reg_r0_23, reg_r0_23, (unsigned int) 6); /* line 258 */
   __ADD(reg_r0_21, reg_r0_21, reg_r0_18); /* line 259 */
   __LDW(reg_r0_19, mem_trace_ld(reg_r0_19,0,4)); /* line 260 */
   __SLCT(reg_r0_28, reg_b0_0, reg_r0_28, reg_r0_25); /* line 261 */
} /* line 261 */
  sim_icache_fetch(156 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_23, reg_r0_5, reg_r0_23); /* line 263 */
   __CMPLT(reg_b0_0, reg_r0_21, 0); /* line 264 */
   __ADD(reg_r0_18, reg_r0_21, (unsigned int) 255); /* line 265 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_26); /* line 266 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 267 */
} /* line 267 */
  sim_icache_fetch(161 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_18, reg_b0_0, reg_r0_18, reg_r0_21); /* line 269 */
   __CMPLT(reg_b0_0, reg_r0_22, 0); /* line 270 */
   __ADD(reg_r0_21, reg_r0_22, (unsigned int) 255); /* line 271 */
   __SHRU(reg_r0_25, reg_r0_19, (unsigned int) 8); /* line 272 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_28); /* line 273 */
} /* line 273 */
  sim_icache_fetch(166 + t_thisfile.offset, 6);
{
   ...
   __SHR(reg_r0_18, reg_r0_18, (unsigned int) 8); /* line 276 */
   __SLCT(reg_r0_21, reg_b0_0, reg_r0_21, reg_r0_22); /* line 277 */
   __ADD(reg_r0_22, reg_r0_3, (unsigned int) 4); /* line 278 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 279 */
} /* line 279 */
  sim_icache_fetch(172 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __LDW(reg_r0_23, mem_trace_ld(reg_r0_23,0,4)); /* line 281 */
   __SHR(reg_r0_21, reg_r0_21, (unsigned int) 8); /* line 282 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 6); /* line 283 */
   __MULLU(reg_r0_26, reg_r0_20, reg_r0_25); /* line 284 */
   __MULHS(reg_r0_25, reg_r0_20, reg_r0_25); /* line 285 */
} /* line 285 */
  sim_icache_fetch(177 + t_thisfile.offset, 6);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_21 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHRU(reg_r0_29, reg_r0_9, (unsigned int) 16); /* line 287 */
   __ADD(reg_r0_22, reg_r0_5, reg_r0_22); /* line 288 */
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 289 */
   __SHRU(reg_r0_28, reg_r0_4, (unsigned int) 16); /* line 290 */
   __ADD(reg_r0_18, reg_r0_18, t__i32_0); /* line 291 */
} /* line 291 */
  sim_icache_fetch(183 + t_thisfile.offset, 6);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_18 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHRU(reg_r0_18, reg_r0_23, (unsigned int) 8); /* line 293 */
   __SH2ADD(reg_r0_22, reg_r0_22, (unsigned int) conv7_image); /* line 294 */
   __LDW(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 295 */
   __ADD(reg_r0_26, reg_r0_26, reg_r0_25); /* line 296 */
   __ADD(reg_r0_27, reg_r0_27, t__i32_0); /* line 297 */
} /* line 297 */
  sim_icache_fetch(189 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 299 */
   __LDW(reg_r0_22, mem_trace_ld(reg_r0_22,0,4)); /* line 300 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 301 */
   __ADD(reg_r0_25, reg_r0_26, (unsigned int) 255); /* line 302 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 303 */
} /* line 303 */
  sim_icache_fetch(194 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_r0_26 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULLU(reg_r0_26, reg_r0_24, reg_r0_18); /* line 305 */
   __MULHS(reg_r0_18, reg_r0_24, reg_r0_18); /* line 306 */
   __SLCT(reg_r0_25, reg_b0_0, reg_r0_25, t__i32_0); /* line 307 */
   __MULLU(reg_r0_30, reg_r0_7, reg_r0_28); /* line 308 */
   __MULHS(reg_r0_28, reg_r0_7, reg_r0_28); /* line 309 */
} /* line 309 */
  sim_icache_fetch(199 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 311 */
   __SHRU(reg_r0_32, reg_r0_14, (unsigned int) 16); /* line 312 */
   __SHRU(reg_r0_33, reg_r0_16, (unsigned int) 16); /* line 313 */
   __SHRU(reg_r0_31, reg_r0_22, (unsigned int) 8); /* line 314 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 315 */
} /* line 315 */
  sim_icache_fetch(204 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_r0_18 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULLU(reg_r0_18, reg_r0_10, reg_r0_29); /* line 317 */
   __ADD(reg_r0_26, reg_r0_26, t__i32_0); /* line 318 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 319 */
   __ADD(reg_r0_30, reg_r0_30, reg_r0_28); /* line 320 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_25); /* line 321 */
} /* line 321 */
  sim_icache_fetch(209 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 323 */
   __ADD(reg_r0_25, reg_r0_26, (unsigned int) 255); /* line 324 */
   __MULLU(reg_r0_28, reg_r0_21, reg_r0_31); /* line 325 */
   __MULHS(reg_r0_31, reg_r0_21, reg_r0_31); /* line 326 */
   __CMPLT(reg_b0_1, reg_r0_30, 0); /* line 327 */
} /* line 327 */
  sim_icache_fetch(214 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULHS(reg_r0_29, reg_r0_10, reg_r0_29); /* line 329 */
   __SLCT(reg_r0_25, reg_b0_0, reg_r0_25, reg_r0_26); /* line 330 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 331 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 332 */
   __ADD(reg_r0_26, reg_r0_30, (unsigned int) 255); /* line 333 */
} /* line 333 */
  sim_icache_fetch(219 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_30 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 335 */
   __MULLU(reg_r0_30, reg_r0_15, reg_r0_32); /* line 336 */
   __MULHS(reg_r0_32, reg_r0_15, reg_r0_32); /* line 337 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_31); /* line 338 */
   __SLCT(reg_r0_26, reg_b0_1, reg_r0_26, t__i32_0); /* line 339 */
} /* line 339 */
  sim_icache_fetch(224 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_18, reg_r0_18, reg_r0_29); /* line 341 */
   __MULLU(reg_r0_29, reg_r0_17, reg_r0_33); /* line 342 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 343 */
   __ADD(reg_r0_31, reg_r0_28, (unsigned int) 255); /* line 344 */
   __SHR(reg_r0_26, reg_r0_26, (unsigned int) 8); /* line 345 */
} /* line 345 */
  sim_icache_fetch(229 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_18, 0); /* line 347 */
   __ADD(reg_r0_28, reg_r0_18, (unsigned int) 255); /* line 348 */
   __ADD(reg_r0_30, reg_r0_30, reg_r0_32); /* line 349 */
   __MULHS(reg_r0_33, reg_r0_17, reg_r0_33); /* line 350 */
   __SLCT(reg_r0_31, t__i32_0, reg_r0_31, t__i32_1); /* line 351 */
} /* line 351 */
  sim_icache_fetch(234 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_28, reg_b0_0, reg_r0_28, reg_r0_18); /* line 353 */
   __CMPLT(reg_b0_0, reg_r0_30, 0); /* line 354 */
   __ADD(reg_r0_18, reg_r0_30, (unsigned int) 255); /* line 355 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 356 */
   __SHRU(reg_r0_32, reg_r0_19, (unsigned int) 16); /* line 357 */
} /* line 357 */
  sim_icache_fetch(239 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 359 */
   __SLCT(reg_r0_18, reg_b0_0, reg_r0_18, reg_r0_30); /* line 360 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_33); /* line 361 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 362 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_31); /* line 363 */
} /* line 363 */
  sim_icache_fetch(244 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_25 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_18, reg_r0_18, (unsigned int) 8); /* line 365 */
   __CMPLT(reg_b0_0, reg_r0_29, 0); /* line 366 */
   __ADD(reg_r0_25, reg_r0_29, (unsigned int) 255); /* line 367 */
   __ADD(reg_r0_11, reg_r0_11, t__i32_0); /* line 368 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_26); /* line 369 */
} /* line 369 */
  sim_icache_fetch(249 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_27 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHRU(reg_r0_27, reg_r0_23, (unsigned int) 16); /* line 371 */
   __SLCT(reg_r0_25, reg_b0_0, reg_r0_25, reg_r0_29); /* line 372 */
   __MULLU(reg_r0_26, reg_r0_20, reg_r0_32); /* line 373 */
   __MULHS(reg_r0_32, reg_r0_20, reg_r0_32); /* line 374 */
   __ADD(reg_r0_11, t__i32_0, reg_r0_11); /* line 375 */
} /* line 375 */
  sim_icache_fetch(254 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 377 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 378 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 379 */
   __SHRU(reg_r0_29, reg_r0_22, (unsigned int) 16); /* line 380 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 381 */
} /* line 381 */
  sim_icache_fetch(259 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_25 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULLU(reg_r0_25, reg_r0_24, reg_r0_27); /* line 383 */
   __MULHS(reg_r0_27, reg_r0_24, reg_r0_27); /* line 384 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 385 */
   __ADD(reg_r0_26, reg_r0_26, reg_r0_32); /* line 386 */
   __ADD(reg_r0_18, reg_r0_18, t__i32_0); /* line 387 */
} /* line 387 */
  sim_icache_fetch(264 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_18 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULLU(reg_r0_30, reg_r0_21, reg_r0_29); /* line 389 */
   __MULHS(reg_r0_29, reg_r0_21, reg_r0_29); /* line 390 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 391 */
   __ADD(reg_r0_18, reg_r0_26, (unsigned int) 255); /* line 392 */
   __ADD(reg_r0_28, reg_r0_28, t__i32_0); /* line 393 */
} /* line 393 */
  sim_icache_fetch(269 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULLU(reg_r0_4, reg_r0_10, reg_r0_9); /* line 395 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_27); /* line 396 */
   __SLCT(reg_r0_18, reg_b0_0, reg_r0_18, reg_r0_26); /* line 397 */
   __MULLU(reg_r0_26, reg_r0_7, t__i32_0); /* line 398 */
   __MULHS(reg_r0_7, reg_r0_7, t__i32_0); /* line 399 */
} /* line 399 */
  sim_icache_fetch(274 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULHS(reg_r0_10, reg_r0_10, reg_r0_9); /* line 401 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 402 */
   __ADD(reg_r0_27, reg_r0_25, (unsigned int) 255); /* line 403 */
   __ADD(reg_r0_30, reg_r0_30, reg_r0_29); /* line 404 */
   __SHR(reg_r0_18, reg_r0_18, (unsigned int) 8); /* line 405 */
} /* line 405 */
  sim_icache_fetch(279 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_27, reg_b0_0, reg_r0_27, reg_r0_25); /* line 407 */
   __CMPLT(reg_b0_0, reg_r0_30, 0); /* line 408 */
   __ADD(reg_r0_9, reg_r0_30, (unsigned int) 255); /* line 409 */
   __ADD(reg_r0_26, reg_r0_26, reg_r0_7); /* line 410 */
   __ADD(reg_r0_12, reg_r0_12, reg_r0_18); /* line 411 */
} /* line 411 */
  sim_icache_fetch(284 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_4, reg_r0_4, reg_r0_10); /* line 413 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 414 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_30); /* line 415 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 416 */
   __ADD(reg_r0_7, reg_r0_26, (unsigned int) 255); /* line 417 */
} /* line 417 */
  sim_icache_fetch(289 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_4, 0); /* line 419 */
   __ADD(reg_r0_10, reg_r0_4, (unsigned int) 255); /* line 420 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 421 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 422 */
   __SLCT(reg_r0_7, t__i32_0, reg_r0_7, reg_r0_26); /* line 423 */
} /* line 423 */
  sim_icache_fetch(294 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_4); /* line 425 */
   __MULLU(reg_r0_4, reg_r0_15, reg_r0_14); /* line 426 */
   __MULHS(reg_r0_15, reg_r0_15, reg_r0_14); /* line 427 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 428 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_9); /* line 429 */
} /* line 429 */
  sim_icache_fetch(299 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 431 */
   __AND(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 432 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 433 */
   __AND(reg_r0_19, reg_r0_19, (unsigned int) 255); /* line 434 */
   __ADD(reg_r0_12, reg_r0_12, reg_r0_27); /* line 435 */
} /* line 435 */
  sim_icache_fetch(304 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_4, reg_r0_4, reg_r0_15); /* line 437 */
   __MULLU(reg_r0_7, reg_r0_17, reg_r0_16); /* line 438 */
   __MULHS(reg_r0_17, reg_r0_17, reg_r0_16); /* line 439 */
   __ADD(reg_r0_10, reg_r0_10, t__i32_0); /* line 440 */
   __ADD(reg_r0_12, reg_r0_28, reg_r0_12); /* line 441 */
} /* line 441 */
  sim_icache_fetch(309 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULLU(reg_r0_15, reg_r0_24, reg_r0_23); /* line 443 */
   __CMPLT(reg_b0_0, reg_r0_4, 0); /* line 444 */
   __ADD(reg_r0_9, reg_r0_4, (unsigned int) 255); /* line 445 */
   __MULLU(reg_r0_14, reg_r0_20, reg_r0_19); /* line 446 */
   __MULHS(reg_r0_20, reg_r0_20, reg_r0_19); /* line 447 */
} /* line 447 */
  sim_icache_fetch(314 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MULHS(reg_r0_24, reg_r0_24, reg_r0_23); /* line 449 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_4); /* line 450 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_17); /* line 451 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 452 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 453 */
} /* line 453 */
  sim_icache_fetch(319 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 455 */
   __CMPLT(reg_b0_0, reg_r0_7, 0); /* line 456 */
   __ADD(reg_r0_4, reg_r0_7, (unsigned int) 255); /* line 457 */
   __MULLU(reg_r0_16, reg_r0_21, reg_r0_22); /* line 458 */
   __ADD(reg_r0_14, reg_r0_14, reg_r0_20); /* line 459 */
} /* line 459 */
  sim_icache_fetch(324 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_15, reg_r0_15, reg_r0_24); /* line 461 */
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_7); /* line 462 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_22); /* line 463 */
   __CMPLT(reg_b0_0, reg_r0_14, 0); /* line 464 */
   __ADD(reg_r0_7, reg_r0_14, (unsigned int) 255); /* line 465 */
} /* line 465 */
  sim_icache_fetch(329 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_15, 0); /* line 467 */
   __ADD(reg_r0_14, reg_r0_15, (unsigned int) 255); /* line 468 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 469 */
   __SLCT(reg_r0_7, t__i32_0, reg_r0_7, t__i32_1); /* line 470 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 471 */
} /* line 471 */
  sim_icache_fetch(334 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_14, reg_b0_0, reg_r0_14, reg_r0_15); /* line 473 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_21); /* line 474 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 475 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 476 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_4); /* line 477 */
} /* line 477 */
  sim_icache_fetch(339 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 479 */
   __CMPLT(reg_b0_0, reg_r0_16, 0); /* line 480 */
   __ADD(reg_r0_4, reg_r0_16, (unsigned int) 255); /* line 481 */
   __ADD(reg_r0_13, reg_r0_13, reg_r0_7); /* line 482 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_9); /* line 483 */
} /* line 483 */
  sim_icache_fetch(344 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_16); /* line 485 */
} /* line 485 */
  ...
  sim_icache_fetch(346 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_14, reg_r0_14, reg_r0_4); /* line 489 */
} /* line 489 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_13, reg_r0_13, reg_r0_14); /* line 491 */
} /* line 491 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_13, reg_r0_10, reg_r0_13); /* line 493 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_13, reg_r0_13, 0); /* line 498 */
   __MAX(reg_r0_11, reg_r0_11, 0); /* line 499 */
   __MAX(reg_r0_12, reg_r0_12, 0); /* line 500 */
   __SH2ADD(reg_r0_2, reg_r0_34, reg_r0_36); /* line 501 */
   __ADD(reg_r0_4, reg_r0_34, (unsigned int) 1); /* line 502 */
} /* line 502 */
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 504 */
   __MIN(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 505 */
   __MIN(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 506 */
   __ADD(reg_r0_7, reg_r0_35, (unsigned int) 1); /* line 507 */
} /* line 507 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 509 */
   __SHL(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 510 */
} /* line 510 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_13, reg_r0_13, reg_r0_12); /* line 512 */
} /* line 512 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_13, reg_r0_13, reg_r0_11); /* line 514 */
} /* line 514 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_13); /* line 516 */
  ...
  sim_icache_fetch(365 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_36, reg_r0_36, (unsigned int) 256); /* line 521 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 64); /* line 522 */
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 1); /* line 523 */
  ...
  sim_icache_fetch(370 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_37); /* line 530 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 531 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(375 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 533 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 534 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 535 */
   __ADD_CYCLES(1);
} /* line 535 */
