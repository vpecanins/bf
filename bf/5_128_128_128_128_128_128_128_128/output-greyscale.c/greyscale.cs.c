  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 156 */
   __MOV(reg_r0_5, (unsigned int) grey_framebuffer); /* line 157 */
   __MOV(reg_r0_6, (unsigned int) grey_image); /* line 158 */
   __MOV(reg_r0_24, t__i32_0); /* line 159 */
} /* line 159 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 164 */
   __MOV(reg_r0_9, (unsigned int) -55); /* line 165 */
   __MOV(reg_r0_4, reg_r0_5); /* line 166 */
   __MOV(reg_r0_2, reg_r0_6); /* line 167 */
   __MOV(reg_r0_21, reg_r0_3); /* line 168 */
} /* line 168 */
  sim_icache_fetch(73 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MOV(reg_r0_22, reg_r0_5); /* line 170 */
   __MOV(reg_r0_23, reg_r0_6); /* line 171 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L5X3; 
...
l_L6X3: ;/* line 175 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __LDW(reg_r0_5, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 176 */
   __LDW(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 177 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 178 */
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 179 */
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 16),0,4)); /* line 180 */
} /* line 180 */
  sim_icache_fetch(81 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 20),0,4)); /* line 182 */
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 24),0,4)); /* line 183 */
   __LDW(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 184 */
   __LDW(reg_r0_13, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 185 */
   __CMPLT(reg_b0_0, reg_r0_9, 0); /* line 186 */
} /* line 186 */
  sim_icache_fetch(86 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __AND(reg_r0_15, reg_r0_3, (unsigned int) 255); /* line 188 */
   __AND(reg_r0_17, reg_r0_5, (unsigned int) 255); /* line 189 */
   __SHRU(reg_r0_14, reg_r0_3, (unsigned int) 8); /* line 190 */
   __SHRU(reg_r0_16, reg_r0_5, (unsigned int) 8); /* line 191 */
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 192 */
} /* line 192 */
  sim_icache_fetch(91 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 194 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 195 */
   __SHRU(reg_r0_18, reg_r0_6, (unsigned int) 8); /* line 196 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 197 */
   __SHRU(reg_r0_5, reg_r0_5, (unsigned int) 16); /* line 198 */
} /* line 198 */
  sim_icache_fetch(96 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_14 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __AND(reg_r0_14, reg_r0_6, (unsigned int) 255); /* line 200 */
   __MAX(reg_r0_15, reg_r0_15, t__i32_0); /* line 201 */
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 202 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 203 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 204 */
} /* line 204 */
  sim_icache_fetch(101 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_14, reg_r0_14, reg_r0_18); /* line 206 */
   __MAX(reg_r0_15, reg_r0_15, reg_r0_3); /* line 207 */
   __MAX(reg_r0_17, reg_r0_17, reg_r0_5); /* line 208 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 209 */
   __SHRU(reg_r0_3, reg_r0_7, (unsigned int) 8); /* line 210 */
} /* line 210 */
  sim_icache_fetch(106 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ZXTB(reg_r0_15, reg_r0_15); /* line 212 */
   __ZXTB(reg_r0_17, reg_r0_17); /* line 213 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 214 */
   __AND(reg_r0_5, reg_r0_7, (unsigned int) 255); /* line 215 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 216 */
} /* line 216 */
  sim_icache_fetch(111 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHL(reg_r0_18, reg_r0_15, (unsigned int) 8); /* line 218 */
   __SHL(reg_r0_16, reg_r0_15, (unsigned int) 16); /* line 219 */
   __SHL(reg_r0_20, reg_r0_17, (unsigned int) 8); /* line 220 */
   __SHL(reg_r0_19, reg_r0_17, (unsigned int) 16); /* line 221 */
   __MAX(reg_r0_14, reg_r0_14, reg_r0_6); /* line 222 */
} /* line 222 */
  sim_icache_fetch(116 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_15, reg_r0_15, reg_r0_16); /* line 224 */
   __OR(reg_r0_17, reg_r0_17, reg_r0_19); /* line 225 */
   __ZXTB(reg_r0_14, reg_r0_14); /* line 226 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 227 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 228 */
} /* line 228 */
  sim_icache_fetch(121 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_15, reg_r0_15, reg_r0_18); /* line 230 */
   __OR(reg_r0_17, reg_r0_17, reg_r0_20); /* line 231 */
   __SHL(reg_r0_6, reg_r0_14, (unsigned int) 8); /* line 232 */
   __SHL(reg_r0_3, reg_r0_14, (unsigned int) 16); /* line 233 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 234 */
} /* line 234 */
  sim_icache_fetch(126 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_14, reg_r0_14, reg_r0_3); /* line 236 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_7); /* line 237 */
   __AND(reg_r0_7, reg_r0_8, (unsigned int) 255); /* line 238 */
   __SHRU(reg_r0_3, reg_r0_8, (unsigned int) 8); /* line 239 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 240 */
} /* line 240 */
  sim_icache_fetch(131 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_14, reg_r0_14, reg_r0_6); /* line 242 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 243 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 244 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 245 */
   __SHRU(reg_r0_6, reg_r0_10, (unsigned int) 8); /* line 246 */
} /* line 246 */
  sim_icache_fetch(136 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHL(reg_r0_18, reg_r0_5, (unsigned int) 8); /* line 248 */
   __SHL(reg_r0_16, reg_r0_5, (unsigned int) 16); /* line 249 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_3); /* line 250 */
   __AND(reg_r0_3, reg_r0_10, (unsigned int) 255); /* line 251 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 252 */
} /* line 252 */
  sim_icache_fetch(141 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_5, reg_r0_5, reg_r0_16); /* line 254 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_8); /* line 255 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_6); /* line 256 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 257 */
   __SHRU(reg_r0_6, reg_r0_11, (unsigned int) 8); /* line 258 */
} /* line 258 */
  sim_icache_fetch(146 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_5, reg_r0_5, reg_r0_18); /* line 260 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 261 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 262 */
   __AND(reg_r0_8, reg_r0_11, (unsigned int) 255); /* line 263 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 264 */
} /* line 264 */
  sim_icache_fetch(151 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHL(reg_r0_18, reg_r0_7, (unsigned int) 8); /* line 266 */
   __SHL(reg_r0_16, reg_r0_7, (unsigned int) 16); /* line 267 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_10); /* line 268 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_6); /* line 269 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 270 */
} /* line 270 */
  sim_icache_fetch(156 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_7, reg_r0_7, reg_r0_16); /* line 272 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 273 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 274 */
   __AND(reg_r0_10, reg_r0_12, (unsigned int) 255); /* line 275 */
   __SHRU(reg_r0_6, reg_r0_12, (unsigned int) 8); /* line 276 */
} /* line 276 */
  sim_icache_fetch(161 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_7, reg_r0_7, reg_r0_18); /* line 278 */
   __SHL(reg_r0_18, reg_r0_3, (unsigned int) 8); /* line 279 */
   __SHL(reg_r0_16, reg_r0_3, (unsigned int) 16); /* line 280 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_11); /* line 281 */
  ...
  sim_icache_fetch(166 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_3, reg_r0_3, reg_r0_16); /* line 284 */
   __ZXTB(reg_r0_8, reg_r0_8); /* line 285 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_6); /* line 286 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 287 */
   __SHRU(reg_r0_6, reg_r0_13, (unsigned int) 8); /* line 288 */
} /* line 288 */
  sim_icache_fetch(171 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_3, reg_r0_3, reg_r0_18); /* line 290 */
   __SHL(reg_r0_16, reg_r0_8, (unsigned int) 8); /* line 291 */
   __SHL(reg_r0_11, reg_r0_8, (unsigned int) 16); /* line 292 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 293 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 294 */
} /* line 294 */
  sim_icache_fetch(176 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_8, reg_r0_8, reg_r0_11); /* line 296 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_12); /* line 297 */
   __AND(reg_r0_11, reg_r0_13, (unsigned int) 255); /* line 298 */
   __SHRU(reg_r0_13, reg_r0_13, (unsigned int) 16); /* line 299 */
   __LDWs(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 36),0,4)); /* line 300 */
} /* line 300 */
  sim_icache_fetch(181 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_8, reg_r0_8, reg_r0_16); /* line 302 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 303 */
   __MAX(reg_r0_11, reg_r0_11, reg_r0_6); /* line 304 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 305 */
   __LDWs(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 306 */
} /* line 306 */
  sim_icache_fetch(186 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHL(reg_r0_18, reg_r0_10, (unsigned int) 8); /* line 308 */
   __SHL(reg_r0_16, reg_r0_10, (unsigned int) 16); /* line 309 */
   __MAX(reg_r0_11, reg_r0_11, reg_r0_13); /* line 310 */
   __AND(reg_r0_19, reg_r0_12, (unsigned int) 255); /* line 311 */
   __SHRU(reg_r0_13, reg_r0_12, (unsigned int) 8); /* line 312 */
} /* line 312 */
  sim_icache_fetch(191 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_10, reg_r0_10, reg_r0_16); /* line 314 */
   __ZXTB(reg_r0_11, reg_r0_11); /* line 315 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 316 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 317 */
   __SHRU(reg_r0_16, reg_r0_6, (unsigned int) 8); /* line 318 */
} /* line 318 */
  sim_icache_fetch(196 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_10, reg_r0_10, reg_r0_18); /* line 320 */
   __SHL(reg_r0_20, reg_r0_11, (unsigned int) 8); /* line 321 */
   __SHL(reg_r0_18, reg_r0_11, (unsigned int) 16); /* line 322 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_13); /* line 323 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 324 */
} /* line 324 */
  sim_icache_fetch(201 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_11, reg_r0_11, reg_r0_18); /* line 326 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_12); /* line 327 */
   __AND(reg_r0_12, reg_r0_6, (unsigned int) 255); /* line 328 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 329 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 330 */
} /* line 330 */
  sim_icache_fetch(206 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_11, reg_r0_11, reg_r0_20); /* line 332 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 333 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_16); /* line 334 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 335 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 336 */
} /* line 336 */
  sim_icache_fetch(211 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_15); /* line 338 */
   __SHL(reg_r0_16, reg_r0_19, (unsigned int) 8); /* line 339 */
   __SHL(reg_r0_13, reg_r0_19, (unsigned int) 16); /* line 340 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_6); /* line 341 */
   __ADD(reg_r0_9, reg_r0_9, (unsigned int) 11); /* line 342 */
} /* line 342 */
  sim_icache_fetch(216 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_17); /* line 344 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_14); /* line 345 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_5); /* line 346 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_13); /* line 347 */
   __ZXTB(reg_r0_12, reg_r0_12); /* line 348 */
} /* line 348 */
  sim_icache_fetch(221 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_7); /* line 350 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_3); /* line 351 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_16); /* line 352 */
   __SHL(reg_r0_6, reg_r0_12, (unsigned int) 8); /* line 353 */
   __SHL(reg_r0_5, reg_r0_12, (unsigned int) 16); /* line 354 */
} /* line 354 */
  sim_icache_fetch(226 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_8); /* line 356 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_10); /* line 357 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_11); /* line 358 */
   __OR(reg_r0_12, reg_r0_12, reg_r0_5); /* line 359 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(231 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_19); /* line 362 */
   __OR(reg_r0_12, reg_r0_12, reg_r0_6); /* line 363 */
} /* line 363 */
  sim_icache_fetch(233 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_12); /* line 365 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 366 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_23, (unsigned int) 256); /* line 371 */
   __ADD(reg_r0_5, reg_r0_22, (unsigned int) 256); /* line 372 */
   __ADD(reg_r0_3, reg_r0_21, (unsigned int) 1); /* line 373 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_24); /* line 380 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 381 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 383 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 384 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 385 */
   __ADD_CYCLES(1);
} /* line 385 */
