  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   ...
   __MOV(reg_r0_40, t__i32_0); /* line 154 */
} /* line 154 */
  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 23);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(23);
  ...
  sim_icache_fetch(114 + t_thisfile.offset, 23);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(23);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 211 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 212 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 213 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 214 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 215 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 216 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 217 */
   ...
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 222 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 223 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 224 */
   ...
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 232 */
   __SHRU(reg_r0_36, reg_r0_15, (unsigned int) 8); /* line 233 */
} /* line 233 */
  sim_icache_fetch(137 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 235 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 236 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 237 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 238 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 239 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 240 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_28); /* line 241 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_30); /* line 242 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 243 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 244 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 245 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 246 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 247 */
   __AND(reg_r0_16, reg_r0_15, (unsigned int) 255); /* line 248 */
  ...
  sim_icache_fetch(153 + t_thisfile.offset, 12);
{
   ...
   __MAX(reg_r0_16, reg_r0_16, reg_r0_36); /* line 262 */
  ...
  sim_icache_fetch(165 + t_thisfile.offset, 11);
{
   ...
   __MAX(reg_r0_16, reg_r0_16, reg_r0_15); /* line 275 */
} /* line 275 */
  sim_icache_fetch(176 + t_thisfile.offset, 19);
{
   ...
   __SHL(reg_r0_18, reg_r0_27, (unsigned int) 8); /* line 287 */
   __SHL(reg_r0_15, reg_r0_27, (unsigned int) 16); /* line 288 */
   __SHL(reg_r0_22, reg_r0_29, (unsigned int) 8); /* line 289 */
   __SHL(reg_r0_20, reg_r0_29, (unsigned int) 16); /* line 290 */
   __SHL(reg_r0_26, reg_r0_31, (unsigned int) 8); /* line 291 */
   __SHL(reg_r0_24, reg_r0_31, (unsigned int) 16); /* line 292 */
   __ZXTB(reg_r0_33, reg_r0_33); /* line 293 */
   __ZXTB(reg_r0_35, reg_r0_35); /* line 294 */
   __ZXTB(reg_r0_16, reg_r0_16); /* line 295 */
} /* line 295 */
  sim_icache_fetch(195 + t_thisfile.offset, 14);
{
   ...
   __OR(reg_r0_29, reg_r0_29, reg_r0_20); /* line 303 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_24); /* line 304 */
   ...
   __SHL(reg_r0_15, reg_r0_16, (unsigned int) 8); /* line 309 */
   __SHL(reg_r0_12, reg_r0_16, (unsigned int) 16); /* line 310 */
} /* line 310 */
  sim_icache_fetch(209 + t_thisfile.offset, 11);
{
   ...
   __OR(reg_r0_27, reg_r0_27, reg_r0_18); /* line 317 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_22); /* line 318 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_26); /* line 319 */
   __OR(reg_r0_33, reg_r0_33, reg_r0_3); /* line 320 */
   __OR(reg_r0_35, reg_r0_35, reg_r0_8); /* line 321 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_12); /* line 322 */
} /* line 322 */
  sim_icache_fetch(220 + t_thisfile.offset, 11);
{
   ...
   __OR(reg_r0_16, reg_r0_16, reg_r0_15); /* line 334 */
} /* line 334 */
  ...
  sim_icache_fetch(233 + t_thisfile.offset, 4);
{
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_16); /* line 340 */
  ...
  sim_icache_fetch(237 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_39, (unsigned int) 256); /* line 346 */
   __ADD(reg_r0_5, reg_r0_38, (unsigned int) 256); /* line 347 */
   __ADD(reg_r0_3, reg_r0_37, (unsigned int) 1); /* line 348 */
  ...
  sim_icache_fetch(243 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_40); /* line 355 */
