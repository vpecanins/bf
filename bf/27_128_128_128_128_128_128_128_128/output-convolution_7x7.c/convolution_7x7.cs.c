...
/* "" */
/* "-dir /home/user/tools/vex-3.43 -fmm=/home/user/workspace/assignment1/configurations/bf/27_128_128_128_128_128_128_128_128/configuration.mm -width 1 -c99inline -ms -mas_g -mas_G -O3 -H3 -o a.out" */
  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 27);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(27);
   ...
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 139 */
} /* line 139 */
  sim_icache_fetch(54 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   ...
   __MOV(reg_r0_56, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 153 */
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 20),0,4), reg_r0_57); /* line 154 */
} /* line 154 */
  sim_icache_fetch(66 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_57, reg_r0_5); /* line 156 */
} /* line 156 */
l_L4X3: ;/* line 159 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(71 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_22, 0); /* line 172 */
   __MOV(reg_r0_17, 0); /* line 173 */
   __MOV(reg_r0_23, 0); /* line 174 */
   __MOV(reg_r0_54, reg_r0_4); /* line 175 */
   __MOV(reg_r0_55, reg_r0_7); /* line 176 */
} /* line 176 */
...
l_L8X3: ;/* line 181 */
__LABEL(l_L8X3);
  sim_icache_fetch(81 + t_thisfile.offset, 24);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   ...
   __ADD(reg_r0_18, reg_r0_3, (unsigned int) 1); /* line 185 */
   __SH2ADD(reg_r0_19, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 186 */
   __ADD(reg_r0_11, reg_r0_3, (unsigned int) 2); /* line 187 */
   __SH2ADD(reg_r0_12, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 8)); /* line 188 */
   __ADD(reg_r0_13, reg_r0_3, (unsigned int) 3); /* line 189 */
   __SH2ADD(reg_r0_14, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 12)); /* line 190 */
   __ADD(reg_r0_20, reg_r0_3, (unsigned int) 4); /* line 191 */
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 192 */
   __ADD(reg_r0_15, reg_r0_3, (unsigned int) 5); /* line 193 */
   __SH2ADD(reg_r0_16, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 194 */
   ...
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 197 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 198 */
} /* line 198 */
  sim_icache_fetch(105 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __LDWs(reg_r0_10, mem_trace_ld(reg_r0_10,0,4)); /* line 200 */
   __SH2ADD(reg_r0_9, reg_r0_9, (unsigned int) conv7_image); /* line 201 */
   __LDWs(reg_r0_19, mem_trace_ld(reg_r0_19,0,4)); /* line 202 */
   __SHL(reg_r0_18, reg_r0_18, (unsigned int) 6); /* line 203 */
   __SHL(reg_r0_11, reg_r0_11, (unsigned int) 6); /* line 204 */
   __LDWs(reg_r0_12, mem_trace_ld(reg_r0_12,0,4)); /* line 205 */
   __SHL(reg_r0_13, reg_r0_13, (unsigned int) 6); /* line 206 */
   __LDWs(reg_r0_14, mem_trace_ld(reg_r0_14,0,4)); /* line 207 */
   __SHL(reg_r0_20, reg_r0_20, (unsigned int) 6); /* line 208 */
   __LDWs(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 209 */
   __SHL(reg_r0_15, reg_r0_15, (unsigned int) 6); /* line 210 */
   __LDWs(reg_r0_16, mem_trace_ld(reg_r0_16,0,4)); /* line 211 */
   __SHL(reg_r0_4, reg_r0_4, (unsigned int) 6); /* line 212 */
   __LDWs(reg_r0_7, mem_trace_ld(reg_r0_7,0,4)); /* line 213 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(121 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 216 */
   __ADD(reg_r0_18, reg_r0_5, reg_r0_18); /* line 217 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 218 */
   __ADD(reg_r0_13, reg_r0_5, reg_r0_13); /* line 219 */
   __ADD(reg_r0_20, reg_r0_5, reg_r0_20); /* line 220 */
   __ADD(reg_r0_15, reg_r0_5, reg_r0_15); /* line 221 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 222 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 223 */
} /* line 223 */
  sim_icache_fetch(129 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SH2ADD(reg_r0_18, reg_r0_18, (unsigned int) conv7_image); /* line 225 */
   __SH2ADD(reg_r0_11, reg_r0_11, (unsigned int) conv7_image); /* line 226 */
   __SH2ADD(reg_r0_13, reg_r0_13, (unsigned int) conv7_image); /* line 227 */
   __SH2ADD(reg_r0_20, reg_r0_20, (unsigned int) conv7_image); /* line 228 */
   __SH2ADD(reg_r0_15, reg_r0_15, (unsigned int) conv7_image); /* line 229 */
   __SH2ADD(reg_r0_4, reg_r0_4, (unsigned int) conv7_image); /* line 230 */
} /* line 230 */
  sim_icache_fetch(141 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHRU(reg_r0_25, t__i32_0, (unsigned int) 16); /* line 232 */
   __AND(reg_r0_9, t__i32_0, (unsigned int) 255); /* line 233 */
   __SHRU(reg_r0_24, t__i32_0, (unsigned int) 8); /* line 234 */
   __LDW(reg_r0_18, mem_trace_ld(reg_r0_18,0,4)); /* line 235 */
   __LDW(reg_r0_11, mem_trace_ld(reg_r0_11,0,4)); /* line 236 */
   __LDW(reg_r0_13, mem_trace_ld(reg_r0_13,0,4)); /* line 237 */
   __LDW(reg_r0_20, mem_trace_ld(reg_r0_20,0,4)); /* line 238 */
   __LDW(reg_r0_15, mem_trace_ld(reg_r0_15,0,4)); /* line 239 */
   __LDW(reg_r0_4, mem_trace_ld(reg_r0_4,0,4)); /* line 240 */
} /* line 240 */
  sim_icache_fetch(150 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 242 */
   __MULLU(reg_r0_26, reg_r0_10, reg_r0_9); /* line 243 */
   __MULHS(reg_r0_9, reg_r0_10, reg_r0_9); /* line 244 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 245 */
} /* line 245 */
  sim_icache_fetch(154 + t_thisfile.offset, 22);
{
  unsigned int t__i32_0;
  ...
  t__i32_6 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   __MULLU(reg_r0_35, t__i32_0, reg_r0_25); /* line 247 */
   __MULHS(reg_r0_10, t__i32_0, reg_r0_25); /* line 248 */
   __MULLU(reg_r0_28, t__i32_0, reg_r0_24); /* line 249 */
   __MULHS(reg_r0_24, t__i32_0, reg_r0_24); /* line 250 */
   __SHRU(reg_r0_38, t__i32_1, (unsigned int) 16); /* line 251 */
   __AND(reg_r0_18, t__i32_1, (unsigned int) 255); /* line 252 */
   __SHRU(reg_r0_32, t__i32_1, (unsigned int) 8); /* line 253 */
   __SHRU(reg_r0_25, t__i32_2, (unsigned int) 16); /* line 254 */
   __AND(reg_r0_11, t__i32_2, (unsigned int) 255); /* line 255 */
   __SHRU(reg_r0_29, t__i32_2, (unsigned int) 8); /* line 256 */
   __SHRU(reg_r0_36, t__i32_3, (unsigned int) 16); /* line 257 */
   __AND(reg_r0_13, t__i32_3, (unsigned int) 255); /* line 258 */
   __SHRU(reg_r0_30, t__i32_3, (unsigned int) 8); /* line 259 */
   __SHRU(reg_r0_39, t__i32_4, (unsigned int) 16); /* line 260 */
   __AND(reg_r0_20, t__i32_4, (unsigned int) 255); /* line 261 */
   __SHRU(reg_r0_33, t__i32_4, (unsigned int) 8); /* line 262 */
   __SHRU(reg_r0_37, t__i32_5, (unsigned int) 16); /* line 263 */
   __AND(reg_r0_15, t__i32_5, (unsigned int) 255); /* line 264 */
   __SHRU(reg_r0_31, t__i32_5, (unsigned int) 8); /* line 265 */
   __SHRU(reg_r0_34, t__i32_6, (unsigned int) 16); /* line 266 */
   __AND(reg_r0_4, t__i32_6, (unsigned int) 255); /* line 267 */
   __SHRU(reg_r0_27, t__i32_6, (unsigned int) 8); /* line 268 */
} /* line 268 */
  sim_icache_fetch(176 + t_thisfile.offset, 25);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(25);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 270 */
   __AND(reg_r0_38, reg_r0_38, (unsigned int) 255); /* line 271 */
   __MULLU(reg_r0_43, reg_r0_19, reg_r0_18); /* line 272 */
   __MULHS(reg_r0_18, reg_r0_19, reg_r0_18); /* line 273 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 274 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 275 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 276 */
   __MULLU(reg_r0_9, reg_r0_12, reg_r0_11); /* line 277 */
   __MULHS(reg_r0_11, reg_r0_12, reg_r0_11); /* line 278 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 279 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 280 */
   __MULLU(reg_r0_41, reg_r0_14, reg_r0_13); /* line 281 */
   __MULHS(reg_r0_13, reg_r0_14, reg_r0_13); /* line 282 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 283 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 284 */
   __MULLU(reg_r0_44, reg_r0_21, reg_r0_20); /* line 285 */
   __MULHS(reg_r0_20, reg_r0_21, reg_r0_20); /* line 286 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 287 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 288 */
   __MULLU(reg_r0_42, reg_r0_16, reg_r0_15); /* line 289 */
   __MULHS(reg_r0_15, reg_r0_16, reg_r0_15); /* line 290 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 291 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 292 */
   __MULLU(reg_r0_40, reg_r0_7, reg_r0_4); /* line 293 */
   __MULHS(reg_r0_4, reg_r0_7, reg_r0_4); /* line 294 */
} /* line 294 */
  sim_icache_fetch(201 + t_thisfile.offset, 27);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_8 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(27);
   __ADD(reg_r0_35, reg_r0_35, reg_r0_10); /* line 296 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 297 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 298 */
   __MULLU(reg_r0_36, t__i32_0, reg_r0_38); /* line 299 */
   __MULHS(reg_r0_19, t__i32_0, reg_r0_38); /* line 300 */
   __MULLU(reg_r0_48, t__i32_0, reg_r0_32); /* line 301 */
   __MULHS(reg_r0_32, t__i32_0, reg_r0_32); /* line 302 */
   __MULLU(reg_r0_10, t__i32_1, reg_r0_25); /* line 303 */
   __MULHS(reg_r0_12, t__i32_1, reg_r0_25); /* line 304 */
   __MULLU(reg_r0_24, t__i32_1, reg_r0_29); /* line 305 */
   __MULHS(reg_r0_29, t__i32_1, reg_r0_29); /* line 306 */
   __MULLU(reg_r0_25, t__i32_3, t__i32_2); /* line 307 */
   __MULHS(reg_r0_14, t__i32_3, t__i32_2); /* line 308 */
   __MULLU(reg_r0_46, t__i32_3, reg_r0_30); /* line 309 */
   __MULHS(reg_r0_30, t__i32_3, reg_r0_30); /* line 310 */
   __MULLU(reg_r0_37, t__i32_4, reg_r0_39); /* line 311 */
   __MULHS(reg_r0_21, t__i32_4, reg_r0_39); /* line 312 */
   __MULLU(reg_r0_49, t__i32_4, reg_r0_33); /* line 313 */
   __MULHS(reg_r0_33, t__i32_4, reg_r0_33); /* line 314 */
   __MULLU(reg_r0_34, t__i32_6, t__i32_5); /* line 315 */
   __MULHS(reg_r0_16, t__i32_6, t__i32_5); /* line 316 */
   __MULLU(reg_r0_47, t__i32_6, reg_r0_31); /* line 317 */
   __MULHS(reg_r0_31, t__i32_6, reg_r0_31); /* line 318 */
   __MULLU(reg_r0_50, t__i32_8, t__i32_7); /* line 319 */
   __MULHS(reg_r0_7, t__i32_8, t__i32_7); /* line 320 */
   __MULLU(reg_r0_45, t__i32_8, reg_r0_27); /* line 321 */
   __MULHS(reg_r0_27, t__i32_8, reg_r0_27); /* line 322 */
} /* line 322 */
  sim_icache_fetch(228 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __CMPLT(reg_b0_2, reg_r0_35, 0); /* line 324 */
   __ADD(reg_r0_39, reg_r0_35, (unsigned int) 255); /* line 325 */
   __ADD(reg_r0_4, reg_r0_26, (unsigned int) 255); /* line 326 */
   __CMPLT(reg_b0_1, reg_r0_28, 0); /* line 327 */
   __ADD(reg_r0_38, reg_r0_28, (unsigned int) 255); /* line 328 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_18); /* line 329 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_11); /* line 330 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_13); /* line 331 */
   __ADD(reg_r0_44, reg_r0_44, reg_r0_20); /* line 332 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_15); /* line 333 */
   __ADD(reg_r0_40, reg_r0_40, t__i32_0); /* line 334 */
} /* line 334 */
  sim_icache_fetch(239 + t_thisfile.offset, 27);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_14 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(27);
   __SLCT(reg_r0_39, reg_b0_2, reg_r0_39, reg_r0_35); /* line 336 */
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_26); /* line 337 */
   __SLCT(reg_r0_38, reg_b0_1, reg_r0_38, reg_r0_28); /* line 338 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_19); /* line 339 */
   __CMPLT(reg_b0_4, reg_r0_43, 0); /* line 340 */
   __ADD(reg_r0_14, reg_r0_43, (unsigned int) 255); /* line 341 */
   __ADD(reg_r0_48, reg_r0_48, reg_r0_32); /* line 342 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_12); /* line 343 */
   __CMPLT(reg_b0_0, reg_r0_9, 0); /* line 344 */
   __ADD(reg_r0_11, reg_r0_9, (unsigned int) 255); /* line 345 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 346 */
   __ADD(reg_r0_25, reg_r0_25, t__i32_0); /* line 347 */
   __CMPLT(reg_b0_2, reg_r0_41, 0); /* line 348 */
   __ADD(reg_r0_12, reg_r0_41, (unsigned int) 255); /* line 349 */
   __ADD(reg_r0_46, reg_r0_46, reg_r0_30); /* line 350 */
   __ADD(reg_r0_37, reg_r0_37, reg_r0_21); /* line 351 */
   __CMPLT(reg_b0_5, reg_r0_44, 0); /* line 352 */
   __ADD(reg_r0_15, reg_r0_44, (unsigned int) 255); /* line 353 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_33); /* line 354 */
   __ADD(reg_r0_34, reg_r0_34, reg_r0_16); /* line 355 */
   __CMPLT(reg_b0_3, reg_r0_42, 0); /* line 356 */
   __ADD(reg_r0_13, reg_r0_42, (unsigned int) 255); /* line 357 */
   __ADD(reg_r0_47, reg_r0_47, reg_r0_31); /* line 358 */
   __ADD(reg_r0_50, reg_r0_50, reg_r0_7); /* line 359 */
   __CMPLT(reg_b0_1, reg_r0_40, 0); /* line 360 */
   __ADD(reg_r0_7, reg_r0_40, (unsigned int) 255); /* line 361 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_27); /* line 362 */
} /* line 362 */
  sim_icache_fetch(266 + t_thisfile.offset, 27);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_4 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(27);
   __SHR(reg_r0_39, reg_r0_39, (unsigned int) 8); /* line 364 */
   __SHR(reg_r0_38, reg_r0_38, (unsigned int) 8); /* line 365 */
   __ADD(reg_r0_53, reg_r0_36, (unsigned int) 255); /* line 366 */
   __CMPLT(reg_b0_3, reg_r0_48, 0); /* line 367 */
   __ADD(reg_r0_28, reg_r0_48, (unsigned int) 255); /* line 368 */
   __CMPLT(reg_b0_1, reg_r0_10, 0); /* line 369 */
   __ADD(reg_r0_35, reg_r0_10, (unsigned int) 255); /* line 370 */
   __CMPLT(reg_b0_7, reg_r0_24, 0); /* line 371 */
   __ADD(reg_r0_18, reg_r0_24, (unsigned int) 255); /* line 372 */
   __ADD(reg_r0_51, reg_r0_25, (unsigned int) 255); /* line 373 */
   __CMPLT(reg_b0_5, reg_r0_46, 0); /* line 374 */
   __ADD(reg_r0_20, reg_r0_46, (unsigned int) 255); /* line 375 */
   __CMPLT(reg_b0_2, reg_r0_49, 0); /* line 376 */
   __ADD(reg_r0_30, reg_r0_49, (unsigned int) 255); /* line 377 */
   __ADD(reg_r0_52, reg_r0_34, (unsigned int) 255); /* line 378 */
   __CMPLT(reg_b0_4, reg_r0_47, 0); /* line 379 */
   __ADD(reg_r0_26, reg_r0_47, (unsigned int) 255); /* line 380 */
   __CMPLT(reg_b0_0, reg_r0_50, 0); /* line 381 */
   __ADD(reg_r0_32, reg_r0_50, (unsigned int) 255); /* line 382 */
   __CMPLT(reg_b0_6, reg_r0_45, 0); /* line 383 */
   __ADD(reg_r0_16, reg_r0_45, (unsigned int) 255); /* line 384 */
   __MFB(reg_r0_19, t__i32_0); /* line 385 */
   __MFB(reg_r0_21, t__i32_1); /* line 386 */
   __MFB(reg_r0_27, t__i32_2); /* line 387 */
   __MFB(reg_r0_29, t__i32_3); /* line 388 */
   __MFB(reg_r0_31, t__i32_4); /* line 389 */
   __MFB(reg_r0_33, t__i32_5); /* line 390 */
} /* line 390 */
  sim_icache_fetch(293 + t_thisfile.offset, 18);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_b0_2 ;
  t__i32_1 = reg_b0_0 ;
   ...
   __CMPLT(reg_b0_2, reg_r0_36, 0); /* line 393 */
   __SLCT(reg_r0_28, reg_b0_3, reg_r0_28, reg_r0_48); /* line 394 */
   __SLCT(reg_r0_35, reg_b0_1, reg_r0_35, reg_r0_10); /* line 395 */
   __SLCT(reg_r0_18, reg_b0_7, reg_r0_18, reg_r0_24); /* line 396 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 397 */
   __SLCT(reg_r0_20, reg_b0_5, reg_r0_20, reg_r0_46); /* line 398 */
   __CMPLT(reg_b0_3, reg_r0_37, 0); /* line 399 */
   __ADD(reg_r0_10, reg_r0_37, (unsigned int) 255); /* line 400 */
   __SLCT(reg_r0_30, t__i32_0, reg_r0_30, reg_r0_49); /* line 401 */
   __CMPLT(reg_b0_1, reg_r0_34, 0); /* line 402 */
   __SLCT(reg_r0_26, reg_b0_4, reg_r0_26, reg_r0_47); /* line 403 */
   __SLCT(reg_r0_32, t__i32_1, reg_r0_32, reg_r0_50); /* line 404 */
   __SLCT(reg_r0_16, reg_b0_6, reg_r0_16, reg_r0_45); /* line 405 */
   __MTB(reg_b0_7, reg_r0_27); /* line 406 */
   __MTB(reg_b0_6, reg_r0_29); /* line 407 */
   __MTB(reg_b0_5, reg_r0_31); /* line 408 */
   __MTB(reg_b0_4, reg_r0_33); /* line 409 */
} /* line 409 */
  sim_icache_fetch(311 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __SLCT(reg_r0_53, reg_b0_2, reg_r0_53, reg_r0_36); /* line 411 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 412 */
   __SHR(reg_r0_35, reg_r0_35, (unsigned int) 8); /* line 413 */
   __SLCT(reg_r0_11, reg_b0_5, reg_r0_11, reg_r0_9); /* line 414 */
   __SHR(reg_r0_18, reg_r0_18, (unsigned int) 8); /* line 415 */
   __SLCT(reg_r0_51, reg_b0_0, reg_r0_51, reg_r0_25); /* line 416 */
   __SLCT(reg_r0_12, reg_b0_6, reg_r0_12, reg_r0_41); /* line 417 */
   __SHR(reg_r0_20, reg_r0_20, (unsigned int) 8); /* line 418 */
   __SLCT(reg_r0_10, reg_b0_3, reg_r0_10, reg_r0_37); /* line 419 */
   __SHR(reg_r0_30, reg_r0_30, (unsigned int) 8); /* line 420 */
   __SLCT(reg_r0_52, reg_b0_1, reg_r0_52, reg_r0_34); /* line 421 */
   __SLCT(reg_r0_13, reg_b0_7, reg_r0_13, reg_r0_42); /* line 422 */
   __SHR(reg_r0_26, reg_r0_26, (unsigned int) 8); /* line 423 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 424 */
   __SLCT(reg_r0_7, reg_b0_4, reg_r0_7, reg_r0_40); /* line 425 */
   __SHR(reg_r0_16, reg_r0_16, (unsigned int) 8); /* line 426 */
   __MTB(reg_b0_1, reg_r0_19); /* line 427 */
   __MTB(reg_b0_0, reg_r0_21); /* line 428 */
} /* line 428 */
  sim_icache_fetch(329 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SHR(reg_r0_53, reg_r0_53, (unsigned int) 8); /* line 430 */
   __SLCT(reg_r0_14, reg_b0_0, reg_r0_14, reg_r0_43); /* line 431 */
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 432 */
   __SHR(reg_r0_51, reg_r0_51, (unsigned int) 8); /* line 433 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 434 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 435 */
   __SLCT(reg_r0_15, reg_b0_1, reg_r0_15, reg_r0_44); /* line 436 */
   __SHR(reg_r0_52, reg_r0_52, (unsigned int) 8); /* line 437 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 438 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 439 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_16); /* line 440 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_26); /* line 441 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_30); /* line 442 */
   __ADD(reg_r0_18, reg_r0_18, reg_r0_20); /* line 443 */
   __ADD(reg_r0_39, reg_r0_39, reg_r0_32); /* line 444 */
} /* line 444 */
  sim_icache_fetch(344 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 446 */
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 447 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_18); /* line 448 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_28); /* line 449 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_7); /* line 450 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_13); /* line 451 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_12); /* line 452 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_52); /* line 453 */
   __ADD(reg_r0_53, reg_r0_53, reg_r0_10); /* line 454 */
   __ADD(reg_r0_35, reg_r0_35, reg_r0_51); /* line 455 */
} /* line 455 */
  sim_icache_fetch(354 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_17, reg_r0_38, reg_r0_17); /* line 457 */
   __ADD(reg_r0_14, reg_r0_14, reg_r0_15); /* line 458 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_11); /* line 459 */
   __ADD(reg_r0_39, reg_r0_39, reg_r0_35); /* line 460 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_53); /* line 461 */
} /* line 461 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_23, reg_r0_14); /* line 463 */
   __ADD(reg_r0_22, reg_r0_39, reg_r0_22); /* line 464 */
} /* line 464 */
  sim_icache_fetch(361 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_4, reg_r0_23); /* line 466 */
  ...
  sim_icache_fetch(363 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_23, reg_r0_23, 0); /* line 471 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 472 */
   __MAX(reg_r0_22, reg_r0_22, 0); /* line 473 */
   __SH2ADD(reg_r0_2, reg_r0_54, reg_r0_56); /* line 474 */
   __ADD(reg_r0_4, reg_r0_54, (unsigned int) 1); /* line 475 */
} /* line 475 */
  sim_icache_fetch(368 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 477 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 478 */
   __MIN(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 479 */
   __ADD(reg_r0_7, reg_r0_55, (unsigned int) 1); /* line 480 */
} /* line 480 */
  sim_icache_fetch(372 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_17, reg_r0_17, (unsigned int) 8); /* line 482 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 16); /* line 483 */
} /* line 483 */
  sim_icache_fetch(374 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_22); /* line 485 */
} /* line 485 */
  sim_icache_fetch(375 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_17); /* line 487 */
} /* line 487 */
  sim_icache_fetch(376 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_23); /* line 489 */
...
l_L7X3: ;/* line 493 */
__LABEL(l_L7X3);
  sim_icache_fetch(378 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_56, reg_r0_56, (unsigned int) 256); /* line 494 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 64); /* line 495 */
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 1); /* line 496 */
  ...
  sim_icache_fetch(383 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_57); /* line 503 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 504 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(388 + t_thisfile.offset, 3);
{
  ...
  t__i32_0 = reg_r0_57 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MOV(reg_r0_3, 0); /* line 506 */
   __LDW(reg_r0_57, mem_trace_ld((reg_r0_1 + (unsigned int) 20),0,4)); /* line 507 */
   __MOV(reg_l0_0, t__i32_0); /* line 508 */
} /* line 508 */
