  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 27);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(27);
  ...
  sim_icache_fetch(118 + t_thisfile.offset, 24);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(24);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 215 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 216 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 217 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 218 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 219 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 220 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 221 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 222 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 223 */
   ...
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 228 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 229 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 230 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 231 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 232 */
   __AND(reg_r0_35, reg_r0_14, (unsigned int) 255); /* line 233 */
   __SHRU(reg_r0_34, reg_r0_14, (unsigned int) 8); /* line 234 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 235 */
   __AND(reg_r0_37, reg_r0_15, (unsigned int) 255); /* line 236 */
   __SHRU(reg_r0_36, reg_r0_15, (unsigned int) 8); /* line 237 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 238 */
} /* line 238 */
  sim_icache_fetch(142 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 240 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 241 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 242 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 243 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 244 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 245 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_28); /* line 246 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_30); /* line 247 */
   __MAX(reg_r0_33, reg_r0_33, reg_r0_32); /* line 248 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 249 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 250 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 251 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 252 */
} /* line 252 */
  sim_icache_fetch(155 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 254 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 255 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 256 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 257 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 258 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 259 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_10); /* line 260 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_11); /* line 261 */
   __MAX(reg_r0_33, reg_r0_33, reg_r0_12); /* line 262 */
   __MAX(reg_r0_35, reg_r0_35, reg_r0_34); /* line 263 */
   __MAX(reg_r0_37, reg_r0_37, reg_r0_36); /* line 264 */
} /* line 264 */
  sim_icache_fetch(166 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 266 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 267 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 268 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 269 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 270 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 271 */
   __ZXTB(reg_r0_29, reg_r0_29); /* line 272 */
   __ZXTB(reg_r0_31, reg_r0_31); /* line 273 */
   __ZXTB(reg_r0_33, reg_r0_33); /* line 274 */
   __MAX(reg_r0_35, reg_r0_35, reg_r0_14); /* line 275 */
   __MAX(reg_r0_37, reg_r0_37, reg_r0_15); /* line 276 */
} /* line 276 */
  sim_icache_fetch(177 + t_thisfile.offset, 20);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(20);
   __SHL(reg_r0_5, reg_r0_17, (unsigned int) 8); /* line 278 */
   __SHL(reg_r0_3, reg_r0_17, (unsigned int) 16); /* line 279 */
   __SHL(reg_r0_7, reg_r0_19, (unsigned int) 8); /* line 280 */
   __SHL(reg_r0_6, reg_r0_19, (unsigned int) 16); /* line 281 */
   __SHL(reg_r0_9, reg_r0_21, (unsigned int) 8); /* line 282 */
   __SHL(reg_r0_8, reg_r0_21, (unsigned int) 16); /* line 283 */
   __SHL(reg_r0_11, reg_r0_23, (unsigned int) 8); /* line 284 */
   __SHL(reg_r0_10, reg_r0_23, (unsigned int) 16); /* line 285 */
   __SHL(reg_r0_14, reg_r0_25, (unsigned int) 8); /* line 286 */
   __SHL(reg_r0_12, reg_r0_25, (unsigned int) 16); /* line 287 */
   __SHL(reg_r0_16, reg_r0_27, (unsigned int) 8); /* line 288 */
   __SHL(reg_r0_15, reg_r0_27, (unsigned int) 16); /* line 289 */
   __SHL(reg_r0_20, reg_r0_29, (unsigned int) 8); /* line 290 */
   __SHL(reg_r0_18, reg_r0_29, (unsigned int) 16); /* line 291 */
   __SHL(reg_r0_24, reg_r0_31, (unsigned int) 8); /* line 292 */
   __SHL(reg_r0_22, reg_r0_31, (unsigned int) 16); /* line 293 */
   __SHL(reg_r0_28, reg_r0_33, (unsigned int) 8); /* line 294 */
   __SHL(reg_r0_26, reg_r0_33, (unsigned int) 16); /* line 295 */
   __ZXTB(reg_r0_35, reg_r0_35); /* line 296 */
   __ZXTB(reg_r0_37, reg_r0_37); /* line 297 */
} /* line 297 */
  sim_icache_fetch(197 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_3); /* line 299 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_6); /* line 300 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_8); /* line 301 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_10); /* line 302 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_12); /* line 303 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_15); /* line 304 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_18); /* line 305 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_22); /* line 306 */
   __OR(reg_r0_33, reg_r0_33, reg_r0_26); /* line 307 */
   __SHL(reg_r0_6, reg_r0_35, (unsigned int) 8); /* line 308 */
   __SHL(reg_r0_3, reg_r0_35, (unsigned int) 16); /* line 309 */
   __SHL(reg_r0_10, reg_r0_37, (unsigned int) 8); /* line 310 */
   __SHL(reg_r0_8, reg_r0_37, (unsigned int) 16); /* line 311 */
} /* line 311 */
  sim_icache_fetch(210 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __OR(reg_r0_17, reg_r0_17, reg_r0_5); /* line 313 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_7); /* line 314 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_9); /* line 315 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_11); /* line 316 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_14); /* line 317 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_16); /* line 318 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_20); /* line 319 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_24); /* line 320 */
   __OR(reg_r0_33, reg_r0_33, reg_r0_28); /* line 321 */
   __OR(reg_r0_35, reg_r0_35, reg_r0_3); /* line 322 */
   __OR(reg_r0_37, reg_r0_37, reg_r0_8); /* line 323 */
} /* line 323 */
  sim_icache_fetch(221 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 325 */
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 328 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 329 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 330 */
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_33); /* line 333 */
   __OR(reg_r0_35, reg_r0_35, reg_r0_6); /* line 334 */
   __OR(reg_r0_37, reg_r0_37, reg_r0_10); /* line 335 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
