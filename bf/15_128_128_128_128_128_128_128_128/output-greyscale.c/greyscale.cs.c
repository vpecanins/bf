  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   ...
   __MOV(reg_r0_35, t__i32_0); /* line 155 */
} /* line 155 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   ...
   __MOV(reg_r0_32, reg_r0_3); /* line 164 */
   __MOV(reg_r0_33, reg_r0_5); /* line 165 */
   __MOV(reg_r0_34, reg_r0_6); /* line 166 */
} /* line 166 */
  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
  ...
  sim_icache_fetch(106 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 204 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 205 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 206 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 207 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 208 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 209 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 210 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 211 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 212 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 213 */
   __AND(reg_r0_27, reg_r0_9, (unsigned int) 255); /* line 214 */
   __SHRU(reg_r0_26, reg_r0_9, (unsigned int) 8); /* line 215 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 216 */
   __AND(reg_r0_29, reg_r0_10, (unsigned int) 255); /* line 217 */
   __SHRU(reg_r0_28, reg_r0_10, (unsigned int) 8); /* line 218 */
} /* line 218 */
  sim_icache_fetch(121 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 220 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 221 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 222 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 223 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 224 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 225 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 226 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 227 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 228 */
   __AND(reg_r0_18, reg_r0_11, (unsigned int) 255); /* line 229 */
   __SHRU(reg_r0_16, reg_r0_11, (unsigned int) 8); /* line 230 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 231 */
   __AND(reg_r0_22, reg_r0_12, (unsigned int) 255); /* line 232 */
   __SHRU(reg_r0_20, reg_r0_12, (unsigned int) 8); /* line 233 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 234 */
} /* line 234 */
  sim_icache_fetch(136 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 236 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 237 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 238 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 239 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 240 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 241 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_28); /* line 242 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 243 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 244 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 245 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 246 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 247 */
   __AND(reg_r0_5, reg_r0_14, (unsigned int) 255); /* line 248 */
   __SHRU(reg_r0_3, reg_r0_14, (unsigned int) 8); /* line 249 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 250 */
} /* line 250 */
  sim_icache_fetch(151 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 252 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 253 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 254 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 255 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 256 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 257 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_10); /* line 258 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 259 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_20); /* line 260 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 261 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 262 */
   __AND(reg_r0_7, reg_r0_15, (unsigned int) 255); /* line 263 */
   __SHRU(reg_r0_6, reg_r0_15, (unsigned int) 8); /* line 264 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 265 */
} /* line 265 */
  sim_icache_fetch(165 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SHL(reg_r0_9, reg_r0_17, (unsigned int) 8); /* line 267 */
   __SHL(reg_r0_8, reg_r0_17, (unsigned int) 16); /* line 268 */
   __SHL(reg_r0_16, reg_r0_19, (unsigned int) 8); /* line 269 */
   __SHL(reg_r0_10, reg_r0_19, (unsigned int) 16); /* line 270 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 8); /* line 271 */
   __SHL(reg_r0_20, reg_r0_21, (unsigned int) 16); /* line 272 */
   __SHL(reg_r0_28, reg_r0_23, (unsigned int) 8); /* line 273 */
   __SHL(reg_r0_26, reg_r0_23, (unsigned int) 16); /* line 274 */
   __SHL(reg_r0_31, reg_r0_25, (unsigned int) 8); /* line 275 */
   __SHL(reg_r0_30, reg_r0_25, (unsigned int) 16); /* line 276 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 277 */
   __ZXTB(reg_r0_29, reg_r0_29); /* line 278 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_11); /* line 279 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_12); /* line 280 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 281 */
} /* line 281 */
  sim_icache_fetch(180 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __OR(reg_r0_17, reg_r0_17, reg_r0_8); /* line 283 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_10); /* line 284 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_20); /* line 285 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_26); /* line 286 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_30); /* line 287 */
   __SHL(reg_r0_8, reg_r0_27, (unsigned int) 8); /* line 288 */
   __SHL(reg_r0_3, reg_r0_27, (unsigned int) 16); /* line 289 */
   __SHL(reg_r0_11, reg_r0_29, (unsigned int) 8); /* line 290 */
   __SHL(reg_r0_10, reg_r0_29, (unsigned int) 16); /* line 291 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 292 */
   __ZXTB(reg_r0_22, reg_r0_22); /* line 293 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_14); /* line 294 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 295 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 296 */
} /* line 296 */
  sim_icache_fetch(194 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_9); /* line 298 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_16); /* line 299 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 300 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_28); /* line 301 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_31); /* line 302 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_3); /* line 303 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_10); /* line 304 */
   __SHL(reg_r0_9, reg_r0_18, (unsigned int) 8); /* line 305 */
   __SHL(reg_r0_3, reg_r0_18, (unsigned int) 16); /* line 306 */
   __SHL(reg_r0_12, reg_r0_22, (unsigned int) 8); /* line 307 */
   __SHL(reg_r0_10, reg_r0_22, (unsigned int) 16); /* line 308 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 309 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_6); /* line 310 */
} /* line 310 */
  sim_icache_fetch(207 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 312 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 313 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 314 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 315 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 316 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_8); /* line 317 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_11); /* line 318 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_3); /* line 319 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_10); /* line 320 */
   __SHL(reg_r0_6, reg_r0_5, (unsigned int) 8); /* line 321 */
   __SHL(reg_r0_3, reg_r0_5, (unsigned int) 16); /* line 322 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_15); /* line 323 */
} /* line 323 */
  sim_icache_fetch(219 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 325 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_29); /* line 326 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_9); /* line 327 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_12); /* line 328 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_3); /* line 329 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 330 */
} /* line 330 */
  sim_icache_fetch(225 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_18); /* line 332 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_22); /* line 333 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_6); /* line 334 */
   __SHL(reg_r0_6, reg_r0_7, (unsigned int) 8); /* line 335 */
   __SHL(reg_r0_3, reg_r0_7, (unsigned int) 16); /* line 336 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(231 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_5); /* line 339 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_3); /* line 340 */
} /* line 340 */
  sim_icache_fetch(233 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_7, reg_r0_7, reg_r0_6); /* line 342 */
} /* line 342 */
  sim_icache_fetch(234 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_7); /* line 344 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 345 */
  ...
  sim_icache_fetch(237 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_34, (unsigned int) 256); /* line 350 */
   __ADD(reg_r0_5, reg_r0_33, (unsigned int) 256); /* line 351 */
   __ADD(reg_r0_3, reg_r0_32, (unsigned int) 1); /* line 352 */
  ...
  sim_icache_fetch(243 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_35); /* line 359 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 360 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(248 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 362 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 363 */
   __INC_NOP_CNT((unsigned int) 1);
