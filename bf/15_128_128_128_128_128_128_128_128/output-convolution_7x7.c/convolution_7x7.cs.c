  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
  ...
  sim_icache_fetch(42 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   ...
   __MOV(reg_r0_53, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 154 */
   __MOV(reg_r0_54, reg_r0_5); /* line 155 */
} /* line 155 */
l_L4X3: ;/* line 158 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_51, reg_r0_4); /* line 174 */
   __MOV(reg_r0_52, reg_r0_7); /* line 175 */
} /* line 175 */
...
l_L8X3: ;/* line 180 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 22);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
  ...
  sim_icache_fetch(102 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __LDWs(reg_r0_10, mem_trace_ld(reg_r0_10,0,4)); /* line 197 */
   __SH2ADD(reg_r0_9, reg_r0_9, (unsigned int) conv7_image); /* line 198 */
   __LDWs(reg_r0_19, mem_trace_ld(reg_r0_19,0,4)); /* line 199 */
   __SHL(reg_r0_18, reg_r0_18, (unsigned int) 6); /* line 200 */
   __SHL(reg_r0_11, reg_r0_11, (unsigned int) 6); /* line 201 */
   __LDWs(reg_r0_12, mem_trace_ld(reg_r0_12,0,4)); /* line 202 */
   __SHL(reg_r0_13, reg_r0_13, (unsigned int) 6); /* line 203 */
   __LDWs(reg_r0_14, mem_trace_ld(reg_r0_14,0,4)); /* line 204 */
   __SHL(reg_r0_20, reg_r0_20, (unsigned int) 6); /* line 205 */
   __LDWs(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 206 */
   __SHL(reg_r0_15, reg_r0_15, (unsigned int) 6); /* line 207 */
   __LDWs(reg_r0_16, mem_trace_ld(reg_r0_16,0,4)); /* line 208 */
   __SHL(reg_r0_4, reg_r0_4, (unsigned int) 6); /* line 209 */
   __LDWs(reg_r0_7, mem_trace_ld(reg_r0_7,0,4)); /* line 210 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(118 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 213 */
   __ADD(reg_r0_18, reg_r0_5, reg_r0_18); /* line 214 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 215 */
   __ADD(reg_r0_13, reg_r0_5, reg_r0_13); /* line 216 */
   __ADD(reg_r0_20, reg_r0_5, reg_r0_20); /* line 217 */
   __ADD(reg_r0_15, reg_r0_5, reg_r0_15); /* line 218 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 219 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 220 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 221 */
  ...
  sim_icache_fetch(149 + t_thisfile.offset, 4);
{
  ...
  sim_icache_fetch(153 + t_thisfile.offset, 15);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   ...
   __SHRU(reg_r0_33, reg_r0_20, (unsigned int) 8); /* line 256 */
   __SHRU(reg_r0_37, reg_r0_15, (unsigned int) 16); /* line 257 */
   __SHRU(reg_r0_31, reg_r0_15, (unsigned int) 8); /* line 258 */
   __SHRU(reg_r0_34, reg_r0_4, (unsigned int) 16); /* line 259 */
   __SHRU(reg_r0_27, reg_r0_4, (unsigned int) 8); /* line 260 */
} /* line 260 */
  sim_icache_fetch(168 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 262 */
   __AND(reg_r0_38, reg_r0_38, (unsigned int) 255); /* line 263 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 264 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 265 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 266 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 267 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 268 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 269 */
   __SHRU(reg_r0_39, reg_r0_20, (unsigned int) 16); /* line 270 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 271 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 272 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 273 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 274 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 275 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 276 */
} /* line 276 */
  sim_icache_fetch(183 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 278 */
   __MULLU(reg_r0_42, reg_r0_19, reg_r0_32); /* line 279 */
   __MULHS(reg_r0_32, reg_r0_19, reg_r0_32); /* line 280 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_29); /* line 281 */
   __MULHS(reg_r0_29, reg_r0_12, reg_r0_29); /* line 282 */
   __MULLU(reg_r0_40, reg_r0_14, reg_r0_30); /* line 283 */
   __MULHS(reg_r0_30, reg_r0_14, reg_r0_30); /* line 284 */
   __MULLU(reg_r0_43, reg_r0_21, reg_r0_33); /* line 285 */
   __MULHS(reg_r0_33, reg_r0_21, reg_r0_33); /* line 286 */
   __MULLU(reg_r0_41, reg_r0_16, reg_r0_31); /* line 287 */
   __MULHS(reg_r0_31, reg_r0_16, reg_r0_31); /* line 288 */
   __MULLU(reg_r0_44, reg_r0_7, reg_r0_34); /* line 289 */
   __MULHS(reg_r0_34, reg_r0_7, reg_r0_34); /* line 290 */
   __MULLU(reg_r0_9, reg_r0_7, reg_r0_27); /* line 291 */
   __MULHS(reg_r0_27, reg_r0_7, reg_r0_27); /* line 292 */
} /* line 292 */
  sim_icache_fetch(198 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __ADD(reg_r0_35, reg_r0_35, reg_r0_10); /* line 294 */
   __CMPLT(reg_b0_1, reg_r0_26, 0); /* line 295 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 296 */
   __ADD(reg_r0_45, reg_r0_28, (unsigned int) 255); /* line 297 */
   __MULLU(reg_r0_48, reg_r0_19, reg_r0_38); /* line 298 */
   __MULHS(reg_r0_38, reg_r0_19, reg_r0_38); /* line 299 */
   __MULLU(reg_r0_10, reg_r0_12, reg_r0_25); /* line 300 */
   __MULHS(reg_r0_25, reg_r0_12, reg_r0_25); /* line 301 */
   __MULLU(reg_r0_46, reg_r0_14, reg_r0_36); /* line 302 */
   __MULHS(reg_r0_36, reg_r0_14, reg_r0_36); /* line 303 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 304 */
   __MULLU(reg_r0_47, reg_r0_16, reg_r0_37); /* line 305 */
   __MULHS(reg_r0_37, reg_r0_16, reg_r0_37); /* line 306 */
   __MULLU(reg_r0_49, reg_r0_7, reg_r0_4); /* line 307 */
   __MULHS(reg_r0_7, reg_r0_7, reg_r0_4); /* line 308 */
} /* line 308 */
  sim_icache_fetch(213 + t_thisfile.offset, 15);
{
  unsigned int t__i32_0;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __CMPLT(reg_b0_0, reg_r0_35, 0); /* line 310 */
   __ADD(reg_r0_4, reg_r0_35, (unsigned int) 255); /* line 311 */
   __ADD(reg_r0_28, reg_r0_26, (unsigned int) 255); /* line 312 */
   __SLCT(reg_r0_45, t__i32_0, reg_r0_45, t__i32_1); /* line 313 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_32); /* line 314 */
   __MULLU(reg_r0_29, reg_r0_12, reg_r0_11); /* line 315 */
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_11); /* line 316 */
   __ADD(reg_r0_24, reg_r0_24, t__i32_2); /* line 317 */
   __ADD(reg_r0_40, reg_r0_40, reg_r0_30); /* line 318 */
   __MULLU(reg_r0_27, reg_r0_21, reg_r0_39); /* line 319 */
   __MULHS(reg_r0_39, reg_r0_21, reg_r0_39); /* line 320 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_33); /* line 321 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_31); /* line 322 */
   __ADD(reg_r0_44, reg_r0_44, reg_r0_34); /* line 323 */
   __ADD(reg_r0_9, reg_r0_9, t__i32_3); /* line 324 */
} /* line 324 */
  sim_icache_fetch(228 + t_thisfile.offset, 15);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SHR(reg_r0_45, reg_r0_45, (unsigned int) 8); /* line 326 */
   __CMPLT(reg_b0_6, reg_r0_42, 0); /* line 327 */
   __ADD(reg_r0_33, reg_r0_42, (unsigned int) 255); /* line 328 */
   __CMPLT(reg_b0_3, reg_r0_24, 0); /* line 329 */
   __ADD(reg_r0_30, reg_r0_24, (unsigned int) 255); /* line 330 */
   __CMPLT(reg_b0_4, reg_r0_40, 0); /* line 331 */
   __ADD(reg_r0_31, reg_r0_40, (unsigned int) 255); /* line 332 */
   __CMPLT(reg_b0_7, reg_r0_43, 0); /* line 333 */
   __ADD(reg_r0_34, reg_r0_43, (unsigned int) 255); /* line 334 */
   __CMPLT(reg_b0_5, reg_r0_41, 0); /* line 335 */
   __ADD(reg_r0_32, reg_r0_41, (unsigned int) 255); /* line 336 */
   __CMPLT(reg_b0_1, reg_r0_44, 0); /* line 337 */
   __CMPLT(reg_b0_2, reg_r0_9, 0); /* line 338 */
   __ADD(reg_r0_11, reg_r0_9, (unsigned int) 255); /* line 339 */
   __MFB(reg_r0_50, t__i32_0); /* line 340 */
} /* line 340 */
  sim_icache_fetch(243 + t_thisfile.offset, 15);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_35); /* line 342 */
   __ADD(reg_r0_48, reg_r0_48, reg_r0_38); /* line 343 */
   __SLCT(reg_r0_33, reg_b0_6, reg_r0_33, reg_r0_42); /* line 344 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_25); /* line 345 */
   __SLCT(reg_r0_30, reg_b0_3, reg_r0_30, reg_r0_24); /* line 346 */
   __ADD(reg_r0_46, reg_r0_46, reg_r0_36); /* line 347 */
   __SLCT(reg_r0_31, reg_b0_4, reg_r0_31, reg_r0_40); /* line 348 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_39); /* line 349 */
   __SLCT(reg_r0_34, reg_b0_7, reg_r0_34, reg_r0_43); /* line 350 */
   __ADD(reg_r0_47, reg_r0_47, reg_r0_37); /* line 351 */
   __SLCT(reg_r0_32, reg_b0_5, reg_r0_32, reg_r0_41); /* line 352 */
   __ADD(reg_r0_9, reg_r0_44, (unsigned int) 255); /* line 353 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_7); /* line 354 */
   __SLCT(reg_r0_11, reg_b0_2, reg_r0_11, t__i32_0); /* line 355 */
   __MTB(reg_b0_0, reg_r0_50); /* line 356 */
} /* line 356 */
  sim_icache_fetch(258 + t_thisfile.offset, 15);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 358 */
   __CMPLT(reg_b0_4, reg_r0_48, 0); /* line 359 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 360 */
   __CMPLT(reg_b0_1, reg_r0_10, 0); /* line 361 */
   __ADD(reg_r0_7, reg_r0_10, (unsigned int) 255); /* line 362 */
   __SHR(reg_r0_30, reg_r0_30, (unsigned int) 8); /* line 363 */
   __CMPLT(reg_b0_2, reg_r0_46, 0); /* line 364 */
   __ADD(reg_r0_24, reg_r0_46, (unsigned int) 255); /* line 365 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 366 */
   __SHR(reg_r0_34, reg_r0_34, (unsigned int) 8); /* line 367 */
   __CMPLT(reg_b0_3, reg_r0_47, 0); /* line 368 */
   __ADD(reg_r0_25, reg_r0_47, (unsigned int) 255); /* line 369 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 370 */
   __SLCT(reg_r0_9, t__i32_0, reg_r0_9, reg_r0_44); /* line 371 */
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 372 */
} /* line 372 */
  sim_icache_fetch(273 + t_thisfile.offset, 15);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SLCT(reg_r0_28, reg_b0_0, reg_r0_28, reg_r0_26); /* line 374 */
   __ADD(reg_r0_10, reg_r0_48, (unsigned int) 255); /* line 375 */
   __SLCT(reg_r0_7, reg_b0_1, reg_r0_7, t__i32_0); /* line 376 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_12); /* line 377 */
   __SLCT(reg_r0_24, reg_b0_2, reg_r0_24, reg_r0_46); /* line 378 */
   __CMPLT(reg_b0_1, reg_r0_27, 0); /* line 379 */
   __ADD(reg_r0_11, reg_r0_27, (unsigned int) 255); /* line 380 */
   __SLCT(reg_r0_25, reg_b0_3, reg_r0_25, reg_r0_47); /* line 381 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 382 */
   __CMPLT(reg_b0_2, reg_r0_49, 0); /* line 383 */
   __ADD(reg_r0_31, reg_r0_49, (unsigned int) 255); /* line 384 */
   __ADD(reg_r0_45, reg_r0_45, t__i32_1); /* line 385 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_32); /* line 386 */
   __ADD(reg_r0_33, reg_r0_33, reg_r0_34); /* line 387 */
   __ADD(reg_r0_30, reg_r0_30, t__i32_2); /* line 388 */
} /* line 388 */
  sim_icache_fetch(288 + t_thisfile.offset, 15);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 390 */
   __SLCT(reg_r0_10, reg_b0_4, reg_r0_10, reg_r0_48); /* line 391 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 392 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 393 */
   __CMPLT(reg_b0_0, reg_r0_29, 0); /* line 394 */
   __ADD(reg_r0_9, reg_r0_29, (unsigned int) 255); /* line 395 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 396 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 397 */
   __SLCT(reg_r0_11, reg_b0_1, reg_r0_11, reg_r0_27); /* line 398 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 399 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 400 */
   __SLCT(reg_r0_31, reg_b0_2, reg_r0_31, reg_r0_49); /* line 401 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_30); /* line 402 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_33); /* line 403 */
   __ADD(reg_r0_4, reg_r0_4, t__i32_0); /* line 404 */
} /* line 404 */
  sim_icache_fetch(303 + t_thisfile.offset, 14);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_15 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 406 */
   __MULLU(reg_r0_15, reg_r0_19, reg_r0_18); /* line 407 */
   __MULHS(reg_r0_19, reg_r0_19, reg_r0_18); /* line 408 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_29); /* line 409 */
   __MULLU(reg_r0_12, reg_r0_14, reg_r0_13); /* line 410 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 411 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 412 */
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 413 */
   __MULLU(reg_r0_13, reg_r0_16, t__i32_0); /* line 414 */
   __MULHS(reg_r0_16, reg_r0_16, t__i32_0); /* line 415 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 416 */
   __ADD(reg_r0_17, reg_r0_45, reg_r0_17); /* line 417 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_25); /* line 418 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_24); /* line 419 */
} /* line 419 */
  sim_icache_fetch(317 + t_thisfile.offset, 6);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 421 */
   __MULLU(reg_r0_7, reg_r0_21, reg_r0_20); /* line 422 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_20); /* line 423 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_31); /* line 424 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_11); /* line 425 */
   __ADD(reg_r0_4, reg_r0_4, t__i32_0); /* line 426 */
} /* line 426 */
  sim_icache_fetch(323 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_15, reg_r0_15, reg_r0_19); /* line 428 */
   __ADD(reg_r0_12, reg_r0_12, reg_r0_14); /* line 429 */
   __ADD(reg_r0_13, reg_r0_13, reg_r0_16); /* line 430 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_10); /* line 431 */
} /* line 431 */
  sim_icache_fetch(327 + t_thisfile.offset, 8);
{
  ...
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __CMPLT(reg_b0_2, reg_r0_15, 0); /* line 433 */
   __ADD(reg_r0_11, reg_r0_15, (unsigned int) 255); /* line 434 */
   __CMPLT(reg_b0_0, reg_r0_12, 0); /* line 435 */
   __ADD(reg_r0_4, reg_r0_12, (unsigned int) 255); /* line 436 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_21); /* line 437 */
   __CMPLT(reg_b0_1, reg_r0_13, 0); /* line 438 */
   __ADD(reg_r0_10, reg_r0_13, (unsigned int) 255); /* line 439 */
   __ADD(reg_r0_22, t__i32_0, reg_r0_22); /* line 440 */
} /* line 440 */
  sim_icache_fetch(335 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_11, reg_b0_2, reg_r0_11, reg_r0_15); /* line 442 */
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_12); /* line 443 */
   __CMPLT(reg_b0_0, reg_r0_7, 0); /* line 444 */
   __ADD(reg_r0_12, reg_r0_7, (unsigned int) 255); /* line 445 */
   __SLCT(reg_r0_10, reg_b0_1, reg_r0_10, reg_r0_13); /* line 446 */
} /* line 446 */
  sim_icache_fetch(340 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 448 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 449 */
   __SLCT(reg_r0_12, reg_b0_0, reg_r0_12, reg_r0_7); /* line 450 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 451 */
} /* line 451 */
  sim_icache_fetch(344 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 453 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_10); /* line 454 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_4); /* line 455 */
} /* line 455 */
  sim_icache_fetch(347 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_11, reg_r0_11, reg_r0_12); /* line 457 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_9); /* line 458 */
} /* line 458 */
  sim_icache_fetch(349 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_23, reg_r0_23, reg_r0_11); /* line 460 */
} /* line 460 */
  sim_icache_fetch(350 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_28, reg_r0_23); /* line 462 */
  ...
  sim_icache_fetch(352 + t_thisfile.offset, 5);
{
   ...
   __SH2ADD(reg_r0_2, reg_r0_51, reg_r0_53); /* line 470 */
   __ADD(reg_r0_4, reg_r0_51, (unsigned int) 1); /* line 471 */
} /* line 471 */
  sim_icache_fetch(357 + t_thisfile.offset, 4);
{
   ...
   __ADD(reg_r0_7, reg_r0_52, (unsigned int) 1); /* line 476 */
} /* line 476 */
...
l_L7X3: ;/* line 489 */
__LABEL(l_L7X3);
  sim_icache_fetch(367 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_53, reg_r0_53, (unsigned int) 256); /* line 490 */
  ...
  sim_icache_fetch(372 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_54); /* line 499 */
