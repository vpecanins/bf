  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   ...
   __MOV(reg_r0_28, t__i32_0); /* line 157 */
} /* line 157 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   ...
   __MOV(reg_r0_12, (unsigned int) -55); /* line 163 */
   __MOV(reg_r0_4, reg_r0_5); /* line 164 */
   __MOV(reg_r0_2, reg_r0_6); /* line 165 */
   __MOV(reg_r0_25, reg_r0_3); /* line 166 */
   __MOV(reg_r0_26, reg_r0_5); /* line 167 */
   __MOV(reg_r0_27, reg_r0_6); /* line 168 */
} /* line 168 */
...
l_L6X3: ;/* line 173 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
  ...
  sim_icache_fetch(84 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __LDW(reg_r0_13, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 183 */
   __CMPLT(reg_b0_0, reg_r0_12, 0); /* line 184 */
   __LDWs(reg_r0_14, mem_trace_ld((reg_r0_2 + (unsigned int) 36),0,4)); /* line 185 */
   __LDWs(reg_r0_15, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 186 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 187 */
   __ADD(reg_r0_12, reg_r0_12, (unsigned int) 11); /* line 188 */
} /* line 188 */
  sim_icache_fetch(90 + t_thisfile.offset, 8);
{
  ...
  sim_icache_fetch(98 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   ...
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 204 */
   __AND(reg_r0_23, reg_r0_7, (unsigned int) 255); /* line 205 */
   __SHRU(reg_r0_22, reg_r0_7, (unsigned int) 8); /* line 206 */
} /* line 206 */
  sim_icache_fetch(106 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 208 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 209 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 210 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 211 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 212 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 213 */
   __AND(reg_r0_18, reg_r0_8, (unsigned int) 255); /* line 214 */
   __SHRU(reg_r0_16, reg_r0_8, (unsigned int) 8); /* line 215 */
} /* line 215 */
  sim_icache_fetch(114 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 217 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 218 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 219 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 220 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 221 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 222 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 223 */
   __SHRU(reg_r0_3, reg_r0_9, (unsigned int) 8); /* line 224 */
} /* line 224 */
  sim_icache_fetch(122 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 226 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 227 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 228 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 229 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 230 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 231 */
   __AND(reg_r0_5, reg_r0_9, (unsigned int) 255); /* line 232 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 233 */
} /* line 233 */
  sim_icache_fetch(130 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __SHL(reg_r0_7, reg_r0_17, (unsigned int) 8); /* line 235 */
   __SHL(reg_r0_6, reg_r0_17, (unsigned int) 16); /* line 236 */
   __SHL(reg_r0_20, reg_r0_19, (unsigned int) 8); /* line 237 */
   __SHL(reg_r0_16, reg_r0_19, (unsigned int) 16); /* line 238 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 8); /* line 239 */
   __SHL(reg_r0_22, reg_r0_21, (unsigned int) 16); /* line 240 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 241 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_8); /* line 242 */
} /* line 242 */
  sim_icache_fetch(138 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __OR(reg_r0_17, reg_r0_17, reg_r0_6); /* line 244 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_16); /* line 245 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_22); /* line 246 */
   __SHL(reg_r0_8, reg_r0_23, (unsigned int) 8); /* line 247 */
   __SHL(reg_r0_6, reg_r0_23, (unsigned int) 16); /* line 248 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 249 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 250 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 251 */
} /* line 251 */
  sim_icache_fetch(146 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __OR(reg_r0_17, reg_r0_17, reg_r0_7); /* line 253 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_20); /* line 254 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 255 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_6); /* line 256 */
   __SHL(reg_r0_6, reg_r0_18, (unsigned int) 8); /* line 257 */
   __SHL(reg_r0_3, reg_r0_18, (unsigned int) 16); /* line 258 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 259 */
   __SHRU(reg_r0_7, reg_r0_10, (unsigned int) 8); /* line 260 */
} /* line 260 */
  sim_icache_fetch(154 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __OR(reg_r0_23, reg_r0_23, reg_r0_8); /* line 262 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_3); /* line 263 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_9); /* line 264 */
   __AND(reg_r0_3, reg_r0_10, (unsigned int) 255); /* line 265 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 266 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 267 */
   __AND(reg_r0_9, reg_r0_11, (unsigned int) 255); /* line 268 */
   __SHRU(reg_r0_8, reg_r0_11, (unsigned int) 8); /* line 269 */
} /* line 269 */
  sim_icache_fetch(162 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __OR(reg_r0_18, reg_r0_18, reg_r0_6); /* line 271 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 272 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_7); /* line 273 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 274 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 275 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 276 */
   __AND(reg_r0_7, reg_r0_13, (unsigned int) 255); /* line 277 */
   __SHRU(reg_r0_6, reg_r0_13, (unsigned int) 8); /* line 278 */
} /* line 278 */
  sim_icache_fetch(170 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __SHL(reg_r0_20, reg_r0_5, (unsigned int) 8); /* line 280 */
   __SHL(reg_r0_16, reg_r0_5, (unsigned int) 16); /* line 281 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_10); /* line 282 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_8); /* line 283 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 284 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 285 */
   __SHRU(reg_r0_13, reg_r0_13, (unsigned int) 16); /* line 286 */
   __SHRU(reg_r0_8, reg_r0_14, (unsigned int) 8); /* line 287 */
} /* line 287 */
  sim_icache_fetch(178 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __OR(reg_r0_5, reg_r0_5, reg_r0_16); /* line 289 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 290 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_11); /* line 291 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_6); /* line 292 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 293 */
   __AND(reg_r0_6, reg_r0_14, (unsigned int) 255); /* line 294 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 295 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 296 */
} /* line 296 */
  sim_icache_fetch(186 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __OR(reg_r0_5, reg_r0_5, reg_r0_20); /* line 298 */
   __SHL(reg_r0_11, reg_r0_3, (unsigned int) 8); /* line 299 */
   __SHL(reg_r0_10, reg_r0_3, (unsigned int) 16); /* line 300 */
   __ZXTB(reg_r0_9, reg_r0_9); /* line 301 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_13); /* line 302 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_8); /* line 303 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 304 */
   __SHRU(reg_r0_8, reg_r0_15, (unsigned int) 8); /* line 305 */
} /* line 305 */
  sim_icache_fetch(194 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __OR(reg_r0_3, reg_r0_3, reg_r0_10); /* line 307 */
   __SHL(reg_r0_13, reg_r0_9, (unsigned int) 8); /* line 308 */
   __SHL(reg_r0_10, reg_r0_9, (unsigned int) 16); /* line 309 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 310 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_14); /* line 311 */
   __AND(reg_r0_14, reg_r0_15, (unsigned int) 255); /* line 312 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 313 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 314 */
} /* line 314 */
  sim_icache_fetch(202 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 316 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_11); /* line 317 */
   __OR(reg_r0_9, reg_r0_9, reg_r0_10); /* line 318 */
   __SHL(reg_r0_11, reg_r0_7, (unsigned int) 8); /* line 319 */
   __SHL(reg_r0_10, reg_r0_7, (unsigned int) 16); /* line 320 */
   __ZXTB(reg_r0_6, reg_r0_6); /* line 321 */
   __MAX(reg_r0_14, reg_r0_14, reg_r0_8); /* line 322 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 323 */
} /* line 323 */
  sim_icache_fetch(210 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   ...
   __OR(reg_r0_9, reg_r0_9, reg_r0_13); /* line 328 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_10); /* line 329 */
   __SHL(reg_r0_10, reg_r0_6, (unsigned int) 8); /* line 330 */
   __SHL(reg_r0_8, reg_r0_6, (unsigned int) 16); /* line 331 */
   __MAX(reg_r0_14, reg_r0_14, reg_r0_15); /* line 332 */
} /* line 332 */
  sim_icache_fetch(218 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_18); /* line 334 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_5); /* line 335 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_3); /* line 336 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_9); /* line 337 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_11); /* line 338 */
   __OR(reg_r0_6, reg_r0_6, reg_r0_8); /* line 339 */
   __ZXTB(reg_r0_14, reg_r0_14); /* line 340 */
} /* line 340 */
  sim_icache_fetch(225 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_7); /* line 342 */
   __OR(reg_r0_6, reg_r0_6, reg_r0_10); /* line 343 */
   __SHL(reg_r0_5, reg_r0_14, (unsigned int) 8); /* line 344 */
   __SHL(reg_r0_3, reg_r0_14, (unsigned int) 16); /* line 345 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(230 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_6); /* line 348 */
   __OR(reg_r0_14, reg_r0_14, reg_r0_3); /* line 349 */
} /* line 349 */
  sim_icache_fetch(232 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_14, reg_r0_14, reg_r0_5); /* line 351 */
} /* line 351 */
  sim_icache_fetch(233 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_14); /* line 353 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 354 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_27, (unsigned int) 256); /* line 359 */
   __ADD(reg_r0_5, reg_r0_26, (unsigned int) 256); /* line 360 */
   __ADD(reg_r0_3, reg_r0_25, (unsigned int) 1); /* line 361 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_28); /* line 368 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 369 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 371 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 372 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 373 */
   __ADD_CYCLES(1);
} /* line 373 */
