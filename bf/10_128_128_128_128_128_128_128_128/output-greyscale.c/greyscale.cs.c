  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   ...
   __MOV(reg_r0_31, t__i32_0); /* line 156 */
} /* line 156 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   ...
   __MOV(reg_r0_28, reg_r0_3); /* line 165 */
   __MOV(reg_r0_29, reg_r0_5); /* line 166 */
   __MOV(reg_r0_30, reg_r0_6); /* line 167 */
} /* line 167 */
...
l_L6X3: ;/* line 172 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   ...
   __CMPLT(reg_b0_0, reg_r0_13, 0); /* line 182 */
} /* line 182 */
  sim_icache_fetch(86 + t_thisfile.offset, 4);
{
  ...
  sim_icache_fetch(90 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   ...
   __SHRU(reg_r0_22, reg_r0_7, (unsigned int) 8); /* line 198 */
} /* line 198 */
  sim_icache_fetch(100 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 200 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 201 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 202 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 203 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 204 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 205 */
   __AND(reg_r0_23, reg_r0_7, (unsigned int) 255); /* line 206 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 207 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 208 */
   __SHRU(reg_r0_24, reg_r0_8, (unsigned int) 8); /* line 209 */
} /* line 209 */
  sim_icache_fetch(110 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 211 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 212 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 213 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 214 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 215 */
   __AND(reg_r0_16, reg_r0_8, (unsigned int) 255); /* line 216 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 217 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 218 */
   __AND(reg_r0_20, reg_r0_9, (unsigned int) 255); /* line 219 */
   __SHRU(reg_r0_18, reg_r0_9, (unsigned int) 8); /* line 220 */
} /* line 220 */
  sim_icache_fetch(120 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 222 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 223 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 224 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 225 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_24); /* line 226 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 227 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 228 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 229 */
   __AND(reg_r0_5, reg_r0_10, (unsigned int) 255); /* line 230 */
   __SHRU(reg_r0_3, reg_r0_10, (unsigned int) 8); /* line 231 */
} /* line 231 */
  sim_icache_fetch(130 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 233 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 234 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 235 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 236 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_8); /* line 237 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_18); /* line 238 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 239 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 240 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 241 */
   __SHRU(reg_r0_6, reg_r0_11, (unsigned int) 8); /* line 242 */
} /* line 242 */
  sim_icache_fetch(140 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHL(reg_r0_8, reg_r0_17, (unsigned int) 8); /* line 244 */
   __SHL(reg_r0_7, reg_r0_17, (unsigned int) 16); /* line 245 */
   __SHL(reg_r0_22, reg_r0_19, (unsigned int) 8); /* line 246 */
   __SHL(reg_r0_18, reg_r0_19, (unsigned int) 16); /* line 247 */
   __SHL(reg_r0_25, reg_r0_21, (unsigned int) 8); /* line 248 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 16); /* line 249 */
   __SHL(reg_r0_27, reg_r0_23, (unsigned int) 8); /* line 250 */
   __SHL(reg_r0_26, reg_r0_23, (unsigned int) 16); /* line 251 */
   __ZXTB(reg_r0_16, reg_r0_16); /* line 252 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_9); /* line 253 */
} /* line 253 */
  sim_icache_fetch(150 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __OR(reg_r0_17, reg_r0_17, reg_r0_7); /* line 255 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_18); /* line 256 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 257 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_26); /* line 258 */
   __SHL(reg_r0_9, reg_r0_16, (unsigned int) 8); /* line 259 */
   __SHL(reg_r0_7, reg_r0_16, (unsigned int) 16); /* line 260 */
   __ZXTB(reg_r0_20, reg_r0_20); /* line 261 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 262 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 263 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 264 */
} /* line 264 */
  sim_icache_fetch(160 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __OR(reg_r0_17, reg_r0_17, reg_r0_8); /* line 266 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_22); /* line 267 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_25); /* line 268 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_27); /* line 269 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_7); /* line 270 */
   __SHL(reg_r0_7, reg_r0_20, (unsigned int) 8); /* line 271 */
   __SHL(reg_r0_3, reg_r0_20, (unsigned int) 16); /* line 272 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_10); /* line 273 */
   __AND(reg_r0_8, reg_r0_11, (unsigned int) 255); /* line 274 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 275 */
} /* line 275 */
  sim_icache_fetch(170 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __OR(reg_r0_16, reg_r0_16, reg_r0_9); /* line 277 */
   __OR(reg_r0_20, reg_r0_20, reg_r0_3); /* line 278 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 279 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_6); /* line 280 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 281 */
   __AND(reg_r0_6, reg_r0_12, (unsigned int) 255); /* line 282 */
   __SHRU(reg_r0_3, reg_r0_12, (unsigned int) 8); /* line 283 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 284 */
   __AND(reg_r0_10, reg_r0_14, (unsigned int) 255); /* line 285 */
   __SHRU(reg_r0_9, reg_r0_14, (unsigned int) 8); /* line 286 */
} /* line 286 */
  sim_icache_fetch(180 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __OR(reg_r0_20, reg_r0_20, reg_r0_7); /* line 288 */
   __SHL(reg_r0_18, reg_r0_5, (unsigned int) 8); /* line 289 */
   __SHL(reg_r0_7, reg_r0_5, (unsigned int) 16); /* line 290 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_11); /* line 291 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 292 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 293 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 294 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 295 */
   __AND(reg_r0_22, reg_r0_15, (unsigned int) 255); /* line 296 */
   __SHRU(reg_r0_11, reg_r0_15, (unsigned int) 8); /* line 297 */
} /* line 297 */
  sim_icache_fetch(190 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 299 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 300 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 301 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_7); /* line 302 */
   __ZXTB(reg_r0_8, reg_r0_8); /* line 303 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_3); /* line 304 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_9); /* line 305 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 306 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 307 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 308 */
} /* line 308 */
  sim_icache_fetch(200 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 310 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_16); /* line 311 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_20); /* line 312 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_18); /* line 313 */
   __SHL(reg_r0_7, reg_r0_8, (unsigned int) 8); /* line 314 */
   __SHL(reg_r0_3, reg_r0_8, (unsigned int) 16); /* line 315 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_12); /* line 316 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_14); /* line 317 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_11); /* line 318 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 319 */
} /* line 319 */
  sim_icache_fetch(210 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_5); /* line 321 */
   __OR(reg_r0_8, reg_r0_8, reg_r0_3); /* line 322 */
   __ZXTB(reg_r0_6, reg_r0_6); /* line 323 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 324 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_15); /* line 325 */
} /* line 325 */
  sim_icache_fetch(215 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_8, reg_r0_8, reg_r0_7); /* line 327 */
   __SHL(reg_r0_5, reg_r0_6, (unsigned int) 8); /* line 328 */
   __SHL(reg_r0_3, reg_r0_6, (unsigned int) 16); /* line 329 */
   __SHL(reg_r0_9, reg_r0_10, (unsigned int) 8); /* line 330 */
   __SHL(reg_r0_7, reg_r0_10, (unsigned int) 16); /* line 331 */
   __ZXTB(reg_r0_22, reg_r0_22); /* line 332 */
} /* line 332 */
  sim_icache_fetch(221 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_8); /* line 334 */
   __OR(reg_r0_6, reg_r0_6, reg_r0_3); /* line 335 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_7); /* line 336 */
   __SHL(reg_r0_7, reg_r0_22, (unsigned int) 8); /* line 337 */
   __SHL(reg_r0_3, reg_r0_22, (unsigned int) 16); /* line 338 */
} /* line 338 */
  sim_icache_fetch(226 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_6, reg_r0_6, reg_r0_5); /* line 340 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_9); /* line 341 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_3); /* line 342 */
} /* line 342 */
  sim_icache_fetch(229 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_6); /* line 344 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_7); /* line 345 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(232 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_10); /* line 348 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_22); /* line 349 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 350 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_30, (unsigned int) 256); /* line 355 */
   __ADD(reg_r0_5, reg_r0_29, (unsigned int) 256); /* line 356 */
   __ADD(reg_r0_3, reg_r0_28, (unsigned int) 1); /* line 357 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_31); /* line 364 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 365 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 367 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 368 */
