  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
  ...
  sim_icache_fetch(37 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   ...
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 133 */
} /* line 133 */
  sim_icache_fetch(47 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), 0); /* line 135 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), 0); /* line 136 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), 0); /* line 137 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), 0); /* line 138 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), 0); /* line 139 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), 0); /* line 140 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), 0); /* line 141 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), 0); /* line 142 */
  ...
  sim_icache_fetch(57 + t_thisfile.offset, 4);
{
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 60),0,4), 0); /* line 148 */
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_8, 0); /* line 153 */
   __MOV(reg_r0_3, 0); /* line 154 */
   __MOV(reg_r0_46, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 155 */
   __MOV(reg_r0_47, reg_r0_5); /* line 156 */
} /* line 156 */
l_L4X3: ;/* line 159 */
__LABEL(l_L4X3);
  sim_icache_fetch(66 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __CMPLT(reg_b0_0, reg_r0_3, (unsigned int) 58); /* line 160 */
   __MOV(reg_r0_4, (unsigned int) -58); /* line 161 */
   __MOV(reg_r0_7, 0); /* line 162 */
} /* line 162 */
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __CMPLT(reg_b0_0, reg_r0_4, 0); /* line 168 */
   __MOV(reg_r0_2, (unsigned int) -7); /* line 169 */
   __MOV(reg_r0_6, 0); /* line 170 */
   __MOV(reg_r0_5, reg_r0_7); /* line 171 */
   __MOV(reg_r0_17, 0); /* line 172 */
   __MOV(reg_r0_16, 0); /* line 173 */
   __MOV(reg_r0_18, 0); /* line 174 */
   __MOV(reg_r0_44, reg_r0_4); /* line 175 */
   __MOV(reg_r0_45, reg_r0_7); /* line 176 */
} /* line 176 */
...
l_L8X3: ;/* line 181 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __CMPLT(reg_b0_0, reg_r0_2, 0); /* line 182 */
   __SH2ADD(reg_r0_10, reg_r0_6, (unsigned int) filter7x7); /* line 183 */
   __ADD(reg_r0_9, reg_r0_5, reg_r0_8); /* line 184 */
   ...
   __ADD(reg_r0_15, reg_r0_3, (unsigned int) 5); /* line 189 */
  ...
  sim_icache_fetch(94 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __LDWs(reg_r0_10, mem_trace_ld(reg_r0_10,0,4)); /* line 193 */
   __SH2ADD(reg_r0_9, reg_r0_9, (unsigned int) conv7_image); /* line 194 */
   __SHL(reg_r0_11, reg_r0_11, (unsigned int) 6); /* line 195 */
   __LDWs(reg_r0_12, mem_trace_ld(reg_r0_12,0,4)); /* line 196 */
   __SHL(reg_r0_13, reg_r0_13, (unsigned int) 6); /* line 197 */
   __LDWs(reg_r0_14, mem_trace_ld(reg_r0_14,0,4)); /* line 198 */
   __SHL(reg_r0_15, reg_r0_15, (unsigned int) 6); /* line 199 */
   __SHL(reg_r0_4, reg_r0_4, (unsigned int) 6); /* line 200 */
   __LDWs(reg_r0_7, mem_trace_ld(reg_r0_7,0,4)); /* line 201 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(105 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 204 */
   __ADD(reg_r0_20, reg_r0_3, (unsigned int) 1); /* line 205 */
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 206 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 207 */
   __ADD(reg_r0_13, reg_r0_5, reg_r0_13); /* line 208 */
   __ADD(reg_r0_22, reg_r0_3, (unsigned int) 4); /* line 209 */
   __SH2ADD(reg_r0_23, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 210 */
   __ADD(reg_r0_15, reg_r0_5, reg_r0_15); /* line 211 */
   __SH2ADD(reg_r0_19, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 212 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 213 */
} /* line 213 */
  sim_icache_fetch(118 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __LDW(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 215 */
   __SHL(reg_r0_20, reg_r0_20, (unsigned int) 6); /* line 216 */
   __SH2ADD(reg_r0_11, reg_r0_11, (unsigned int) conv7_image); /* line 217 */
   __SH2ADD(reg_r0_13, reg_r0_13, (unsigned int) conv7_image); /* line 218 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 6); /* line 219 */
   __LDW(reg_r0_23, mem_trace_ld(reg_r0_23,0,4)); /* line 220 */
   __SH2ADD(reg_r0_15, reg_r0_15, (unsigned int) conv7_image); /* line 221 */
   __LDW(reg_r0_19, mem_trace_ld(reg_r0_19,0,4)); /* line 222 */
   __SH2ADD(reg_r0_4, reg_r0_4, (unsigned int) conv7_image); /* line 223 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 224 */
} /* line 224 */
  sim_icache_fetch(132 + t_thisfile.offset, 10);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHRU(reg_r0_25, t__i32_0, (unsigned int) 16); /* line 226 */
   __AND(reg_r0_9, t__i32_0, (unsigned int) 255); /* line 227 */
   __SHRU(reg_r0_24, t__i32_0, (unsigned int) 8); /* line 228 */
   __ADD(reg_r0_20, reg_r0_5, reg_r0_20); /* line 229 */
   __LDW(reg_r0_11, mem_trace_ld(reg_r0_11,0,4)); /* line 230 */
   __LDW(reg_r0_13, mem_trace_ld(reg_r0_13,0,4)); /* line 231 */
   __ADD(reg_r0_22, reg_r0_5, reg_r0_22); /* line 232 */
   __LDW(reg_r0_15, mem_trace_ld(reg_r0_15,0,4)); /* line 233 */
   __LDW(reg_r0_4, mem_trace_ld(reg_r0_4,0,4)); /* line 234 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 235 */
} /* line 235 */
  sim_icache_fetch(142 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 237 */
   __MULLU(reg_r0_26, reg_r0_10, reg_r0_9); /* line 238 */
   __MULHS(reg_r0_9, reg_r0_10, reg_r0_9); /* line 239 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 240 */
   __SH2ADD(reg_r0_20, reg_r0_20, (unsigned int) conv7_image); /* line 241 */
   __SH2ADD(reg_r0_22, reg_r0_22, (unsigned int) conv7_image); /* line 242 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 243 */
} /* line 243 */
  sim_icache_fetch(151 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __MULLU(reg_r0_33, reg_r0_10, reg_r0_25); /* line 245 */
   __MULLU(reg_r0_28, reg_r0_10, reg_r0_24); /* line 246 */
   __MULHS(reg_r0_24, reg_r0_10, reg_r0_24); /* line 247 */
   __LDW(reg_r0_20, mem_trace_ld(reg_r0_20,0,4)); /* line 248 */
   __SHRU(reg_r0_29, reg_r0_11, (unsigned int) 8); /* line 249 */
   __SHRU(reg_r0_30, reg_r0_13, (unsigned int) 8); /* line 250 */
   __LDW(reg_r0_22, mem_trace_ld(reg_r0_22,0,4)); /* line 251 */
   __SHRU(reg_r0_31, reg_r0_15, (unsigned int) 8); /* line 252 */
   __SHRU(reg_r0_32, reg_r0_4, (unsigned int) 16); /* line 253 */
   __SHRU(reg_r0_27, reg_r0_4, (unsigned int) 8); /* line 254 */
} /* line 254 */
  sim_icache_fetch(161 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __MULHS(reg_r0_10, reg_r0_10, reg_r0_25); /* line 256 */
   __SHRU(reg_r0_25, reg_r0_11, (unsigned int) 16); /* line 257 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 258 */
   __SHRU(reg_r0_34, reg_r0_13, (unsigned int) 16); /* line 259 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 260 */
   __SHRU(reg_r0_35, reg_r0_15, (unsigned int) 16); /* line 261 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 262 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 263 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 264 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 265 */
} /* line 265 */
  sim_icache_fetch(171 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 267 */
   __SHRU(reg_r0_39, reg_r0_20, (unsigned int) 8); /* line 268 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_29); /* line 269 */
   __MULHS(reg_r0_29, reg_r0_12, reg_r0_29); /* line 270 */
   __MULLU(reg_r0_37, reg_r0_14, reg_r0_30); /* line 271 */
   __MULHS(reg_r0_30, reg_r0_14, reg_r0_30); /* line 272 */
   __MULLU(reg_r0_38, reg_r0_19, reg_r0_31); /* line 273 */
   __MULHS(reg_r0_31, reg_r0_19, reg_r0_31); /* line 274 */
   __MULLU(reg_r0_36, reg_r0_7, reg_r0_27); /* line 275 */
   __MULHS(reg_r0_27, reg_r0_7, reg_r0_27); /* line 276 */
} /* line 276 */
  sim_icache_fetch(181 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __ADD(reg_r0_33, reg_r0_33, reg_r0_10); /* line 278 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 279 */
   __ADD(reg_r0_40, reg_r0_28, (unsigned int) 255); /* line 280 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 281 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 282 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 283 */
   __SHRU(reg_r0_41, reg_r0_22, (unsigned int) 8); /* line 284 */
   __AND(reg_r0_35, reg_r0_35, (unsigned int) 255); /* line 285 */
   __MULLU(reg_r0_42, reg_r0_7, reg_r0_32); /* line 286 */
   __MULHS(reg_r0_32, reg_r0_7, reg_r0_32); /* line 287 */
} /* line 287 */
  sim_icache_fetch(191 + t_thisfile.offset, 10);
{
  unsigned int t__i32_0;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __CMPLT(reg_b0_0, reg_r0_33, 0); /* line 289 */
   __ADD(reg_r0_27, reg_r0_33, (unsigned int) 255); /* line 290 */
   __SLCT(reg_r0_40, t__i32_0, reg_r0_40, reg_r0_28); /* line 291 */
   __MULLU(reg_r0_10, reg_r0_21, reg_r0_39); /* line 292 */
   __MULHS(reg_r0_39, reg_r0_21, reg_r0_39); /* line 293 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 294 */
   __ADD(reg_r0_37, reg_r0_37, reg_r0_30); /* line 295 */
   __AND(reg_r0_41, reg_r0_41, (unsigned int) 255); /* line 296 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_31); /* line 297 */
   __ADD(reg_r0_36, reg_r0_36, t__i32_1); /* line 298 */
} /* line 298 */
  sim_icache_fetch(201 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHR(reg_r0_40, reg_r0_40, (unsigned int) 8); /* line 300 */
   __CMPLT(reg_b0_2, reg_r0_24, 0); /* line 301 */
   __ADD(reg_r0_29, reg_r0_24, (unsigned int) 255); /* line 302 */
   __CMPLT(reg_b0_3, reg_r0_37, 0); /* line 303 */
   __ADD(reg_r0_30, reg_r0_37, (unsigned int) 255); /* line 304 */
   __MULLU(reg_r0_43, reg_r0_23, reg_r0_41); /* line 305 */
   __CMPLT(reg_b0_4, reg_r0_38, 0); /* line 306 */
   __ADD(reg_r0_31, reg_r0_38, (unsigned int) 255); /* line 307 */
   __CMPLT(reg_b0_1, reg_r0_36, 0); /* line 308 */
   __ADD(reg_r0_28, reg_r0_36, (unsigned int) 255); /* line 309 */
} /* line 309 */
  sim_icache_fetch(211 + t_thisfile.offset, 10);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_24 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SLCT(reg_r0_27, reg_b0_0, reg_r0_27, reg_r0_33); /* line 311 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_39); /* line 312 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_25); /* line 313 */
   __MULHS(reg_r0_25, reg_r0_12, reg_r0_25); /* line 314 */
   __SLCT(reg_r0_29, reg_b0_2, reg_r0_29, t__i32_0); /* line 315 */
   __SLCT(reg_r0_30, reg_b0_3, reg_r0_30, reg_r0_37); /* line 316 */
   __MULHS(reg_r0_41, reg_r0_23, reg_r0_41); /* line 317 */
   __SLCT(reg_r0_31, reg_b0_4, reg_r0_31, reg_r0_38); /* line 318 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_32); /* line 319 */
   __SLCT(reg_r0_28, reg_b0_1, reg_r0_28, reg_r0_36); /* line 320 */
} /* line 320 */
  sim_icache_fetch(221 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 322 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 323 */
   __ADD(reg_r0_32, reg_r0_10, (unsigned int) 255); /* line 324 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 325 */
   __MULLU(reg_r0_36, reg_r0_14, reg_r0_34); /* line 326 */
   __SHR(reg_r0_30, reg_r0_30, (unsigned int) 8); /* line 327 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 328 */
   __CMPLT(reg_b0_1, reg_r0_42, 0); /* line 329 */
   __ADD(reg_r0_33, reg_r0_42, (unsigned int) 255); /* line 330 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 331 */
} /* line 331 */
  sim_icache_fetch(231 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SLCT(reg_r0_32, reg_b0_0, reg_r0_32, reg_r0_10); /* line 333 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_25); /* line 334 */
   __MULHS(reg_r0_34, reg_r0_14, reg_r0_34); /* line 335 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_41); /* line 336 */
   __MULLU(reg_r0_10, reg_r0_19, reg_r0_35); /* line 337 */
   __MULHS(reg_r0_35, reg_r0_19, reg_r0_35); /* line 338 */
   __SLCT(reg_r0_33, reg_b0_1, reg_r0_33, reg_r0_42); /* line 339 */
   __ADD(reg_r0_40, reg_r0_40, reg_r0_28); /* line 340 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_31); /* line 341 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_30); /* line 342 */
} /* line 342 */
  sim_icache_fetch(241 + t_thisfile.offset, 10);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_29 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHRU(reg_r0_29, reg_r0_20, (unsigned int) 16); /* line 344 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 345 */
   __CMPLT(reg_b0_1, reg_r0_24, 0); /* line 346 */
   __ADD(reg_r0_28, reg_r0_24, (unsigned int) 255); /* line 347 */
   __SHRU(reg_r0_30, reg_r0_22, (unsigned int) 16); /* line 348 */
   __CMPLT(reg_b0_0, reg_r0_43, 0); /* line 349 */
   __ADD(reg_r0_25, reg_r0_43, (unsigned int) 255); /* line 350 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 351 */
   __MULLU(reg_r0_31, reg_r0_7, reg_r0_4); /* line 352 */
   __ADD(reg_r0_40, reg_r0_40, t__i32_0); /* line 353 */
} /* line 353 */
  sim_icache_fetch(251 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 355 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 356 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 357 */
   __SLCT(reg_r0_28, reg_b0_1, reg_r0_28, reg_r0_24); /* line 358 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_34); /* line 359 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 360 */
   __SLCT(reg_r0_25, reg_b0_0, reg_r0_25, reg_r0_43); /* line 361 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_35); /* line 362 */
   __MULHS(reg_r0_7, reg_r0_7, reg_r0_4); /* line 363 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_33); /* line 364 */
} /* line 364 */
  sim_icache_fetch(261 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __MULLU(reg_r0_24, reg_r0_21, reg_r0_29); /* line 366 */
   __MULHS(reg_r0_29, reg_r0_21, reg_r0_29); /* line 367 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 368 */
   __CMPLT(reg_b0_0, reg_r0_36, 0); /* line 369 */
   __ADD(reg_r0_4, reg_r0_36, (unsigned int) 255); /* line 370 */
   __MULLU(reg_r0_33, reg_r0_23, reg_r0_30); /* line 371 */
   __MULHS(reg_r0_30, reg_r0_23, reg_r0_30); /* line 372 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 373 */
   __CMPLT(reg_b0_1, reg_r0_10, 0); /* line 374 */
   __ADD(reg_r0_9, reg_r0_10, (unsigned int) 255); /* line 375 */
} /* line 375 */
  sim_icache_fetch(271 + t_thisfile.offset, 10);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 377 */
   __ADD(reg_r0_7, reg_r0_26, (unsigned int) 255); /* line 378 */
   __MULLU(reg_r0_10, reg_r0_12, reg_r0_11); /* line 379 */
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_11); /* line 380 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 381 */
   __SLCT(reg_r0_4, t__i32_0, reg_r0_4, reg_r0_36); /* line 382 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 383 */
   __SLCT(reg_r0_9, reg_b0_1, reg_r0_9, t__i32_1); /* line 384 */
   __ADD(reg_r0_31, reg_r0_31, t__i32_2); /* line 385 */
   __ADD(reg_r0_32, reg_r0_32, reg_r0_25); /* line 386 */
} /* line 386 */
  sim_icache_fetch(281 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_26); /* line 388 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 389 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 390 */
   __MULLU(reg_r0_25, reg_r0_14, reg_r0_13); /* line 391 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 392 */
   __ADD(reg_r0_33, reg_r0_33, reg_r0_30); /* line 393 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 394 */
   __CMPLT(reg_b0_1, reg_r0_31, 0); /* line 395 */
   __ADD(reg_r0_11, reg_r0_31, (unsigned int) 255); /* line 396 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_32); /* line 397 */
} /* line 397 */
  sim_icache_fetch(291 + t_thisfile.offset, 10);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_r0_9 ;
  t__i32_1 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 399 */
   __CMPLT(reg_b0_0, reg_r0_24, 0); /* line 400 */
   __ADD(reg_r0_4, reg_r0_24, (unsigned int) 255); /* line 401 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_12); /* line 402 */
   __CMPLT(reg_b0_2, reg_r0_33, 0); /* line 403 */
   __ADD(reg_r0_9, reg_r0_33, (unsigned int) 255); /* line 404 */
   __SLCT(reg_r0_11, reg_b0_1, reg_r0_11, reg_r0_31); /* line 405 */
   __ADD(reg_r0_16, reg_r0_40, reg_r0_16); /* line 406 */
   __ADD(reg_r0_17, reg_r0_17, t__i32_0); /* line 407 */
   __ADD(reg_r0_28, reg_r0_28, t__i32_1); /* line 408 */
} /* line 408 */
  sim_icache_fetch(301 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_24); /* line 410 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 411 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 412 */
   __ADD(reg_r0_12, reg_r0_10, (unsigned int) 255); /* line 413 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_14); /* line 414 */
   __SLCT(reg_r0_9, reg_b0_2, reg_r0_9, reg_r0_33); /* line 415 */
   __MULLU(reg_r0_13, reg_r0_19, reg_r0_15); /* line 416 */
   __MULHS(reg_r0_19, reg_r0_19, reg_r0_15); /* line 417 */
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 418 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_28); /* line 419 */
} /* line 419 */
  sim_icache_fetch(311 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_11 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 421 */
   __MULLU(reg_r0_11, reg_r0_21, reg_r0_20); /* line 422 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_20); /* line 423 */
   __SLCT(reg_r0_12, reg_b0_0, reg_r0_12, reg_r0_10); /* line 424 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 425 */
   __ADD(reg_r0_10, reg_r0_25, (unsigned int) 255); /* line 426 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 427 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 428 */
   __ADD(reg_r0_7, reg_r0_7, t__i32_0); /* line 429 */
} /* line 429 */
  sim_icache_fetch(320 + t_thisfile.offset, 6);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 431 */
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_25); /* line 432 */
   __MULLU(reg_r0_9, reg_r0_23, reg_r0_22); /* line 433 */
   __MULHS(reg_r0_23, reg_r0_23, reg_r0_22); /* line 434 */
   __ADD(reg_r0_13, reg_r0_13, reg_r0_19); /* line 435 */
   __ADD(reg_r0_4, reg_r0_4, t__i32_0); /* line 436 */
} /* line 436 */
  sim_icache_fetch(326 + t_thisfile.offset, 5);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_11, reg_r0_11, reg_r0_21); /* line 438 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 439 */
   __CMPLT(reg_b0_0, reg_r0_13, 0); /* line 440 */
   __ADD(reg_r0_4, reg_r0_13, (unsigned int) 255); /* line 441 */
   __ADD(reg_r0_17, reg_r0_17, t__i32_0); /* line 442 */
} /* line 442 */
  sim_icache_fetch(331 + t_thisfile.offset, 6);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_10 ;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_11, 0); /* line 444 */
   __ADD(reg_r0_10, reg_r0_11, (unsigned int) 255); /* line 445 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_23); /* line 446 */
   __SLCT(reg_r0_4, t__i32_0, reg_r0_4, reg_r0_13); /* line 447 */
   __ADD(reg_r0_12, reg_r0_12, t__i32_1); /* line 448 */
   __ADD(reg_r0_17, reg_r0_27, reg_r0_17); /* line 449 */
} /* line 449 */
  sim_icache_fetch(337 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_11); /* line 451 */
   __CMPLT(reg_b0_0, reg_r0_9, 0); /* line 452 */
   __ADD(reg_r0_11, reg_r0_9, (unsigned int) 255); /* line 453 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 454 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_12); /* line 455 */
} /* line 455 */
  sim_icache_fetch(342 + t_thisfile.offset, 3);
{
   ...
   __SLCT(reg_r0_11, reg_b0_0, reg_r0_11, reg_r0_9); /* line 458 */
   __ADD(reg_r0_18, reg_r0_18, reg_r0_4); /* line 459 */
} /* line 459 */
  sim_icache_fetch(345 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 461 */
} /* line 461 */
  sim_icache_fetch(346 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_10, reg_r0_10, reg_r0_11); /* line 463 */
} /* line 463 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_18, reg_r0_18, reg_r0_10); /* line 465 */
} /* line 465 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_18, reg_r0_7, reg_r0_18); /* line 467 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_18, reg_r0_18, 0); /* line 472 */
   __MAX(reg_r0_16, reg_r0_16, 0); /* line 473 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 474 */
   __SH2ADD(reg_r0_2, reg_r0_44, reg_r0_46); /* line 475 */
   __ADD(reg_r0_4, reg_r0_44, (unsigned int) 1); /* line 476 */
} /* line 476 */
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 478 */
   __MIN(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 479 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 480 */
   __ADD(reg_r0_7, reg_r0_45, (unsigned int) 1); /* line 481 */
} /* line 481 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_16, reg_r0_16, (unsigned int) 8); /* line 483 */
   __SHL(reg_r0_17, reg_r0_17, (unsigned int) 16); /* line 484 */
} /* line 484 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_18, reg_r0_18, reg_r0_17); /* line 486 */
} /* line 486 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_18, reg_r0_18, reg_r0_16); /* line 488 */
} /* line 488 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_18); /* line 490 */
  ...
  sim_icache_fetch(365 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_46, reg_r0_46, (unsigned int) 256); /* line 495 */
  ...
  sim_icache_fetch(370 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_47); /* line 504 */
  ...
  sim_icache_fetch(375 + t_thisfile.offset, 3);
{
   ...
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 508 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 509 */
   __ADD_CYCLES(1);
} /* line 509 */
