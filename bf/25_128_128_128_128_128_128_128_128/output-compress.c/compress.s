...
;;								## 2
	...
	c0    mov $r0.5 = (compress_18561.Buf + 0)   ## addr(compress_18561.Buf?1.0)(P32)
	c0    ldw $r0.2 = 0x2c[$r0.1]  ## restore ## t6
	c0    ldw $r0.4 = 0x30[$r0.1]  ## restore ## t11
;;								## 3
	c0    stw ((bufp + 0) + 0)[$r0.0] = $r0.5   ## bblock 0, line 18, 0(I32), addr(compress_18561.Buf?1.0)(P32)
...
;;								## 1
	...
	c0    ldb.d $r0.61 = 0[$r0.46]   ## [spec] bblock 4, line 64-1, t203(SI8), t148
	c0    ldb.d $r0.62 = 0[$r0.45]   ## [spec] bblock 7, line 64-1, t201(SI8), t91
...
;;								## 19
	...
	c0    cmpne $b0.2 = $r0.61, $r0.0   ## [spec] bblock 4, line 64-1,  t212(I1),  t203(SI8),  0(SI32)
	c0    cmpeq $b0.3 = $r0.61, $r0.4   ## [spec] bblock 7, line 65-1,  t200(I1),  t203(SI8),  t1(SI8)
...
;;								## 20
	...
	c0    cmpne $b0.4 = $r0.62, $r0.0   ## [spec] bblock 7, line 64-1,  t214(I1),  t201(SI8),  0(SI32)
	c0    cmpeq $b0.5 = $r0.62, $r0.4   ## [spec] bblock 10, line 65-1,  t198(I1),  t201(SI8),  t1(SI8)
...
;;								## 3
L61?3:
	c0    stw ((compress_18561.offset + 0) + 0)[$r0.0] = $r0.0   ## bblock 1, line 197, 0(I32), 0(SI32)
...
.trace 7
	      ## auto_size == 0
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 0, line 275, t1, 0(I32)
...
;;								## 2
	c0    add $r0.12 = $r0.7, (compress_18561.buf + 0)   ## bblock 7, line 280,  t21,  t8(SI29),  addr(compress_18561.buf?1.0)(P32)
	c0    ldb $r0.10 = (compress_18561.buf + 0)[$r0.7]   ## bblock 7, line 282, t17(SI8), t8(SI29)
	c0    add $r0.13 = $r0.7, ((compress_18561.buf + 0) + 1)   ## bblock 7, line 283,  t3,  t8(SI29),  (addr(compress_18561.buf?1.0)(P32) + 0x1(I32))(P32)
...
;;								## 6
	c0    stb (compress_18561.buf + 0)[$r0.7] = $r0.2   ## bblock 7, line 282, t8(SI29), t19
...
L167?3:
	...
	c0    mov $r0.3 = (compress_18561.buf + 0)   ## [spec] bblock 21, line 297,  t710,  addr(compress_18561.buf?1.0)(P32)
;;								## 9
...
;;								## 11
L168?3:
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 9, line 294, t32, 0(I32)
...
;;								## 14
	c0    stw ((compress_18561.offset + 0) + 0)[$r0.0] = $r0.2   ## bblock 9, line 294, 0(I32), t35
...
.trace 15
L171?3:
	c0    stw ((compress_18561.offset + 0) + 0)[$r0.0] = $r0.0   ## bblock 23, line 306, 0(I32), 0(SI32)
;;								## 0
.trace 9
L169?3:
	...
	c0    ldw.d $r0.22 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## [spec] bblock 11, line 310, t54, 0(I32)
	...
	c0    mov $r0.5 = (compress_18561.buf + 0)   ## [spec] bblock 17, line 0,  t630,  addr(compress_18561.buf?1.0)(P32)
...
.trace 14
L173?3:
	c0    stw ((compress_18561.offset + 0) + 0)[$r0.0] = $r0.0   ## bblock 12, line 316, 0(I32), 0(SI32)
...
.trace 8
L166?3:
	c0    ldw $r0.4 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 1, line 334, t78, 0(I32)
	c0    ldw.d $r0.3 = ((bytes_out + 0) + 0)[$r0.0]   ## [spec] bblock 2, line 337, t90, 0(I32)
	c0    ldw.d $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## [spec] bblock 2, line 337, t91, 0(I32)
	      xnop 1
;;								## 1
...
L179?3:
	...
	c0    stw ((compress_18561.offset + 0) + 0)[$r0.0] = $r0.0   ## bblock 2, line 338, 0(I32), 0(SI32)
;;								## 4
...
L178?3:
	...
	c0    mov $r0.5 = (compress_18561.buf + 0)   ## bblock 4, line 0,  t570,  addr(compress_18561.buf?1.0)(P32)
	c0    mov $r0.3 = $r0.0   ## bblock 4, line 335,  t122,  0(SI32)
;;								## 0
.trace 1
L180?3:
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 5, line 335, t135, 0(I32)
...
;;								## 9
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 6, line 335-1, t217, 0(I32)
...
;;								## 19
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 70, line 335-2, t210, 0(I32)
...
;;								## 29
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 67, line 335-3, t203, 0(I32)
...
;;								## 39
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 64, line 335-4, t196, 0(I32)
...
;;								## 49
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 61, line 335-5, t189, 0(I32)
...
;;								## 59
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 58, line 335-6, t182, 0(I32)
...
;;								## 69
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 55, line 335-7, t175, 0(I32)
...
;;								## 79
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 52, line 335-8, t168, 0(I32)
...
;;								## 89
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 49, line 335-9, t161, 0(I32)
...
;;								## 99
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 46, line 335-10, t154, 0(I32)
...
;;								## 109
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 43, line 335-11, t147, 0(I32)
...
;;								## 119
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 40, line 335-12, t125, 0(I32)
...
;;								## 129
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 37, line 335-13, t80, 0(I32)
...
;;								## 139
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 34, line 335-14, t121, 0(I32)
...
;;								## 149
	c0    ldw $r0.2 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 31, line 335-15, t132, 0(I32)
...
L196?3:
	...
	c0    ldw $r0.5 = ((compress_18561.offset + 0) + 0)[$r0.0]   ## bblock 2, line 337, t91, 0(I32)
	      xnop 1
;;								## 1
