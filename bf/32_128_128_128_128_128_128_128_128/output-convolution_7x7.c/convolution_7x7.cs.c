  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(32);
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), 0); /* line 138 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), 0); /* line 139 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 44),0,4), 0); /* line 140 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 48),0,4), 0); /* line 141 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 52),0,4), 0); /* line 142 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 56),0,4), 0); /* line 143 */
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 144 */
} /* line 144 */
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 4);
{
   ...
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 20),0,4), reg_r0_57); /* line 153 */
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 24),0,4), reg_r0_58); /* line 154 */
} /* line 154 */
  sim_icache_fetch(65 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_57, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 156 */
   __MOV(reg_r0_58, reg_r0_5); /* line 157 */
} /* line 157 */
l_L4X3: ;/* line 160 */
__LABEL(l_L4X3);
...
l_L6X3: ;/* line 168 */
__LABEL(l_L6X3);
  sim_icache_fetch(72 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   ...
   __MOV(reg_r0_17, 0); /* line 174 */
   __MOV(reg_r0_23, 0); /* line 175 */
   __MOV(reg_r0_55, reg_r0_4); /* line 176 */
   __MOV(reg_r0_56, reg_r0_7); /* line 177 */
} /* line 177 */
...
l_L8X3: ;/* line 182 */
__LABEL(l_L8X3);
  sim_icache_fetch(82 + t_thisfile.offset, 24);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   ...
   __ADD(reg_r0_18, reg_r0_3, (unsigned int) 1); /* line 186 */
   __SH2ADD(reg_r0_19, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 187 */
   __ADD(reg_r0_11, reg_r0_3, (unsigned int) 2); /* line 188 */
   __SH2ADD(reg_r0_12, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 8)); /* line 189 */
   __ADD(reg_r0_13, reg_r0_3, (unsigned int) 3); /* line 190 */
   __SH2ADD(reg_r0_14, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 12)); /* line 191 */
   __ADD(reg_r0_20, reg_r0_3, (unsigned int) 4); /* line 192 */
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 193 */
   __ADD(reg_r0_15, reg_r0_3, (unsigned int) 5); /* line 194 */
   __SH2ADD(reg_r0_16, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 195 */
   __ADD(reg_r0_4, reg_r0_3, (unsigned int) 6); /* line 196 */
   __SH2ADD(reg_r0_7, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 24)); /* line 197 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 198 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 199 */
} /* line 199 */
  sim_icache_fetch(106 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __LDWs(reg_r0_10, mem_trace_ld(reg_r0_10,0,4)); /* line 201 */
   __SH2ADD(reg_r0_9, reg_r0_9, (unsigned int) conv7_image); /* line 202 */
   __LDWs(reg_r0_19, mem_trace_ld(reg_r0_19,0,4)); /* line 203 */
   __SHL(reg_r0_18, reg_r0_18, (unsigned int) 6); /* line 204 */
   __SHL(reg_r0_11, reg_r0_11, (unsigned int) 6); /* line 205 */
   __LDWs(reg_r0_12, mem_trace_ld(reg_r0_12,0,4)); /* line 206 */
   __SHL(reg_r0_13, reg_r0_13, (unsigned int) 6); /* line 207 */
   __LDWs(reg_r0_14, mem_trace_ld(reg_r0_14,0,4)); /* line 208 */
   __SHL(reg_r0_20, reg_r0_20, (unsigned int) 6); /* line 209 */
   __LDWs(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 210 */
   __SHL(reg_r0_15, reg_r0_15, (unsigned int) 6); /* line 211 */
   __LDWs(reg_r0_16, mem_trace_ld(reg_r0_16,0,4)); /* line 212 */
   __SHL(reg_r0_4, reg_r0_4, (unsigned int) 6); /* line 213 */
   __LDWs(reg_r0_7, mem_trace_ld(reg_r0_7,0,4)); /* line 214 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(122 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 217 */
   __ADD(reg_r0_18, reg_r0_5, reg_r0_18); /* line 218 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 219 */
   __ADD(reg_r0_13, reg_r0_5, reg_r0_13); /* line 220 */
   __ADD(reg_r0_20, reg_r0_5, reg_r0_20); /* line 221 */
   __ADD(reg_r0_15, reg_r0_5, reg_r0_15); /* line 222 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 223 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 224 */
} /* line 224 */
  sim_icache_fetch(130 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SH2ADD(reg_r0_18, reg_r0_18, (unsigned int) conv7_image); /* line 226 */
   __SH2ADD(reg_r0_11, reg_r0_11, (unsigned int) conv7_image); /* line 227 */
   __SH2ADD(reg_r0_13, reg_r0_13, (unsigned int) conv7_image); /* line 228 */
   __SH2ADD(reg_r0_20, reg_r0_20, (unsigned int) conv7_image); /* line 229 */
   __SH2ADD(reg_r0_15, reg_r0_15, (unsigned int) conv7_image); /* line 230 */
   __SH2ADD(reg_r0_4, reg_r0_4, (unsigned int) conv7_image); /* line 231 */
} /* line 231 */
  sim_icache_fetch(142 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHRU(reg_r0_25, t__i32_0, (unsigned int) 16); /* line 233 */
   __AND(reg_r0_9, t__i32_0, (unsigned int) 255); /* line 234 */
   __SHRU(reg_r0_24, t__i32_0, (unsigned int) 8); /* line 235 */
   __LDW(reg_r0_18, mem_trace_ld(reg_r0_18,0,4)); /* line 236 */
   __LDW(reg_r0_11, mem_trace_ld(reg_r0_11,0,4)); /* line 237 */
   __LDW(reg_r0_13, mem_trace_ld(reg_r0_13,0,4)); /* line 238 */
   __LDW(reg_r0_20, mem_trace_ld(reg_r0_20,0,4)); /* line 239 */
   __LDW(reg_r0_15, mem_trace_ld(reg_r0_15,0,4)); /* line 240 */
   __LDW(reg_r0_4, mem_trace_ld(reg_r0_4,0,4)); /* line 241 */
} /* line 241 */
  sim_icache_fetch(151 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 243 */
   __MULLU(reg_r0_26, reg_r0_10, reg_r0_9); /* line 244 */
   __MULHS(reg_r0_9, reg_r0_10, reg_r0_9); /* line 245 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 246 */
} /* line 246 */
  sim_icache_fetch(155 + t_thisfile.offset, 22);
{
  unsigned int t__i32_0;
  ...
  t__i32_6 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   __MULLU(reg_r0_35, t__i32_0, reg_r0_25); /* line 248 */
   __MULHS(reg_r0_10, t__i32_0, reg_r0_25); /* line 249 */
   __MULLU(reg_r0_28, t__i32_0, reg_r0_24); /* line 250 */
   __MULHS(reg_r0_24, t__i32_0, reg_r0_24); /* line 251 */
   __SHRU(reg_r0_38, t__i32_1, (unsigned int) 16); /* line 252 */
   __AND(reg_r0_18, t__i32_1, (unsigned int) 255); /* line 253 */
   __SHRU(reg_r0_32, t__i32_1, (unsigned int) 8); /* line 254 */
   __SHRU(reg_r0_25, t__i32_2, (unsigned int) 16); /* line 255 */
   __AND(reg_r0_11, t__i32_2, (unsigned int) 255); /* line 256 */
   __SHRU(reg_r0_29, t__i32_2, (unsigned int) 8); /* line 257 */
   __SHRU(reg_r0_36, t__i32_3, (unsigned int) 16); /* line 258 */
   __AND(reg_r0_13, t__i32_3, (unsigned int) 255); /* line 259 */
   __SHRU(reg_r0_30, t__i32_3, (unsigned int) 8); /* line 260 */
   __SHRU(reg_r0_39, t__i32_4, (unsigned int) 16); /* line 261 */
   __AND(reg_r0_20, t__i32_4, (unsigned int) 255); /* line 262 */
   __SHRU(reg_r0_33, t__i32_4, (unsigned int) 8); /* line 263 */
   __SHRU(reg_r0_37, t__i32_5, (unsigned int) 16); /* line 264 */
   __AND(reg_r0_15, t__i32_5, (unsigned int) 255); /* line 265 */
   __SHRU(reg_r0_31, t__i32_5, (unsigned int) 8); /* line 266 */
   __SHRU(reg_r0_34, t__i32_6, (unsigned int) 16); /* line 267 */
   __AND(reg_r0_4, t__i32_6, (unsigned int) 255); /* line 268 */
   __SHRU(reg_r0_27, t__i32_6, (unsigned int) 8); /* line 269 */
} /* line 269 */
  sim_icache_fetch(177 + t_thisfile.offset, 25);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(25);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 271 */
   __AND(reg_r0_38, reg_r0_38, (unsigned int) 255); /* line 272 */
   __MULLU(reg_r0_43, reg_r0_19, reg_r0_18); /* line 273 */
   __MULHS(reg_r0_18, reg_r0_19, reg_r0_18); /* line 274 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 275 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 276 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 277 */
   __MULLU(reg_r0_9, reg_r0_12, reg_r0_11); /* line 278 */
   __MULHS(reg_r0_11, reg_r0_12, reg_r0_11); /* line 279 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 280 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 281 */
   __MULLU(reg_r0_41, reg_r0_14, reg_r0_13); /* line 282 */
   __MULHS(reg_r0_13, reg_r0_14, reg_r0_13); /* line 283 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 284 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 285 */
   __MULLU(reg_r0_44, reg_r0_21, reg_r0_20); /* line 286 */
   __MULHS(reg_r0_20, reg_r0_21, reg_r0_20); /* line 287 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 288 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 289 */
   __MULLU(reg_r0_42, reg_r0_16, reg_r0_15); /* line 290 */
   __MULHS(reg_r0_15, reg_r0_16, reg_r0_15); /* line 291 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 292 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 293 */
   __MULLU(reg_r0_40, reg_r0_7, reg_r0_4); /* line 294 */
   __MULHS(reg_r0_4, reg_r0_7, reg_r0_4); /* line 295 */
} /* line 295 */
  sim_icache_fetch(202 + t_thisfile.offset, 28);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_9 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(28);
   __ADD(reg_r0_35, reg_r0_35, reg_r0_10); /* line 297 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 298 */
   __ADD(reg_r0_38, reg_r0_26, (unsigned int) 255); /* line 299 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 300 */
   __MULLU(reg_r0_36, t__i32_1, t__i32_0); /* line 301 */
   __MULHS(reg_r0_19, t__i32_1, t__i32_0); /* line 302 */
   __MULLU(reg_r0_48, t__i32_1, reg_r0_32); /* line 303 */
   __MULHS(reg_r0_32, t__i32_1, reg_r0_32); /* line 304 */
   __MULLU(reg_r0_10, t__i32_2, reg_r0_25); /* line 305 */
   __MULHS(reg_r0_12, t__i32_2, reg_r0_25); /* line 306 */
   __MULLU(reg_r0_24, t__i32_2, reg_r0_29); /* line 307 */
   __MULHS(reg_r0_29, t__i32_2, reg_r0_29); /* line 308 */
   __MULLU(reg_r0_25, t__i32_4, t__i32_3); /* line 309 */
   __MULHS(reg_r0_14, t__i32_4, t__i32_3); /* line 310 */
   __MULLU(reg_r0_46, t__i32_4, reg_r0_30); /* line 311 */
   __MULHS(reg_r0_30, t__i32_4, reg_r0_30); /* line 312 */
   __MULLU(reg_r0_37, t__i32_5, reg_r0_39); /* line 313 */
   __MULHS(reg_r0_21, t__i32_5, reg_r0_39); /* line 314 */
   __MULLU(reg_r0_49, t__i32_5, reg_r0_33); /* line 315 */
   __MULHS(reg_r0_33, t__i32_5, reg_r0_33); /* line 316 */
   __MULLU(reg_r0_34, t__i32_7, t__i32_6); /* line 317 */
   __MULHS(reg_r0_16, t__i32_7, t__i32_6); /* line 318 */
   __MULLU(reg_r0_47, t__i32_7, reg_r0_31); /* line 319 */
   __MULHS(reg_r0_31, t__i32_7, reg_r0_31); /* line 320 */
   __MULLU(reg_r0_50, t__i32_9, t__i32_8); /* line 321 */
   __MULHS(reg_r0_7, t__i32_9, t__i32_8); /* line 322 */
   __MULLU(reg_r0_45, t__i32_9, reg_r0_27); /* line 323 */
   __MULHS(reg_r0_27, t__i32_9, reg_r0_27); /* line 324 */
} /* line 324 */
  sim_icache_fetch(230 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __CMPLT(reg_b0_2, reg_r0_35, 0); /* line 326 */
   __ADD(reg_r0_51, reg_r0_35, (unsigned int) 255); /* line 327 */
   __SLCT(reg_r0_38, reg_b0_0, reg_r0_38, reg_r0_26); /* line 328 */
   __CMPLT(reg_b0_1, reg_r0_28, 0); /* line 329 */
   __ADD(reg_r0_39, reg_r0_28, (unsigned int) 255); /* line 330 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_18); /* line 331 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_11); /* line 332 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_13); /* line 333 */
   __ADD(reg_r0_44, reg_r0_44, reg_r0_20); /* line 334 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_15); /* line 335 */
   __ADD(reg_r0_40, reg_r0_40, reg_r0_4); /* line 336 */
} /* line 336 */
  sim_icache_fetch(241 + t_thisfile.offset, 27);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(27);
   __SLCT(reg_r0_51, reg_b0_2, reg_r0_51, reg_r0_35); /* line 338 */
   __SHR(reg_r0_38, reg_r0_38, (unsigned int) 8); /* line 339 */
   __SLCT(reg_r0_39, reg_b0_1, reg_r0_39, reg_r0_28); /* line 340 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_19); /* line 341 */
   __CMPLT(reg_b0_4, reg_r0_43, 0); /* line 342 */
   __ADD(reg_r0_13, reg_r0_43, (unsigned int) 255); /* line 343 */
   __ADD(reg_r0_48, reg_r0_48, reg_r0_32); /* line 344 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_12); /* line 345 */
   __CMPLT(reg_b0_1, reg_r0_9, 0); /* line 346 */
   __ADD(reg_r0_7, reg_r0_9, (unsigned int) 255); /* line 347 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 348 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_14); /* line 349 */
   __CMPLT(reg_b0_2, reg_r0_41, 0); /* line 350 */
   __ADD(reg_r0_11, reg_r0_41, (unsigned int) 255); /* line 351 */
   __ADD(reg_r0_46, reg_r0_46, reg_r0_30); /* line 352 */
   __ADD(reg_r0_37, reg_r0_37, reg_r0_21); /* line 353 */
   __CMPLT(reg_b0_5, reg_r0_44, 0); /* line 354 */
   __ADD(reg_r0_14, reg_r0_44, (unsigned int) 255); /* line 355 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_33); /* line 356 */
   __ADD(reg_r0_34, reg_r0_34, reg_r0_16); /* line 357 */
   __CMPLT(reg_b0_3, reg_r0_42, 0); /* line 358 */
   __ADD(reg_r0_12, reg_r0_42, (unsigned int) 255); /* line 359 */
   __ADD(reg_r0_47, reg_r0_47, reg_r0_31); /* line 360 */
   __ADD(reg_r0_50, reg_r0_50, t__i32_0); /* line 361 */
   __CMPLT(reg_b0_0, reg_r0_40, 0); /* line 362 */
   __ADD(reg_r0_4, reg_r0_40, (unsigned int) 255); /* line 363 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_27); /* line 364 */
} /* line 364 */
  sim_icache_fetch(268 + t_thisfile.offset, 28);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_5 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(28);
   __SHR(reg_r0_51, reg_r0_51, (unsigned int) 8); /* line 366 */
   __SHR(reg_r0_39, reg_r0_39, (unsigned int) 8); /* line 367 */
   __ADD(reg_r0_53, reg_r0_36, (unsigned int) 255); /* line 368 */
   __CMPLT(reg_b0_3, reg_r0_48, 0); /* line 369 */
   __ADD(reg_r0_27, reg_r0_48, (unsigned int) 255); /* line 370 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 371 */
   __ADD(reg_r0_33, reg_r0_10, (unsigned int) 255); /* line 372 */
   __CMPLT(reg_b0_7, reg_r0_24, 0); /* line 373 */
   __ADD(reg_r0_16, reg_r0_24, (unsigned int) 255); /* line 374 */
   __ADD(reg_r0_35, reg_r0_25, (unsigned int) 255); /* line 375 */
   __CMPLT(reg_b0_5, reg_r0_46, 0); /* line 376 */
   __ADD(reg_r0_19, reg_r0_46, (unsigned int) 255); /* line 377 */
   __ADD(reg_r0_54, reg_r0_37, (unsigned int) 255); /* line 378 */
   __CMPLT(reg_b0_2, reg_r0_49, 0); /* line 379 */
   __ADD(reg_r0_29, reg_r0_49, (unsigned int) 255); /* line 380 */
   __ADD(reg_r0_52, reg_r0_34, (unsigned int) 255); /* line 381 */
   __CMPLT(reg_b0_4, reg_r0_47, 0); /* line 382 */
   __ADD(reg_r0_21, reg_r0_47, (unsigned int) 255); /* line 383 */
   __CMPLT(reg_b0_1, reg_r0_50, 0); /* line 384 */
   __ADD(reg_r0_31, reg_r0_50, (unsigned int) 255); /* line 385 */
   __CMPLT(reg_b0_6, reg_r0_45, 0); /* line 386 */
   __ADD(reg_r0_15, reg_r0_45, (unsigned int) 255); /* line 387 */
   __MFB(reg_r0_18, t__i32_0); /* line 388 */
   __MFB(reg_r0_20, t__i32_1); /* line 389 */
   __MFB(reg_r0_26, t__i32_2); /* line 390 */
   __MFB(reg_r0_28, t__i32_3); /* line 391 */
   __MFB(reg_r0_30, t__i32_4); /* line 392 */
   __MFB(reg_r0_32, t__i32_5); /* line 393 */
} /* line 393 */
  sim_icache_fetch(296 + t_thisfile.offset, 16);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_b0_2 ;
  t__i32_1 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __CMPLT(reg_b0_2, reg_r0_36, 0); /* line 395 */
   __SLCT(reg_r0_27, reg_b0_3, reg_r0_27, reg_r0_48); /* line 396 */
   __SLCT(reg_r0_33, reg_b0_0, reg_r0_33, reg_r0_10); /* line 397 */
   __SLCT(reg_r0_16, reg_b0_7, reg_r0_16, reg_r0_24); /* line 398 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 399 */
   __SLCT(reg_r0_19, reg_b0_5, reg_r0_19, reg_r0_46); /* line 400 */
   __CMPLT(reg_b0_3, reg_r0_37, 0); /* line 401 */
   __SLCT(reg_r0_29, t__i32_0, reg_r0_29, reg_r0_49); /* line 402 */
   __CMPLT(reg_b0_1, reg_r0_34, 0); /* line 403 */
   __SLCT(reg_r0_21, reg_b0_4, reg_r0_21, reg_r0_47); /* line 404 */
   __SLCT(reg_r0_31, t__i32_1, reg_r0_31, reg_r0_50); /* line 405 */
   __SLCT(reg_r0_15, reg_b0_6, reg_r0_15, reg_r0_45); /* line 406 */
   __MTB(reg_b0_7, reg_r0_26); /* line 407 */
   __MTB(reg_b0_6, reg_r0_28); /* line 408 */
   __MTB(reg_b0_5, reg_r0_30); /* line 409 */
   __MTB(reg_b0_4, reg_r0_32); /* line 410 */
} /* line 410 */
  sim_icache_fetch(312 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __SLCT(reg_r0_53, reg_b0_2, reg_r0_53, reg_r0_36); /* line 412 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 413 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 414 */
   __SLCT(reg_r0_7, reg_b0_5, reg_r0_7, reg_r0_9); /* line 415 */
   __SHR(reg_r0_16, reg_r0_16, (unsigned int) 8); /* line 416 */
   __SLCT(reg_r0_35, reg_b0_0, reg_r0_35, reg_r0_25); /* line 417 */
   __SLCT(reg_r0_11, reg_b0_6, reg_r0_11, reg_r0_41); /* line 418 */
   __SHR(reg_r0_19, reg_r0_19, (unsigned int) 8); /* line 419 */
   __SLCT(reg_r0_54, reg_b0_3, reg_r0_54, reg_r0_37); /* line 420 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 421 */
   __SLCT(reg_r0_52, reg_b0_1, reg_r0_52, reg_r0_34); /* line 422 */
   __SLCT(reg_r0_12, reg_b0_7, reg_r0_12, reg_r0_42); /* line 423 */
   __SHR(reg_r0_21, reg_r0_21, (unsigned int) 8); /* line 424 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 425 */
   __SLCT(reg_r0_4, reg_b0_4, reg_r0_4, reg_r0_40); /* line 426 */
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 427 */
   __MTB(reg_b0_1, reg_r0_18); /* line 428 */
   __MTB(reg_b0_0, reg_r0_20); /* line 429 */
} /* line 429 */
  sim_icache_fetch(330 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SHR(reg_r0_53, reg_r0_53, (unsigned int) 8); /* line 431 */
   __SLCT(reg_r0_13, reg_b0_0, reg_r0_13, reg_r0_43); /* line 432 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 433 */
   __SHR(reg_r0_35, reg_r0_35, (unsigned int) 8); /* line 434 */
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 435 */
   __SHR(reg_r0_54, reg_r0_54, (unsigned int) 8); /* line 436 */
   __SLCT(reg_r0_14, reg_b0_1, reg_r0_14, reg_r0_44); /* line 437 */
   __SHR(reg_r0_52, reg_r0_52, (unsigned int) 8); /* line 438 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 439 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 440 */
   __ADD(reg_r0_39, reg_r0_39, reg_r0_15); /* line 441 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_21); /* line 442 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_29); /* line 443 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_19); /* line 444 */
   __ADD(reg_r0_51, reg_r0_51, reg_r0_31); /* line 445 */
} /* line 445 */
  sim_icache_fetch(345 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 447 */
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 448 */
   __ADD(reg_r0_39, reg_r0_39, reg_r0_16); /* line 449 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_27); /* line 450 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_4); /* line 451 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_12); /* line 452 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_11); /* line 453 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_52); /* line 454 */
   __ADD(reg_r0_53, reg_r0_53, reg_r0_54); /* line 455 */
   __ADD(reg_r0_33, reg_r0_33, reg_r0_35); /* line 456 */
} /* line 456 */
  sim_icache_fetch(355 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_17, reg_r0_39, reg_r0_17); /* line 458 */
   __ADD(reg_r0_13, reg_r0_13, reg_r0_14); /* line 459 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_7); /* line 460 */
   __ADD(reg_r0_51, reg_r0_51, reg_r0_33); /* line 461 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_53); /* line 462 */
} /* line 462 */
  sim_icache_fetch(360 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_23, reg_r0_13); /* line 464 */
   __ADD(reg_r0_22, reg_r0_51, reg_r0_22); /* line 465 */
} /* line 465 */
  sim_icache_fetch(362 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_38, reg_r0_23); /* line 467 */
...
l_L9X3: ;/* line 471 */
__LABEL(l_L9X3);
  sim_icache_fetch(364 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_23, reg_r0_23, 0); /* line 472 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 473 */
   __MAX(reg_r0_22, reg_r0_22, 0); /* line 474 */
   __SH2ADD(reg_r0_2, reg_r0_55, reg_r0_57); /* line 475 */
   __ADD(reg_r0_4, reg_r0_55, (unsigned int) 1); /* line 476 */
} /* line 476 */
  sim_icache_fetch(369 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 478 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 479 */
   __MIN(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 480 */
   __ADD(reg_r0_7, reg_r0_56, (unsigned int) 1); /* line 481 */
} /* line 481 */
  sim_icache_fetch(373 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_17, reg_r0_17, (unsigned int) 8); /* line 483 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 16); /* line 484 */
} /* line 484 */
  sim_icache_fetch(375 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_22); /* line 486 */
} /* line 486 */
  sim_icache_fetch(376 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_17); /* line 488 */
} /* line 488 */
  sim_icache_fetch(377 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_23); /* line 490 */
...
l_L7X3: ;/* line 494 */
__LABEL(l_L7X3);
  sim_icache_fetch(379 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_57, reg_r0_57, (unsigned int) 256); /* line 495 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 64); /* line 496 */
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 1); /* line 497 */
...
__LABEL(l_L5X3);
		 /* line 501 */
  sim_icache_fetch(384 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_58); /* line 504 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 505 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(389 + t_thisfile.offset, 4);
{
  ...
  t__i32_0 = reg_r0_58 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_3, 0); /* line 507 */
   __LDW(reg_r0_58, mem_trace_ld((reg_r0_1 + (unsigned int) 24),0,4)); /* line 508 */
   __LDW(reg_r0_57, mem_trace_ld((reg_r0_1 + (unsigned int) 20),0,4)); /* line 509 */
   __MOV(reg_l0_0, t__i32_0); /* line 510 */
} /* line 510 */
