  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(32);
   ...
   __AND(reg_r0_33, reg_r0_12, (unsigned int) 255); /* line 211 */
   __SHRU(reg_r0_32, reg_r0_12, (unsigned int) 8); /* line 212 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 213 */
   __AND(reg_r0_35, reg_r0_14, (unsigned int) 255); /* line 214 */
   __SHRU(reg_r0_34, reg_r0_14, (unsigned int) 8); /* line 215 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 216 */
   __AND(reg_r0_37, reg_r0_15, (unsigned int) 255); /* line 217 */
   __SHRU(reg_r0_36, reg_r0_15, (unsigned int) 8); /* line 218 */
} /* line 218 */
  sim_icache_fetch(123 + t_thisfile.offset, 22);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 220 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 221 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 222 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 223 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 224 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 225 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 226 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 227 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 228 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 229 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 230 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 231 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 232 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 233 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 234 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 235 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 236 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 237 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 238 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 239 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 240 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 241 */
} /* line 241 */
  sim_icache_fetch(145 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 243 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 244 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 245 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 246 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 247 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 248 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_28); /* line 249 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_30); /* line 250 */
   __MAX(reg_r0_33, reg_r0_33, reg_r0_32); /* line 251 */
   __MAX(reg_r0_35, reg_r0_35, reg_r0_34); /* line 252 */
   __MAX(reg_r0_37, reg_r0_37, reg_r0_36); /* line 253 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 254 */
} /* line 254 */
  sim_icache_fetch(157 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 256 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 257 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 258 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 259 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 260 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 261 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_10); /* line 262 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_11); /* line 263 */
   __MAX(reg_r0_33, reg_r0_33, reg_r0_12); /* line 264 */
   __MAX(reg_r0_35, reg_r0_35, reg_r0_14); /* line 265 */
   __MAX(reg_r0_37, reg_r0_37, reg_r0_15); /* line 266 */
} /* line 266 */
  sim_icache_fetch(168 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 268 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 269 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 270 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 271 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 272 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 273 */
   __ZXTB(reg_r0_29, reg_r0_29); /* line 274 */
   __ZXTB(reg_r0_31, reg_r0_31); /* line 275 */
   __ZXTB(reg_r0_33, reg_r0_33); /* line 276 */
   __ZXTB(reg_r0_35, reg_r0_35); /* line 277 */
   __ZXTB(reg_r0_37, reg_r0_37); /* line 278 */
} /* line 278 */
  sim_icache_fetch(179 + t_thisfile.offset, 22);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   __SHL(reg_r0_5, reg_r0_17, (unsigned int) 8); /* line 280 */
   __SHL(reg_r0_3, reg_r0_17, (unsigned int) 16); /* line 281 */
   __SHL(reg_r0_7, reg_r0_19, (unsigned int) 8); /* line 282 */
   __SHL(reg_r0_6, reg_r0_19, (unsigned int) 16); /* line 283 */
   __SHL(reg_r0_9, reg_r0_21, (unsigned int) 8); /* line 284 */
   __SHL(reg_r0_8, reg_r0_21, (unsigned int) 16); /* line 285 */
   __SHL(reg_r0_11, reg_r0_23, (unsigned int) 8); /* line 286 */
   __SHL(reg_r0_10, reg_r0_23, (unsigned int) 16); /* line 287 */
   __SHL(reg_r0_14, reg_r0_25, (unsigned int) 8); /* line 288 */
   __SHL(reg_r0_12, reg_r0_25, (unsigned int) 16); /* line 289 */
   __SHL(reg_r0_16, reg_r0_27, (unsigned int) 8); /* line 290 */
   __SHL(reg_r0_15, reg_r0_27, (unsigned int) 16); /* line 291 */
   __SHL(reg_r0_20, reg_r0_29, (unsigned int) 8); /* line 292 */
   __SHL(reg_r0_18, reg_r0_29, (unsigned int) 16); /* line 293 */
   __SHL(reg_r0_24, reg_r0_31, (unsigned int) 8); /* line 294 */
   __SHL(reg_r0_22, reg_r0_31, (unsigned int) 16); /* line 295 */
   __SHL(reg_r0_28, reg_r0_33, (unsigned int) 8); /* line 296 */
   __SHL(reg_r0_26, reg_r0_33, (unsigned int) 16); /* line 297 */
   __SHL(reg_r0_32, reg_r0_35, (unsigned int) 8); /* line 298 */
   __SHL(reg_r0_30, reg_r0_35, (unsigned int) 16); /* line 299 */
   __SHL(reg_r0_36, reg_r0_37, (unsigned int) 8); /* line 300 */
   __SHL(reg_r0_34, reg_r0_37, (unsigned int) 16); /* line 301 */
} /* line 301 */
  sim_icache_fetch(201 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __OR(reg_r0_17, reg_r0_17, reg_r0_3); /* line 303 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_6); /* line 304 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_8); /* line 305 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_10); /* line 306 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_12); /* line 307 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_15); /* line 308 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_18); /* line 309 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_22); /* line 310 */
   __OR(reg_r0_33, reg_r0_33, reg_r0_26); /* line 311 */
   __OR(reg_r0_35, reg_r0_35, reg_r0_30); /* line 312 */
   __OR(reg_r0_37, reg_r0_37, reg_r0_34); /* line 313 */
} /* line 313 */
  sim_icache_fetch(212 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __OR(reg_r0_17, reg_r0_17, reg_r0_5); /* line 315 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_7); /* line 316 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_9); /* line 317 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_11); /* line 318 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_14); /* line 319 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_16); /* line 320 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_20); /* line 321 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_24); /* line 322 */
   __OR(reg_r0_33, reg_r0_33, reg_r0_28); /* line 323 */
   __OR(reg_r0_35, reg_r0_35, reg_r0_32); /* line 324 */
   __OR(reg_r0_37, reg_r0_37, reg_r0_36); /* line 325 */
} /* line 325 */
  sim_icache_fetch(223 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 327 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 328 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 329 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 330 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 331 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 332 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_29); /* line 333 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_31); /* line 334 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_33); /* line 335 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(233 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_35); /* line 338 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_37); /* line 339 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 340 */
  ...
  sim_icache_fetch(237 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_40, (unsigned int) 256); /* line 345 */
   __ADD(reg_r0_5, reg_r0_39, (unsigned int) 256); /* line 346 */
   __ADD(reg_r0_3, reg_r0_38, (unsigned int) 1); /* line 347 */
  ...
  sim_icache_fetch(243 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_41); /* line 354 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 355 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(248 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 357 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 358 */
   __INC_NOP_CNT((unsigned int) 1);
