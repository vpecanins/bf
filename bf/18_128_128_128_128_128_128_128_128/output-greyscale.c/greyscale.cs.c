  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   ...
   __MOV(reg_r0_35, t__i32_0); /* line 154 */
} /* line 154 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   ...
   __MOV(reg_r0_32, reg_r0_3); /* line 163 */
   __MOV(reg_r0_33, reg_r0_5); /* line 164 */
   __MOV(reg_r0_34, reg_r0_6); /* line 165 */
} /* line 165 */
  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
  ...
  sim_icache_fetch(109 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 206 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 207 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 208 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 209 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 210 */
   ...
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 214 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 215 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 216 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 217 */
   ...
   __AND(reg_r0_31, reg_r0_11, (unsigned int) 255); /* line 221 */
   __SHRU(reg_r0_30, reg_r0_11, (unsigned int) 8); /* line 222 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 223 */
} /* line 223 */
  sim_icache_fetch(127 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 225 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 226 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 227 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 228 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 229 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 230 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 231 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 232 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 233 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 234 */
   __AND(reg_r0_18, reg_r0_12, (unsigned int) 255); /* line 235 */
   __SHRU(reg_r0_16, reg_r0_12, (unsigned int) 8); /* line 236 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 237 */
   __AND(reg_r0_22, reg_r0_14, (unsigned int) 255); /* line 238 */
   __SHRU(reg_r0_20, reg_r0_14, (unsigned int) 8); /* line 239 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 240 */
   __AND(reg_r0_26, reg_r0_15, (unsigned int) 255); /* line 241 */
   __SHRU(reg_r0_24, reg_r0_15, (unsigned int) 8); /* line 242 */
} /* line 242 */
  sim_icache_fetch(145 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 244 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 245 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 246 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 247 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 248 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 249 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_28); /* line 250 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_30); /* line 251 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 252 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 253 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 254 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 255 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 256 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 257 */
} /* line 257 */
  sim_icache_fetch(159 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 259 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 260 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 261 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 262 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 263 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 264 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_10); /* line 265 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_11); /* line 266 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 267 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_20); /* line 268 */
   __MAX(reg_r0_26, reg_r0_26, reg_r0_24); /* line 269 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 270 */
} /* line 270 */
  sim_icache_fetch(171 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __SHL(reg_r0_5, reg_r0_17, (unsigned int) 8); /* line 272 */
   __SHL(reg_r0_3, reg_r0_17, (unsigned int) 16); /* line 273 */
   __SHL(reg_r0_7, reg_r0_19, (unsigned int) 8); /* line 274 */
   __SHL(reg_r0_6, reg_r0_19, (unsigned int) 16); /* line 275 */
   __SHL(reg_r0_9, reg_r0_21, (unsigned int) 8); /* line 276 */
   __SHL(reg_r0_8, reg_r0_21, (unsigned int) 16); /* line 277 */
   __SHL(reg_r0_11, reg_r0_23, (unsigned int) 8); /* line 278 */
   __SHL(reg_r0_10, reg_r0_23, (unsigned int) 16); /* line 279 */
   __SHL(reg_r0_20, reg_r0_25, (unsigned int) 8); /* line 280 */
   __SHL(reg_r0_16, reg_r0_25, (unsigned int) 16); /* line 281 */
   __SHL(reg_r0_28, reg_r0_27, (unsigned int) 8); /* line 282 */
   __SHL(reg_r0_24, reg_r0_27, (unsigned int) 16); /* line 283 */
   __ZXTB(reg_r0_29, reg_r0_29); /* line 284 */
   __ZXTB(reg_r0_31, reg_r0_31); /* line 285 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_12); /* line 286 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_14); /* line 287 */
   __MAX(reg_r0_26, reg_r0_26, reg_r0_15); /* line 288 */
} /* line 288 */
  sim_icache_fetch(188 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_3); /* line 290 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_6); /* line 291 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_8); /* line 292 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_10); /* line 293 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_16); /* line 294 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_24); /* line 295 */
   __SHL(reg_r0_6, reg_r0_29, (unsigned int) 8); /* line 296 */
   __SHL(reg_r0_3, reg_r0_29, (unsigned int) 16); /* line 297 */
   __SHL(reg_r0_10, reg_r0_31, (unsigned int) 8); /* line 298 */
   __SHL(reg_r0_8, reg_r0_31, (unsigned int) 16); /* line 299 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 300 */
   __ZXTB(reg_r0_22, reg_r0_22); /* line 301 */
   __ZXTB(reg_r0_26, reg_r0_26); /* line 302 */
} /* line 302 */
  sim_icache_fetch(201 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __OR(reg_r0_17, reg_r0_17, reg_r0_5); /* line 304 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_7); /* line 305 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_9); /* line 306 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_11); /* line 307 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_20); /* line 308 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_28); /* line 309 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_3); /* line 310 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_8); /* line 311 */
   __SHL(reg_r0_5, reg_r0_18, (unsigned int) 8); /* line 312 */
   __SHL(reg_r0_3, reg_r0_18, (unsigned int) 16); /* line 313 */
   __SHL(reg_r0_8, reg_r0_22, (unsigned int) 8); /* line 314 */
   __SHL(reg_r0_7, reg_r0_22, (unsigned int) 16); /* line 315 */
   __SHL(reg_r0_11, reg_r0_26, (unsigned int) 8); /* line 316 */
   __SHL(reg_r0_9, reg_r0_26, (unsigned int) 16); /* line 317 */
} /* line 317 */
  sim_icache_fetch(215 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 319 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 320 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 321 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 322 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 323 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 324 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_6); /* line 325 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_10); /* line 326 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_3); /* line 327 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_7); /* line 328 */
   __OR(reg_r0_26, reg_r0_26, reg_r0_9); /* line 329 */
} /* line 329 */
  sim_icache_fetch(226 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_29); /* line 331 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_31); /* line 332 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_5); /* line 333 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_8); /* line 334 */
   __OR(reg_r0_26, reg_r0_26, reg_r0_11); /* line 335 */
} /* line 335 */
  sim_icache_fetch(231 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_18); /* line 337 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(233 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_22); /* line 340 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_26); /* line 341 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 342 */
  ...
  sim_icache_fetch(237 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_34, (unsigned int) 256); /* line 347 */
   __ADD(reg_r0_5, reg_r0_33, (unsigned int) 256); /* line 348 */
   __ADD(reg_r0_3, reg_r0_32, (unsigned int) 1); /* line 349 */
  ...
  sim_icache_fetch(243 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_35); /* line 356 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 357 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(248 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 359 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 360 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 361 */
   __ADD_CYCLES(1);
} /* line 361 */
