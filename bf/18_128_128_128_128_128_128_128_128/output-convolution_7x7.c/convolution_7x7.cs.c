  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   ...
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 130 */
} /* line 130 */
  sim_icache_fetch(45 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   ...
   __MOV(reg_r0_53, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 153 */
   __MOV(reg_r0_54, reg_r0_5); /* line 154 */
} /* line 154 */
l_L4X3: ;/* line 157 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_51, reg_r0_4); /* line 173 */
   __MOV(reg_r0_52, reg_r0_7); /* line 174 */
} /* line 174 */
  ...
  sim_icache_fetch(149 + t_thisfile.offset, 4);
{
  ...
  sim_icache_fetch(153 + t_thisfile.offset, 18);
{
  unsigned int t__i32_0;
  ...
  t__i32_2 = reg_r0_4 ;
   ...
   __SHRU(reg_r0_34, t__i32_2, (unsigned int) 16); /* line 260 */
   __AND(reg_r0_4, t__i32_2, (unsigned int) 255); /* line 261 */
   __SHRU(reg_r0_27, t__i32_2, (unsigned int) 8); /* line 262 */
} /* line 262 */
  sim_icache_fetch(171 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 264 */
   __AND(reg_r0_38, reg_r0_38, (unsigned int) 255); /* line 265 */
   ...
   __MULLU(reg_r0_9, reg_r0_12, reg_r0_11); /* line 269 */
   __MULHS(reg_r0_11, reg_r0_12, reg_r0_11); /* line 270 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 271 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 272 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 273 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 274 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 275 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 276 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 277 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 278 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 279 */
   __MULLU(reg_r0_40, reg_r0_7, reg_r0_4); /* line 280 */
   __MULHS(reg_r0_4, reg_r0_7, reg_r0_4); /* line 281 */
} /* line 281 */
  sim_icache_fetch(189 + t_thisfile.offset, 18);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_r0_12 ;
  t__i32_1 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __ADD(reg_r0_35, reg_r0_35, reg_r0_10); /* line 283 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 284 */
   __MULLU(reg_r0_44, reg_r0_19, reg_r0_32); /* line 285 */
   __MULHS(reg_r0_32, reg_r0_19, reg_r0_32); /* line 286 */
   __MULLU(reg_r0_10, t__i32_0, reg_r0_25); /* line 287 */
   __MULHS(reg_r0_12, t__i32_0, reg_r0_25); /* line 288 */
   __MULLU(reg_r0_24, t__i32_0, reg_r0_29); /* line 289 */
   __MULHS(reg_r0_29, t__i32_0, reg_r0_29); /* line 290 */
   __MULLU(reg_r0_42, reg_r0_14, reg_r0_30); /* line 291 */
   __MULHS(reg_r0_30, reg_r0_14, reg_r0_30); /* line 292 */
   __MULLU(reg_r0_45, reg_r0_21, reg_r0_33); /* line 293 */
   __MULHS(reg_r0_33, reg_r0_21, reg_r0_33); /* line 294 */
   __MULLU(reg_r0_43, reg_r0_16, reg_r0_31); /* line 295 */
   __MULHS(reg_r0_31, reg_r0_16, reg_r0_31); /* line 296 */
   __MULLU(reg_r0_46, t__i32_1, reg_r0_34); /* line 297 */
   __MULHS(reg_r0_7, t__i32_1, reg_r0_34); /* line 298 */
   __MULLU(reg_r0_41, t__i32_1, reg_r0_27); /* line 299 */
   __MULHS(reg_r0_27, t__i32_1, reg_r0_27); /* line 300 */
} /* line 300 */
  sim_icache_fetch(207 + t_thisfile.offset, 18);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __CMPLT(reg_b0_1, reg_r0_35, 0); /* line 302 */
   __ADD(reg_r0_34, reg_r0_35, (unsigned int) 255); /* line 303 */
   __CMPLT(reg_b0_2, reg_r0_26, 0); /* line 304 */
   __ADD(reg_r0_4, reg_r0_26, (unsigned int) 255); /* line 305 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 306 */
   __ADD(reg_r0_25, reg_r0_28, (unsigned int) 255); /* line 307 */
   __MULLU(reg_r0_49, reg_r0_19, reg_r0_38); /* line 308 */
   __MULHS(reg_r0_38, reg_r0_19, reg_r0_38); /* line 309 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_11); /* line 310 */
   __MULLU(reg_r0_47, reg_r0_14, reg_r0_36); /* line 311 */
   __MULHS(reg_r0_36, reg_r0_14, reg_r0_36); /* line 312 */
   __MULLU(reg_r0_11, reg_r0_14, reg_r0_13); /* line 313 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 314 */
   __MULLU(reg_r0_50, reg_r0_21, reg_r0_39); /* line 315 */
   __MULHS(reg_r0_39, reg_r0_21, reg_r0_39); /* line 316 */
   __MULLU(reg_r0_48, reg_r0_16, reg_r0_37); /* line 317 */
   __MULHS(reg_r0_37, reg_r0_16, reg_r0_37); /* line 318 */
   __ADD(reg_r0_40, reg_r0_40, t__i32_0); /* line 319 */
} /* line 319 */
  sim_icache_fetch(225 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __SLCT(reg_r0_34, reg_b0_1, reg_r0_34, reg_r0_35); /* line 321 */
   __SLCT(reg_r0_4, reg_b0_2, reg_r0_4, reg_r0_26); /* line 322 */
   __SLCT(reg_r0_25, reg_b0_0, reg_r0_25, reg_r0_28); /* line 323 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 324 */
   __ADD(reg_r0_44, reg_r0_44, reg_r0_32); /* line 325 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_12); /* line 326 */
   __CMPLT(reg_b0_1, reg_r0_9, 0); /* line 327 */
   __ADD(reg_r0_12, reg_r0_9, (unsigned int) 255); /* line 328 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 329 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_30); /* line 330 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 331 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_33); /* line 332 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 333 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_31); /* line 334 */
   __ADD(reg_r0_46, reg_r0_46, reg_r0_7); /* line 335 */
   __CMPLT(reg_b0_0, reg_r0_40, 0); /* line 336 */
   __ADD(reg_r0_7, reg_r0_40, (unsigned int) 255); /* line 337 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_27); /* line 338 */
} /* line 338 */
  sim_icache_fetch(243 + t_thisfile.offset, 18);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __SHR(reg_r0_34, reg_r0_34, (unsigned int) 8); /* line 340 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 341 */
   __CMPLT(reg_b0_6, reg_r0_44, 0); /* line 342 */
   __ADD(reg_r0_29, reg_r0_44, (unsigned int) 255); /* line 343 */
   __CMPLT(reg_b0_3, reg_r0_24, 0); /* line 344 */
   __ADD(reg_r0_26, reg_r0_24, (unsigned int) 255); /* line 345 */
   __CMPLT(reg_b0_4, reg_r0_42, 0); /* line 346 */
   __ADD(reg_r0_27, reg_r0_42, (unsigned int) 255); /* line 347 */
   __CMPLT(reg_b0_7, reg_r0_45, 0); /* line 348 */
   __ADD(reg_r0_30, reg_r0_45, (unsigned int) 255); /* line 349 */
   __CMPLT(reg_b0_5, reg_r0_43, 0); /* line 350 */
   __ADD(reg_r0_28, reg_r0_43, (unsigned int) 255); /* line 351 */
   __CMPLT(reg_b0_1, reg_r0_46, 0); /* line 352 */
   __ADD(reg_r0_32, reg_r0_46, (unsigned int) 255); /* line 353 */
   __CMPLT(reg_b0_2, reg_r0_41, 0); /* line 354 */
   __ADD(reg_r0_13, reg_r0_41, (unsigned int) 255); /* line 355 */
   __MFB(reg_r0_31, t__i32_0); /* line 356 */
   __MFB(reg_r0_33, reg_b0_0); /* line 357 */
} /* line 357 */
  sim_icache_fetch(261 + t_thisfile.offset, 18);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_24 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 359 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_38); /* line 360 */
   __SLCT(reg_r0_29, reg_b0_6, reg_r0_29, reg_r0_44); /* line 361 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 362 */
   __ADD(reg_r0_24, reg_r0_10, (unsigned int) 255); /* line 363 */
   __SLCT(reg_r0_26, reg_b0_3, reg_r0_26, t__i32_0); /* line 364 */
   __ADD(reg_r0_47, reg_r0_47, reg_r0_36); /* line 365 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_14); /* line 366 */
   __SLCT(reg_r0_27, reg_b0_4, reg_r0_27, reg_r0_42); /* line 367 */
   __ADD(reg_r0_50, reg_r0_50, reg_r0_39); /* line 368 */
   __SLCT(reg_r0_30, reg_b0_7, reg_r0_30, reg_r0_45); /* line 369 */
   __ADD(reg_r0_48, reg_r0_48, reg_r0_37); /* line 370 */
   __MULLU(reg_r0_14, reg_r0_16, reg_r0_15); /* line 371 */
   __SLCT(reg_r0_28, reg_b0_5, reg_r0_28, reg_r0_43); /* line 372 */
   __SLCT(reg_r0_32, reg_b0_1, reg_r0_32, reg_r0_46); /* line 373 */
   __SLCT(reg_r0_13, reg_b0_2, reg_r0_13, reg_r0_41); /* line 374 */
   __MTB(reg_b0_2, reg_r0_31); /* line 375 */
   __MTB(reg_b0_1, reg_r0_33); /* line 376 */
} /* line 376 */
  sim_icache_fetch(279 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __CMPLT(reg_b0_4, reg_r0_49, 0); /* line 378 */
   __ADD(reg_r0_33, reg_r0_49, (unsigned int) 255); /* line 379 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 380 */
   __SLCT(reg_r0_24, reg_b0_0, reg_r0_24, reg_r0_10); /* line 381 */
   __SLCT(reg_r0_12, reg_b0_2, reg_r0_12, reg_r0_9); /* line 382 */
   __SHR(reg_r0_26, reg_r0_26, (unsigned int) 8); /* line 383 */
   __CMPLT(reg_b0_0, reg_r0_47, 0); /* line 384 */
   __ADD(reg_r0_10, reg_r0_47, (unsigned int) 255); /* line 385 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 386 */
   __CMPLT(reg_b0_5, reg_r0_50, 0); /* line 387 */
   __ADD(reg_r0_35, reg_r0_50, (unsigned int) 255); /* line 388 */
   __SHR(reg_r0_30, reg_r0_30, (unsigned int) 8); /* line 389 */
   __CMPLT(reg_b0_3, reg_r0_48, 0); /* line 390 */
   __ADD(reg_r0_31, reg_r0_48, (unsigned int) 255); /* line 391 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 392 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 393 */
   __SLCT(reg_r0_7, reg_b0_1, reg_r0_7, reg_r0_40); /* line 394 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 395 */
} /* line 395 */
  sim_icache_fetch(297 + t_thisfile.offset, 18);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_r0_15 ;
  t__i32_1 = reg_r0_13 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __SLCT(reg_r0_33, reg_b0_4, reg_r0_33, reg_r0_49); /* line 397 */
   __MULLU(reg_r0_13, reg_r0_19, reg_r0_18); /* line 398 */
   __MULHS(reg_r0_19, reg_r0_19, reg_r0_18); /* line 399 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 400 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 401 */
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_47); /* line 402 */
   __CMPLT(reg_b0_0, reg_r0_11, 0); /* line 403 */
   __ADD(reg_r0_9, reg_r0_11, (unsigned int) 255); /* line 404 */
   __SLCT(reg_r0_35, reg_b0_5, reg_r0_35, reg_r0_50); /* line 405 */
   __MULLU(reg_r0_15, reg_r0_21, reg_r0_20); /* line 406 */
   __SLCT(reg_r0_31, reg_b0_3, reg_r0_31, reg_r0_48); /* line 407 */
   __MULHS(reg_r0_16, reg_r0_16, t__i32_0); /* line 408 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 409 */
   __ADD(reg_r0_25, reg_r0_25, t__i32_1); /* line 410 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_28); /* line 411 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_30); /* line 412 */
   __ADD(reg_r0_26, reg_r0_26, reg_r0_27); /* line 413 */
   __ADD(reg_r0_34, reg_r0_34, reg_r0_32); /* line 414 */
} /* line 414 */
  sim_icache_fetch(315 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 416 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 417 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_11); /* line 418 */
   __SHR(reg_r0_35, reg_r0_35, (unsigned int) 8); /* line 419 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_20); /* line 420 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 421 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_26); /* line 422 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_29); /* line 423 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_7); /* line 424 */
} /* line 424 */
  sim_icache_fetch(324 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __ADD(reg_r0_13, reg_r0_13, reg_r0_19); /* line 426 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 427 */
   __ADD(reg_r0_14, reg_r0_14, reg_r0_16); /* line 428 */
   __ADD(reg_r0_17, reg_r0_25, reg_r0_17); /* line 429 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_31); /* line 430 */
   __ADD(reg_r0_33, reg_r0_33, reg_r0_35); /* line 431 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_10); /* line 432 */
} /* line 432 */
  sim_icache_fetch(331 + t_thisfile.offset, 8);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __CMPLT(reg_b0_1, reg_r0_13, 0); /* line 434 */
   __ADD(reg_r0_9, reg_r0_13, (unsigned int) 255); /* line 435 */
   __ADD(reg_r0_15, reg_r0_15, reg_r0_21); /* line 436 */
   __CMPLT(reg_b0_0, reg_r0_14, 0); /* line 437 */
   __ADD(reg_r0_7, reg_r0_14, (unsigned int) 255); /* line 438 */
   __ADD(reg_r0_12, reg_r0_12, t__i32_0); /* line 439 */
   __ADD(reg_r0_34, reg_r0_34, reg_r0_24); /* line 440 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_33); /* line 441 */
} /* line 441 */
  sim_icache_fetch(339 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SLCT(reg_r0_9, reg_b0_1, reg_r0_9, reg_r0_13); /* line 443 */
   __CMPLT(reg_b0_0, reg_r0_15, 0); /* line 444 */
   __ADD(reg_r0_10, reg_r0_15, (unsigned int) 255); /* line 445 */
   __SLCT(reg_r0_7, t__i32_0, reg_r0_7, reg_r0_14); /* line 446 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_12); /* line 447 */
   __ADD(reg_r0_22, reg_r0_34, reg_r0_22); /* line 448 */
} /* line 448 */
  sim_icache_fetch(345 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 450 */
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_15); /* line 451 */
  ...
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 454 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_7); /* line 455 */
} /* line 455 */
  sim_icache_fetch(350 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_9, reg_r0_9, reg_r0_10); /* line 457 */
} /* line 457 */
  sim_icache_fetch(351 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_23, reg_r0_23, reg_r0_9); /* line 459 */
} /* line 459 */
  sim_icache_fetch(352 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_4, reg_r0_23); /* line 461 */
  ...
  sim_icache_fetch(354 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_23, reg_r0_23, 0); /* line 466 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 467 */
   __MAX(reg_r0_22, reg_r0_22, 0); /* line 468 */
   __SH2ADD(reg_r0_2, reg_r0_51, reg_r0_53); /* line 469 */
   __ADD(reg_r0_4, reg_r0_51, (unsigned int) 1); /* line 470 */
} /* line 470 */
  sim_icache_fetch(359 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 472 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 473 */
   __MIN(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 474 */
   __ADD(reg_r0_7, reg_r0_52, (unsigned int) 1); /* line 475 */
} /* line 475 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   ...
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 16); /* line 478 */
} /* line 478 */
  sim_icache_fetch(365 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_22); /* line 480 */
} /* line 480 */
  sim_icache_fetch(366 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_17); /* line 482 */
} /* line 482 */
  sim_icache_fetch(367 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_23); /* line 484 */
  ...
  sim_icache_fetch(369 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_53, reg_r0_53, (unsigned int) 256); /* line 489 */
  ...
  sim_icache_fetch(374 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_54); /* line 498 */
