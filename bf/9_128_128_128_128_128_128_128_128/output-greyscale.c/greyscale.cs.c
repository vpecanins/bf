  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 153 */
   __MOV(reg_r0_5, (unsigned int) grey_framebuffer); /* line 154 */
   __MOV(reg_r0_6, (unsigned int) grey_image); /* line 155 */
   __MOV(reg_r0_29, t__i32_0); /* line 156 */
} /* line 156 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 161 */
   __MOV(reg_r0_13, (unsigned int) -55); /* line 162 */
   __MOV(reg_r0_4, reg_r0_5); /* line 163 */
   __MOV(reg_r0_2, reg_r0_6); /* line 164 */
   __MOV(reg_r0_26, reg_r0_3); /* line 165 */
   __MOV(reg_r0_27, reg_r0_5); /* line 166 */
   __MOV(reg_r0_28, reg_r0_6); /* line 167 */
} /* line 167 */
...
l_L6X3: ;/* line 172 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __LDW(reg_r0_5, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 173 */
   __LDW(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 174 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 175 */
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 176 */
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 16),0,4)); /* line 177 */
   __LDW(reg_r0_9, mem_trace_ld((reg_r0_2 + (unsigned int) 20),0,4)); /* line 178 */
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 24),0,4)); /* line 179 */
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 180 */
   __LDW(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 181 */
} /* line 181 */
  sim_icache_fetch(85 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __CMPLT(reg_b0_0, reg_r0_13, 0); /* line 183 */
   __LDWs(reg_r0_14, mem_trace_ld((reg_r0_2 + (unsigned int) 36),0,4)); /* line 184 */
   __LDWs(reg_r0_15, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 185 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 186 */
   __ADD(reg_r0_13, reg_r0_13, (unsigned int) 11); /* line 187 */
} /* line 187 */
  sim_icache_fetch(90 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __AND(reg_r0_17, reg_r0_3, (unsigned int) 255); /* line 189 */
   __AND(reg_r0_19, reg_r0_5, (unsigned int) 255); /* line 190 */
   __AND(reg_r0_21, reg_r0_6, (unsigned int) 255); /* line 191 */
   __SHRU(reg_r0_16, reg_r0_3, (unsigned int) 8); /* line 192 */
   __SHRU(reg_r0_18, reg_r0_5, (unsigned int) 8); /* line 193 */
   __SHRU(reg_r0_20, reg_r0_6, (unsigned int) 8); /* line 194 */
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 195 */
   __SHRU(reg_r0_5, reg_r0_5, (unsigned int) 16); /* line 196 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 197 */
} /* line 197 */
  sim_icache_fetch(99 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 199 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 200 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 201 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 202 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 203 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 204 */
   __AND(reg_r0_23, reg_r0_7, (unsigned int) 255); /* line 205 */
   __SHRU(reg_r0_22, reg_r0_7, (unsigned int) 8); /* line 206 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 207 */
} /* line 207 */
  sim_icache_fetch(108 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 209 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 210 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 211 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 212 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 213 */
   __AND(reg_r0_18, reg_r0_8, (unsigned int) 255); /* line 214 */
   __SHRU(reg_r0_16, reg_r0_8, (unsigned int) 8); /* line 215 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 216 */
   __SHRU(reg_r0_20, reg_r0_9, (unsigned int) 8); /* line 217 */
} /* line 217 */
  sim_icache_fetch(117 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 219 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 220 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 221 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 222 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 223 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 224 */
   __AND(reg_r0_3, reg_r0_9, (unsigned int) 255); /* line 225 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 226 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 227 */
} /* line 227 */
  sim_icache_fetch(126 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 229 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 230 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 231 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 232 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 233 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_20); /* line 234 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 235 */
   __AND(reg_r0_6, reg_r0_10, (unsigned int) 255); /* line 236 */
   __SHRU(reg_r0_5, reg_r0_10, (unsigned int) 8); /* line 237 */
} /* line 237 */
  sim_icache_fetch(135 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHL(reg_r0_16, reg_r0_17, (unsigned int) 8); /* line 239 */
   __SHL(reg_r0_7, reg_r0_17, (unsigned int) 16); /* line 240 */
   __SHL(reg_r0_22, reg_r0_19, (unsigned int) 8); /* line 241 */
   __SHL(reg_r0_20, reg_r0_19, (unsigned int) 16); /* line 242 */
   __SHL(reg_r0_25, reg_r0_21, (unsigned int) 8); /* line 243 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 16); /* line 244 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 245 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_8); /* line 246 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_9); /* line 247 */
} /* line 247 */
  sim_icache_fetch(144 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __OR(reg_r0_17, reg_r0_17, reg_r0_7); /* line 249 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_20); /* line 250 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 251 */
   __SHL(reg_r0_8, reg_r0_23, (unsigned int) 8); /* line 252 */
   __SHL(reg_r0_7, reg_r0_23, (unsigned int) 16); /* line 253 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 254 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 255 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 256 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 257 */
} /* line 257 */
  sim_icache_fetch(153 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __OR(reg_r0_17, reg_r0_17, reg_r0_16); /* line 259 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_22); /* line 260 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_25); /* line 261 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_7); /* line 262 */
   __SHL(reg_r0_9, reg_r0_18, (unsigned int) 8); /* line 263 */
   __SHL(reg_r0_7, reg_r0_18, (unsigned int) 16); /* line 264 */
   __SHL(reg_r0_20, reg_r0_3, (unsigned int) 8); /* line 265 */
   __SHL(reg_r0_16, reg_r0_3, (unsigned int) 16); /* line 266 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_5); /* line 267 */
} /* line 267 */
  sim_icache_fetch(162 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __OR(reg_r0_23, reg_r0_23, reg_r0_8); /* line 269 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_7); /* line 270 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_16); /* line 271 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 272 */
   __AND(reg_r0_7, reg_r0_11, (unsigned int) 255); /* line 273 */
   __SHRU(reg_r0_5, reg_r0_11, (unsigned int) 8); /* line 274 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 275 */
   __AND(reg_r0_16, reg_r0_12, (unsigned int) 255); /* line 276 */
   __SHRU(reg_r0_8, reg_r0_12, (unsigned int) 8); /* line 277 */
} /* line 277 */
  sim_icache_fetch(171 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __OR(reg_r0_18, reg_r0_18, reg_r0_9); /* line 279 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_20); /* line 280 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_10); /* line 281 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 282 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 283 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 284 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 285 */
   __AND(reg_r0_10, reg_r0_14, (unsigned int) 255); /* line 286 */
   __SHRU(reg_r0_9, reg_r0_14, (unsigned int) 8); /* line 287 */
} /* line 287 */
  sim_icache_fetch(180 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __ZXTB(reg_r0_6, reg_r0_6); /* line 289 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_5); /* line 290 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_8); /* line 291 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 292 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 293 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 294 */
   __AND(reg_r0_8, reg_r0_15, (unsigned int) 255); /* line 295 */
   __SHRU(reg_r0_5, reg_r0_15, (unsigned int) 8); /* line 296 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 297 */
} /* line 297 */
  sim_icache_fetch(189 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 299 */
   __SHL(reg_r0_22, reg_r0_6, (unsigned int) 8); /* line 300 */
   __SHL(reg_r0_20, reg_r0_6, (unsigned int) 16); /* line 301 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_11); /* line 302 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_12); /* line 303 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_9); /* line 304 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 305 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 306 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 307 */
} /* line 307 */
  sim_icache_fetch(198 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 309 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 310 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 311 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_18); /* line 312 */
   __OR(reg_r0_6, reg_r0_6, reg_r0_20); /* line 313 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 314 */
   __ZXTB(reg_r0_16, reg_r0_16); /* line 315 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_14); /* line 316 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_5); /* line 317 */
} /* line 317 */
  sim_icache_fetch(207 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_3); /* line 319 */
   __OR(reg_r0_6, reg_r0_6, reg_r0_22); /* line 320 */
   __SHL(reg_r0_9, reg_r0_7, (unsigned int) 8); /* line 321 */
   __SHL(reg_r0_5, reg_r0_7, (unsigned int) 16); /* line 322 */
   __SHL(reg_r0_12, reg_r0_16, (unsigned int) 8); /* line 323 */
   __SHL(reg_r0_11, reg_r0_16, (unsigned int) 16); /* line 324 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 325 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_15); /* line 326 */
} /* line 326 */
  sim_icache_fetch(215 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_6); /* line 328 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_5); /* line 329 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_11); /* line 330 */
   __SHL(reg_r0_5, reg_r0_10, (unsigned int) 8); /* line 331 */
   __SHL(reg_r0_3, reg_r0_10, (unsigned int) 16); /* line 332 */
   __ZXTB(reg_r0_8, reg_r0_8); /* line 333 */
} /* line 333 */
  sim_icache_fetch(221 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_7, reg_r0_7, reg_r0_9); /* line 335 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_12); /* line 336 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_3); /* line 337 */
   __SHL(reg_r0_6, reg_r0_8, (unsigned int) 8); /* line 338 */
   __SHL(reg_r0_3, reg_r0_8, (unsigned int) 16); /* line 339 */
} /* line 339 */
  sim_icache_fetch(226 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_7); /* line 341 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_16); /* line 342 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_5); /* line 343 */
   __OR(reg_r0_8, reg_r0_8, reg_r0_3); /* line 344 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(231 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_10); /* line 347 */
   __OR(reg_r0_8, reg_r0_8, reg_r0_6); /* line 348 */
} /* line 348 */
  sim_icache_fetch(233 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_8); /* line 350 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 351 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_28, (unsigned int) 256); /* line 356 */
   __ADD(reg_r0_5, reg_r0_27, (unsigned int) 256); /* line 357 */
   __ADD(reg_r0_3, reg_r0_26, (unsigned int) 1); /* line 358 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_29); /* line 365 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 366 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 368 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 369 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 370 */
   __ADD_CYCLES(1);
} /* line 370 */
