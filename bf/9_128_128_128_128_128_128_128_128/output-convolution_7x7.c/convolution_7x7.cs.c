  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
  ...
  sim_icache_fetch(36 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   ...
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 131 */
} /* line 131 */
  sim_icache_fetch(45 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   ...
   __MOV(reg_r0_44, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 155 */
   __MOV(reg_r0_45, reg_r0_5); /* line 156 */
} /* line 156 */
l_L4X3: ;/* line 159 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_16, 0); /* line 172 */
   __MOV(reg_r0_15, 0); /* line 173 */
   __MOV(reg_r0_17, 0); /* line 174 */
   __MOV(reg_r0_42, reg_r0_4); /* line 175 */
   __MOV(reg_r0_43, reg_r0_7); /* line 176 */
} /* line 176 */
...
l_L8X3: ;/* line 181 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
  ...
  sim_icache_fetch(93 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   ...
   __LDWs(reg_r0_14, mem_trace_ld(reg_r0_14,0,4)); /* line 197 */
  ...
  sim_icache_fetch(103 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 202 */
   __ADD(reg_r0_20, reg_r0_3, (unsigned int) 1); /* line 203 */
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 204 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 205 */
   __ADD(reg_r0_13, reg_r0_5, reg_r0_13); /* line 206 */
   __ADD(reg_r0_22, reg_r0_3, (unsigned int) 4); /* line 207 */
   __ADD(reg_r0_18, reg_r0_3, (unsigned int) 5); /* line 208 */
   __SH2ADD(reg_r0_19, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 209 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 210 */
} /* line 210 */
  sim_icache_fetch(114 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __LDW(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 212 */
   __SHL(reg_r0_20, reg_r0_20, (unsigned int) 6); /* line 213 */
   __SH2ADD(reg_r0_11, reg_r0_11, (unsigned int) conv7_image); /* line 214 */
   __SH2ADD(reg_r0_13, reg_r0_13, (unsigned int) conv7_image); /* line 215 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 6); /* line 216 */
   __SH2ADD(reg_r0_23, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 217 */
   __SHL(reg_r0_18, reg_r0_18, (unsigned int) 6); /* line 218 */
   __LDW(reg_r0_19, mem_trace_ld(reg_r0_19,0,4)); /* line 219 */
   __SH2ADD(reg_r0_4, reg_r0_4, (unsigned int) conv7_image); /* line 220 */
} /* line 220 */
  sim_icache_fetch(127 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHRU(reg_r0_25, reg_r0_9, (unsigned int) 16); /* line 222 */
   __SHRU(reg_r0_24, reg_r0_9, (unsigned int) 8); /* line 223 */
   __ADD(reg_r0_20, reg_r0_5, reg_r0_20); /* line 224 */
   __LDW(reg_r0_11, mem_trace_ld(reg_r0_11,0,4)); /* line 225 */
   __LDW(reg_r0_13, mem_trace_ld(reg_r0_13,0,4)); /* line 226 */
   __ADD(reg_r0_22, reg_r0_5, reg_r0_22); /* line 227 */
   __LDW(reg_r0_23, mem_trace_ld(reg_r0_23,0,4)); /* line 228 */
   __ADD(reg_r0_18, reg_r0_5, reg_r0_18); /* line 229 */
   __LDW(reg_r0_4, mem_trace_ld(reg_r0_4,0,4)); /* line 230 */
} /* line 230 */
  sim_icache_fetch(136 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 232 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 233 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 234 */
   __SH2ADD(reg_r0_20, reg_r0_20, (unsigned int) conv7_image); /* line 235 */
   __SH2ADD(reg_r0_22, reg_r0_22, (unsigned int) conv7_image); /* line 236 */
   __SH2ADD(reg_r0_18, reg_r0_18, (unsigned int) conv7_image); /* line 237 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 238 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 239 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 240 */
} /* line 240 */
  sim_icache_fetch(148 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __MULLU(reg_r0_27, reg_r0_10, reg_r0_24); /* line 242 */
   __MULHS(reg_r0_24, reg_r0_10, reg_r0_24); /* line 243 */
   __LDW(reg_r0_20, mem_trace_ld(reg_r0_20,0,4)); /* line 244 */
   __SHRU(reg_r0_28, reg_r0_11, (unsigned int) 8); /* line 245 */
   __SHRU(reg_r0_29, reg_r0_13, (unsigned int) 8); /* line 246 */
   __LDW(reg_r0_22, mem_trace_ld(reg_r0_22,0,4)); /* line 247 */
   __LDW(reg_r0_18, mem_trace_ld(reg_r0_18,0,4)); /* line 248 */
   __SHRU(reg_r0_30, reg_r0_4, (unsigned int) 16); /* line 249 */
   __SHRU(reg_r0_26, reg_r0_4, (unsigned int) 8); /* line 250 */
} /* line 250 */
  sim_icache_fetch(157 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __MULLU(reg_r0_31, reg_r0_10, reg_r0_25); /* line 252 */
   __MULHS(reg_r0_25, reg_r0_10, reg_r0_25); /* line 253 */
   __SHRU(reg_r0_32, reg_r0_11, (unsigned int) 16); /* line 254 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 255 */
   __SHRU(reg_r0_33, reg_r0_13, (unsigned int) 16); /* line 256 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 257 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 258 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 259 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 260 */
} /* line 260 */
  sim_icache_fetch(166 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __ADD(reg_r0_27, reg_r0_27, reg_r0_24); /* line 262 */
   __SHRU(reg_r0_37, reg_r0_20, (unsigned int) 8); /* line 263 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_28); /* line 264 */
   __MULHS(reg_r0_28, reg_r0_12, reg_r0_28); /* line 265 */
   __MULLU(reg_r0_35, reg_r0_14, reg_r0_29); /* line 266 */
   __MULHS(reg_r0_29, reg_r0_14, reg_r0_29); /* line 267 */
   __SHRU(reg_r0_36, reg_r0_18, (unsigned int) 8); /* line 268 */
   __MULLU(reg_r0_34, reg_r0_7, reg_r0_26); /* line 269 */
   __MULHS(reg_r0_26, reg_r0_7, reg_r0_26); /* line 270 */
} /* line 270 */
  sim_icache_fetch(175 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __ADD(reg_r0_31, reg_r0_31, reg_r0_25); /* line 272 */
   __CMPLT(reg_b0_0, reg_r0_27, 0); /* line 273 */
   __ADD(reg_r0_38, reg_r0_27, (unsigned int) 255); /* line 274 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 275 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 276 */
   __SHRU(reg_r0_39, reg_r0_22, (unsigned int) 8); /* line 277 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 278 */
   __MULLU(reg_r0_40, reg_r0_7, reg_r0_30); /* line 279 */
   __MULHS(reg_r0_30, reg_r0_7, reg_r0_30); /* line 280 */
} /* line 280 */
  sim_icache_fetch(184 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_26 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SLCT(reg_r0_38, reg_b0_0, reg_r0_38, reg_r0_27); /* line 282 */
   __MULLU(reg_r0_26, reg_r0_21, reg_r0_37); /* line 283 */
   __MULHS(reg_r0_37, reg_r0_21, reg_r0_37); /* line 284 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_28); /* line 285 */
   __ADD(reg_r0_35, reg_r0_35, reg_r0_29); /* line 286 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 287 */
   __MULLU(reg_r0_25, reg_r0_19, reg_r0_36); /* line 288 */
   __MULHS(reg_r0_36, reg_r0_19, reg_r0_36); /* line 289 */
   __ADD(reg_r0_34, reg_r0_34, t__i32_0); /* line 290 */
} /* line 290 */
  sim_icache_fetch(193 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHR(reg_r0_38, reg_r0_38, (unsigned int) 8); /* line 292 */
   __CMPLT(reg_b0_1, reg_r0_24, 0); /* line 293 */
   __ADD(reg_r0_28, reg_r0_24, (unsigned int) 255); /* line 294 */
   __CMPLT(reg_b0_2, reg_r0_35, 0); /* line 295 */
   __ADD(reg_r0_29, reg_r0_35, (unsigned int) 255); /* line 296 */
   __MULLU(reg_r0_41, reg_r0_23, reg_r0_39); /* line 297 */
   __MULHS(reg_r0_39, reg_r0_23, reg_r0_39); /* line 298 */
   __CMPLT(reg_b0_0, reg_r0_34, 0); /* line 299 */
   __ADD(reg_r0_27, reg_r0_34, (unsigned int) 255); /* line 300 */
} /* line 300 */
  sim_icache_fetch(202 + t_thisfile.offset, 9);
{
  ...
  t__i32_2 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __CMPLT(reg_b0_0, reg_r0_31, 0); /* line 302 */
   __ADD(reg_r0_24, reg_r0_31, (unsigned int) 255); /* line 303 */
   __ADD(reg_r0_26, reg_r0_26, reg_r0_37); /* line 304 */
   __MULLU(reg_r0_30, reg_r0_12, reg_r0_32); /* line 305 */
   __SLCT(reg_r0_28, reg_b0_1, reg_r0_28, t__i32_0); /* line 306 */
   __SLCT(reg_r0_29, reg_b0_2, reg_r0_29, reg_r0_35); /* line 307 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_36); /* line 308 */
   __ADD(reg_r0_40, reg_r0_40, t__i32_1); /* line 309 */
   __SLCT(reg_r0_27, t__i32_2, reg_r0_27, reg_r0_34); /* line 310 */
} /* line 310 */
  sim_icache_fetch(211 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __CMPLT(reg_b0_2, reg_r0_26, 0); /* line 312 */
   __ADD(reg_r0_35, reg_r0_26, (unsigned int) 255); /* line 313 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 314 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 315 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_39); /* line 316 */
   __CMPLT(reg_b0_1, reg_r0_25, 0); /* line 317 */
   __ADD(reg_r0_34, reg_r0_25, (unsigned int) 255); /* line 318 */
   __CMPLT(reg_b0_3, reg_r0_40, 0); /* line 319 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 320 */
} /* line 320 */
  sim_icache_fetch(220 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_25 ;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SLCT(reg_r0_24, reg_b0_0, reg_r0_24, reg_r0_31); /* line 322 */
   __SLCT(reg_r0_35, reg_b0_2, reg_r0_35, reg_r0_26); /* line 323 */
   __MULHS(reg_r0_32, reg_r0_12, reg_r0_32); /* line 324 */
   __CMPLT(reg_b0_1, reg_r0_41, 0); /* line 325 */
   __ADD(reg_r0_25, reg_r0_41, (unsigned int) 255); /* line 326 */
   __SLCT(reg_r0_34, t__i32_0, reg_r0_34, t__i32_1); /* line 327 */
   __ADD(reg_r0_26, reg_r0_40, (unsigned int) 255); /* line 328 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_27); /* line 329 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_29); /* line 330 */
} /* line 330 */
  sim_icache_fetch(229 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_28 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 332 */
   __SHRU(reg_r0_28, reg_r0_20, (unsigned int) 16); /* line 333 */
   __SHR(reg_r0_35, reg_r0_35, (unsigned int) 8); /* line 334 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 335 */
   __SLCT(reg_r0_25, reg_b0_1, reg_r0_25, reg_r0_41); /* line 336 */
   __SHRU(reg_r0_27, reg_r0_18, (unsigned int) 16); /* line 337 */
   __SHR(reg_r0_34, reg_r0_34, (unsigned int) 8); /* line 338 */
   __SLCT(reg_r0_26, reg_b0_3, reg_r0_26, reg_r0_40); /* line 339 */
   __ADD(reg_r0_38, reg_r0_38, t__i32_0); /* line 340 */
} /* line 340 */
  sim_icache_fetch(238 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 342 */
   __ADD(reg_r0_30, reg_r0_30, reg_r0_32); /* line 343 */
   __MULLU(reg_r0_29, reg_r0_14, reg_r0_33); /* line 344 */
   __MULHS(reg_r0_33, reg_r0_14, reg_r0_33); /* line 345 */
   __SHRU(reg_r0_31, reg_r0_22, (unsigned int) 16); /* line 346 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 347 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 348 */
   __SHR(reg_r0_26, reg_r0_26, (unsigned int) 8); /* line 349 */
   __ADD(reg_r0_15, reg_r0_15, reg_r0_34); /* line 350 */
} /* line 350 */
  sim_icache_fetch(247 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_26 ;
  t__i32_0 = reg_r0_25 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __MULLU(reg_r0_32, reg_r0_21, reg_r0_28); /* line 352 */
   __MULHS(reg_r0_28, reg_r0_21, reg_r0_28); /* line 353 */
   __CMPLT(reg_b0_0, reg_r0_30, 0); /* line 354 */
   __ADD(reg_r0_25, reg_r0_30, (unsigned int) 255); /* line 355 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 356 */
   __MULLU(reg_r0_26, reg_r0_19, reg_r0_27); /* line 357 */
   __MULHS(reg_r0_27, reg_r0_19, reg_r0_27); /* line 358 */
   __ADD(reg_r0_35, reg_r0_35, t__i32_0); /* line 359 */
   __ADD(reg_r0_24, reg_r0_24, t__i32_1); /* line 360 */
} /* line 360 */
  sim_icache_fetch(256 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __MULLU(reg_r0_4, reg_r0_10, reg_r0_9); /* line 362 */
   __MULHS(reg_r0_10, reg_r0_10, reg_r0_9); /* line 363 */
   __SLCT(reg_r0_25, reg_b0_0, reg_r0_25, reg_r0_30); /* line 364 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_33); /* line 365 */
   __MULLU(reg_r0_30, reg_r0_23, reg_r0_31); /* line 366 */
   __MULHS(reg_r0_31, reg_r0_23, reg_r0_31); /* line 367 */
   __MULLU(reg_r0_33, reg_r0_7, t__i32_0); /* line 368 */
   __MULHS(reg_r0_7, reg_r0_7, t__i32_0); /* line 369 */
   __ADD(reg_r0_15, reg_r0_15, reg_r0_35); /* line 370 */
} /* line 370 */
  sim_icache_fetch(265 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __ADD(reg_r0_32, reg_r0_32, reg_r0_28); /* line 372 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 373 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 374 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 375 */
   __CMPLT(reg_b0_0, reg_r0_29, 0); /* line 376 */
   __ADD(reg_r0_9, reg_r0_29, (unsigned int) 255); /* line 377 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 378 */
   __ADD(reg_r0_26, reg_r0_26, reg_r0_27); /* line 379 */
   __ADD(reg_r0_15, reg_r0_38, reg_r0_15); /* line 380 */
} /* line 380 */
  sim_icache_fetch(274 + t_thisfile.offset, 9);
{
  ...
  t__i32_0 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __ADD(reg_r0_4, reg_r0_4, reg_r0_10); /* line 382 */
   __CMPLT(reg_b0_1, reg_r0_32, 0); /* line 383 */
   __ADD(reg_r0_28, reg_r0_32, (unsigned int) 255); /* line 384 */
   __MULLU(reg_r0_7, reg_r0_12, reg_r0_11); /* line 385 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_29); /* line 386 */
   __ADD(reg_r0_30, reg_r0_30, reg_r0_31); /* line 387 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 388 */
   __ADD(reg_r0_27, reg_r0_26, (unsigned int) 255); /* line 389 */
   __ADD(reg_r0_33, reg_r0_33, t__i32_0); /* line 390 */
} /* line 390 */
  sim_icache_fetch(283 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __CMPLT(reg_b0_2, reg_r0_4, 0); /* line 392 */
   __ADD(reg_r0_29, reg_r0_4, (unsigned int) 255); /* line 393 */
   __SLCT(reg_r0_28, reg_b0_1, reg_r0_28, reg_r0_32); /* line 394 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 395 */
   __CMPLT(reg_b0_0, reg_r0_30, 0); /* line 396 */
   __ADD(reg_r0_10, reg_r0_30, (unsigned int) 255); /* line 397 */
   __SLCT(reg_r0_27, t__i32_0, reg_r0_27, reg_r0_26); /* line 398 */
   __CMPLT(reg_b0_1, reg_r0_33, 0); /* line 399 */
   __ADD(reg_r0_26, reg_r0_33, (unsigned int) 255); /* line 400 */
} /* line 400 */
  sim_icache_fetch(292 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SLCT(reg_r0_29, reg_b0_2, reg_r0_29, reg_r0_4); /* line 402 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 403 */
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_11); /* line 404 */
   __MULLU(reg_r0_4, reg_r0_14, reg_r0_13); /* line 405 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 406 */
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_30); /* line 407 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 408 */
   __SLCT(reg_r0_26, reg_b0_1, reg_r0_26, reg_r0_33); /* line 409 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_9); /* line 410 */
} /* line 410 */
  sim_icache_fetch(301 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 412 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 413 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 414 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 415 */
   __MULLU(reg_r0_9, reg_r0_19, reg_r0_18); /* line 416 */
   __MULHS(reg_r0_19, reg_r0_19, reg_r0_18); /* line 417 */
   __SHR(reg_r0_26, reg_r0_26, (unsigned int) 8); /* line 418 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_27); /* line 419 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_25); /* line 420 */
} /* line 420 */
  sim_icache_fetch(310 + t_thisfile.offset, 8);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __MULLU(reg_r0_10, reg_r0_21, reg_r0_20); /* line 422 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_20); /* line 423 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_12); /* line 424 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_14); /* line 425 */
   __MULLU(reg_r0_11, reg_r0_23, reg_r0_22); /* line 426 */
   __MULHS(reg_r0_23, reg_r0_23, reg_r0_22); /* line 427 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_26); /* line 428 */
   __ADD(reg_r0_28, reg_r0_28, t__i32_0); /* line 429 */
} /* line 429 */
  sim_icache_fetch(318 + t_thisfile.offset, 6);
{
   ...
   __ADD(reg_r0_12, reg_r0_7, (unsigned int) 255); /* line 432 */
   __CMPLT(reg_b0_1, reg_r0_4, 0); /* line 433 */
   __ADD(reg_r0_13, reg_r0_4, (unsigned int) 255); /* line 434 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_19); /* line 435 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_28); /* line 436 */
} /* line 436 */
  sim_icache_fetch(324 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __ADD(reg_r0_10, reg_r0_10, reg_r0_21); /* line 438 */
   __SLCT(reg_r0_12, reg_b0_0, reg_r0_12, reg_r0_7); /* line 439 */
   __SLCT(reg_r0_13, reg_b0_1, reg_r0_13, reg_r0_4); /* line 440 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_23); /* line 441 */
   __CMPLT(reg_b0_0, reg_r0_9, 0); /* line 442 */
   __ADD(reg_r0_4, reg_r0_9, (unsigned int) 255); /* line 443 */
   __ADD(reg_r0_16, reg_r0_24, reg_r0_16); /* line 444 */
} /* line 444 */
  sim_icache_fetch(331 + t_thisfile.offset, 7);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_9 ;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 446 */
   __ADD(reg_r0_7, reg_r0_10, (unsigned int) 255); /* line 447 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 448 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 449 */
   __CMPLT(reg_b0_1, reg_r0_11, 0); /* line 450 */
   __ADD(reg_r0_9, reg_r0_11, (unsigned int) 255); /* line 451 */
   __SLCT(reg_r0_4, t__i32_0, reg_r0_4, t__i32_1); /* line 452 */
} /* line 452 */
  sim_icache_fetch(338 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_10); /* line 454 */
   __SLCT(reg_r0_9, reg_b0_1, reg_r0_9, reg_r0_11); /* line 455 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 456 */
   __ADD(reg_r0_12, reg_r0_12, reg_r0_13); /* line 457 */
} /* line 457 */
  sim_icache_fetch(342 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 459 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 460 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_4); /* line 461 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_12); /* line 462 */
} /* line 462 */
  sim_icache_fetch(346 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_7, reg_r0_7, reg_r0_9); /* line 464 */
} /* line 464 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_17, reg_r0_17, reg_r0_7); /* line 466 */
} /* line 466 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_17, reg_r0_29, reg_r0_17); /* line 468 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   ...
   __MAX(reg_r0_15, reg_r0_15, 0); /* line 474 */
   __MAX(reg_r0_16, reg_r0_16, 0); /* line 475 */
   __SH2ADD(reg_r0_2, reg_r0_42, reg_r0_44); /* line 476 */
   __ADD(reg_r0_4, reg_r0_42, (unsigned int) 1); /* line 477 */
} /* line 477 */
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   ...
   __MIN(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 480 */
   __MIN(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 481 */
   __ADD(reg_r0_7, reg_r0_43, (unsigned int) 1); /* line 482 */
} /* line 482 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 484 */
   __SHL(reg_r0_16, reg_r0_16, (unsigned int) 16); /* line 485 */
} /* line 485 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_17, reg_r0_17, reg_r0_16); /* line 487 */
} /* line 487 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_17, reg_r0_17, reg_r0_15); /* line 489 */
} /* line 489 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_17); /* line 491 */
  ...
  sim_icache_fetch(365 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_44, reg_r0_44, (unsigned int) 256); /* line 496 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 64); /* line 497 */
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 1); /* line 498 */
  ...
  sim_icache_fetch(370 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_45); /* line 505 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 506 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(375 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 508 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 509 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 510 */
   __ADD_CYCLES(1);
} /* line 510 */
