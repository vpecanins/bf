  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   ...
   __MOV(reg_r0_29, t__i32_0); /* line 157 */
} /* line 157 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   ...
   __MOV(reg_r0_11, (unsigned int) -55); /* line 163 */
   __MOV(reg_r0_4, reg_r0_5); /* line 164 */
   __MOV(reg_r0_2, reg_r0_6); /* line 165 */
   __MOV(reg_r0_26, reg_r0_3); /* line 166 */
   __MOV(reg_r0_27, reg_r0_5); /* line 167 */
   __MOV(reg_r0_28, reg_r0_6); /* line 168 */
} /* line 168 */
  ...
  sim_icache_fetch(83 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __LDW(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 182 */
   __LDW(reg_r0_13, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 183 */
   __CMPLT(reg_b0_0, reg_r0_11, 0); /* line 184 */
   ...
   __ADD(reg_r0_11, reg_r0_11, (unsigned int) 11); /* line 188 */
} /* line 188 */
  ...
  sim_icache_fetch(97 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __AND(reg_r0_21, reg_r0_6, (unsigned int) 255); /* line 198 */
  ...
  sim_icache_fetch(104 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 206 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 207 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 208 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 209 */
   __AND(reg_r0_18, reg_r0_7, (unsigned int) 255); /* line 210 */
   __SHRU(reg_r0_16, reg_r0_7, (unsigned int) 8); /* line 211 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 212 */
} /* line 212 */
  sim_icache_fetch(111 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 214 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 215 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 216 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 217 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 218 */
   __AND(reg_r0_5, reg_r0_8, (unsigned int) 255); /* line 219 */
   __SHRU(reg_r0_3, reg_r0_8, (unsigned int) 8); /* line 220 */
} /* line 220 */
  sim_icache_fetch(118 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 222 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 223 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 224 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 225 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 226 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 227 */
   __SHRU(reg_r0_6, reg_r0_9, (unsigned int) 8); /* line 228 */
} /* line 228 */
  sim_icache_fetch(125 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __SHL(reg_r0_20, reg_r0_17, (unsigned int) 8); /* line 230 */
   __SHL(reg_r0_16, reg_r0_17, (unsigned int) 16); /* line 231 */
   __SHL(reg_r0_23, reg_r0_19, (unsigned int) 8); /* line 232 */
   __SHL(reg_r0_22, reg_r0_19, (unsigned int) 16); /* line 233 */
   __SHL(reg_r0_25, reg_r0_21, (unsigned int) 8); /* line 234 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 16); /* line 235 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_7); /* line 236 */
} /* line 236 */
  sim_icache_fetch(132 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __OR(reg_r0_17, reg_r0_17, reg_r0_16); /* line 238 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_22); /* line 239 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 240 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 241 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 242 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 243 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 244 */
} /* line 244 */
  sim_icache_fetch(139 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __OR(reg_r0_17, reg_r0_17, reg_r0_20); /* line 246 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_23); /* line 247 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_25); /* line 248 */
   __SHL(reg_r0_7, reg_r0_18, (unsigned int) 8); /* line 249 */
   __SHL(reg_r0_3, reg_r0_18, (unsigned int) 16); /* line 250 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_8); /* line 251 */
  ...
  sim_icache_fetch(146 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __OR(reg_r0_18, reg_r0_18, reg_r0_3); /* line 254 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 255 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_6); /* line 256 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 257 */
   __AND(reg_r0_6, reg_r0_10, (unsigned int) 255); /* line 258 */
   __SHRU(reg_r0_3, reg_r0_10, (unsigned int) 8); /* line 259 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 260 */
} /* line 260 */
  sim_icache_fetch(153 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __OR(reg_r0_18, reg_r0_18, reg_r0_7); /* line 262 */
   __SHL(reg_r0_16, reg_r0_5, (unsigned int) 8); /* line 263 */
   __SHL(reg_r0_7, reg_r0_5, (unsigned int) 16); /* line 264 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 265 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 266 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 267 */
   __SHRU(reg_r0_20, reg_r0_12, (unsigned int) 8); /* line 268 */
} /* line 268 */
  sim_icache_fetch(160 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __OR(reg_r0_5, reg_r0_5, reg_r0_7); /* line 270 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_9); /* line 271 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_3); /* line 272 */
   __AND(reg_r0_3, reg_r0_12, (unsigned int) 255); /* line 273 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 274 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 275 */
   __SHRU(reg_r0_7, reg_r0_13, (unsigned int) 8); /* line 276 */
} /* line 276 */
  sim_icache_fetch(167 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __OR(reg_r0_5, reg_r0_5, reg_r0_16); /* line 278 */
   __ZXTB(reg_r0_8, reg_r0_8); /* line 279 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_10); /* line 280 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_20); /* line 281 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 282 */
   __AND(reg_r0_9, reg_r0_13, (unsigned int) 255); /* line 283 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 284 */
} /* line 284 */
  sim_icache_fetch(174 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __SHL(reg_r0_16, reg_r0_8, (unsigned int) 8); /* line 286 */
   __SHL(reg_r0_10, reg_r0_8, (unsigned int) 16); /* line 287 */
   __ZXTB(reg_r0_6, reg_r0_6); /* line 288 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_12); /* line 289 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_7); /* line 290 */
   __SHRU(reg_r0_13, reg_r0_13, (unsigned int) 16); /* line 291 */
   __SHRU(reg_r0_7, reg_r0_14, (unsigned int) 8); /* line 292 */
} /* line 292 */
  sim_icache_fetch(181 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __OR(reg_r0_8, reg_r0_8, reg_r0_10); /* line 294 */
   __SHL(reg_r0_12, reg_r0_6, (unsigned int) 8); /* line 295 */
   __SHL(reg_r0_10, reg_r0_6, (unsigned int) 16); /* line 296 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 297 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 298 */
   __AND(reg_r0_20, reg_r0_14, (unsigned int) 255); /* line 299 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 300 */
} /* line 300 */
  sim_icache_fetch(188 + t_thisfile.offset, 7);
{
   ...
   __OR(reg_r0_6, reg_r0_6, reg_r0_10); /* line 303 */
   __SHL(reg_r0_16, reg_r0_3, (unsigned int) 8); /* line 304 */
   __SHL(reg_r0_10, reg_r0_3, (unsigned int) 16); /* line 305 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_13); /* line 306 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_7); /* line 307 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 308 */
} /* line 308 */
  sim_icache_fetch(195 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __OR(reg_r0_6, reg_r0_6, reg_r0_12); /* line 310 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_10); /* line 311 */
   __ZXTB(reg_r0_9, reg_r0_9); /* line 312 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 313 */
   __AND(reg_r0_10, reg_r0_15, (unsigned int) 255); /* line 314 */
   __SHRU(reg_r0_7, reg_r0_15, (unsigned int) 8); /* line 315 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 316 */
} /* line 316 */
  sim_icache_fetch(202 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 318 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_16); /* line 319 */
   __SHL(reg_r0_13, reg_r0_9, (unsigned int) 8); /* line 320 */
   __SHL(reg_r0_12, reg_r0_9, (unsigned int) 16); /* line 321 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_14); /* line 322 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 323 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 324 */
} /* line 324 */
  sim_icache_fetch(209 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 326 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 327 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_18); /* line 328 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_5); /* line 329 */
   __OR(reg_r0_9, reg_r0_9, reg_r0_12); /* line 330 */
   __ZXTB(reg_r0_20, reg_r0_20); /* line 331 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_7); /* line 332 */
} /* line 332 */
  sim_icache_fetch(216 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_8); /* line 334 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_6); /* line 335 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_3); /* line 336 */
   __OR(reg_r0_9, reg_r0_9, reg_r0_13); /* line 337 */
   __SHL(reg_r0_7, reg_r0_20, (unsigned int) 8); /* line 338 */
   __SHL(reg_r0_5, reg_r0_20, (unsigned int) 16); /* line 339 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_15); /* line 340 */
} /* line 340 */
  sim_icache_fetch(223 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_9); /* line 342 */
   __OR(reg_r0_20, reg_r0_20, reg_r0_5); /* line 343 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 344 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(227 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_20, reg_r0_20, reg_r0_7); /* line 347 */
   __SHL(reg_r0_5, reg_r0_10, (unsigned int) 8); /* line 348 */
   __SHL(reg_r0_3, reg_r0_10, (unsigned int) 16); /* line 349 */
} /* line 349 */
  sim_icache_fetch(230 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_20); /* line 351 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_3); /* line 352 */
} /* line 352 */
  sim_icache_fetch(232 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_10, reg_r0_10, reg_r0_5); /* line 354 */
} /* line 354 */
  sim_icache_fetch(233 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_10); /* line 356 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 357 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_28, (unsigned int) 256); /* line 362 */
   __ADD(reg_r0_5, reg_r0_27, (unsigned int) 256); /* line 363 */
   __ADD(reg_r0_3, reg_r0_26, (unsigned int) 1); /* line 364 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_29); /* line 371 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 372 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 374 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 375 */
