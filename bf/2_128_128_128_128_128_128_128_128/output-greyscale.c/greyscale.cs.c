  ...
  sim_icache_fetch(61 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 169 */
   __MOV(reg_r0_7, (unsigned int) grey_image); /* line 170 */
} /* line 170 */
  sim_icache_fetch(64 + t_thisfile.offset, 3);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_5, (unsigned int) grey_framebuffer); /* line 172 */
   __MOV(reg_r0_22, t__i32_0); /* line 173 */
} /* line 173 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 2);
{
   ...
   __MOV(reg_r0_6, (unsigned int) -55); /* line 179 */
} /* line 179 */
  sim_icache_fetch(70 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_4, reg_r0_5); /* line 181 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L5X3; 
  ...
  sim_icache_fetch(72 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_2, reg_r0_7); /* line 184 */
   __MOV(reg_r0_19, reg_r0_3); /* line 185 */
} /* line 185 */
  sim_icache_fetch(74 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_20, reg_r0_5); /* line 187 */
   __MOV(reg_r0_21, reg_r0_7); /* line 188 */
} /* line 188 */
l_L6X3: ;/* line 191 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __LDW(reg_r0_5, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 192 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 193 */
} /* line 193 */
  sim_icache_fetch(78 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 195 */
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 196 */
} /* line 196 */
  sim_icache_fetch(80 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_10, reg_r0_3, (unsigned int) 255); /* line 198 */
   __SHRU(reg_r0_9, reg_r0_3, (unsigned int) 8); /* line 199 */
} /* line 199 */
  sim_icache_fetch(82 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 201 */
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 202 */
} /* line 202 */
  sim_icache_fetch(84 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_10, reg_r0_10, reg_r0_9); /* line 204 */
  ...
  sim_icache_fetch(86 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_3 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_3, reg_r0_5, (unsigned int) 8); /* line 207 */
   __MAX(reg_r0_10, reg_r0_10, t__i32_0); /* line 208 */
} /* line 208 */
  sim_icache_fetch(88 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 210 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 211 */
} /* line 211 */
  sim_icache_fetch(90 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_11, reg_r0_10, (unsigned int) 8); /* line 213 */
   __SHL(reg_r0_9, reg_r0_10, (unsigned int) 16); /* line 214 */
} /* line 214 */
  sim_icache_fetch(92 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_9, reg_r0_5, (unsigned int) 255); /* line 216 */
   __OR(reg_r0_10, reg_r0_10, t__i32_0); /* line 217 */
} /* line 217 */
  sim_icache_fetch(94 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_9, reg_r0_9, reg_r0_3); /* line 219 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_11); /* line 220 */
} /* line 220 */
  sim_icache_fetch(96 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_3, reg_r0_7, (unsigned int) 8); /* line 222 */
   __SHRU(reg_r0_5, reg_r0_5, (unsigned int) 16); /* line 223 */
} /* line 223 */
  sim_icache_fetch(98 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 225 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 226 */
} /* line 226 */
  sim_icache_fetch(100 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_5, reg_r0_7, (unsigned int) 255); /* line 228 */
   __MAX(reg_r0_9, reg_r0_9, t__i32_0); /* line 229 */
} /* line 229 */
  sim_icache_fetch(102 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 231 */
   __ZXTB(reg_r0_9, reg_r0_9); /* line 232 */
} /* line 232 */
  sim_icache_fetch(104 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_11, reg_r0_9, (unsigned int) 8); /* line 234 */
   __SHL(reg_r0_3, reg_r0_9, (unsigned int) 16); /* line 235 */
} /* line 235 */
  sim_icache_fetch(106 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_9, reg_r0_9, reg_r0_3); /* line 237 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 238 */
} /* line 238 */
  sim_icache_fetch(108 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_9, reg_r0_9, reg_r0_11); /* line 240 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 241 */
} /* line 241 */
  sim_icache_fetch(110 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_5, reg_r0_5, reg_r0_7); /* line 243 */
   __SHRU(reg_r0_3, reg_r0_8, (unsigned int) 8); /* line 244 */
} /* line 244 */
  sim_icache_fetch(112 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_5, reg_r0_5); /* line 246 */
  ...
  sim_icache_fetch(114 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_11, reg_r0_5, (unsigned int) 8); /* line 249 */
   __SHL(reg_r0_7, reg_r0_5, (unsigned int) 16); /* line 250 */
} /* line 250 */
  sim_icache_fetch(116 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_5, reg_r0_5, reg_r0_7); /* line 252 */
   __AND(reg_r0_7, reg_r0_8, (unsigned int) 255); /* line 253 */
} /* line 253 */
  sim_icache_fetch(118 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_5, reg_r0_5, reg_r0_11); /* line 255 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_3); /* line 256 */
} /* line 256 */
  sim_icache_fetch(120 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 258 */
   __LDW(reg_r0_3, mem_trace_ld((reg_r0_2 + (unsigned int) 16),0,4)); /* line 259 */
} /* line 259 */
  sim_icache_fetch(122 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 261 */
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 20),0,4)); /* line 262 */
} /* line 262 */
  sim_icache_fetch(124 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_7, reg_r0_7, reg_r0_8); /* line 264 */
   __SHRU(reg_r0_8, reg_r0_3, (unsigned int) 8); /* line 265 */
} /* line 265 */
  sim_icache_fetch(126 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_7, reg_r0_7); /* line 267 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 268 */
} /* line 268 */
  sim_icache_fetch(128 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_13, reg_r0_7, (unsigned int) 8); /* line 270 */
   __SHL(reg_r0_12, reg_r0_7, (unsigned int) 16); /* line 271 */
} /* line 271 */
  sim_icache_fetch(130 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_7, reg_r0_7, reg_r0_12); /* line 273 */
   __AND(reg_r0_12, reg_r0_3, (unsigned int) 255); /* line 274 */
} /* line 274 */
  sim_icache_fetch(132 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_7, reg_r0_7, reg_r0_13); /* line 276 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_8); /* line 277 */
} /* line 277 */
  sim_icache_fetch(134 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 279 */
   __SHRU(reg_r0_8, reg_r0_11, (unsigned int) 8); /* line 280 */
} /* line 280 */
  sim_icache_fetch(136 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 282 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 283 */
} /* line 283 */
  sim_icache_fetch(138 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_12, reg_r0_12, reg_r0_3); /* line 285 */
   __AND(reg_r0_3, reg_r0_11, (unsigned int) 255); /* line 286 */
} /* line 286 */
  sim_icache_fetch(140 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_12, reg_r0_12); /* line 288 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_8); /* line 289 */
} /* line 289 */
  sim_icache_fetch(142 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_13, reg_r0_12, (unsigned int) 8); /* line 291 */
   __SHL(reg_r0_8, reg_r0_12, (unsigned int) 16); /* line 292 */
} /* line 292 */
  sim_icache_fetch(144 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_12, reg_r0_12, reg_r0_8); /* line 294 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 295 */
} /* line 295 */
  sim_icache_fetch(146 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_12, reg_r0_12, reg_r0_13); /* line 297 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 298 */
} /* line 298 */
  sim_icache_fetch(148 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_3, reg_r0_3, reg_r0_11); /* line 300 */
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 24),0,4)); /* line 301 */
} /* line 301 */
  sim_icache_fetch(150 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_3, reg_r0_3); /* line 303 */
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 304 */
} /* line 304 */
  sim_icache_fetch(152 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_14, reg_r0_3, (unsigned int) 8); /* line 306 */
   __SHL(reg_r0_13, reg_r0_3, (unsigned int) 16); /* line 307 */
} /* line 307 */
  sim_icache_fetch(154 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_3, reg_r0_3, reg_r0_13); /* line 309 */
   __SHRU(reg_r0_13, reg_r0_8, (unsigned int) 8); /* line 310 */
} /* line 310 */
  sim_icache_fetch(156 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_3, reg_r0_3, reg_r0_14); /* line 312 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 313 */
} /* line 313 */
  sim_icache_fetch(158 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_14, reg_r0_8, (unsigned int) 255); /* line 315 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 316 */
} /* line 316 */
  sim_icache_fetch(160 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_14, reg_r0_14, reg_r0_13); /* line 318 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 319 */
} /* line 319 */
  sim_icache_fetch(162 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_14, reg_r0_14, reg_r0_8); /* line 321 */
   __SHRU(reg_r0_8, reg_r0_11, (unsigned int) 8); /* line 322 */
} /* line 322 */
  sim_icache_fetch(164 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_14, reg_r0_14); /* line 324 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 325 */
} /* line 325 */
  sim_icache_fetch(166 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_15, reg_r0_14, (unsigned int) 8); /* line 327 */
   __SHL(reg_r0_13, reg_r0_14, (unsigned int) 16); /* line 328 */
} /* line 328 */
  sim_icache_fetch(168 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_14, reg_r0_14, reg_r0_13); /* line 330 */
   __AND(reg_r0_13, reg_r0_11, (unsigned int) 255); /* line 331 */
} /* line 331 */
  sim_icache_fetch(170 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_14, reg_r0_14, reg_r0_15); /* line 333 */
   __MAX(reg_r0_13, reg_r0_13, reg_r0_8); /* line 334 */
} /* line 334 */
  sim_icache_fetch(172 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 336 */
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 337 */
} /* line 337 */
  sim_icache_fetch(174 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 339 */
   __CMPLT(reg_b0_0, reg_r0_6, 0); /* line 340 */
} /* line 340 */
  sim_icache_fetch(176 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_13, reg_r0_13, reg_r0_11); /* line 342 */
   __SHRU(reg_r0_11, reg_r0_8, (unsigned int) 8); /* line 343 */
} /* line 343 */
  sim_icache_fetch(178 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_13, reg_r0_13); /* line 345 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 346 */
} /* line 346 */
  sim_icache_fetch(180 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_16, reg_r0_13, (unsigned int) 8); /* line 348 */
   __SHL(reg_r0_15, reg_r0_13, (unsigned int) 16); /* line 349 */
} /* line 349 */
  sim_icache_fetch(182 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_13, reg_r0_13, reg_r0_15); /* line 351 */
   __AND(reg_r0_15, reg_r0_8, (unsigned int) 255); /* line 352 */
} /* line 352 */
  sim_icache_fetch(184 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_13, reg_r0_13, reg_r0_16); /* line 354 */
   __MAX(reg_r0_15, reg_r0_15, reg_r0_11); /* line 355 */
} /* line 355 */
  sim_icache_fetch(186 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 357 */
   __LDWs(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 36),0,4)); /* line 358 */
} /* line 358 */
  sim_icache_fetch(188 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 360 */
   __LDWs(reg_r0_16, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 361 */
} /* line 361 */
  sim_icache_fetch(190 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_15, reg_r0_15, reg_r0_8); /* line 363 */
   __SHRU(reg_r0_8, reg_r0_11, (unsigned int) 8); /* line 364 */
} /* line 364 */
  sim_icache_fetch(192 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_15, reg_r0_15); /* line 366 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 367 */
} /* line 367 */
  sim_icache_fetch(194 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_18, reg_r0_15, (unsigned int) 8); /* line 369 */
   __SHL(reg_r0_17, reg_r0_15, (unsigned int) 16); /* line 370 */
} /* line 370 */
  sim_icache_fetch(196 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_15, reg_r0_15, reg_r0_17); /* line 372 */
   __AND(reg_r0_17, reg_r0_11, (unsigned int) 255); /* line 373 */
} /* line 373 */
  sim_icache_fetch(198 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_15, reg_r0_15, reg_r0_18); /* line 375 */
   __MAX(reg_r0_17, reg_r0_17, reg_r0_8); /* line 376 */
} /* line 376 */
  sim_icache_fetch(200 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 378 */
   __SHRU(reg_r0_8, reg_r0_16, (unsigned int) 8); /* line 379 */
} /* line 379 */
  sim_icache_fetch(202 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 381 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 382 */
} /* line 382 */
  sim_icache_fetch(204 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_11); /* line 384 */
   __AND(reg_r0_11, reg_r0_16, (unsigned int) 255); /* line 385 */
} /* line 385 */
  sim_icache_fetch(206 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 387 */
   __MAX(reg_r0_11, reg_r0_11, reg_r0_8); /* line 388 */
} /* line 388 */
  sim_icache_fetch(208 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_18, reg_r0_17, (unsigned int) 8); /* line 390 */
   __SHL(reg_r0_8, reg_r0_17, (unsigned int) 16); /* line 391 */
} /* line 391 */
  sim_icache_fetch(210 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_17, reg_r0_17, reg_r0_8); /* line 393 */
   __SHRU(reg_r0_16, reg_r0_16, (unsigned int) 16); /* line 394 */
} /* line 394 */
  sim_icache_fetch(212 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_17, reg_r0_17, reg_r0_18); /* line 396 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 397 */
} /* line 397 */
  sim_icache_fetch(214 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_11, reg_r0_11, reg_r0_16); /* line 399 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 400 */
} /* line 400 */
  sim_icache_fetch(216 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ZXTB(reg_r0_11, reg_r0_11); /* line 402 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 11); /* line 403 */
} /* line 403 */
  sim_icache_fetch(218 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_16, reg_r0_11, (unsigned int) 8); /* line 405 */
   __SHL(reg_r0_8, reg_r0_11, (unsigned int) 16); /* line 406 */
} /* line 406 */
  sim_icache_fetch(220 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_10); /* line 408 */
   __OR(reg_r0_11, reg_r0_11, reg_r0_8); /* line 409 */
} /* line 409 */
  sim_icache_fetch(222 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_9); /* line 411 */
   __OR(reg_r0_11, reg_r0_11, reg_r0_16); /* line 412 */
} /* line 412 */
  sim_icache_fetch(224 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_5); /* line 414 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_7); /* line 415 */
} /* line 415 */
  sim_icache_fetch(226 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_12); /* line 417 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_3); /* line 418 */
} /* line 418 */
  sim_icache_fetch(228 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_14); /* line 420 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_13); /* line 421 */
} /* line 421 */
  sim_icache_fetch(230 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_15); /* line 423 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(232 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_17); /* line 426 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_11); /* line 427 */
} /* line 427 */
  sim_icache_fetch(234 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 429 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_7, reg_r0_21, (unsigned int) 256); /* line 434 */
   __ADD(reg_r0_5, reg_r0_20, (unsigned int) 256); /* line 435 */
} /* line 435 */
  sim_icache_fetch(240 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_3, reg_r0_19, (unsigned int) 1); /* line 437 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_22); /* line 442 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 443 */
} /* line 443 */
		 /* line 444 */
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 448 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 449 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 450 */
   __ADD_CYCLES(1);
} /* line 450 */
