  ...
  sim_icache_fetch(61 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 162 */
   __MOV(reg_r0_6, (unsigned int) grey_image); /* line 163 */
   __MOV(reg_r0_23, reg_r0_5); /* line 164 */
} /* line 164 */
  sim_icache_fetch(65 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_5, (unsigned int) grey_framebuffer); /* line 166 */
} /* line 166 */
l_L4X3: ;/* line 169 */
__LABEL(l_L4X3);
  sim_icache_fetch(67 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 170 */
   __MOV(reg_r0_7, (unsigned int) -55); /* line 171 */
   __MOV(reg_r0_4, reg_r0_5); /* line 172 */
} /* line 172 */
  sim_icache_fetch(70 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MOV(reg_r0_2, reg_r0_6); /* line 174 */
   __MOV(reg_r0_20, reg_r0_3); /* line 175 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L5X3; 
  ...
  sim_icache_fetch(73 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_21, reg_r0_5); /* line 178 */
   __MOV(reg_r0_22, reg_r0_6); /* line 179 */
} /* line 179 */
l_L6X3: ;/* line 182 */
__LABEL(l_L6X3);
  sim_icache_fetch(75 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_5, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 183 */
   __LDW(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 184 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 185 */
} /* line 185 */
  sim_icache_fetch(78 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 187 */
   __LDW(reg_r0_9, mem_trace_ld((reg_r0_2 + (unsigned int) 16),0,4)); /* line 188 */
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 20),0,4)); /* line 189 */
} /* line 189 */
  sim_icache_fetch(81 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __AND(reg_r0_12, reg_r0_3, (unsigned int) 255); /* line 191 */
   __SHRU(reg_r0_11, reg_r0_3, (unsigned int) 8); /* line 192 */
  ...
  sim_icache_fetch(84 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 195 */
   __SHRU(reg_r0_13, reg_r0_5, (unsigned int) 8); /* line 196 */
  ...
  sim_icache_fetch(87 + t_thisfile.offset, 3);
{
  ...
  t__i32_0 = reg_r0_11 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __AND(reg_r0_11, reg_r0_5, (unsigned int) 255); /* line 199 */
   __MAX(reg_r0_12, reg_r0_12, t__i32_0); /* line 200 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 201 */
} /* line 201 */
  sim_icache_fetch(90 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MAX(reg_r0_11, reg_r0_11, reg_r0_13); /* line 203 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_3); /* line 204 */
   __SHRU(reg_r0_5, reg_r0_5, (unsigned int) 16); /* line 205 */
} /* line 205 */
  sim_icache_fetch(93 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHRU(reg_r0_3, reg_r0_6, (unsigned int) 8); /* line 207 */
   __ZXTB(reg_r0_12, reg_r0_12); /* line 208 */
  ...
  sim_icache_fetch(96 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_14, reg_r0_12, (unsigned int) 8); /* line 211 */
   __SHL(reg_r0_13, reg_r0_12, (unsigned int) 16); /* line 212 */
   __MAX(reg_r0_11, reg_r0_11, reg_r0_5); /* line 213 */
} /* line 213 */
  sim_icache_fetch(99 + t_thisfile.offset, 3);
{
   ...
   __OR(reg_r0_12, reg_r0_12, reg_r0_13); /* line 216 */
   __ZXTB(reg_r0_11, reg_r0_11); /* line 217 */
} /* line 217 */
  sim_icache_fetch(102 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_12, reg_r0_12, reg_r0_14); /* line 219 */
   __SHL(reg_r0_13, reg_r0_11, (unsigned int) 8); /* line 220 */
   __SHL(reg_r0_5, reg_r0_11, (unsigned int) 16); /* line 221 */
} /* line 221 */
  sim_icache_fetch(105 + t_thisfile.offset, 3);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __AND(reg_r0_5, reg_r0_6, (unsigned int) 255); /* line 223 */
   __OR(reg_r0_11, reg_r0_11, t__i32_0); /* line 224 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 225 */
} /* line 225 */
  sim_icache_fetch(108 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 227 */
   __OR(reg_r0_11, reg_r0_11, reg_r0_13); /* line 228 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 229 */
} /* line 229 */
  sim_icache_fetch(111 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MAX(reg_r0_5, reg_r0_5, reg_r0_6); /* line 231 */
   __AND(reg_r0_6, reg_r0_8, (unsigned int) 255); /* line 232 */
   __SHRU(reg_r0_3, reg_r0_8, (unsigned int) 8); /* line 233 */
} /* line 233 */
  sim_icache_fetch(114 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ZXTB(reg_r0_5, reg_r0_5); /* line 235 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 236 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 237 */
} /* line 237 */
  sim_icache_fetch(117 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_14, reg_r0_5, (unsigned int) 8); /* line 239 */
   __SHL(reg_r0_13, reg_r0_5, (unsigned int) 16); /* line 240 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_3); /* line 241 */
} /* line 241 */
  sim_icache_fetch(120 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_5, reg_r0_5, reg_r0_13); /* line 243 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 244 */
   __SHRU(reg_r0_3, reg_r0_9, (unsigned int) 8); /* line 245 */
} /* line 245 */
  sim_icache_fetch(123 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_5, reg_r0_5, reg_r0_14); /* line 247 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_8); /* line 248 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 249 */
} /* line 249 */
  sim_icache_fetch(126 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ZXTB(reg_r0_6, reg_r0_6); /* line 251 */
   __AND(reg_r0_8, reg_r0_9, (unsigned int) 255); /* line 252 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 253 */
} /* line 253 */
  sim_icache_fetch(129 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_14, reg_r0_6, (unsigned int) 8); /* line 255 */
   __SHL(reg_r0_13, reg_r0_6, (unsigned int) 16); /* line 256 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_3); /* line 257 */
} /* line 257 */
  sim_icache_fetch(132 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_6, reg_r0_6, reg_r0_13); /* line 259 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 260 */
   __SHRU(reg_r0_3, reg_r0_10, (unsigned int) 8); /* line 261 */
} /* line 261 */
  sim_icache_fetch(135 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_6, reg_r0_6, reg_r0_14); /* line 263 */
   __MAX(reg_r0_8, reg_r0_8, reg_r0_9); /* line 264 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 265 */
} /* line 265 */
  sim_icache_fetch(138 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ZXTB(reg_r0_8, reg_r0_8); /* line 267 */
   __AND(reg_r0_9, reg_r0_10, (unsigned int) 255); /* line 268 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 269 */
} /* line 269 */
  sim_icache_fetch(141 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_14, reg_r0_8, (unsigned int) 8); /* line 271 */
   __SHL(reg_r0_13, reg_r0_8, (unsigned int) 16); /* line 272 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_3); /* line 273 */
} /* line 273 */
  sim_icache_fetch(144 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_8, reg_r0_8, reg_r0_13); /* line 275 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 276 */
   __LDW(reg_r0_3, mem_trace_ld((reg_r0_2 + (unsigned int) 24),0,4)); /* line 277 */
} /* line 277 */
  sim_icache_fetch(147 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_8, reg_r0_8, reg_r0_14); /* line 279 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_10); /* line 280 */
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 281 */
} /* line 281 */
  sim_icache_fetch(150 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ZXTB(reg_r0_9, reg_r0_9); /* line 283 */
   __AND(reg_r0_14, reg_r0_3, (unsigned int) 255); /* line 284 */
   __SHRU(reg_r0_13, reg_r0_3, (unsigned int) 8); /* line 285 */
} /* line 285 */
  sim_icache_fetch(153 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_16, reg_r0_9, (unsigned int) 8); /* line 287 */
   __SHL(reg_r0_15, reg_r0_9, (unsigned int) 16); /* line 288 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 289 */
} /* line 289 */
  sim_icache_fetch(156 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_9, reg_r0_9, reg_r0_15); /* line 291 */
   __MAX(reg_r0_14, reg_r0_14, reg_r0_13); /* line 292 */
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 293 */
} /* line 293 */
  sim_icache_fetch(159 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_9, reg_r0_9, reg_r0_16); /* line 295 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 296 */
   __SHRU(reg_r0_13, reg_r0_10, (unsigned int) 8); /* line 297 */
} /* line 297 */
  sim_icache_fetch(162 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MAX(reg_r0_14, reg_r0_14, reg_r0_3); /* line 299 */
   __AND(reg_r0_3, reg_r0_10, (unsigned int) 255); /* line 300 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 301 */
} /* line 301 */
  sim_icache_fetch(165 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ZXTB(reg_r0_14, reg_r0_14); /* line 303 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_13); /* line 304 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 305 */
} /* line 305 */
  sim_icache_fetch(168 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_15, reg_r0_14, (unsigned int) 8); /* line 307 */
   __SHL(reg_r0_13, reg_r0_14, (unsigned int) 16); /* line 308 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 309 */
} /* line 309 */
  sim_icache_fetch(171 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_14, reg_r0_14, reg_r0_13); /* line 311 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_10); /* line 312 */
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 313 */
} /* line 313 */
  sim_icache_fetch(174 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_14, reg_r0_14, reg_r0_15); /* line 315 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 316 */
   __CMPLT(reg_b0_0, reg_r0_7, 0); /* line 317 */
} /* line 317 */
  sim_icache_fetch(177 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_15, reg_r0_3, (unsigned int) 8); /* line 319 */
   __SHL(reg_r0_13, reg_r0_3, (unsigned int) 16); /* line 320 */
   __SHRU(reg_r0_16, reg_r0_10, (unsigned int) 8); /* line 321 */
} /* line 321 */
  sim_icache_fetch(180 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_3, reg_r0_3, reg_r0_13); /* line 323 */
   __AND(reg_r0_13, reg_r0_10, (unsigned int) 255); /* line 324 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 325 */
} /* line 325 */
  sim_icache_fetch(183 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_3, reg_r0_3, reg_r0_15); /* line 327 */
   __MAX(reg_r0_13, reg_r0_13, reg_r0_16); /* line 328 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 329 */
} /* line 329 */
  sim_icache_fetch(186 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 331 */
   __LDWs(reg_r0_15, mem_trace_ld((reg_r0_2 + (unsigned int) 36),0,4)); /* line 332 */
   __LDWs(reg_r0_16, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 333 */
} /* line 333 */
  sim_icache_fetch(189 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MAX(reg_r0_13, reg_r0_13, reg_r0_10); /* line 335 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 336 */
   __ADD(reg_r0_7, reg_r0_7, (unsigned int) 11); /* line 337 */
} /* line 337 */
  sim_icache_fetch(192 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ZXTB(reg_r0_13, reg_r0_13); /* line 339 */
   __AND(reg_r0_17, reg_r0_15, (unsigned int) 255); /* line 340 */
   __SHRU(reg_r0_10, reg_r0_15, (unsigned int) 8); /* line 341 */
} /* line 341 */
  sim_icache_fetch(195 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_19, reg_r0_13, (unsigned int) 8); /* line 343 */
   __SHL(reg_r0_18, reg_r0_13, (unsigned int) 16); /* line 344 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 345 */
} /* line 345 */
  sim_icache_fetch(198 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_13, reg_r0_13, reg_r0_18); /* line 347 */
   __MAX(reg_r0_17, reg_r0_17, reg_r0_10); /* line 348 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 349 */
} /* line 349 */
  sim_icache_fetch(201 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_13, reg_r0_13, reg_r0_19); /* line 351 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 352 */
   __SHRU(reg_r0_10, reg_r0_16, (unsigned int) 8); /* line 353 */
} /* line 353 */
  sim_icache_fetch(204 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_15); /* line 355 */
   __AND(reg_r0_15, reg_r0_16, (unsigned int) 255); /* line 356 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 357 */
} /* line 357 */
  sim_icache_fetch(207 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 359 */
   __MAX(reg_r0_15, reg_r0_15, reg_r0_10); /* line 360 */
   __SHRU(reg_r0_16, reg_r0_16, (unsigned int) 16); /* line 361 */
} /* line 361 */
  sim_icache_fetch(210 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHL(reg_r0_18, reg_r0_17, (unsigned int) 8); /* line 363 */
   __SHL(reg_r0_10, reg_r0_17, (unsigned int) 16); /* line 364 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 365 */
} /* line 365 */
  sim_icache_fetch(213 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_12); /* line 367 */
   __OR(reg_r0_17, reg_r0_17, reg_r0_10); /* line 368 */
   __MAX(reg_r0_15, reg_r0_15, reg_r0_16); /* line 369 */
} /* line 369 */
  sim_icache_fetch(216 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_11); /* line 371 */
   __OR(reg_r0_17, reg_r0_17, reg_r0_18); /* line 372 */
   __ZXTB(reg_r0_15, reg_r0_15); /* line 373 */
} /* line 373 */
  sim_icache_fetch(219 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_5); /* line 375 */
   __SHL(reg_r0_11, reg_r0_15, (unsigned int) 8); /* line 376 */
   __SHL(reg_r0_10, reg_r0_15, (unsigned int) 16); /* line 377 */
} /* line 377 */
  sim_icache_fetch(222 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_6); /* line 379 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_8); /* line 380 */
   __OR(reg_r0_15, reg_r0_15, reg_r0_10); /* line 381 */
} /* line 381 */
  sim_icache_fetch(225 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_9); /* line 383 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_14); /* line 384 */
   __OR(reg_r0_15, reg_r0_15, reg_r0_11); /* line 385 */
} /* line 385 */
  sim_icache_fetch(228 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_3); /* line 387 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_13); /* line 388 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(231 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_17); /* line 391 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_15); /* line 392 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 394 */
} /* line 394 */
  ...
  sim_icache_fetch(235 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ADD(reg_r0_6, reg_r0_22, (unsigned int) 256); /* line 400 */
   __ADD(reg_r0_5, reg_r0_21, (unsigned int) 256); /* line 401 */
   __ADD(reg_r0_3, reg_r0_20, (unsigned int) 1); /* line 403 */
} /* line 403 */
...
__LABEL(l_L5X3);
		 /* line 408 */
  sim_icache_fetch(241 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_23); /* line 411 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 412 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(246 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 414 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 415 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 416 */
   __ADD_CYCLES(1);
} /* line 416 */
