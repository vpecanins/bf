  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
  ...
  sim_icache_fetch(108 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   ...
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 215 */
   ...
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 219 */
   __AND(reg_r0_31, reg_r0_11, (unsigned int) 255); /* line 220 */
   __SHRU(reg_r0_30, reg_r0_11, (unsigned int) 8); /* line 221 */
} /* line 221 */
  sim_icache_fetch(125 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 223 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 224 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 225 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 226 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 227 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 228 */
   ...
   __AND(reg_r0_18, reg_r0_12, (unsigned int) 255); /* line 234 */
   __SHRU(reg_r0_16, reg_r0_12, (unsigned int) 8); /* line 235 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 236 */
   __AND(reg_r0_22, reg_r0_14, (unsigned int) 255); /* line 237 */
   __SHRU(reg_r0_20, reg_r0_14, (unsigned int) 8); /* line 238 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 239 */
} /* line 239 */
  sim_icache_fetch(142 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 241 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 242 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 243 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 244 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 245 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 246 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_28); /* line 247 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_30); /* line 248 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 249 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 250 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 251 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 252 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 253 */
   __AND(reg_r0_5, reg_r0_15, (unsigned int) 255); /* line 254 */
   __SHRU(reg_r0_3, reg_r0_15, (unsigned int) 8); /* line 255 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 256 */
} /* line 256 */
  sim_icache_fetch(158 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 258 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 259 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 260 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 261 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 262 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 263 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_10); /* line 264 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_11); /* line 265 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 266 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_20); /* line 267 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 268 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 269 */
} /* line 269 */
  sim_icache_fetch(170 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __SHL(reg_r0_7, reg_r0_17, (unsigned int) 8); /* line 271 */
   __SHL(reg_r0_6, reg_r0_17, (unsigned int) 16); /* line 272 */
   __SHL(reg_r0_9, reg_r0_19, (unsigned int) 8); /* line 273 */
   __SHL(reg_r0_8, reg_r0_19, (unsigned int) 16); /* line 274 */
   __SHL(reg_r0_11, reg_r0_21, (unsigned int) 8); /* line 275 */
   __SHL(reg_r0_10, reg_r0_21, (unsigned int) 16); /* line 276 */
   __SHL(reg_r0_20, reg_r0_23, (unsigned int) 8); /* line 277 */
   __SHL(reg_r0_16, reg_r0_23, (unsigned int) 16); /* line 278 */
   __SHL(reg_r0_26, reg_r0_25, (unsigned int) 8); /* line 279 */
   __SHL(reg_r0_24, reg_r0_25, (unsigned int) 16); /* line 280 */
   __SHL(reg_r0_30, reg_r0_27, (unsigned int) 8); /* line 281 */
   __SHL(reg_r0_28, reg_r0_27, (unsigned int) 16); /* line 282 */
   __ZXTB(reg_r0_29, reg_r0_29); /* line 283 */
   __ZXTB(reg_r0_31, reg_r0_31); /* line 284 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_12); /* line 285 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_14); /* line 286 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 287 */
} /* line 287 */
  sim_icache_fetch(187 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_6); /* line 289 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_8); /* line 290 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_10); /* line 291 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_16); /* line 292 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_24); /* line 293 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_28); /* line 294 */
   __SHL(reg_r0_6, reg_r0_29, (unsigned int) 8); /* line 295 */
   __SHL(reg_r0_3, reg_r0_29, (unsigned int) 16); /* line 296 */
   __SHL(reg_r0_10, reg_r0_31, (unsigned int) 8); /* line 297 */
   __SHL(reg_r0_8, reg_r0_31, (unsigned int) 16); /* line 298 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 299 */
   __ZXTB(reg_r0_22, reg_r0_22); /* line 300 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_15); /* line 301 */
} /* line 301 */
  sim_icache_fetch(200 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_7); /* line 303 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_9); /* line 304 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_11); /* line 305 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_20); /* line 306 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_26); /* line 307 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_30); /* line 308 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_3); /* line 309 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_8); /* line 310 */
   __SHL(reg_r0_7, reg_r0_18, (unsigned int) 8); /* line 311 */
   __SHL(reg_r0_3, reg_r0_18, (unsigned int) 16); /* line 312 */
   __SHL(reg_r0_9, reg_r0_22, (unsigned int) 8); /* line 313 */
   __SHL(reg_r0_8, reg_r0_22, (unsigned int) 16); /* line 314 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 315 */
} /* line 315 */
  sim_icache_fetch(213 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 317 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 318 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 319 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 320 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 321 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 322 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_6); /* line 323 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_10); /* line 324 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_3); /* line 325 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_8); /* line 326 */
   __SHL(reg_r0_6, reg_r0_5, (unsigned int) 8); /* line 327 */
   __SHL(reg_r0_3, reg_r0_5, (unsigned int) 16); /* line 328 */
} /* line 328 */
  sim_icache_fetch(225 + t_thisfile.offset, 5);
{
   ...
   __OR(reg_r0_18, reg_r0_18, reg_r0_7); /* line 332 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_9); /* line 333 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_3); /* line 334 */
} /* line 334 */
  sim_icache_fetch(230 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_18); /* line 336 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_6); /* line 337 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(233 + t_thisfile.offset, 4);
{
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_5); /* line 341 */
