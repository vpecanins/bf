  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   ...
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 129 */
} /* line 129 */
  ...
  sim_icache_fetch(149 + t_thisfile.offset, 4);
{
  ...
  sim_icache_fetch(153 + t_thisfile.offset, 17);
{
  unsigned int t__i32_0;
  ...
  t__i32_1 = reg_r0_4 ;
   ...
   __SHRU(reg_r0_39, reg_r0_20, (unsigned int) 16); /* line 255 */
   ...
   __SHRU(reg_r0_34, t__i32_1, (unsigned int) 16); /* line 259 */
   __AND(reg_r0_4, t__i32_1, (unsigned int) 255); /* line 260 */
   __SHRU(reg_r0_27, t__i32_1, (unsigned int) 8); /* line 261 */
} /* line 261 */
  sim_icache_fetch(170 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   ...
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 277 */
   __MULLU(reg_r0_40, reg_r0_7, reg_r0_4); /* line 278 */
   __MULHS(reg_r0_4, reg_r0_7, reg_r0_4); /* line 279 */
} /* line 279 */
  sim_icache_fetch(187 + t_thisfile.offset, 17);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __ADD(reg_r0_35, reg_r0_35, reg_r0_10); /* line 281 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 282 */
   __MULLU(reg_r0_43, reg_r0_19, reg_r0_32); /* line 283 */
   __MULHS(reg_r0_32, reg_r0_19, reg_r0_32); /* line 284 */
   __MULLU(reg_r0_10, reg_r0_12, reg_r0_25); /* line 285 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_29); /* line 286 */
   __MULHS(reg_r0_29, reg_r0_12, reg_r0_29); /* line 287 */
   __MULLU(reg_r0_41, reg_r0_14, reg_r0_30); /* line 288 */
   __MULHS(reg_r0_30, reg_r0_14, reg_r0_30); /* line 289 */
   __MULLU(reg_r0_44, reg_r0_21, reg_r0_33); /* line 290 */
   __MULHS(reg_r0_33, reg_r0_21, reg_r0_33); /* line 291 */
   __MULLU(reg_r0_42, reg_r0_16, reg_r0_31); /* line 292 */
   __MULHS(reg_r0_31, reg_r0_16, reg_r0_31); /* line 293 */
   __MULLU(reg_r0_45, t__i32_0, reg_r0_34); /* line 294 */
   __MULHS(reg_r0_7, t__i32_0, reg_r0_34); /* line 295 */
   __MULLU(reg_r0_9, t__i32_0, reg_r0_27); /* line 296 */
   __MULHS(reg_r0_27, t__i32_0, reg_r0_27); /* line 297 */
} /* line 297 */
  sim_icache_fetch(204 + t_thisfile.offset, 17);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __CMPLT(reg_b0_1, reg_r0_35, 0); /* line 299 */
   __ADD(reg_r0_46, reg_r0_35, (unsigned int) 255); /* line 300 */
   __CMPLT(reg_b0_2, reg_r0_26, 0); /* line 301 */
   __ADD(reg_r0_4, reg_r0_26, (unsigned int) 255); /* line 302 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 303 */
   __ADD(reg_r0_34, reg_r0_28, (unsigned int) 255); /* line 304 */
   __MULLU(reg_r0_49, reg_r0_19, reg_r0_38); /* line 305 */
   __MULHS(reg_r0_38, reg_r0_19, reg_r0_38); /* line 306 */
   __MULHS(reg_r0_25, reg_r0_12, reg_r0_25); /* line 307 */
   __MULLU(reg_r0_51, reg_r0_12, reg_r0_11); /* line 308 */
   __MULLU(reg_r0_47, reg_r0_14, reg_r0_36); /* line 309 */
   __MULHS(reg_r0_36, reg_r0_14, reg_r0_36); /* line 310 */
   __MULLU(reg_r0_50, reg_r0_21, reg_r0_39); /* line 311 */
   __MULHS(reg_r0_39, reg_r0_21, reg_r0_39); /* line 312 */
   __MULLU(reg_r0_48, reg_r0_16, reg_r0_37); /* line 313 */
   __MULHS(reg_r0_37, reg_r0_16, reg_r0_37); /* line 314 */
   __ADD(reg_r0_40, reg_r0_40, t__i32_0); /* line 315 */
} /* line 315 */
  sim_icache_fetch(221 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __SLCT(reg_r0_46, reg_b0_1, reg_r0_46, reg_r0_35); /* line 317 */
   __SLCT(reg_r0_4, reg_b0_2, reg_r0_4, reg_r0_26); /* line 318 */
   __SLCT(reg_r0_34, reg_b0_0, reg_r0_34, reg_r0_28); /* line 319 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 320 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_32); /* line 321 */
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_11); /* line 322 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 323 */
   __MULLU(reg_r0_11, reg_r0_14, reg_r0_13); /* line 324 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 325 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_30); /* line 326 */
   __ADD(reg_r0_44, reg_r0_44, reg_r0_33); /* line 327 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 328 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_31); /* line 329 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_7); /* line 330 */
   __CMPLT(reg_b0_0, reg_r0_40, 0); /* line 331 */
   __ADD(reg_r0_7, reg_r0_40, (unsigned int) 255); /* line 332 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_27); /* line 333 */
} /* line 333 */
  sim_icache_fetch(238 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __SHR(reg_r0_46, reg_r0_46, (unsigned int) 8); /* line 335 */
   __SHR(reg_r0_34, reg_r0_34, (unsigned int) 8); /* line 336 */
   __CMPLT(reg_b0_5, reg_r0_43, 0); /* line 337 */
   __ADD(reg_r0_29, reg_r0_43, (unsigned int) 255); /* line 338 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_25); /* line 339 */
   __CMPLT(reg_b0_2, reg_r0_24, 0); /* line 340 */
   __ADD(reg_r0_26, reg_r0_24, (unsigned int) 255); /* line 341 */
   __CMPLT(reg_b0_3, reg_r0_41, 0); /* line 342 */
   __ADD(reg_r0_27, reg_r0_41, (unsigned int) 255); /* line 343 */
   __CMPLT(reg_b0_6, reg_r0_44, 0); /* line 344 */
   __ADD(reg_r0_30, reg_r0_44, (unsigned int) 255); /* line 345 */
   __CMPLT(reg_b0_4, reg_r0_42, 0); /* line 346 */
   __ADD(reg_r0_28, reg_r0_42, (unsigned int) 255); /* line 347 */
   __CMPLT(reg_b0_7, reg_r0_45, 0); /* line 348 */
   __ADD(reg_r0_31, reg_r0_45, (unsigned int) 255); /* line 349 */
   __CMPLT(reg_b0_1, reg_r0_9, 0); /* line 350 */
   __ADD(reg_r0_13, reg_r0_9, (unsigned int) 255); /* line 351 */
} /* line 351 */
  sim_icache_fetch(255 + t_thisfile.offset, 17);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_9 ;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 353 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_38); /* line 354 */
   __SLCT(reg_r0_29, reg_b0_5, reg_r0_29, reg_r0_43); /* line 355 */
   __CMPLT(reg_b0_1, reg_r0_10, 0); /* line 356 */
   __ADD(reg_r0_9, reg_r0_10, (unsigned int) 255); /* line 357 */
   __ADD(reg_r0_51, reg_r0_51, reg_r0_12); /* line 358 */
   __SLCT(reg_r0_26, reg_b0_2, reg_r0_26, reg_r0_24); /* line 359 */
   __ADD(reg_r0_47, reg_r0_47, reg_r0_36); /* line 360 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_14); /* line 361 */
   __SLCT(reg_r0_27, reg_b0_3, reg_r0_27, reg_r0_41); /* line 362 */
   __ADD(reg_r0_50, reg_r0_50, reg_r0_39); /* line 363 */
   __SLCT(reg_r0_30, reg_b0_6, reg_r0_30, reg_r0_44); /* line 364 */
   __ADD(reg_r0_48, reg_r0_48, reg_r0_37); /* line 365 */
   __SLCT(reg_r0_28, reg_b0_4, reg_r0_28, reg_r0_42); /* line 366 */
   __SLCT(reg_r0_31, reg_b0_7, reg_r0_31, reg_r0_45); /* line 367 */
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_40); /* line 368 */
   __SLCT(reg_r0_13, t__i32_0, reg_r0_13, t__i32_1); /* line 369 */
} /* line 369 */
  sim_icache_fetch(272 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __CMPLT(reg_b0_2, reg_r0_49, 0); /* line 371 */
   __ADD(reg_r0_14, reg_r0_49, (unsigned int) 255); /* line 372 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 373 */
   __SLCT(reg_r0_9, reg_b0_1, reg_r0_9, reg_r0_10); /* line 374 */
   __SHR(reg_r0_26, reg_r0_26, (unsigned int) 8); /* line 375 */
   __CMPLT(reg_b0_0, reg_r0_47, 0); /* line 376 */
   __ADD(reg_r0_10, reg_r0_47, (unsigned int) 255); /* line 377 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 378 */
   __CMPLT(reg_b0_3, reg_r0_50, 0); /* line 379 */
   __ADD(reg_r0_24, reg_r0_50, (unsigned int) 255); /* line 380 */
   __SHR(reg_r0_30, reg_r0_30, (unsigned int) 8); /* line 381 */
   __CMPLT(reg_b0_1, reg_r0_48, 0); /* line 382 */
   __ADD(reg_r0_12, reg_r0_48, (unsigned int) 255); /* line 383 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 384 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 385 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 386 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 387 */
} /* line 387 */
  sim_icache_fetch(289 + t_thisfile.offset, 17);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __SLCT(reg_r0_14, reg_b0_2, reg_r0_14, reg_r0_49); /* line 389 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 390 */
   __CMPLT(reg_b0_0, reg_r0_51, 0); /* line 391 */
   __ADD(reg_r0_7, reg_r0_51, (unsigned int) 255); /* line 392 */
   __SLCT(reg_r0_10, t__i32_0, reg_r0_10, reg_r0_47); /* line 393 */
   __CMPLT(reg_b0_1, reg_r0_11, 0); /* line 394 */
   __ADD(reg_r0_13, reg_r0_11, (unsigned int) 255); /* line 395 */
   __SLCT(reg_r0_24, reg_b0_3, reg_r0_24, reg_r0_50); /* line 396 */
   __SLCT(reg_r0_12, t__i32_1, reg_r0_12, reg_r0_48); /* line 397 */
   __MULLU(reg_r0_25, reg_r0_16, reg_r0_15); /* line 398 */
   __MULHS(reg_r0_16, reg_r0_16, reg_r0_15); /* line 399 */
   __ADD(reg_r0_34, reg_r0_34, t__i32_2); /* line 400 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_28); /* line 401 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_30); /* line 402 */
   __ADD(reg_r0_26, reg_r0_26, reg_r0_27); /* line 403 */
   __ADD(reg_r0_4, reg_r0_4, t__i32_3); /* line 404 */
   __ADD(reg_r0_46, reg_r0_46, reg_r0_31); /* line 405 */
} /* line 405 */
  sim_icache_fetch(306 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_11 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 407 */
   __MULLU(reg_r0_11, reg_r0_19, reg_r0_18); /* line 408 */
   __MULHS(reg_r0_19, reg_r0_19, reg_r0_18); /* line 409 */
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_51); /* line 410 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 411 */
   __SLCT(reg_r0_13, reg_b0_1, reg_r0_13, t__i32_0); /* line 412 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 413 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 414 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 415 */
   __ADD(reg_r0_34, reg_r0_34, reg_r0_26); /* line 416 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_29); /* line 417 */
} /* line 417 */
  sim_icache_fetch(317 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   ...
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 420 */
   __MULLU(reg_r0_10, reg_r0_21, reg_r0_20); /* line 421 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_20); /* line 422 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_16); /* line 423 */
   __ADD(reg_r0_17, reg_r0_34, reg_r0_17); /* line 424 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_12); /* line 425 */
   __ADD(reg_r0_14, reg_r0_14, reg_r0_24); /* line 426 */
   __ADD(reg_r0_9, reg_r0_9, t__i32_0); /* line 427 */
} /* line 427 */
  sim_icache_fetch(326 + t_thisfile.offset, 6);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __ADD(reg_r0_11, reg_r0_11, reg_r0_19); /* line 429 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 430 */
   __ADD(reg_r0_9, reg_r0_25, (unsigned int) 255); /* line 431 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_13); /* line 432 */
   __ADD(reg_r0_46, reg_r0_46, t__i32_0); /* line 433 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_14); /* line 434 */
} /* line 434 */
  sim_icache_fetch(332 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_11, 0); /* line 436 */
   __ADD(reg_r0_7, reg_r0_11, (unsigned int) 255); /* line 437 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_21); /* line 438 */
   __SLCT(reg_r0_9, t__i32_0, reg_r0_9, reg_r0_25); /* line 439 */
   __ADD(reg_r0_4, reg_r0_4, t__i32_1); /* line 440 */
   __ADD(reg_r0_22, reg_r0_46, reg_r0_22); /* line 441 */
} /* line 441 */
  sim_icache_fetch(338 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_11); /* line 443 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 444 */
   __ADD(reg_r0_11, reg_r0_10, (unsigned int) 255); /* line 445 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 446 */
} /* line 446 */
  sim_icache_fetch(342 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 448 */
   __SLCT(reg_r0_11, reg_b0_0, reg_r0_11, reg_r0_10); /* line 449 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_9); /* line 450 */
} /* line 450 */
  sim_icache_fetch(345 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 452 */
} /* line 452 */
  sim_icache_fetch(346 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_7, reg_r0_7, reg_r0_11); /* line 454 */
} /* line 454 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_23, reg_r0_23, reg_r0_7); /* line 456 */
} /* line 456 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_4, reg_r0_23); /* line 458 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_23, reg_r0_23, 0); /* line 463 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 464 */
   __MAX(reg_r0_22, reg_r0_22, 0); /* line 465 */
   __SH2ADD(reg_r0_2, reg_r0_52, reg_r0_54); /* line 466 */
   __ADD(reg_r0_4, reg_r0_52, (unsigned int) 1); /* line 467 */
} /* line 467 */
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 469 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 470 */
   __MIN(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 471 */
   __ADD(reg_r0_7, reg_r0_53, (unsigned int) 1); /* line 472 */
} /* line 472 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_17, reg_r0_17, (unsigned int) 8); /* line 474 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 16); /* line 475 */
} /* line 475 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_22); /* line 477 */
} /* line 477 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_17); /* line 479 */
} /* line 479 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_23); /* line 481 */
  ...
  sim_icache_fetch(365 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_54, reg_r0_54, (unsigned int) 256); /* line 486 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 64); /* line 487 */
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 1); /* line 488 */
  ...
  sim_icache_fetch(370 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_55); /* line 495 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 496 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(375 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 498 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 499 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 500 */
   __ADD_CYCLES(1);
} /* line 500 */
