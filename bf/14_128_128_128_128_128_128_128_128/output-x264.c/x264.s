...
;;								## 1
.call x264_13982.x264_pixel_sad_16x16, caller, arg($r0.3:u32,$r0.4:s32,$r0.5:u32,$r0.6:s32), ret($r0.3:s32)
	c0    call $l0.0 = x264_13982.x264_pixel_sad_16x16   ## bblock 0, line 26,  raddr(x264_13982.x264_pixel_sad_16x16)(P32),  t42,  16(SI32),  t2,  t47
...
;;								## 5
.call x264_13982.x264_pixel_sad_16x16, caller, arg($r0.3:u32,$r0.4:s32,$r0.5:u32,$r0.6:s32), ret($r0.3:s32)
	c0    call $l0.0 = x264_13982.x264_pixel_sad_16x16   ## bblock 1, line 27,  raddr(x264_13982.x264_pixel_sad_16x16)(P32),  t42,  16(SI32),  t44,  t47
;;								## 6
	c0    mov $r0.4 = 16   ## 16(SI32)
...
;;								## 9
.call x264_13982.x264_pixel_sad_16x16, caller, arg($r0.3:u32,$r0.4:s32,$r0.5:u32,$r0.6:s32), ret($r0.3:s32)
	c0    call $l0.0 = x264_13982.x264_pixel_sad_16x16   ## bblock 2, line 28,  raddr(x264_13982.x264_pixel_sad_16x16)(P32),  t42,  16(SI32),  t45,  t47
;;								## 10
	c0    mov $r0.4 = 16   ## 16(SI32)
...
;;								## 13
.call x264_13982.x264_pixel_sad_16x16, caller, arg($r0.3:u32,$r0.4:s32,$r0.5:u32,$r0.6:s32), ret($r0.3:s32)
	c0    call $l0.0 = x264_13982.x264_pixel_sad_16x16   ## bblock 3, line 29,  raddr(x264_13982.x264_pixel_sad_16x16)(P32),  t42,  16(SI32),  t46,  t47
;;								## 14
...
.equ ?2.2?2auto_size, 0x40
 ## End x264_13982.x264_pixel_sad_x4_16x16
 ## Begin NOP
.section .text
.proc
...
;;								## 3
.call x264_13982.x264_pixel_sad_x4_16x16, caller, arg($r0.3:u32,$r0.4:u32,$r0.5:u32,$r0.6:u32,$r0.7:u32,$r0.8:s32,$r0.9:u32), ret()
	c0    call $l0.0 = x264_13982.x264_pixel_sad_x4_16x16   ## bblock 1, line 86,  raddr(x264_13982.x264_pixel_sad_x4_16x16)(P32),  addr(fenc1?1.0)(P32),  addr(pix0?1.0)(P32),  addr(pix1?1.0)(P32),  addr(pix2?1.0)(P32),  addr(pix3?1.0)(P32),  16(SI32),  t0
;;								## 4
...
;;								## 0
.call x264_13982.x264_pixel_sad_x4_16x16, caller, arg($r0.3:u32,$r0.4:u32,$r0.5:u32,$r0.6:u32,$r0.7:u32,$r0.8:s32,$r0.9:u32), ret()
	c0    call $l0.0 = x264_13982.x264_pixel_sad_x4_16x16   ## bblock 24, line 94,  raddr(x264_13982.x264_pixel_sad_x4_16x16)(P32),  addr(fenc2?1.0)(P32),  addr(pix4?1.0)(P32),  addr(pix5?1.0)(P32),  addr(pix6?1.0)(P32),  addr(pix7?1.0)(P32),  16(SI32),  t1
;;								## 1
...
.import NOP
.type NOP,@function
.import x264_13982.x264_pixel_sad_x4_16x16
.type x264_13982.x264_pixel_sad_x4_16x16,@function
.import x264_13982.x264_pixel_sad_16x16
.type x264_13982.x264_pixel_sad_16x16,@function
.import puts
.type puts,@function
.import abs
.type abs,@function
