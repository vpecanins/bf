  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
  ...
  sim_icache_fetch(105 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 203 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 204 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 205 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 206 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 207 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 208 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 209 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 210 */
   ...
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 215 */
   __SHRU(reg_r0_28, reg_r0_10, (unsigned int) 8); /* line 216 */
} /* line 216 */
  sim_icache_fetch(119 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 218 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 219 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 220 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 221 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 222 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 223 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 224 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 225 */
   __AND(reg_r0_16, reg_r0_10, (unsigned int) 255); /* line 226 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 227 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 228 */
   __AND(reg_r0_20, reg_r0_11, (unsigned int) 255); /* line 229 */
   __SHRU(reg_r0_18, reg_r0_11, (unsigned int) 8); /* line 230 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 231 */
} /* line 231 */
  sim_icache_fetch(133 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 233 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 234 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 235 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 236 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 237 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 238 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_28); /* line 239 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 240 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 241 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 242 */
   __AND(reg_r0_5, reg_r0_12, (unsigned int) 255); /* line 243 */
   __SHRU(reg_r0_3, reg_r0_12, (unsigned int) 8); /* line 244 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 245 */
   __SHRU(reg_r0_6, reg_r0_14, (unsigned int) 8); /* line 246 */
} /* line 246 */
  sim_icache_fetch(147 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 248 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 249 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 250 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 251 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 252 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 253 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_10); /* line 254 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_18); /* line 255 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 256 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 257 */
   __AND(reg_r0_7, reg_r0_14, (unsigned int) 255); /* line 258 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 259 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 260 */
   __SHRU(reg_r0_8, reg_r0_15, (unsigned int) 8); /* line 261 */
} /* line 261 */
  sim_icache_fetch(161 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __SHL(reg_r0_10, reg_r0_17, (unsigned int) 8); /* line 263 */
   __SHL(reg_r0_9, reg_r0_17, (unsigned int) 16); /* line 264 */
   __SHL(reg_r0_22, reg_r0_19, (unsigned int) 8); /* line 265 */
   __SHL(reg_r0_18, reg_r0_19, (unsigned int) 16); /* line 266 */
   __SHL(reg_r0_26, reg_r0_21, (unsigned int) 8); /* line 267 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 16); /* line 268 */
   __SHL(reg_r0_29, reg_r0_23, (unsigned int) 8); /* line 269 */
   __SHL(reg_r0_28, reg_r0_23, (unsigned int) 16); /* line 270 */
   __SHL(reg_r0_31, reg_r0_25, (unsigned int) 8); /* line 271 */
   __SHL(reg_r0_30, reg_r0_25, (unsigned int) 16); /* line 272 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 273 */
   __ZXTB(reg_r0_16, reg_r0_16); /* line 274 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_11); /* line 275 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 276 */
} /* line 276 */
  sim_icache_fetch(175 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __OR(reg_r0_17, reg_r0_17, reg_r0_9); /* line 278 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_18); /* line 279 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 280 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_28); /* line 281 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_30); /* line 282 */
   __SHL(reg_r0_9, reg_r0_27, (unsigned int) 8); /* line 283 */
   __SHL(reg_r0_3, reg_r0_27, (unsigned int) 16); /* line 284 */
   __SHL(reg_r0_18, reg_r0_16, (unsigned int) 8); /* line 285 */
   __SHL(reg_r0_11, reg_r0_16, (unsigned int) 16); /* line 286 */
   __ZXTB(reg_r0_20, reg_r0_20); /* line 287 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_12); /* line 288 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_6); /* line 289 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 290 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 291 */
} /* line 291 */
  sim_icache_fetch(189 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_10); /* line 293 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_22); /* line 294 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_26); /* line 295 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_29); /* line 296 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_31); /* line 297 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_3); /* line 298 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_11); /* line 299 */
   __SHL(reg_r0_6, reg_r0_20, (unsigned int) 8); /* line 300 */
   __SHL(reg_r0_3, reg_r0_20, (unsigned int) 16); /* line 301 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 302 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_14); /* line 303 */
   __AND(reg_r0_10, reg_r0_15, (unsigned int) 255); /* line 304 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 305 */
} /* line 305 */
  sim_icache_fetch(202 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 307 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 308 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 309 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 310 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 311 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_9); /* line 312 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_18); /* line 313 */
   __OR(reg_r0_20, reg_r0_20, reg_r0_3); /* line 314 */
   __SHL(reg_r0_9, reg_r0_5, (unsigned int) 8); /* line 315 */
   __SHL(reg_r0_3, reg_r0_5, (unsigned int) 16); /* line 316 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 317 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_8); /* line 318 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 319 */
} /* line 319 */
  sim_icache_fetch(215 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 321 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_16); /* line 322 */
   __OR(reg_r0_20, reg_r0_20, reg_r0_6); /* line 323 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_3); /* line 324 */
   __SHL(reg_r0_6, reg_r0_7, (unsigned int) 8); /* line 325 */
   __SHL(reg_r0_3, reg_r0_7, (unsigned int) 16); /* line 326 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_15); /* line 327 */
} /* line 327 */
  sim_icache_fetch(222 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_20); /* line 329 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_9); /* line 330 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_3); /* line 331 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 332 */
} /* line 332 */
  sim_icache_fetch(226 + t_thisfile.offset, 5);
{
   ...
   __OR(reg_r0_7, reg_r0_7, reg_r0_6); /* line 335 */
   __SHL(reg_r0_6, reg_r0_10, (unsigned int) 8); /* line 336 */
   __SHL(reg_r0_3, reg_r0_10, (unsigned int) 16); /* line 337 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(231 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_7); /* line 340 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_3); /* line 341 */
} /* line 341 */
  sim_icache_fetch(233 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_10, reg_r0_10, reg_r0_6); /* line 343 */
} /* line 343 */
  sim_icache_fetch(234 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_10); /* line 345 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 346 */
  ...
  sim_icache_fetch(237 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_34, (unsigned int) 256); /* line 351 */
   __ADD(reg_r0_5, reg_r0_33, (unsigned int) 256); /* line 352 */
   __ADD(reg_r0_3, reg_r0_32, (unsigned int) 1); /* line 353 */
  ...
  sim_icache_fetch(243 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_35); /* line 360 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 361 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(248 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 363 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 364 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 365 */
   __ADD_CYCLES(1);
} /* line 365 */
