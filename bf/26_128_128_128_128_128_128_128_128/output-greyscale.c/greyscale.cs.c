  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 26);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(26);
  ...
  sim_icache_fetch(117 + t_thisfile.offset, 24);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(24);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 214 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 215 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 216 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 217 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 218 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 219 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 220 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 221 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 222 */
   ...
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 226 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 227 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 228 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 229 */
