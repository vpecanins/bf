  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 158 */
   __MOV(reg_r0_5, (unsigned int) grey_framebuffer); /* line 159 */
   __MOV(reg_r0_6, (unsigned int) grey_image); /* line 160 */
   __MOV(reg_r0_23, t__i32_0); /* line 161 */
} /* line 161 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 166 */
   __MOV(reg_r0_8, (unsigned int) -55); /* line 167 */
   __MOV(reg_r0_4, reg_r0_5); /* line 168 */
   __MOV(reg_r0_2, reg_r0_6); /* line 169 */
} /* line 169 */
  sim_icache_fetch(72 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_20, reg_r0_3); /* line 171 */
   __MOV(reg_r0_21, reg_r0_5); /* line 172 */
   __MOV(reg_r0_22, reg_r0_6); /* line 173 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L5X3; 
  ...
  sim_icache_fetch(76 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __LDW(reg_r0_5, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 178 */
   __LDW(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 179 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 180 */
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 181 */
} /* line 181 */
  sim_icache_fetch(80 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __LDW(reg_r0_9, mem_trace_ld((reg_r0_2 + (unsigned int) 16),0,4)); /* line 183 */
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 20),0,4)); /* line 184 */
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 24),0,4)); /* line 185 */
   __LDW(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 186 */
} /* line 186 */
  sim_icache_fetch(84 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __AND(reg_r0_14, reg_r0_3, (unsigned int) 255); /* line 188 */
   __SHRU(reg_r0_13, reg_r0_3, (unsigned int) 8); /* line 189 */
   __SHRU(reg_r0_15, reg_r0_5, (unsigned int) 8); /* line 190 */
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 191 */
} /* line 191 */
  sim_icache_fetch(88 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __AND(reg_r0_16, reg_r0_5, (unsigned int) 255); /* line 193 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 194 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 195 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 196 */
} /* line 196 */
  sim_icache_fetch(92 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MAX(reg_r0_14, reg_r0_14, reg_r0_13); /* line 198 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_15); /* line 199 */
   __SHRU(reg_r0_13, reg_r0_6, (unsigned int) 8); /* line 200 */
   __SHRU(reg_r0_5, reg_r0_5, (unsigned int) 16); /* line 201 */
} /* line 201 */
  sim_icache_fetch(96 + t_thisfile.offset, 4);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_3 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __AND(reg_r0_3, reg_r0_6, (unsigned int) 255); /* line 203 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 204 */
   __MAX(reg_r0_14, reg_r0_14, t__i32_0); /* line 205 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 206 */
} /* line 206 */
  sim_icache_fetch(100 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MAX(reg_r0_3, reg_r0_3, reg_r0_13); /* line 208 */
   __ZXTB(reg_r0_14, reg_r0_14); /* line 209 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_5); /* line 210 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 211 */
} /* line 211 */
  sim_icache_fetch(104 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHL(reg_r0_13, reg_r0_14, (unsigned int) 8); /* line 213 */
   __SHL(reg_r0_5, reg_r0_14, (unsigned int) 16); /* line 214 */
   __ZXTB(reg_r0_16, reg_r0_16); /* line 215 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 216 */
} /* line 216 */
  sim_icache_fetch(108 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_14, reg_r0_14, reg_r0_5); /* line 218 */
   __SHL(reg_r0_15, reg_r0_16, (unsigned int) 8); /* line 219 */
   __SHL(reg_r0_5, reg_r0_16, (unsigned int) 16); /* line 220 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_6); /* line 221 */
} /* line 221 */
  sim_icache_fetch(112 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_14, reg_r0_14, reg_r0_13); /* line 223 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_5); /* line 224 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 225 */
   __SHRU(reg_r0_5, reg_r0_7, (unsigned int) 8); /* line 226 */
} /* line 226 */
  sim_icache_fetch(116 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_16, reg_r0_16, reg_r0_15); /* line 228 */
   __SHL(reg_r0_13, reg_r0_3, (unsigned int) 8); /* line 229 */
   __SHL(reg_r0_6, reg_r0_3, (unsigned int) 16); /* line 230 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 231 */
} /* line 231 */
  sim_icache_fetch(120 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_3, reg_r0_3, reg_r0_6); /* line 233 */
   __AND(reg_r0_6, reg_r0_7, (unsigned int) 255); /* line 234 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 235 */
   __SHRU(reg_r0_15, reg_r0_9, (unsigned int) 8); /* line 236 */
} /* line 236 */
  sim_icache_fetch(124 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_3, reg_r0_3, reg_r0_13); /* line 238 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_5); /* line 239 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 240 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 241 */
} /* line 241 */
  sim_icache_fetch(128 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MAX(reg_r0_6, reg_r0_6, reg_r0_7); /* line 243 */
   __AND(reg_r0_5, reg_r0_9, (unsigned int) 255); /* line 244 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 245 */
   __SHRU(reg_r0_7, reg_r0_10, (unsigned int) 8); /* line 246 */
} /* line 246 */
  sim_icache_fetch(132 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ZXTB(reg_r0_6, reg_r0_6); /* line 248 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_15); /* line 249 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 250 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 251 */
} /* line 251 */
  sim_icache_fetch(136 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHL(reg_r0_15, reg_r0_6, (unsigned int) 8); /* line 253 */
   __SHL(reg_r0_13, reg_r0_6, (unsigned int) 16); /* line 254 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_9); /* line 255 */
   __AND(reg_r0_9, reg_r0_10, (unsigned int) 255); /* line 256 */
} /* line 256 */
  sim_icache_fetch(140 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_6, reg_r0_6, reg_r0_13); /* line 258 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 259 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_7); /* line 260 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 261 */
} /* line 261 */
  sim_icache_fetch(144 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_6, reg_r0_6, reg_r0_15); /* line 263 */
   __SHL(reg_r0_13, reg_r0_5, (unsigned int) 8); /* line 264 */
   __SHL(reg_r0_7, reg_r0_5, (unsigned int) 16); /* line 265 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 266 */
} /* line 266 */
  sim_icache_fetch(148 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_5, reg_r0_5, reg_r0_7); /* line 268 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_10); /* line 269 */
   __AND(reg_r0_10, reg_r0_11, (unsigned int) 255); /* line 270 */
   __SHRU(reg_r0_7, reg_r0_11, (unsigned int) 8); /* line 271 */
} /* line 271 */
  sim_icache_fetch(152 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_5, reg_r0_5, reg_r0_13); /* line 273 */
   __ZXTB(reg_r0_9, reg_r0_9); /* line 274 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 275 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 276 */
} /* line 276 */
  sim_icache_fetch(156 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHL(reg_r0_15, reg_r0_9, (unsigned int) 8); /* line 278 */
   __SHL(reg_r0_13, reg_r0_9, (unsigned int) 16); /* line 279 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_7); /* line 280 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 281 */
} /* line 281 */
  sim_icache_fetch(160 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_9, reg_r0_9, reg_r0_13); /* line 283 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_11); /* line 284 */
   __AND(reg_r0_11, reg_r0_12, (unsigned int) 255); /* line 285 */
   __SHRU(reg_r0_7, reg_r0_12, (unsigned int) 8); /* line 286 */
} /* line 286 */
  sim_icache_fetch(164 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_9, reg_r0_9, reg_r0_15); /* line 288 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 289 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 290 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 291 */
} /* line 291 */
  sim_icache_fetch(168 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHL(reg_r0_15, reg_r0_10, (unsigned int) 8); /* line 293 */
   __SHL(reg_r0_13, reg_r0_10, (unsigned int) 16); /* line 294 */
   __MAX(reg_r0_11, reg_r0_11, reg_r0_7); /* line 295 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 296 */
} /* line 296 */
  sim_icache_fetch(172 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_10, reg_r0_10, reg_r0_13); /* line 298 */
   __MAX(reg_r0_11, reg_r0_11, reg_r0_12); /* line 299 */
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 300 */
   __CMPLT(reg_b0_0, reg_r0_8, 0); /* line 301 */
} /* line 301 */
  sim_icache_fetch(176 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_10, reg_r0_10, reg_r0_15); /* line 303 */
   __ZXTB(reg_r0_11, reg_r0_11); /* line 304 */
   __LDWs(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 36),0,4)); /* line 305 */
   __LDWs(reg_r0_13, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 306 */
} /* line 306 */
  sim_icache_fetch(180 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHL(reg_r0_17, reg_r0_11, (unsigned int) 8); /* line 308 */
   __SHL(reg_r0_15, reg_r0_11, (unsigned int) 16); /* line 309 */
   __AND(reg_r0_19, reg_r0_7, (unsigned int) 255); /* line 310 */
   __SHRU(reg_r0_18, reg_r0_7, (unsigned int) 8); /* line 311 */
} /* line 311 */
  sim_icache_fetch(184 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_11, reg_r0_11, reg_r0_15); /* line 313 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 314 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 315 */
   __SHRU(reg_r0_15, reg_r0_12, (unsigned int) 8); /* line 316 */
} /* line 316 */
  sim_icache_fetch(188 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_11, reg_r0_11, reg_r0_17); /* line 318 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 319 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 320 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 321 */
} /* line 321 */
  sim_icache_fetch(192 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MAX(reg_r0_19, reg_r0_19, reg_r0_7); /* line 323 */
   __AND(reg_r0_7, reg_r0_12, (unsigned int) 255); /* line 324 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 325 */
   __SHRU(reg_r0_17, reg_r0_13, (unsigned int) 8); /* line 326 */
} /* line 326 */
  sim_icache_fetch(196 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ZXTB(reg_r0_19, reg_r0_19); /* line 328 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_15); /* line 329 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 330 */
   __AND(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 331 */
} /* line 331 */
  sim_icache_fetch(200 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHL(reg_r0_18, reg_r0_19, (unsigned int) 8); /* line 333 */
   __SHL(reg_r0_15, reg_r0_19, (unsigned int) 16); /* line 334 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_12); /* line 335 */
   __AND(reg_r0_12, reg_r0_13, (unsigned int) 255); /* line 336 */
} /* line 336 */
  sim_icache_fetch(204 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_19, reg_r0_19, reg_r0_15); /* line 338 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 339 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_17); /* line 340 */
   __SHRU(reg_r0_13, reg_r0_13, (unsigned int) 16); /* line 341 */
} /* line 341 */
  sim_icache_fetch(208 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_19, reg_r0_19, reg_r0_18); /* line 343 */
   __SHL(reg_r0_17, reg_r0_7, (unsigned int) 8); /* line 344 */
   __SHL(reg_r0_15, reg_r0_7, (unsigned int) 16); /* line 345 */
  ...
  sim_icache_fetch(212 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_7, reg_r0_7, reg_r0_15); /* line 348 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_13); /* line 349 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 350 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 11); /* line 351 */
} /* line 351 */
  sim_icache_fetch(216 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_14); /* line 353 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_16); /* line 354 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_17); /* line 355 */
   __ZXTB(reg_r0_12, reg_r0_12); /* line 356 */
} /* line 356 */
  sim_icache_fetch(220 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_3); /* line 358 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_6); /* line 359 */
   __SHL(reg_r0_14, reg_r0_12, (unsigned int) 8); /* line 360 */
   __SHL(reg_r0_13, reg_r0_12, (unsigned int) 16); /* line 361 */
} /* line 361 */
  sim_icache_fetch(224 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_5); /* line 363 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_9); /* line 364 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_10); /* line 365 */
   __OR(reg_r0_12, reg_r0_12, reg_r0_13); /* line 366 */
} /* line 366 */
  sim_icache_fetch(228 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_11); /* line 368 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_19); /* line 369 */
   __OR(reg_r0_12, reg_r0_12, reg_r0_14); /* line 370 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(232 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_7); /* line 373 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_12); /* line 374 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 375 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_22, (unsigned int) 256); /* line 380 */
   __ADD(reg_r0_5, reg_r0_21, (unsigned int) 256); /* line 381 */
   __ADD(reg_r0_3, reg_r0_20, (unsigned int) 1); /* line 382 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_23); /* line 389 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 390 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 392 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 393 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 394 */
   __ADD_CYCLES(1);
} /* line 394 */
