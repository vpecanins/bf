  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   ...
   __MOV(reg_r0_32, t__i32_0); /* line 155 */
} /* line 155 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   ...
   __MOV(reg_r0_29, reg_r0_3); /* line 164 */
   __MOV(reg_r0_30, reg_r0_5); /* line 165 */
   __MOV(reg_r0_31, reg_r0_6); /* line 166 */
} /* line 166 */
...
l_L6X3: ;/* line 171 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
  ...
  sim_icache_fetch(88 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 185 */
   __ADD(reg_r0_13, reg_r0_13, (unsigned int) 11); /* line 186 */
} /* line 186 */
  sim_icache_fetch(90 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
  ...
  sim_icache_fetch(102 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 201 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 202 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 203 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 204 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 205 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 206 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 207 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 208 */
   __AND(reg_r0_25, reg_r0_8, (unsigned int) 255); /* line 209 */
   __SHRU(reg_r0_24, reg_r0_8, (unsigned int) 8); /* line 210 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 211 */
   __SHRU(reg_r0_26, reg_r0_9, (unsigned int) 8); /* line 212 */
} /* line 212 */
  sim_icache_fetch(114 + t_thisfile.offset, 12);
{
   ...
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 218 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 219 */
   __AND(reg_r0_16, reg_r0_9, (unsigned int) 255); /* line 220 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 221 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 222 */
   __AND(reg_r0_20, reg_r0_10, (unsigned int) 255); /* line 223 */
   __SHRU(reg_r0_18, reg_r0_10, (unsigned int) 8); /* line 224 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 225 */
} /* line 225 */
  sim_icache_fetch(126 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 227 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 228 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 229 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 230 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 231 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_26); /* line 232 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 233 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 234 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 235 */
   __AND(reg_r0_5, reg_r0_11, (unsigned int) 255); /* line 236 */
   __SHRU(reg_r0_3, reg_r0_11, (unsigned int) 8); /* line 237 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 238 */
} /* line 238 */
  sim_icache_fetch(138 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 240 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 241 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 242 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 243 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 244 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_9); /* line 245 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_18); /* line 246 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 247 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 248 */
   __AND(reg_r0_7, reg_r0_12, (unsigned int) 255); /* line 249 */
   __SHRU(reg_r0_6, reg_r0_12, (unsigned int) 8); /* line 250 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 251 */
} /* line 251 */
  sim_icache_fetch(150 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __SHL(reg_r0_9, reg_r0_17, (unsigned int) 8); /* line 253 */
   __SHL(reg_r0_8, reg_r0_17, (unsigned int) 16); /* line 254 */
   __SHL(reg_r0_22, reg_r0_19, (unsigned int) 8); /* line 255 */
   __SHL(reg_r0_18, reg_r0_19, (unsigned int) 16); /* line 256 */
   __SHL(reg_r0_26, reg_r0_21, (unsigned int) 8); /* line 257 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 16); /* line 258 */
   __SHL(reg_r0_28, reg_r0_23, (unsigned int) 8); /* line 259 */
   __SHL(reg_r0_27, reg_r0_23, (unsigned int) 16); /* line 260 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 261 */
   __ZXTB(reg_r0_16, reg_r0_16); /* line 262 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_10); /* line 263 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 264 */
} /* line 264 */
  sim_icache_fetch(162 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __OR(reg_r0_17, reg_r0_17, reg_r0_8); /* line 266 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_18); /* line 267 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 268 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_27); /* line 269 */
   __SHL(reg_r0_8, reg_r0_25, (unsigned int) 8); /* line 270 */
   __SHL(reg_r0_3, reg_r0_25, (unsigned int) 16); /* line 271 */
   __SHL(reg_r0_18, reg_r0_16, (unsigned int) 8); /* line 272 */
   __SHL(reg_r0_10, reg_r0_16, (unsigned int) 16); /* line 273 */
   __ZXTB(reg_r0_20, reg_r0_20); /* line 274 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_11); /* line 275 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 276 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 277 */
} /* line 277 */
  sim_icache_fetch(174 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __OR(reg_r0_17, reg_r0_17, reg_r0_9); /* line 279 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_22); /* line 280 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_26); /* line 281 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_28); /* line 282 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_3); /* line 283 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_10); /* line 284 */
   __SHL(reg_r0_9, reg_r0_20, (unsigned int) 8); /* line 285 */
   __SHL(reg_r0_3, reg_r0_20, (unsigned int) 16); /* line 286 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 287 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_6); /* line 288 */
   __AND(reg_r0_10, reg_r0_14, (unsigned int) 255); /* line 289 */
   __SHRU(reg_r0_6, reg_r0_14, (unsigned int) 8); /* line 290 */
} /* line 290 */
  sim_icache_fetch(186 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 292 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_8); /* line 293 */
   __OR(reg_r0_16, reg_r0_16, reg_r0_18); /* line 294 */
   __OR(reg_r0_20, reg_r0_20, reg_r0_3); /* line 295 */
   __SHL(reg_r0_8, reg_r0_5, (unsigned int) 8); /* line 296 */
   __SHL(reg_r0_3, reg_r0_5, (unsigned int) 16); /* line 297 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_12); /* line 298 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 299 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 300 */
   __AND(reg_r0_12, reg_r0_15, (unsigned int) 255); /* line 301 */
   __SHRU(reg_r0_11, reg_r0_15, (unsigned int) 8); /* line 302 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 303 */
} /* line 303 */
  sim_icache_fetch(198 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 305 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 306 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 307 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 308 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_16); /* line 309 */
   __OR(reg_r0_20, reg_r0_20, reg_r0_9); /* line 310 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_3); /* line 311 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 312 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_6); /* line 313 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 314 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 315 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 316 */
} /* line 316 */
  sim_icache_fetch(210 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_20); /* line 318 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_8); /* line 319 */
   __SHL(reg_r0_6, reg_r0_7, (unsigned int) 8); /* line 320 */
   __SHL(reg_r0_3, reg_r0_7, (unsigned int) 16); /* line 321 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_14); /* line 322 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_11); /* line 323 */
} /* line 323 */
  sim_icache_fetch(216 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_5); /* line 325 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_3); /* line 326 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 327 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_15); /* line 328 */
} /* line 328 */
  sim_icache_fetch(220 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_7, reg_r0_7, reg_r0_6); /* line 330 */
   __SHL(reg_r0_5, reg_r0_10, (unsigned int) 8); /* line 331 */
   __SHL(reg_r0_3, reg_r0_10, (unsigned int) 16); /* line 332 */
   __ZXTB(reg_r0_12, reg_r0_12); /* line 333 */
} /* line 333 */
  sim_icache_fetch(224 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_7); /* line 335 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_3); /* line 336 */
   __SHL(reg_r0_6, reg_r0_12, (unsigned int) 8); /* line 337 */
   __SHL(reg_r0_3, reg_r0_12, (unsigned int) 16); /* line 338 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(229 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_10, reg_r0_10, reg_r0_5); /* line 341 */
   __OR(reg_r0_12, reg_r0_12, reg_r0_3); /* line 342 */
} /* line 342 */
  sim_icache_fetch(231 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_10); /* line 344 */
   __OR(reg_r0_12, reg_r0_12, reg_r0_6); /* line 345 */
} /* line 345 */
  sim_icache_fetch(233 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_12); /* line 347 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 348 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_31, (unsigned int) 256); /* line 353 */
   __ADD(reg_r0_5, reg_r0_30, (unsigned int) 256); /* line 354 */
   __ADD(reg_r0_3, reg_r0_29, (unsigned int) 1); /* line 355 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_32); /* line 362 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 363 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 365 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 366 */
