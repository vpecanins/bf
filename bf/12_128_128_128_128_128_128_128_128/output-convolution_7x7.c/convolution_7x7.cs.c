  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
  ...
  sim_icache_fetch(39 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   ...
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 137 */
} /* line 137 */
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   ...
   __MOV(reg_r0_49, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 154 */
   __MOV(reg_r0_50, reg_r0_5); /* line 155 */
} /* line 155 */
l_L4X3: ;/* line 158 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_19, 0); /* line 171 */
   __MOV(reg_r0_17, 0); /* line 172 */
   __MOV(reg_r0_20, 0); /* line 173 */
   __MOV(reg_r0_47, reg_r0_4); /* line 174 */
   __MOV(reg_r0_48, reg_r0_7); /* line 175 */
} /* line 175 */
...
l_L8X3: ;/* line 180 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   ...
   __SH2ADD(reg_r0_16, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 190 */
   __ADD(reg_r0_4, reg_r0_3, (unsigned int) 6); /* line 191 */
   __SH2ADD(reg_r0_7, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 24)); /* line 192 */
} /* line 192 */
  sim_icache_fetch(97 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __LDWs(reg_r0_10, mem_trace_ld(reg_r0_10,0,4)); /* line 194 */
   __SH2ADD(reg_r0_9, reg_r0_9, (unsigned int) conv7_image); /* line 195 */
   __SHL(reg_r0_18, reg_r0_18, (unsigned int) 6); /* line 196 */
  ...
  sim_icache_fetch(110 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 207 */
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 208 */
   __ADD(reg_r0_18, reg_r0_5, reg_r0_18); /* line 209 */
  ...
  sim_icache_fetch(123 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __LDW(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 219 */
   __SH2ADD(reg_r0_18, reg_r0_18, (unsigned int) conv7_image); /* line 220 */
  ...
  sim_icache_fetch(136 + t_thisfile.offset, 10);
{
  ...
  t__i32_0 = reg_r0_9 ;
   ...
   __LDW(reg_r0_18, mem_trace_ld(reg_r0_18,0,4)); /* line 231 */
  ...
  sim_icache_fetch(146 + t_thisfile.offset, 6);
{
   ...
   __SH2ADD(reg_r0_22, reg_r0_22, (unsigned int) conv7_image); /* line 243 */
} /* line 243 */
  sim_icache_fetch(152 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __MULLU(reg_r0_34, t__i32_0, reg_r0_25); /* line 245 */
   ...
   __SHRU(reg_r0_32, reg_r0_18, (unsigned int) 8); /* line 249 */
   __SHRU(reg_r0_25, reg_r0_11, (unsigned int) 16); /* line 250 */
   ...
   __SHRU(reg_r0_33, reg_r0_4, (unsigned int) 16); /* line 255 */
   __SHRU(reg_r0_27, reg_r0_4, (unsigned int) 8); /* line 256 */
} /* line 256 */
  sim_icache_fetch(164 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 258 */
   __SHRU(reg_r0_37, reg_r0_18, (unsigned int) 16); /* line 259 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 260 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 261 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 262 */
   __SHRU(reg_r0_35, reg_r0_13, (unsigned int) 16); /* line 263 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 264 */
   __SHRU(reg_r0_36, reg_r0_15, (unsigned int) 16); /* line 265 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 266 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 267 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 268 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 269 */
} /* line 269 */
  sim_icache_fetch(176 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 271 */
   __MULLU(reg_r0_40, reg_r0_21, reg_r0_32); /* line 272 */
   __MULHS(reg_r0_32, reg_r0_21, reg_r0_32); /* line 273 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_29); /* line 274 */
   __MULHS(reg_r0_29, reg_r0_12, reg_r0_29); /* line 275 */
   __MULLU(reg_r0_38, reg_r0_14, reg_r0_30); /* line 276 */
   __MULHS(reg_r0_30, reg_r0_14, reg_r0_30); /* line 277 */
   __SHRU(reg_r0_41, reg_r0_22, (unsigned int) 8); /* line 278 */
   __MULLU(reg_r0_39, reg_r0_16, reg_r0_31); /* line 279 */
   __MULHS(reg_r0_31, reg_r0_16, reg_r0_31); /* line 280 */
   __MULLU(reg_r0_9, reg_r0_7, reg_r0_27); /* line 281 */
   __MULHS(reg_r0_27, reg_r0_7, reg_r0_27); /* line 282 */
} /* line 282 */
  sim_icache_fetch(188 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __ADD(reg_r0_34, reg_r0_34, reg_r0_10); /* line 284 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 285 */
   __ADD(reg_r0_42, reg_r0_28, (unsigned int) 255); /* line 286 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 287 */
   __MULLU(reg_r0_10, reg_r0_12, reg_r0_25); /* line 288 */
   __MULHS(reg_r0_25, reg_r0_12, reg_r0_25); /* line 289 */
   __AND(reg_r0_35, reg_r0_35, (unsigned int) 255); /* line 290 */
   __SHRU(reg_r0_44, reg_r0_22, (unsigned int) 16); /* line 291 */
   __AND(reg_r0_41, reg_r0_41, (unsigned int) 255); /* line 292 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 293 */
   __MULLU(reg_r0_43, reg_r0_7, reg_r0_33); /* line 294 */
   __MULHS(reg_r0_33, reg_r0_7, reg_r0_33); /* line 295 */
} /* line 295 */
  sim_icache_fetch(200 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __CMPLT(reg_b0_0, reg_r0_34, 0); /* line 297 */
   __ADD(reg_r0_28, reg_r0_34, (unsigned int) 255); /* line 298 */
   __SLCT(reg_r0_42, t__i32_0, reg_r0_42, t__i32_1); /* line 299 */
   __ADD(reg_r0_40, reg_r0_40, reg_r0_32); /* line 300 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 301 */
   __MULLU(reg_r0_29, reg_r0_14, reg_r0_35); /* line 302 */
   __MULHS(reg_r0_35, reg_r0_14, reg_r0_35); /* line 303 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_30); /* line 304 */
   __MULLU(reg_r0_27, reg_r0_23, reg_r0_41); /* line 305 */
   __MULHS(reg_r0_41, reg_r0_23, reg_r0_41); /* line 306 */
   __ADD(reg_r0_39, reg_r0_39, reg_r0_31); /* line 307 */
   __ADD(reg_r0_9, reg_r0_9, t__i32_2); /* line 308 */
} /* line 308 */
  sim_icache_fetch(212 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __SHR(reg_r0_42, reg_r0_42, (unsigned int) 8); /* line 310 */
   __CMPLT(reg_b0_5, reg_r0_40, 0); /* line 311 */
   __ADD(reg_r0_46, reg_r0_40, (unsigned int) 255); /* line 312 */
   __CMPLT(reg_b0_2, reg_r0_24, 0); /* line 313 */
   __ADD(reg_r0_31, reg_r0_24, (unsigned int) 255); /* line 314 */
   __CMPLT(reg_b0_3, reg_r0_38, 0); /* line 315 */
   __ADD(reg_r0_32, reg_r0_38, (unsigned int) 255); /* line 316 */
   __CMPLT(reg_b0_4, reg_r0_39, 0); /* line 317 */
   __ADD(reg_r0_45, reg_r0_39, (unsigned int) 255); /* line 318 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_33); /* line 319 */
   __CMPLT(reg_b0_1, reg_r0_9, 0); /* line 320 */
   __ADD(reg_r0_30, reg_r0_9, (unsigned int) 255); /* line 321 */
} /* line 321 */
  sim_icache_fetch(224 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_9 ;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __SLCT(reg_r0_28, reg_b0_0, reg_r0_28, reg_r0_34); /* line 323 */
   __SLCT(reg_r0_46, reg_b0_5, reg_r0_46, reg_r0_40); /* line 324 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_25); /* line 325 */
   __SLCT(reg_r0_31, reg_b0_2, reg_r0_31, reg_r0_24); /* line 326 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_35); /* line 327 */
   __SLCT(reg_r0_32, reg_b0_3, reg_r0_32, reg_r0_38); /* line 328 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_41); /* line 329 */
   __MULLU(reg_r0_24, reg_r0_16, reg_r0_36); /* line 330 */
   __SLCT(reg_r0_45, reg_b0_4, reg_r0_45, reg_r0_39); /* line 331 */
   __CMPLT(reg_b0_1, reg_r0_43, 0); /* line 332 */
   __ADD(reg_r0_9, reg_r0_43, (unsigned int) 255); /* line 333 */
   __SLCT(reg_r0_30, t__i32_0, reg_r0_30, t__i32_1); /* line 334 */
} /* line 334 */
  sim_icache_fetch(236 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   ...
   __SHR(reg_r0_46, reg_r0_46, (unsigned int) 8); /* line 337 */
   __CMPLT(reg_b0_1, reg_r0_10, 0); /* line 338 */
   __ADD(reg_r0_33, reg_r0_10, (unsigned int) 255); /* line 339 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 340 */
   __CMPLT(reg_b0_2, reg_r0_29, 0); /* line 341 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 342 */
   __CMPLT(reg_b0_0, reg_r0_27, 0); /* line 343 */
   __ADD(reg_r0_25, reg_r0_27, (unsigned int) 255); /* line 344 */
   __SHR(reg_r0_45, reg_r0_45, (unsigned int) 8); /* line 345 */
   __SLCT(reg_r0_9, t__i32_0, reg_r0_9, reg_r0_43); /* line 346 */
   __SHR(reg_r0_30, reg_r0_30, (unsigned int) 8); /* line 347 */
} /* line 347 */
  sim_icache_fetch(248 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_30 ;
  t__i32_0 = reg_r0_27 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __MULLU(reg_r0_27, reg_r0_21, reg_r0_37); /* line 349 */
   __MULHS(reg_r0_37, reg_r0_21, reg_r0_37); /* line 350 */
   __SLCT(reg_r0_33, reg_b0_1, reg_r0_33, reg_r0_10); /* line 351 */
   __ADD(reg_r0_10, reg_r0_29, (unsigned int) 255); /* line 352 */
   __AND(reg_r0_44, reg_r0_44, (unsigned int) 255); /* line 353 */
   __SLCT(reg_r0_25, reg_b0_0, reg_r0_25, t__i32_0); /* line 354 */
   __MULHS(reg_r0_36, reg_r0_16, reg_r0_36); /* line 355 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 356 */
   __MULLU(reg_r0_30, reg_r0_7, reg_r0_4); /* line 357 */
   __ADD(reg_r0_42, reg_r0_42, t__i32_1); /* line 358 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_45); /* line 359 */
   __ADD(reg_r0_31, reg_r0_31, reg_r0_32); /* line 360 */
} /* line 360 */
  sim_icache_fetch(260 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_9 ;
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 362 */
   __ADD(reg_r0_4, reg_r0_26, (unsigned int) 255); /* line 363 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 364 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 365 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 366 */
   __SLCT(reg_r0_10, reg_b0_2, reg_r0_10, reg_r0_29); /* line 367 */
   __MULLU(reg_r0_9, reg_r0_23, reg_r0_44); /* line 368 */
   __MULHS(reg_r0_44, reg_r0_23, reg_r0_44); /* line 369 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 370 */
   __MULHS(reg_r0_7, reg_r0_7, t__i32_0); /* line 371 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_31); /* line 372 */
   __ADD(reg_r0_28, reg_r0_28, t__i32_1); /* line 373 */
} /* line 373 */
  sim_icache_fetch(272 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_25 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_26); /* line 375 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_37); /* line 376 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 377 */
   __MULLU(reg_r0_25, reg_r0_12, reg_r0_11); /* line 378 */
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_11); /* line 379 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 380 */
   __MULLU(reg_r0_11, reg_r0_14, reg_r0_13); /* line 381 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 382 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 383 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 384 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_36); /* line 385 */
   __ADD(reg_r0_46, reg_r0_46, t__i32_0); /* line 386 */
} /* line 386 */
  sim_icache_fetch(284 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_1 = reg_r0_7 ;
   ...
   __CMPLT(reg_b0_1, reg_r0_27, 0); /* line 389 */
   __ADD(reg_r0_13, reg_r0_27, (unsigned int) 255); /* line 390 */
   __MULLU(reg_r0_15, reg_r0_21, reg_r0_18); /* line 391 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_44); /* line 392 */
   __CMPLT(reg_b0_0, reg_r0_24, 0); /* line 393 */
   __ADD(reg_r0_10, reg_r0_24, (unsigned int) 255); /* line 394 */
   __MULLU(reg_r0_7, reg_r0_16, t__i32_0); /* line 395 */
   __MULHS(reg_r0_16, reg_r0_16, t__i32_0); /* line 396 */
   __ADD(reg_r0_30, reg_r0_30, t__i32_1); /* line 397 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_46); /* line 398 */
   __ADD(reg_r0_33, reg_r0_33, t__i32_2); /* line 399 */
} /* line 399 */
  sim_icache_fetch(296 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_24 ;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __SLCT(reg_r0_13, reg_b0_1, reg_r0_13, reg_r0_27); /* line 401 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_18); /* line 402 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_12); /* line 403 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_14); /* line 404 */
   __CMPLT(reg_b0_0, reg_r0_9, 0); /* line 405 */
   __ADD(reg_r0_24, reg_r0_9, (unsigned int) 255); /* line 406 */
   __MULLU(reg_r0_12, reg_r0_23, reg_r0_22); /* line 407 */
   __SLCT(reg_r0_10, t__i32_0, reg_r0_10, t__i32_1); /* line 408 */
   __CMPLT(reg_b0_1, reg_r0_30, 0); /* line 409 */
   __ADD(reg_r0_26, reg_r0_30, (unsigned int) 255); /* line 410 */
   __ADD(reg_r0_17, reg_r0_42, reg_r0_17); /* line 411 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_33); /* line 412 */
} /* line 412 */
  sim_icache_fetch(308 + t_thisfile.offset, 10);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 414 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 415 */
   __ADD(reg_r0_9, reg_r0_25, (unsigned int) 255); /* line 416 */
   __CMPLT(reg_b0_1, reg_r0_11, 0); /* line 417 */
   __ADD(reg_r0_14, reg_r0_11, (unsigned int) 255); /* line 418 */
   __SLCT(reg_r0_24, t__i32_0, reg_r0_24, t__i32_1); /* line 419 */
   __MULHS(reg_r0_23, reg_r0_23, reg_r0_22); /* line 420 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 421 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_16); /* line 422 */
   __SLCT(reg_r0_26, t__i32_2, reg_r0_26, reg_r0_30); /* line 423 */
} /* line 423 */
  sim_icache_fetch(318 + t_thisfile.offset, 8);
{
  ...
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __ADD(reg_r0_15, reg_r0_15, reg_r0_21); /* line 425 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_25); /* line 426 */
   __SLCT(reg_r0_14, reg_b0_1, reg_r0_14, reg_r0_11); /* line 427 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 428 */
   __CMPLT(reg_b0_0, reg_r0_7, 0); /* line 429 */
   __ADD(reg_r0_10, reg_r0_7, (unsigned int) 255); /* line 430 */
   __SHR(reg_r0_26, reg_r0_26, (unsigned int) 8); /* line 431 */
   __ADD(reg_r0_19, reg_r0_19, t__i32_0); /* line 432 */
} /* line 432 */
  sim_icache_fetch(326 + t_thisfile.offset, 8);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_7 ;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __CMPLT(reg_b0_0, reg_r0_15, 0); /* line 434 */
   __ADD(reg_r0_7, reg_r0_15, (unsigned int) 255); /* line 435 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 436 */
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 437 */
   __ADD(reg_r0_12, reg_r0_12, reg_r0_23); /* line 438 */
   __SLCT(reg_r0_10, t__i32_0, reg_r0_10, t__i32_1); /* line 439 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_26); /* line 440 */
   __ADD(reg_r0_13, reg_r0_13, reg_r0_24); /* line 441 */
} /* line 441 */
  sim_icache_fetch(334 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_15); /* line 443 */
   __CMPLT(reg_b0_0, reg_r0_12, 0); /* line 444 */
   __ADD(reg_r0_11, reg_r0_12, (unsigned int) 255); /* line 445 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 446 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_14); /* line 447 */
   __ADD(reg_r0_19, reg_r0_19, reg_r0_13); /* line 448 */
} /* line 448 */
  sim_icache_fetch(340 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 450 */
   __SLCT(reg_r0_11, reg_b0_0, reg_r0_11, reg_r0_12); /* line 451 */
   __ADD(reg_r0_20, reg_r0_20, reg_r0_10); /* line 452 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_9); /* line 453 */
   __ADD(reg_r0_19, reg_r0_28, reg_r0_19); /* line 454 */
} /* line 454 */
  sim_icache_fetch(345 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 456 */
} /* line 456 */
  sim_icache_fetch(346 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_7, reg_r0_7, reg_r0_11); /* line 458 */
} /* line 458 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_20, reg_r0_20, reg_r0_7); /* line 460 */
} /* line 460 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_20, reg_r0_4, reg_r0_20); /* line 462 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_20, reg_r0_20, 0); /* line 467 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 468 */
   __MAX(reg_r0_19, reg_r0_19, 0); /* line 469 */
   __SH2ADD(reg_r0_2, reg_r0_47, reg_r0_49); /* line 470 */
   __ADD(reg_r0_4, reg_r0_47, (unsigned int) 1); /* line 471 */
} /* line 471 */
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 473 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 474 */
   __MIN(reg_r0_19, reg_r0_19, (unsigned int) 255); /* line 475 */
   __ADD(reg_r0_7, reg_r0_48, (unsigned int) 1); /* line 476 */
} /* line 476 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   ...
   __SHL(reg_r0_19, reg_r0_19, (unsigned int) 16); /* line 479 */
} /* line 479 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_20, reg_r0_20, reg_r0_19); /* line 481 */
} /* line 481 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_20, reg_r0_20, reg_r0_17); /* line 483 */
} /* line 483 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_20); /* line 485 */
  ...
  sim_icache_fetch(365 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_49, reg_r0_49, (unsigned int) 256); /* line 490 */
  ...
  sim_icache_fetch(370 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_50); /* line 499 */
