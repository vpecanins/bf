...
l_L6X3: ;/* line 171 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
  ...
  sim_icache_fetch(89 + t_thisfile.offset, 1);
{
  ...
  sim_icache_fetch(90 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
  ...
  sim_icache_fetch(103 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   ...
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 209 */
   ...
   __AND(reg_r0_27, reg_r0_9, (unsigned int) 255); /* line 213 */
   __SHRU(reg_r0_26, reg_r0_9, (unsigned int) 8); /* line 214 */
} /* line 214 */
  sim_icache_fetch(116 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 216 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 217 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 218 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 219 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 220 */
   ...
   __AND(reg_r0_18, reg_r0_10, (unsigned int) 255); /* line 224 */
   __SHRU(reg_r0_16, reg_r0_10, (unsigned int) 8); /* line 225 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 226 */
   __AND(reg_r0_22, reg_r0_11, (unsigned int) 255); /* line 227 */
   __SHRU(reg_r0_20, reg_r0_11, (unsigned int) 8); /* line 228 */
} /* line 228 */
  sim_icache_fetch(129 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 230 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 231 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 232 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 233 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 234 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 235 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 236 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 237 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 238 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 239 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 240 */
   __AND(reg_r0_5, reg_r0_12, (unsigned int) 255); /* line 241 */
   __SHRU(reg_r0_3, reg_r0_12, (unsigned int) 8); /* line 242 */
} /* line 242 */
  sim_icache_fetch(142 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 244 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 245 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 246 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 247 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 248 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 249 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 250 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_20); /* line 251 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 252 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 253 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 254 */
   __AND(reg_r0_7, reg_r0_14, (unsigned int) 255); /* line 255 */
   __SHRU(reg_r0_6, reg_r0_14, (unsigned int) 8); /* line 256 */
} /* line 256 */
  sim_icache_fetch(155 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __SHL(reg_r0_9, reg_r0_17, (unsigned int) 8); /* line 258 */
   __SHL(reg_r0_8, reg_r0_17, (unsigned int) 16); /* line 259 */
   __SHL(reg_r0_20, reg_r0_19, (unsigned int) 8); /* line 260 */
   __SHL(reg_r0_16, reg_r0_19, (unsigned int) 16); /* line 261 */
   __SHL(reg_r0_26, reg_r0_21, (unsigned int) 8); /* line 262 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 16); /* line 263 */
   __SHL(reg_r0_29, reg_r0_23, (unsigned int) 8); /* line 264 */
   __SHL(reg_r0_28, reg_r0_23, (unsigned int) 16); /* line 265 */
   __SHL(reg_r0_31, reg_r0_25, (unsigned int) 8); /* line 266 */
   __SHL(reg_r0_30, reg_r0_25, (unsigned int) 16); /* line 267 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 268 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_10); /* line 269 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_11); /* line 270 */
} /* line 270 */
  sim_icache_fetch(168 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_8); /* line 272 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_16); /* line 273 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 274 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_28); /* line 275 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_30); /* line 276 */
   __SHL(reg_r0_10, reg_r0_27, (unsigned int) 8); /* line 277 */
   __SHL(reg_r0_8, reg_r0_27, (unsigned int) 16); /* line 278 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 279 */
   __ZXTB(reg_r0_22, reg_r0_22); /* line 280 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 281 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 282 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 283 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 284 */
} /* line 284 */
  sim_icache_fetch(181 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_9); /* line 286 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_20); /* line 287 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_26); /* line 288 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_29); /* line 289 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_31); /* line 290 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_8); /* line 291 */
   __SHL(reg_r0_8, reg_r0_18, (unsigned int) 8); /* line 292 */
   __SHL(reg_r0_3, reg_r0_18, (unsigned int) 16); /* line 293 */
   __SHL(reg_r0_11, reg_r0_22, (unsigned int) 8); /* line 294 */
   __SHL(reg_r0_9, reg_r0_22, (unsigned int) 16); /* line 295 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_12); /* line 296 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_6); /* line 297 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 298 */
} /* line 298 */
  sim_icache_fetch(194 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 300 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 301 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 302 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 303 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 304 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_10); /* line 305 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_3); /* line 306 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_9); /* line 307 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 308 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_14); /* line 309 */
   __AND(reg_r0_6, reg_r0_15, (unsigned int) 255); /* line 310 */
   __SHRU(reg_r0_3, reg_r0_15, (unsigned int) 8); /* line 311 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 312 */
} /* line 312 */
  sim_icache_fetch(207 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 314 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_8); /* line 315 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_11); /* line 316 */
   __SHL(reg_r0_9, reg_r0_5, (unsigned int) 8); /* line 317 */
   __SHL(reg_r0_8, reg_r0_5, (unsigned int) 16); /* line 318 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 319 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 320 */
  ...
  sim_icache_fetch(215 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_18); /* line 323 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_22); /* line 324 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_8); /* line 325 */
   __SHL(reg_r0_10, reg_r0_7, (unsigned int) 8); /* line 326 */
   __SHL(reg_r0_8, reg_r0_7, (unsigned int) 16); /* line 327 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_3); /* line 328 */
} /* line 328 */
  sim_icache_fetch(221 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_5, reg_r0_5, reg_r0_9); /* line 330 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_8); /* line 331 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_15); /* line 332 */
} /* line 332 */
  sim_icache_fetch(224 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_5); /* line 334 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_10); /* line 335 */
   __ZXTB(reg_r0_6, reg_r0_6); /* line 336 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(228 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_7); /* line 339 */
   __SHL(reg_r0_5, reg_r0_6, (unsigned int) 8); /* line 340 */
   __SHL(reg_r0_3, reg_r0_6, (unsigned int) 16); /* line 341 */
} /* line 341 */
  sim_icache_fetch(231 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_6, reg_r0_6, reg_r0_3); /* line 343 */
} /* line 343 */
  sim_icache_fetch(232 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_6, reg_r0_6, reg_r0_5); /* line 345 */
} /* line 345 */
  sim_icache_fetch(233 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_6); /* line 347 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_34, (unsigned int) 256); /* line 353 */
   __ADD(reg_r0_5, reg_r0_33, (unsigned int) 256); /* line 354 */
   __ADD(reg_r0_3, reg_r0_32, (unsigned int) 1); /* line 355 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_35); /* line 362 */
