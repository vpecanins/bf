  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
  ...
  sim_icache_fetch(40 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_20, 0); /* line 171 */
   __MOV(reg_r0_17, 0); /* line 172 */
   __MOV(reg_r0_21, 0); /* line 173 */
...
l_L8X3: ;/* line 180 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 19);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
  ...
  sim_icache_fetch(99 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __LDWs(reg_r0_10, mem_trace_ld(reg_r0_10,0,4)); /* line 195 */
   __SH2ADD(reg_r0_9, reg_r0_9, (unsigned int) conv7_image); /* line 196 */
   __LDWs(reg_r0_19, mem_trace_ld(reg_r0_19,0,4)); /* line 197 */
   __SHL(reg_r0_18, reg_r0_18, (unsigned int) 6); /* line 198 */
   __SHL(reg_r0_11, reg_r0_11, (unsigned int) 6); /* line 199 */
   __LDWs(reg_r0_12, mem_trace_ld(reg_r0_12,0,4)); /* line 200 */
   __SHL(reg_r0_13, reg_r0_13, (unsigned int) 6); /* line 201 */
   __LDWs(reg_r0_14, mem_trace_ld(reg_r0_14,0,4)); /* line 202 */
   __SHL(reg_r0_15, reg_r0_15, (unsigned int) 6); /* line 203 */
   __LDWs(reg_r0_16, mem_trace_ld(reg_r0_16,0,4)); /* line 204 */
   __SHL(reg_r0_4, reg_r0_4, (unsigned int) 6); /* line 205 */
   __LDWs(reg_r0_7, mem_trace_ld(reg_r0_7,0,4)); /* line 206 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(113 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 209 */
   __ADD(reg_r0_18, reg_r0_5, reg_r0_18); /* line 210 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 211 */
   __ADD(reg_r0_13, reg_r0_5, reg_r0_13); /* line 212 */
   __ADD(reg_r0_22, reg_r0_3, (unsigned int) 4); /* line 213 */
   __SH2ADD(reg_r0_23, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 214 */
   __ADD(reg_r0_15, reg_r0_5, reg_r0_15); /* line 215 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 216 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 217 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 218 */
} /* line 218 */
  sim_icache_fetch(124 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
  ...
  sim_icache_fetch(146 + t_thisfile.offset, 6);
{
  ...
  sim_icache_fetch(152 + t_thisfile.offset, 13);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   ...
   __SHRU(reg_r0_35, reg_r0_13, (unsigned int) 16); /* line 252 */
   __SHRU(reg_r0_30, reg_r0_13, (unsigned int) 8); /* line 253 */
   __LDW(reg_r0_22, mem_trace_ld(reg_r0_22,0,4)); /* line 254 */
   __SHRU(reg_r0_31, reg_r0_15, (unsigned int) 8); /* line 255 */
   __SHRU(reg_r0_33, reg_r0_4, (unsigned int) 16); /* line 256 */
   __SHRU(reg_r0_27, reg_r0_4, (unsigned int) 8); /* line 257 */
} /* line 257 */
  sim_icache_fetch(165 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 259 */
   __SHRU(reg_r0_37, reg_r0_18, (unsigned int) 16); /* line 260 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 261 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 262 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 263 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 264 */
   __AND(reg_r0_35, reg_r0_35, (unsigned int) 255); /* line 265 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 266 */
   __SHRU(reg_r0_36, reg_r0_15, (unsigned int) 16); /* line 267 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 268 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 269 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 270 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 271 */
} /* line 271 */
  sim_icache_fetch(178 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 273 */
   __MULLU(reg_r0_40, reg_r0_19, reg_r0_32); /* line 274 */
   __MULHS(reg_r0_32, reg_r0_19, reg_r0_32); /* line 275 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_29); /* line 276 */
   __MULHS(reg_r0_29, reg_r0_12, reg_r0_29); /* line 277 */
   __MULLU(reg_r0_38, reg_r0_14, reg_r0_30); /* line 278 */
   __MULHS(reg_r0_30, reg_r0_14, reg_r0_30); /* line 279 */
   __SHRU(reg_r0_41, reg_r0_22, (unsigned int) 8); /* line 280 */
   __MULLU(reg_r0_39, reg_r0_16, reg_r0_31); /* line 281 */
   __MULHS(reg_r0_31, reg_r0_16, reg_r0_31); /* line 282 */
   __MULLU(reg_r0_42, reg_r0_7, reg_r0_33); /* line 283 */
   __MULLU(reg_r0_9, reg_r0_7, reg_r0_27); /* line 284 */
   __MULHS(reg_r0_27, reg_r0_7, reg_r0_27); /* line 285 */
} /* line 285 */
  sim_icache_fetch(191 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __ADD(reg_r0_34, reg_r0_34, reg_r0_10); /* line 287 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 288 */
   __ADD(reg_r0_43, reg_r0_28, (unsigned int) 255); /* line 289 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 290 */
   __MULLU(reg_r0_10, reg_r0_12, reg_r0_25); /* line 291 */
   __MULHS(reg_r0_25, reg_r0_12, reg_r0_25); /* line 292 */
   __MULLU(reg_r0_44, reg_r0_14, reg_r0_35); /* line 293 */
   __MULHS(reg_r0_35, reg_r0_14, reg_r0_35); /* line 294 */
   __SHRU(reg_r0_45, reg_r0_22, (unsigned int) 16); /* line 295 */
   __AND(reg_r0_41, reg_r0_41, (unsigned int) 255); /* line 296 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 297 */
   __MULHS(reg_r0_33, reg_r0_7, reg_r0_33); /* line 298 */
   __MULLU(reg_r0_46, reg_r0_7, reg_r0_4); /* line 299 */
} /* line 299 */
  sim_icache_fetch(204 + t_thisfile.offset, 13);
{
  unsigned int t__i32_0;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __CMPLT(reg_b0_0, reg_r0_34, 0); /* line 301 */
   __ADD(reg_r0_28, reg_r0_34, (unsigned int) 255); /* line 302 */
   __SLCT(reg_r0_43, t__i32_0, reg_r0_43, t__i32_1); /* line 303 */
   __MULLU(reg_r0_30, reg_r0_19, reg_r0_37); /* line 304 */
   __ADD(reg_r0_40, reg_r0_40, reg_r0_32); /* line 305 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 306 */
   __ADD(reg_r0_38, reg_r0_38, t__i32_2); /* line 307 */
   __MULLU(reg_r0_27, reg_r0_23, reg_r0_41); /* line 308 */
   __MULHS(reg_r0_41, reg_r0_23, reg_r0_41); /* line 309 */
   __MULLU(reg_r0_29, reg_r0_16, reg_r0_36); /* line 310 */
   __MULHS(reg_r0_36, reg_r0_16, reg_r0_36); /* line 311 */
   __ADD(reg_r0_39, reg_r0_39, reg_r0_31); /* line 312 */
   __ADD(reg_r0_9, reg_r0_9, t__i32_3); /* line 313 */
} /* line 313 */
  sim_icache_fetch(217 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __SLCT(reg_r0_28, reg_b0_0, reg_r0_28, reg_r0_34); /* line 315 */
   __SHR(reg_r0_43, reg_r0_43, (unsigned int) 8); /* line 316 */
   __CMPLT(reg_b0_5, reg_r0_40, 0); /* line 317 */
   __ADD(reg_r0_49, reg_r0_40, (unsigned int) 255); /* line 318 */
   __CMPLT(reg_b0_2, reg_r0_24, 0); /* line 319 */
   __ADD(reg_r0_32, reg_r0_24, (unsigned int) 255); /* line 320 */
   __CMPLT(reg_b0_3, reg_r0_38, 0); /* line 321 */
   __ADD(reg_r0_47, reg_r0_38, (unsigned int) 255); /* line 322 */
   __CMPLT(reg_b0_4, reg_r0_39, 0); /* line 323 */
   __ADD(reg_r0_48, reg_r0_39, (unsigned int) 255); /* line 324 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_33); /* line 325 */
   __CMPLT(reg_b0_1, reg_r0_9, 0); /* line 326 */
   __ADD(reg_r0_31, reg_r0_9, (unsigned int) 255); /* line 327 */
} /* line 327 */
  sim_icache_fetch(230 + t_thisfile.offset, 13);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 329 */
   __MULHS(reg_r0_37, reg_r0_19, reg_r0_37); /* line 330 */
   __SLCT(reg_r0_49, reg_b0_5, reg_r0_49, reg_r0_40); /* line 331 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_25); /* line 332 */
   __SLCT(reg_r0_32, reg_b0_2, reg_r0_32, reg_r0_24); /* line 333 */
   __ADD(reg_r0_44, reg_r0_44, reg_r0_35); /* line 334 */
   __SLCT(reg_r0_47, reg_b0_3, reg_r0_47, reg_r0_38); /* line 335 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_41); /* line 336 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_36); /* line 337 */
   __SLCT(reg_r0_48, reg_b0_4, reg_r0_48, reg_r0_39); /* line 338 */
   __CMPLT(reg_b0_0, reg_r0_42, 0); /* line 339 */
   __ADD(reg_r0_9, reg_r0_42, (unsigned int) 255); /* line 340 */
   __SLCT(reg_r0_31, reg_b0_1, reg_r0_31, t__i32_0); /* line 341 */
} /* line 341 */
  sim_icache_fetch(243 + t_thisfile.offset, 13);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __SHR(reg_r0_49, reg_r0_49, (unsigned int) 8); /* line 343 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 344 */
   __ADD(reg_r0_25, reg_r0_10, (unsigned int) 255); /* line 345 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 346 */
   __CMPLT(reg_b0_2, reg_r0_44, 0); /* line 347 */
   __ADD(reg_r0_33, reg_r0_44, (unsigned int) 255); /* line 348 */
   __SHR(reg_r0_47, reg_r0_47, (unsigned int) 8); /* line 349 */
   __CMPLT(reg_b0_1, reg_r0_27, 0); /* line 350 */
   __ADD(reg_r0_24, reg_r0_27, (unsigned int) 255); /* line 351 */
   __CMPLT(reg_b0_3, reg_r0_29, 0); /* line 352 */
   __SHR(reg_r0_48, reg_r0_48, (unsigned int) 8); /* line 353 */
   __SLCT(reg_r0_9, t__i32_0, reg_r0_9, reg_r0_42); /* line 354 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 355 */
} /* line 355 */
  sim_icache_fetch(256 + t_thisfile.offset, 13);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_4 ;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 357 */
   __ADD(reg_r0_4, reg_r0_26, (unsigned int) 255); /* line 358 */
   __ADD(reg_r0_30, reg_r0_30, reg_r0_37); /* line 359 */
   __SLCT(reg_r0_25, t__i32_0, reg_r0_25, reg_r0_10); /* line 360 */
   __SLCT(reg_r0_33, reg_b0_2, reg_r0_33, reg_r0_44); /* line 361 */
   __AND(reg_r0_45, reg_r0_45, (unsigned int) 255); /* line 362 */
   __SLCT(reg_r0_24, reg_b0_1, reg_r0_24, reg_r0_27); /* line 363 */
   __ADD(reg_r0_10, reg_r0_29, (unsigned int) 255); /* line 364 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 365 */
   __MULHS(reg_r0_7, reg_r0_7, t__i32_1); /* line 366 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_31); /* line 367 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_48); /* line 368 */
   __ADD(reg_r0_32, reg_r0_32, reg_r0_47); /* line 369 */
} /* line 369 */
  sim_icache_fetch(269 + t_thisfile.offset, 13);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_26); /* line 371 */
   __CMPLT(reg_b0_1, reg_r0_30, 0); /* line 372 */
   __ADD(reg_r0_9, reg_r0_30, (unsigned int) 255); /* line 373 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 374 */
   __MULLU(reg_r0_26, reg_r0_12, reg_r0_11); /* line 375 */
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_11); /* line 376 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 377 */
   __MULLU(reg_r0_27, reg_r0_23, reg_r0_45); /* line 378 */
   __MULHS(reg_r0_45, reg_r0_23, reg_r0_45); /* line 379 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 380 */
   __SLCT(reg_r0_10, reg_b0_3, reg_r0_10, reg_r0_29); /* line 381 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_32); /* line 382 */
   __ADD(reg_r0_28, reg_r0_28, t__i32_0); /* line 383 */
} /* line 383 */
  sim_icache_fetch(282 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 385 */
   __SLCT(reg_r0_9, reg_b0_1, reg_r0_9, reg_r0_30); /* line 386 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 387 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 388 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 389 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 390 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 391 */
   __ADD(reg_r0_46, reg_r0_46, reg_r0_7); /* line 392 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_24); /* line 393 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_33); /* line 394 */
} /* line 394 */
  sim_icache_fetch(292 + t_thisfile.offset, 13);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_r0_12 ;
  t__i32_1 = reg_r0_10 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 396 */
   __MULLU(reg_r0_12, reg_r0_19, reg_r0_18); /* line 397 */
   __ADD(reg_r0_26, reg_r0_26, t__i32_0); /* line 398 */
   __MULLU(reg_r0_10, reg_r0_14, reg_r0_13); /* line 399 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 400 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_45); /* line 401 */
   __MULLU(reg_r0_11, reg_r0_16, reg_r0_15); /* line 402 */
   __MULHS(reg_r0_16, reg_r0_16, reg_r0_15); /* line 403 */
   __CMPLT(reg_b0_0, reg_r0_46, 0); /* line 404 */
   __ADD(reg_r0_7, reg_r0_46, (unsigned int) 255); /* line 405 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_49); /* line 406 */
   __ADD(reg_r0_20, reg_r0_20, t__i32_1); /* line 407 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_25); /* line 408 */
} /* line 408 */
  sim_icache_fetch(305 + t_thisfile.offset, 9);
{
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __MULHS(reg_r0_19, reg_r0_19, reg_r0_18); /* line 410 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 411 */
   __ADD(reg_r0_15, reg_r0_26, (unsigned int) 255); /* line 412 */
   __CMPLT(reg_b0_1, reg_r0_27, 0); /* line 413 */
   __ADD(reg_r0_13, reg_r0_27, (unsigned int) 255); /* line 414 */
   __MULLU(reg_r0_18, reg_r0_23, reg_r0_22); /* line 415 */
   __MULHS(reg_r0_23, reg_r0_23, reg_r0_22); /* line 416 */
   __SLCT(reg_r0_7, t__i32_0, reg_r0_7, reg_r0_46); /* line 417 */
   __ADD(reg_r0_17, reg_r0_43, reg_r0_17); /* line 418 */
} /* line 418 */
  sim_icache_fetch(314 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_15, reg_b0_0, reg_r0_15, reg_r0_26); /* line 420 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_14); /* line 421 */
   __SLCT(reg_r0_13, reg_b0_1, reg_r0_13, reg_r0_27); /* line 422 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_16); /* line 423 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 424 */
} /* line 424 */
  sim_icache_fetch(319 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __ADD(reg_r0_12, reg_r0_12, reg_r0_19); /* line 426 */
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 427 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 428 */
   __ADD(reg_r0_7, reg_r0_10, (unsigned int) 255); /* line 429 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 430 */
   __ADD(reg_r0_18, reg_r0_18, reg_r0_23); /* line 431 */
   __CMPLT(reg_b0_1, reg_r0_11, 0); /* line 432 */
   __ADD(reg_r0_14, reg_r0_11, (unsigned int) 255); /* line 433 */
   __ADD(reg_r0_4, reg_r0_4, t__i32_0); /* line 434 */
} /* line 434 */
  sim_icache_fetch(328 + t_thisfile.offset, 7);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __CMPLT(reg_b0_0, reg_r0_12, 0); /* line 436 */
   __ADD(reg_r0_10, reg_r0_12, (unsigned int) 255); /* line 437 */
   __SLCT(reg_r0_7, t__i32_0, reg_r0_7, t__i32_1); /* line 438 */
   __CMPLT(reg_b0_1, reg_r0_18, 0); /* line 439 */
   __ADD(reg_r0_11, reg_r0_18, (unsigned int) 255); /* line 440 */
   __SLCT(reg_r0_14, t__i32_2, reg_r0_14, t__i32_3); /* line 441 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_13); /* line 442 */
} /* line 442 */
  sim_icache_fetch(335 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_12); /* line 444 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 445 */
   __SLCT(reg_r0_11, reg_b0_1, reg_r0_11, reg_r0_18); /* line 446 */
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 447 */
   __ADD(reg_r0_20, reg_r0_20, reg_r0_9); /* line 448 */
} /* line 448 */
  sim_icache_fetch(340 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 450 */
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 451 */
   __ADD(reg_r0_21, reg_r0_21, reg_r0_14); /* line 452 */
   __ADD(reg_r0_15, reg_r0_15, reg_r0_7); /* line 453 */
   __ADD(reg_r0_20, reg_r0_28, reg_r0_20); /* line 454 */
} /* line 454 */
  sim_icache_fetch(345 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_10, reg_r0_10, reg_r0_11); /* line 456 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_15); /* line 457 */
} /* line 457 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_21, reg_r0_21, reg_r0_10); /* line 459 */
} /* line 459 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_21, reg_r0_4, reg_r0_21); /* line 461 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_21, reg_r0_21, 0); /* line 466 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 467 */
   __MAX(reg_r0_20, reg_r0_20, 0); /* line 468 */
  ...
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_21, reg_r0_21, (unsigned int) 255); /* line 472 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 473 */
   __MIN(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 474 */
  ...
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   ...
   __SHL(reg_r0_20, reg_r0_20, (unsigned int) 16); /* line 478 */
} /* line 478 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_21, reg_r0_21, reg_r0_20); /* line 480 */
} /* line 480 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_21, reg_r0_21, reg_r0_17); /* line 482 */
} /* line 482 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_21); /* line 484 */
