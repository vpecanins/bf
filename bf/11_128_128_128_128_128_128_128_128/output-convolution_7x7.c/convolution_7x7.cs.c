  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
  ...
  sim_icache_fetch(38 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
  ...
  sim_icache_fetch(49 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   ...
   __MOV(reg_r0_46, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 156 */
   __MOV(reg_r0_47, reg_r0_5); /* line 157 */
} /* line 157 */
l_L4X3: ;/* line 160 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_18, 0); /* line 173 */
   __MOV(reg_r0_17, 0); /* line 174 */
   __MOV(reg_r0_19, 0); /* line 175 */
   __MOV(reg_r0_44, reg_r0_4); /* line 176 */
   __MOV(reg_r0_45, reg_r0_7); /* line 177 */
} /* line 177 */
...
l_L8X3: ;/* line 182 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   ...
   __ADD(reg_r0_15, reg_r0_3, (unsigned int) 5); /* line 190 */
   __SH2ADD(reg_r0_16, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 191 */
   __ADD(reg_r0_4, reg_r0_3, (unsigned int) 6); /* line 192 */
   __SH2ADD(reg_r0_7, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 24)); /* line 193 */
} /* line 193 */
  sim_icache_fetch(96 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __LDWs(reg_r0_10, mem_trace_ld(reg_r0_10,0,4)); /* line 195 */
   __SH2ADD(reg_r0_9, reg_r0_9, (unsigned int) conv7_image); /* line 196 */
   __SHL(reg_r0_11, reg_r0_11, (unsigned int) 6); /* line 197 */
   __LDWs(reg_r0_12, mem_trace_ld(reg_r0_12,0,4)); /* line 198 */
   __SHL(reg_r0_13, reg_r0_13, (unsigned int) 6); /* line 199 */
   __LDWs(reg_r0_14, mem_trace_ld(reg_r0_14,0,4)); /* line 200 */
   __SHL(reg_r0_15, reg_r0_15, (unsigned int) 6); /* line 201 */
   __LDWs(reg_r0_16, mem_trace_ld(reg_r0_16,0,4)); /* line 202 */
   __SHL(reg_r0_4, reg_r0_4, (unsigned int) 6); /* line 203 */
   __LDWs(reg_r0_7, mem_trace_ld(reg_r0_7,0,4)); /* line 204 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(108 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 207 */
   __ADD(reg_r0_20, reg_r0_3, (unsigned int) 1); /* line 208 */
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 209 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 210 */
   __ADD(reg_r0_13, reg_r0_5, reg_r0_13); /* line 211 */
   __ADD(reg_r0_22, reg_r0_3, (unsigned int) 4); /* line 212 */
   __SH2ADD(reg_r0_23, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 213 */
   __ADD(reg_r0_15, reg_r0_5, reg_r0_15); /* line 214 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 215 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 216 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 217 */
} /* line 217 */
  sim_icache_fetch(121 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __LDW(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 219 */
   __SHL(reg_r0_20, reg_r0_20, (unsigned int) 6); /* line 220 */
   __SH2ADD(reg_r0_11, reg_r0_11, (unsigned int) conv7_image); /* line 221 */
   __SH2ADD(reg_r0_13, reg_r0_13, (unsigned int) conv7_image); /* line 222 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 6); /* line 223 */
   __LDW(reg_r0_23, mem_trace_ld(reg_r0_23,0,4)); /* line 224 */
   __SH2ADD(reg_r0_15, reg_r0_15, (unsigned int) conv7_image); /* line 225 */
   __SH2ADD(reg_r0_4, reg_r0_4, (unsigned int) conv7_image); /* line 226 */
} /* line 226 */
  sim_icache_fetch(133 + t_thisfile.offset, 10);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHRU(reg_r0_25, t__i32_0, (unsigned int) 16); /* line 228 */
   __AND(reg_r0_9, t__i32_0, (unsigned int) 255); /* line 229 */
   __SHRU(reg_r0_24, t__i32_0, (unsigned int) 8); /* line 230 */
   __ADD(reg_r0_20, reg_r0_5, reg_r0_20); /* line 231 */
   __LDW(reg_r0_11, mem_trace_ld(reg_r0_11,0,4)); /* line 232 */
   __LDW(reg_r0_13, mem_trace_ld(reg_r0_13,0,4)); /* line 233 */
   __ADD(reg_r0_22, reg_r0_5, reg_r0_22); /* line 234 */
   __LDW(reg_r0_15, mem_trace_ld(reg_r0_15,0,4)); /* line 235 */
   __LDW(reg_r0_4, mem_trace_ld(reg_r0_4,0,4)); /* line 236 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 237 */
} /* line 237 */
  sim_icache_fetch(143 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 239 */
   __MULLU(reg_r0_26, reg_r0_10, reg_r0_9); /* line 240 */
   __MULHS(reg_r0_9, reg_r0_10, reg_r0_9); /* line 241 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 242 */
   __SH2ADD(reg_r0_20, reg_r0_20, (unsigned int) conv7_image); /* line 243 */
   __SH2ADD(reg_r0_22, reg_r0_22, (unsigned int) conv7_image); /* line 244 */
} /* line 244 */
  sim_icache_fetch(151 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __MULLU(reg_r0_33, t__i32_0, reg_r0_25); /* line 246 */
   ...
   __LDW(reg_r0_20, mem_trace_ld(reg_r0_20,0,4)); /* line 250 */
   __SHRU(reg_r0_29, reg_r0_11, (unsigned int) 8); /* line 251 */
   __SHRU(reg_r0_30, reg_r0_13, (unsigned int) 8); /* line 252 */
   __LDW(reg_r0_22, mem_trace_ld(reg_r0_22,0,4)); /* line 253 */
   __SHRU(reg_r0_31, reg_r0_15, (unsigned int) 8); /* line 254 */
   __SHRU(reg_r0_32, reg_r0_4, (unsigned int) 16); /* line 255 */
   __SHRU(reg_r0_27, reg_r0_4, (unsigned int) 8); /* line 256 */
} /* line 256 */
  sim_icache_fetch(162 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 258 */
   __SHRU(reg_r0_25, reg_r0_11, (unsigned int) 16); /* line 259 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 260 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 261 */
   __SHRU(reg_r0_34, reg_r0_13, (unsigned int) 16); /* line 262 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 263 */
   __SHRU(reg_r0_35, reg_r0_15, (unsigned int) 16); /* line 264 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 265 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 266 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 267 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 268 */
} /* line 268 */
  sim_icache_fetch(173 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 270 */
   __SHRU(reg_r0_38, reg_r0_20, (unsigned int) 8); /* line 271 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_29); /* line 272 */
   __MULHS(reg_r0_29, reg_r0_12, reg_r0_29); /* line 273 */
   __MULLU(reg_r0_36, reg_r0_14, reg_r0_30); /* line 274 */
   __MULHS(reg_r0_30, reg_r0_14, reg_r0_30); /* line 275 */
   __SHRU(reg_r0_39, reg_r0_22, (unsigned int) 8); /* line 276 */
   __MULLU(reg_r0_37, reg_r0_16, reg_r0_31); /* line 277 */
   __MULHS(reg_r0_31, reg_r0_16, reg_r0_31); /* line 278 */
   __MULLU(reg_r0_9, reg_r0_7, reg_r0_27); /* line 279 */
   __MULHS(reg_r0_27, reg_r0_7, reg_r0_27); /* line 280 */
} /* line 280 */
  sim_icache_fetch(184 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __ADD(reg_r0_33, reg_r0_33, reg_r0_10); /* line 282 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 283 */
   __ADD(reg_r0_40, reg_r0_28, (unsigned int) 255); /* line 284 */
   __SHRU(reg_r0_10, reg_r0_20, (unsigned int) 16); /* line 285 */
   __AND(reg_r0_38, reg_r0_38, (unsigned int) 255); /* line 286 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 287 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 288 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 289 */
   __AND(reg_r0_35, reg_r0_35, (unsigned int) 255); /* line 290 */
   __MULLU(reg_r0_41, reg_r0_7, reg_r0_32); /* line 291 */
   __MULHS(reg_r0_32, reg_r0_7, reg_r0_32); /* line 292 */
} /* line 292 */
  sim_icache_fetch(195 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __CMPLT(reg_b0_0, reg_r0_33, 0); /* line 294 */
   __ADD(reg_r0_29, reg_r0_33, (unsigned int) 255); /* line 295 */
   __SLCT(reg_r0_40, t__i32_0, reg_r0_40, reg_r0_28); /* line 296 */
   __MULLU(reg_r0_27, reg_r0_21, reg_r0_38); /* line 297 */
   __MULHS(reg_r0_38, reg_r0_21, reg_r0_38); /* line 298 */
   __ADD(reg_r0_24, reg_r0_24, t__i32_1); /* line 299 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_30); /* line 300 */
   __MULLU(reg_r0_28, reg_r0_23, reg_r0_39); /* line 301 */
   __MULHS(reg_r0_39, reg_r0_23, reg_r0_39); /* line 302 */
   __ADD(reg_r0_37, reg_r0_37, reg_r0_31); /* line 303 */
   __ADD(reg_r0_9, reg_r0_9, t__i32_2); /* line 304 */
} /* line 304 */
  sim_icache_fetch(206 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __SLCT(reg_r0_29, reg_b0_0, reg_r0_29, reg_r0_33); /* line 306 */
   __SHR(reg_r0_40, reg_r0_40, (unsigned int) 8); /* line 307 */
   __CMPLT(reg_b0_2, reg_r0_24, 0); /* line 308 */
   __ADD(reg_r0_31, reg_r0_24, (unsigned int) 255); /* line 309 */
   __CMPLT(reg_b0_3, reg_r0_36, 0); /* line 310 */
   __ADD(reg_r0_42, reg_r0_36, (unsigned int) 255); /* line 311 */
   __CMPLT(reg_b0_4, reg_r0_37, 0); /* line 312 */
   __ADD(reg_r0_43, reg_r0_37, (unsigned int) 255); /* line 313 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_32); /* line 314 */
   __CMPLT(reg_b0_1, reg_r0_9, 0); /* line 315 */
   __ADD(reg_r0_30, reg_r0_9, (unsigned int) 255); /* line 316 */
} /* line 316 */
  sim_icache_fetch(217 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_r0_24 ;
  t__i32_1 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 318 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_38); /* line 319 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_25); /* line 320 */
   __MULHS(reg_r0_25, reg_r0_12, reg_r0_25); /* line 321 */
   __SLCT(reg_r0_31, reg_b0_2, reg_r0_31, t__i32_0); /* line 322 */
   __SLCT(reg_r0_42, reg_b0_3, reg_r0_42, reg_r0_36); /* line 323 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_39); /* line 324 */
   __SLCT(reg_r0_43, reg_b0_4, reg_r0_43, reg_r0_37); /* line 325 */
   __CMPLT(reg_b0_0, reg_r0_41, 0); /* line 326 */
   __ADD(reg_r0_9, reg_r0_41, (unsigned int) 255); /* line 327 */
   __SLCT(reg_r0_30, reg_b0_1, reg_r0_30, t__i32_1); /* line 328 */
} /* line 328 */
  sim_icache_fetch(228 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __CMPLT(reg_b0_1, reg_r0_27, 0); /* line 330 */
   __ADD(reg_r0_32, reg_r0_27, (unsigned int) 255); /* line 331 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 332 */
   __MULLU(reg_r0_36, reg_r0_14, reg_r0_34); /* line 333 */
   __MULHS(reg_r0_34, reg_r0_14, reg_r0_34); /* line 334 */
   __SHR(reg_r0_42, reg_r0_42, (unsigned int) 8); /* line 335 */
   __CMPLT(reg_b0_2, reg_r0_28, 0); /* line 336 */
   __ADD(reg_r0_33, reg_r0_28, (unsigned int) 255); /* line 337 */
   __SHR(reg_r0_43, reg_r0_43, (unsigned int) 8); /* line 338 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_41); /* line 339 */
   __SHR(reg_r0_30, reg_r0_30, (unsigned int) 8); /* line 340 */
} /* line 340 */
  sim_icache_fetch(239 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 342 */
   __SLCT(reg_r0_32, reg_b0_1, reg_r0_32, reg_r0_27); /* line 343 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_25); /* line 344 */
   __SHRU(reg_r0_27, reg_r0_22, (unsigned int) 16); /* line 345 */
   __SLCT(reg_r0_33, reg_b0_2, reg_r0_33, reg_r0_28); /* line 346 */
   __MULLU(reg_r0_25, reg_r0_16, reg_r0_35); /* line 347 */
   __MULHS(reg_r0_35, reg_r0_16, reg_r0_35); /* line 348 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 349 */
   __ADD(reg_r0_40, reg_r0_40, reg_r0_30); /* line 350 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_43); /* line 351 */
   __ADD(reg_r0_31, reg_r0_31, reg_r0_42); /* line 352 */
} /* line 352 */
  sim_icache_fetch(250 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __MULLU(reg_r0_28, reg_r0_21, reg_r0_10); /* line 354 */
   __MULHS(reg_r0_10, reg_r0_21, reg_r0_10); /* line 355 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 356 */
   __CMPLT(reg_b0_0, reg_r0_24, 0); /* line 357 */
   __ADD(reg_r0_9, reg_r0_24, (unsigned int) 255); /* line 358 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_34); /* line 359 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 360 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 361 */
   __MULLU(reg_r0_30, reg_r0_7, reg_r0_4); /* line 362 */
   __ADD(reg_r0_40, reg_r0_40, reg_r0_31); /* line 363 */
   __ADD(reg_r0_29, reg_r0_29, t__i32_0); /* line 364 */
} /* line 364 */
  sim_icache_fetch(261 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_33 ;
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __CMPLT(reg_b0_1, reg_r0_26, 0); /* line 366 */
   __ADD(reg_r0_4, reg_r0_26, (unsigned int) 255); /* line 367 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_24); /* line 368 */
   __MULLU(reg_r0_33, reg_r0_12, reg_r0_11); /* line 369 */
   __CMPLT(reg_b0_0, reg_r0_36, 0); /* line 370 */
   __ADD(reg_r0_24, reg_r0_36, (unsigned int) 255); /* line 371 */
   __MULLU(reg_r0_31, reg_r0_23, reg_r0_27); /* line 372 */
   __MULHS(reg_r0_27, reg_r0_23, reg_r0_27); /* line 373 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_35); /* line 374 */
   __MULHS(reg_r0_7, reg_r0_7, t__i32_0); /* line 375 */
   __ADD(reg_r0_32, reg_r0_32, t__i32_1); /* line 376 */
} /* line 376 */
  sim_icache_fetch(272 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_32 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __SLCT(reg_r0_4, reg_b0_1, reg_r0_4, reg_r0_26); /* line 378 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_10); /* line 379 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 380 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 381 */
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_11); /* line 382 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 383 */
   __SLCT(reg_r0_24, reg_b0_0, reg_r0_24, reg_r0_36); /* line 384 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 385 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 386 */
   __ADD(reg_r0_32, reg_r0_25, (unsigned int) 255); /* line 387 */
   __ADD(reg_r0_17, reg_r0_17, t__i32_0); /* line 388 */
} /* line 388 */
  sim_icache_fetch(283 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_7 ;
  t__i32_0 = reg_b0_0 ;
   ...
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 391 */
   __ADD(reg_r0_10, reg_r0_28, (unsigned int) 255); /* line 392 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 393 */
   __MULLU(reg_r0_7, reg_r0_14, reg_r0_13); /* line 394 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 395 */
   __ADD(reg_r0_31, reg_r0_31, reg_r0_27); /* line 396 */
   __SLCT(reg_r0_32, t__i32_0, reg_r0_32, reg_r0_25); /* line 397 */
   __MULLU(reg_r0_11, reg_r0_16, reg_r0_15); /* line 398 */
   __ADD(reg_r0_30, reg_r0_30, t__i32_1); /* line 399 */
   __ADD(reg_r0_17, reg_r0_40, reg_r0_17); /* line 400 */
} /* line 400 */
  sim_icache_fetch(294 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_24 ;
  t__i32_0 = reg_r0_12 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_28); /* line 402 */
   __MULLU(reg_r0_12, reg_r0_21, reg_r0_20); /* line 403 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_20); /* line 404 */
   __ADD(reg_r0_33, reg_r0_33, t__i32_0); /* line 405 */
   __CMPLT(reg_b0_0, reg_r0_31, 0); /* line 406 */
   __ADD(reg_r0_13, reg_r0_31, (unsigned int) 255); /* line 407 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 408 */
   __MULHS(reg_r0_16, reg_r0_16, reg_r0_15); /* line 409 */
   __CMPLT(reg_b0_1, reg_r0_30, 0); /* line 410 */
   __ADD(reg_r0_24, reg_r0_30, (unsigned int) 255); /* line 411 */
   __ADD(reg_r0_9, reg_r0_9, t__i32_1); /* line 412 */
} /* line 412 */
  sim_icache_fetch(305 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_1 = reg_r0_9 ;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 414 */
   __CMPLT(reg_b0_0, reg_r0_33, 0); /* line 415 */
   __ADD(reg_r0_9, reg_r0_33, (unsigned int) 255); /* line 416 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_14); /* line 417 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 418 */
   __SLCT(reg_r0_13, t__i32_0, reg_r0_13, reg_r0_31); /* line 419 */
   __SLCT(reg_r0_24, reg_b0_1, reg_r0_24, reg_r0_30); /* line 420 */
   __ADD(reg_r0_18, reg_r0_18, reg_r0_32); /* line 421 */
   __ADD(reg_r0_29, reg_r0_29, t__i32_1); /* line 422 */
} /* line 422 */
  sim_icache_fetch(314 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __ADD(reg_r0_12, reg_r0_12, reg_r0_21); /* line 424 */
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_33); /* line 425 */
   __CMPLT(reg_b0_0, reg_r0_7, 0); /* line 426 */
   __ADD(reg_r0_14, reg_r0_7, (unsigned int) 255); /* line 427 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 428 */
   __MULLU(reg_r0_15, reg_r0_23, reg_r0_22); /* line 429 */
   __MULHS(reg_r0_23, reg_r0_23, reg_r0_22); /* line 430 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_16); /* line 431 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 432 */
} /* line 432 */
  sim_icache_fetch(323 + t_thisfile.offset, 8);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_13 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __CMPLT(reg_b0_1, reg_r0_12, 0); /* line 434 */
   __ADD(reg_r0_13, reg_r0_12, (unsigned int) 255); /* line 435 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 436 */
   __SLCT(reg_r0_14, reg_b0_0, reg_r0_14, reg_r0_7); /* line 437 */
   __CMPLT(reg_b0_0, reg_r0_11, 0); /* line 438 */
   __ADD(reg_r0_7, reg_r0_11, (unsigned int) 255); /* line 439 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_24); /* line 440 */
   __ADD(reg_r0_10, reg_r0_10, t__i32_0); /* line 441 */
} /* line 441 */
  sim_icache_fetch(331 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SLCT(reg_r0_13, reg_b0_1, reg_r0_13, reg_r0_12); /* line 443 */
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 444 */
   __ADD(reg_r0_15, reg_r0_15, reg_r0_23); /* line 445 */
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_11); /* line 446 */
   __ADD(reg_r0_18, reg_r0_18, reg_r0_10); /* line 447 */
} /* line 447 */
  sim_icache_fetch(336 + t_thisfile.offset, 6);
{
   ...
   __CMPLT(reg_b0_0, reg_r0_15, 0); /* line 450 */
   __ADD(reg_r0_10, reg_r0_15, (unsigned int) 255); /* line 451 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 452 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_14); /* line 453 */
   __ADD(reg_r0_18, reg_r0_29, reg_r0_18); /* line 454 */
} /* line 454 */
  sim_icache_fetch(342 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_15); /* line 456 */
   __ADD(reg_r0_19, reg_r0_19, reg_r0_7); /* line 457 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_9); /* line 458 */
} /* line 458 */
  sim_icache_fetch(345 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 460 */
} /* line 460 */
  sim_icache_fetch(346 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_13, reg_r0_13, reg_r0_10); /* line 462 */
} /* line 462 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_19, reg_r0_19, reg_r0_13); /* line 464 */
} /* line 464 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_19, reg_r0_4, reg_r0_19); /* line 466 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_19, reg_r0_19, 0); /* line 471 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 472 */
   __MAX(reg_r0_18, reg_r0_18, 0); /* line 473 */
   __SH2ADD(reg_r0_2, reg_r0_44, reg_r0_46); /* line 474 */
   __ADD(reg_r0_4, reg_r0_44, (unsigned int) 1); /* line 475 */
} /* line 475 */
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_19, reg_r0_19, (unsigned int) 255); /* line 477 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 478 */
   __MIN(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 479 */
   __ADD(reg_r0_7, reg_r0_45, (unsigned int) 1); /* line 480 */
} /* line 480 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   ...
   __SHL(reg_r0_18, reg_r0_18, (unsigned int) 16); /* line 483 */
} /* line 483 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_19, reg_r0_19, reg_r0_18); /* line 485 */
} /* line 485 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_19, reg_r0_19, reg_r0_17); /* line 487 */
} /* line 487 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_19); /* line 489 */
  ...
  sim_icache_fetch(365 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_46, reg_r0_46, (unsigned int) 256); /* line 494 */
  ...
  sim_icache_fetch(370 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_47); /* line 503 */
  ...
  sim_icache_fetch(375 + t_thisfile.offset, 3);
{
   ...
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 507 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 508 */
   __ADD_CYCLES(1);
} /* line 508 */
