  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 154 */
   __MOV(reg_r0_5, (unsigned int) grey_framebuffer); /* line 155 */
   __MOV(reg_r0_6, (unsigned int) grey_image); /* line 156 */
   __MOV(reg_r0_31, t__i32_0); /* line 157 */
} /* line 157 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 162 */
   __MOV(reg_r0_13, (unsigned int) -55); /* line 163 */
   __MOV(reg_r0_4, reg_r0_5); /* line 164 */
   __MOV(reg_r0_2, reg_r0_6); /* line 165 */
   __MOV(reg_r0_28, reg_r0_3); /* line 166 */
   __MOV(reg_r0_29, reg_r0_5); /* line 167 */
   __MOV(reg_r0_30, reg_r0_6); /* line 168 */
} /* line 168 */
...
l_L6X3: ;/* line 173 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __LDW(reg_r0_5, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 174 */
   __LDW(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 175 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 176 */
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 177 */
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 16),0,4)); /* line 178 */
   __LDW(reg_r0_9, mem_trace_ld((reg_r0_2 + (unsigned int) 20),0,4)); /* line 179 */
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 24),0,4)); /* line 180 */
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 181 */
   __LDW(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 182 */
  ...
  sim_icache_fetch(87 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDWs(reg_r0_15, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 186 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 187 */
   __ADD(reg_r0_13, reg_r0_13, (unsigned int) 11); /* line 188 */
} /* line 188 */
  sim_icache_fetch(90 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __AND(reg_r0_17, reg_r0_3, (unsigned int) 255); /* line 190 */
   __AND(reg_r0_19, reg_r0_5, (unsigned int) 255); /* line 191 */
   __AND(reg_r0_21, reg_r0_6, (unsigned int) 255); /* line 192 */
   __SHRU(reg_r0_16, reg_r0_3, (unsigned int) 8); /* line 193 */
   __SHRU(reg_r0_18, reg_r0_5, (unsigned int) 8); /* line 194 */
   __SHRU(reg_r0_20, reg_r0_6, (unsigned int) 8); /* line 195 */
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 196 */
   __SHRU(reg_r0_5, reg_r0_5, (unsigned int) 16); /* line 197 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 198 */
   __AND(reg_r0_23, reg_r0_7, (unsigned int) 255); /* line 199 */
   __SHRU(reg_r0_22, reg_r0_7, (unsigned int) 8); /* line 200 */
} /* line 200 */
  sim_icache_fetch(101 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 202 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 203 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 204 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 205 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 206 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 207 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 208 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 209 */
   __AND(reg_r0_25, reg_r0_8, (unsigned int) 255); /* line 210 */
   __SHRU(reg_r0_24, reg_r0_8, (unsigned int) 8); /* line 211 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 212 */
} /* line 212 */
  sim_icache_fetch(112 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 214 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 215 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 216 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 217 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 218 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 219 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 220 */
   __AND(reg_r0_18, reg_r0_9, (unsigned int) 255); /* line 221 */
   __SHRU(reg_r0_16, reg_r0_9, (unsigned int) 8); /* line 222 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 223 */
   __SHRU(reg_r0_20, reg_r0_10, (unsigned int) 8); /* line 224 */
} /* line 224 */
  sim_icache_fetch(123 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 226 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 227 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 228 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 229 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 230 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 231 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 232 */
   __AND(reg_r0_3, reg_r0_10, (unsigned int) 255); /* line 233 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 234 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 235 */
   __SHRU(reg_r0_5, reg_r0_11, (unsigned int) 8); /* line 236 */
} /* line 236 */
  sim_icache_fetch(134 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 238 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 239 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 240 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 241 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 242 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 243 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_20); /* line 244 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 245 */
   __AND(reg_r0_6, reg_r0_11, (unsigned int) 255); /* line 246 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 247 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 248 */
} /* line 248 */
  sim_icache_fetch(145 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __SHL(reg_r0_8, reg_r0_17, (unsigned int) 8); /* line 250 */
   __SHL(reg_r0_7, reg_r0_17, (unsigned int) 16); /* line 251 */
   __SHL(reg_r0_20, reg_r0_19, (unsigned int) 8); /* line 252 */
   __SHL(reg_r0_16, reg_r0_19, (unsigned int) 16); /* line 253 */
   __SHL(reg_r0_24, reg_r0_21, (unsigned int) 8); /* line 254 */
   __SHL(reg_r0_22, reg_r0_21, (unsigned int) 16); /* line 255 */
   __SHL(reg_r0_27, reg_r0_23, (unsigned int) 8); /* line 256 */
   __SHL(reg_r0_26, reg_r0_23, (unsigned int) 16); /* line 257 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 258 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_9); /* line 259 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_10); /* line 260 */
} /* line 260 */
  sim_icache_fetch(156 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __OR(reg_r0_17, reg_r0_17, reg_r0_7); /* line 262 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_16); /* line 263 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_22); /* line 264 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_26); /* line 265 */
   __SHL(reg_r0_9, reg_r0_25, (unsigned int) 8); /* line 266 */
   __SHL(reg_r0_7, reg_r0_25, (unsigned int) 16); /* line 267 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 268 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 269 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_5); /* line 270 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 271 */
   __SHRU(reg_r0_5, reg_r0_12, (unsigned int) 8); /* line 272 */
} /* line 272 */
  sim_icache_fetch(167 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __OR(reg_r0_17, reg_r0_17, reg_r0_8); /* line 274 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_20); /* line 275 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_24); /* line 276 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_27); /* line 277 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_7); /* line 278 */
   __SHL(reg_r0_8, reg_r0_18, (unsigned int) 8); /* line 279 */
   __SHL(reg_r0_7, reg_r0_18, (unsigned int) 16); /* line 280 */
   __SHL(reg_r0_16, reg_r0_3, (unsigned int) 8); /* line 281 */
   __SHL(reg_r0_10, reg_r0_3, (unsigned int) 16); /* line 282 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_11); /* line 283 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 284 */
} /* line 284 */
  sim_icache_fetch(178 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __OR(reg_r0_25, reg_r0_25, reg_r0_9); /* line 286 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_7); /* line 287 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_10); /* line 288 */
   __ZXTB(reg_r0_6, reg_r0_6); /* line 289 */
   __AND(reg_r0_7, reg_r0_12, (unsigned int) 255); /* line 290 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 291 */
   __AND(reg_r0_10, reg_r0_14, (unsigned int) 255); /* line 292 */
   __SHRU(reg_r0_9, reg_r0_14, (unsigned int) 8); /* line 293 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 294 */
   __AND(reg_r0_20, reg_r0_15, (unsigned int) 255); /* line 295 */
   __SHRU(reg_r0_11, reg_r0_15, (unsigned int) 8); /* line 296 */
} /* line 296 */
  sim_icache_fetch(189 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 298 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_8); /* line 299 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_16); /* line 300 */
   __SHL(reg_r0_16, reg_r0_6, (unsigned int) 8); /* line 301 */
   __SHL(reg_r0_8, reg_r0_6, (unsigned int) 16); /* line 302 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_5); /* line 303 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 304 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 305 */
  ...
  sim_icache_fetch(200 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 310 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 311 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 312 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 313 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_18); /* line 314 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_3); /* line 315 */
   __OR(reg_r0_6, reg_r0_6, reg_r0_8); /* line 316 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_12); /* line 317 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_9); /* line 318 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_11); /* line 319 */
  ...
  sim_icache_fetch(211 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_6, reg_r0_6, reg_r0_16); /* line 322 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 323 */
   __MAX(reg_r0_10, reg_r0_10, reg_r0_14); /* line 324 */
   __MAX(reg_r0_20, reg_r0_20, reg_r0_15); /* line 325 */
} /* line 325 */
  sim_icache_fetch(215 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_6); /* line 327 */
   __SHL(reg_r0_5, reg_r0_7, (unsigned int) 8); /* line 328 */
   __SHL(reg_r0_3, reg_r0_7, (unsigned int) 16); /* line 329 */
   __ZXTB(reg_r0_10, reg_r0_10); /* line 330 */
   __ZXTB(reg_r0_20, reg_r0_20); /* line 331 */
} /* line 331 */
  sim_icache_fetch(220 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __OR(reg_r0_7, reg_r0_7, reg_r0_3); /* line 333 */
   __SHL(reg_r0_6, reg_r0_10, (unsigned int) 8); /* line 334 */
   __SHL(reg_r0_3, reg_r0_10, (unsigned int) 16); /* line 335 */
   __SHL(reg_r0_9, reg_r0_20, (unsigned int) 8); /* line 336 */
   __SHL(reg_r0_8, reg_r0_20, (unsigned int) 16); /* line 337 */
} /* line 337 */
  sim_icache_fetch(225 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __OR(reg_r0_7, reg_r0_7, reg_r0_5); /* line 339 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_3); /* line 340 */
   __OR(reg_r0_20, reg_r0_20, reg_r0_8); /* line 341 */
} /* line 341 */
  sim_icache_fetch(228 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_7); /* line 343 */
   __OR(reg_r0_10, reg_r0_10, reg_r0_6); /* line 344 */
   __OR(reg_r0_20, reg_r0_20, reg_r0_9); /* line 345 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(232 + t_thisfile.offset, 4);
{
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_20); /* line 349 */
