  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
  ...
  sim_icache_fetch(33 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
  ...
  sim_icache_fetch(39 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
  ...
  sim_icache_fetch(45 + t_thisfile.offset, 6);
{
  ...
  sim_icache_fetch(51 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), 0); /* line 141 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), 0); /* line 142 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), 0); /* line 143 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), 0); /* line 144 */
  ...
  sim_icache_fetch(57 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 52),0,4), 0); /* line 148 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 56),0,4), 0); /* line 149 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 60),0,4), 0); /* line 150 */
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_8, 0); /* line 155 */
   __MOV(reg_r0_3, 0); /* line 156 */
   __MOV(reg_r0_36, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 157 */
   __MOV(reg_r0_37, reg_r0_5); /* line 158 */
} /* line 158 */
l_L4X3: ;/* line 161 */
__LABEL(l_L4X3);
  sim_icache_fetch(66 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __CMPLT(reg_b0_0, reg_r0_3, (unsigned int) 58); /* line 162 */
   __MOV(reg_r0_4, (unsigned int) -58); /* line 163 */
   __MOV(reg_r0_7, 0); /* line 164 */
} /* line 164 */
...
l_L6X3: ;/* line 169 */
__LABEL(l_L6X3);
  sim_icache_fetch(70 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_4, 0); /* line 170 */
   __MOV(reg_r0_6, 0); /* line 171 */
   __MOV(reg_r0_5, reg_r0_7); /* line 172 */
   __MOV(reg_r0_13, 0); /* line 173 */
   __MOV(reg_r0_12, 0); /* line 174 */
   __MOV(reg_r0_14, 0); /* line 175 */
} /* line 175 */
  sim_icache_fetch(76 + t_thisfile.offset, 4);
{
   ...
   __MOV(reg_r0_34, reg_r0_4); /* line 178 */
   __MOV(reg_r0_35, reg_r0_7); /* line 179 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
...
l_L8X3: ;/* line 183 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_2, 0); /* line 184 */
   __SH2ADD(reg_r0_10, reg_r0_6, (unsigned int) filter7x7); /* line 185 */
   __ADD(reg_r0_9, reg_r0_5, reg_r0_8); /* line 186 */
  ...
  sim_icache_fetch(88 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
  ...
  sim_icache_fetch(95 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 198 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 199 */
   __SH2ADD(reg_r0_15, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 8)); /* line 200 */
   ...
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 203 */
} /* line 203 */
  sim_icache_fetch(103 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SH2ADD(reg_r0_11, reg_r0_11, (unsigned int) conv7_image); /* line 205 */
   __LDW(reg_r0_15, mem_trace_ld(reg_r0_15,0,4)); /* line 206 */
   __SHL(reg_r0_16, reg_r0_16, (unsigned int) 6); /* line 207 */
   __LDW(reg_r0_17, mem_trace_ld(reg_r0_17,0,4)); /* line 208 */
   __ADD(reg_r0_18, reg_r0_3, (unsigned int) 5); /* line 209 */
   __SH2ADD(reg_r0_4, reg_r0_4, (unsigned int) conv7_image); /* line 210 */
} /* line 210 */
  sim_icache_fetch(111 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHRU(reg_r0_19, reg_r0_9, (unsigned int) 8); /* line 212 */
   __LDW(reg_r0_11, mem_trace_ld(reg_r0_11,0,4)); /* line 213 */
   __ADD(reg_r0_16, reg_r0_5, reg_r0_16); /* line 214 */
   __SHL(reg_r0_18, reg_r0_18, (unsigned int) 6); /* line 215 */
   __SH2ADD(reg_r0_20, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 216 */
   __LDW(reg_r0_4, mem_trace_ld(reg_r0_4,0,4)); /* line 217 */
} /* line 217 */
  sim_icache_fetch(118 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __AND(reg_r0_19, reg_r0_19, (unsigned int) 255); /* line 219 */
   __ADD(reg_r0_21, reg_r0_3, (unsigned int) 1); /* line 220 */
   __SH2ADD(reg_r0_22, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 221 */
   __SH2ADD(reg_r0_16, reg_r0_16, (unsigned int) conv7_image); /* line 222 */
   __ADD(reg_r0_18, reg_r0_5, reg_r0_18); /* line 223 */
   __LDW(reg_r0_20, mem_trace_ld(reg_r0_20,0,4)); /* line 224 */
} /* line 224 */
  sim_icache_fetch(126 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __MULLU(reg_r0_24, reg_r0_10, reg_r0_19); /* line 226 */
   __MULHS(reg_r0_19, reg_r0_10, reg_r0_19); /* line 227 */
   __SHRU(reg_r0_25, reg_r0_11, (unsigned int) 8); /* line 228 */
   __LDW(reg_r0_16, mem_trace_ld(reg_r0_16,0,4)); /* line 229 */
   __SH2ADD(reg_r0_18, reg_r0_18, (unsigned int) conv7_image); /* line 230 */
   __SHRU(reg_r0_23, reg_r0_4, (unsigned int) 8); /* line 231 */
} /* line 231 */
  sim_icache_fetch(133 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __LDW(reg_r0_22, mem_trace_ld(reg_r0_22,0,4)); /* line 233 */
   __SHL(reg_r0_21, reg_r0_21, (unsigned int) 6); /* line 234 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 235 */
   __ADD(reg_r0_26, reg_r0_3, (unsigned int) 4); /* line 236 */
   __LDW(reg_r0_18, mem_trace_ld(reg_r0_18,0,4)); /* line 237 */
   __AND(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 238 */
} /* line 238 */
  sim_icache_fetch(139 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __ADD(reg_r0_24, reg_r0_24, reg_r0_19); /* line 240 */
   __MULLU(reg_r0_19, reg_r0_15, reg_r0_25); /* line 241 */
   __MULHS(reg_r0_25, reg_r0_15, reg_r0_25); /* line 242 */
   __SHRU(reg_r0_28, reg_r0_16, (unsigned int) 8); /* line 243 */
   __MULLU(reg_r0_27, reg_r0_7, reg_r0_23); /* line 244 */
   __MULHS(reg_r0_23, reg_r0_7, reg_r0_23); /* line 245 */
} /* line 245 */
  sim_icache_fetch(145 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_24, 0); /* line 247 */
   __ADD(reg_r0_29, reg_r0_24, (unsigned int) 255); /* line 248 */
   __ADD(reg_r0_21, reg_r0_5, reg_r0_21); /* line 249 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 250 */
   __SHL(reg_r0_26, reg_r0_26, (unsigned int) 6); /* line 251 */
   __SHRU(reg_r0_30, reg_r0_18, (unsigned int) 8); /* line 252 */
} /* line 252 */
  sim_icache_fetch(151 + t_thisfile.offset, 6);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_23 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SLCT(reg_r0_29, reg_b0_0, reg_r0_29, reg_r0_24); /* line 254 */
   __ADD(reg_r0_19, reg_r0_19, reg_r0_25); /* line 255 */
   __MULLU(reg_r0_23, reg_r0_17, reg_r0_28); /* line 256 */
   __MULHS(reg_r0_28, reg_r0_17, reg_r0_28); /* line 257 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 258 */
   __ADD(reg_r0_27, reg_r0_27, t__i32_0); /* line 259 */
} /* line 259 */
  sim_icache_fetch(157 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 261 */
   __CMPLT(reg_b0_1, reg_r0_19, 0); /* line 262 */
   __ADD(reg_r0_25, reg_r0_19, (unsigned int) 255); /* line 263 */
   __MULLU(reg_r0_31, reg_r0_20, reg_r0_30); /* line 264 */
   __CMPLT(reg_b0_0, reg_r0_27, 0); /* line 265 */
   __ADD(reg_r0_24, reg_r0_27, (unsigned int) 255); /* line 266 */
} /* line 266 */
  sim_icache_fetch(163 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SH2ADD(reg_r0_21, reg_r0_21, (unsigned int) conv7_image); /* line 268 */
   __SLCT(reg_r0_25, reg_b0_1, reg_r0_25, reg_r0_19); /* line 269 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_28); /* line 270 */
   __ADD(reg_r0_26, reg_r0_5, reg_r0_26); /* line 271 */
   __MULHS(reg_r0_30, reg_r0_20, reg_r0_30); /* line 272 */
   __SLCT(reg_r0_24, reg_b0_0, reg_r0_24, reg_r0_27); /* line 273 */
} /* line 273 */
  sim_icache_fetch(170 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __LDW(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 275 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 276 */
   __CMPLT(reg_b0_0, reg_r0_23, 0); /* line 277 */
   __ADD(reg_r0_19, reg_r0_23, (unsigned int) 255); /* line 278 */
   __SH2ADD(reg_r0_26, reg_r0_26, (unsigned int) conv7_image); /* line 279 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 280 */
} /* line 280 */
  sim_icache_fetch(177 + t_thisfile.offset, 7);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_24 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SLCT(reg_r0_19, reg_b0_0, reg_r0_19, reg_r0_23); /* line 282 */
   __LDW(reg_r0_26, mem_trace_ld(reg_r0_26,0,4)); /* line 283 */
   __SH2ADD(reg_r0_23, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 284 */
   __ADD(reg_r0_31, reg_r0_31, reg_r0_30); /* line 285 */
   __SHRU(reg_r0_24, reg_r0_4, (unsigned int) 16); /* line 286 */
   __ADD(reg_r0_29, reg_r0_29, t__i32_0); /* line 287 */
} /* line 287 */
  sim_icache_fetch(184 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHRU(reg_r0_28, reg_r0_21, (unsigned int) 8); /* line 289 */
   __SHR(reg_r0_19, reg_r0_19, (unsigned int) 8); /* line 290 */
   __LDW(reg_r0_23, mem_trace_ld(reg_r0_23,0,4)); /* line 291 */
   __CMPLT(reg_b0_0, reg_r0_31, 0); /* line 292 */
   __ADD(reg_r0_27, reg_r0_31, (unsigned int) 255); /* line 293 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 294 */
} /* line 294 */
  sim_icache_fetch(190 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_19 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 296 */
   __SHRU(reg_r0_19, reg_r0_26, (unsigned int) 8); /* line 297 */
   __SLCT(reg_r0_27, reg_b0_0, reg_r0_27, reg_r0_31); /* line 298 */
   __MULLU(reg_r0_30, reg_r0_7, reg_r0_24); /* line 299 */
   __MULHS(reg_r0_24, reg_r0_7, reg_r0_24); /* line 300 */
   __ADD(reg_r0_25, reg_r0_25, t__i32_0); /* line 301 */
} /* line 301 */
  sim_icache_fetch(196 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_25 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHRU(reg_r0_31, reg_r0_9, (unsigned int) 16); /* line 303 */
   __MULLU(reg_r0_25, reg_r0_22, reg_r0_28); /* line 304 */
   __MULHS(reg_r0_28, reg_r0_22, reg_r0_28); /* line 305 */
   __AND(reg_r0_19, reg_r0_19, (unsigned int) 255); /* line 306 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 307 */
   __ADD(reg_r0_29, reg_r0_29, t__i32_0); /* line 308 */
} /* line 308 */
  sim_icache_fetch(202 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_24 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 310 */
   __SHRU(reg_r0_24, reg_r0_11, (unsigned int) 16); /* line 311 */
   __MULLU(reg_r0_27, reg_r0_23, reg_r0_19); /* line 312 */
   __MULHS(reg_r0_19, reg_r0_23, reg_r0_19); /* line 313 */
   __ADD(reg_r0_30, reg_r0_30, t__i32_0); /* line 314 */
   __ADD(reg_r0_12, reg_r0_12, t__i32_1); /* line 315 */
} /* line 315 */
  sim_icache_fetch(208 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __MULLU(reg_r0_32, reg_r0_10, reg_r0_31); /* line 317 */
   __MULHS(reg_r0_31, reg_r0_10, reg_r0_31); /* line 318 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_28); /* line 319 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 320 */
   __CMPLT(reg_b0_0, reg_r0_30, 0); /* line 321 */
   __ADD(reg_r0_28, reg_r0_30, (unsigned int) 255); /* line 322 */
} /* line 322 */
  sim_icache_fetch(214 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_19 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_1, reg_r0_25, 0); /* line 324 */
   __ADD(reg_r0_33, reg_r0_25, (unsigned int) 255); /* line 325 */
   __MULLU(reg_r0_19, reg_r0_15, reg_r0_24); /* line 326 */
   __MULHS(reg_r0_24, reg_r0_15, reg_r0_24); /* line 327 */
   __ADD(reg_r0_27, reg_r0_27, t__i32_0); /* line 328 */
   __SLCT(reg_r0_28, reg_b0_0, reg_r0_28, reg_r0_30); /* line 329 */
} /* line 329 */
  sim_icache_fetch(220 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __ADD(reg_r0_32, reg_r0_32, reg_r0_31); /* line 331 */
   __SLCT(reg_r0_33, reg_b0_1, reg_r0_33, reg_r0_25); /* line 332 */
   __SHRU(reg_r0_30, reg_r0_16, (unsigned int) 16); /* line 333 */
   __CMPLT(reg_b0_0, reg_r0_27, 0); /* line 334 */
   __ADD(reg_r0_25, reg_r0_27, (unsigned int) 255); /* line 335 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 336 */
} /* line 336 */
  sim_icache_fetch(226 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_32, 0); /* line 338 */
   __ADD(reg_r0_27, reg_r0_32, (unsigned int) 255); /* line 339 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 340 */
   __ADD(reg_r0_19, reg_r0_19, reg_r0_24); /* line 341 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 342 */
   __SLCT(reg_r0_25, t__i32_0, reg_r0_25, t__i32_1); /* line 343 */
} /* line 343 */
  sim_icache_fetch(232 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SLCT(reg_r0_27, reg_b0_0, reg_r0_27, reg_r0_32); /* line 345 */
   __CMPLT(reg_b0_0, reg_r0_19, 0); /* line 346 */
   __ADD(reg_r0_24, reg_r0_19, (unsigned int) 255); /* line 347 */
   __MULLU(reg_r0_31, reg_r0_17, reg_r0_30); /* line 348 */
   __MULHS(reg_r0_30, reg_r0_17, reg_r0_30); /* line 349 */
  ...
  sim_icache_fetch(238 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_25 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 352 */
   __SHRU(reg_r0_25, reg_r0_21, (unsigned int) 16); /* line 353 */
   __SLCT(reg_r0_24, reg_b0_0, reg_r0_24, reg_r0_19); /* line 354 */
   __SHRU(reg_r0_32, reg_r0_26, (unsigned int) 16); /* line 355 */
   __SHRU(reg_r0_19, reg_r0_18, (unsigned int) 16); /* line 356 */
   __ADD(reg_r0_33, reg_r0_33, t__i32_0); /* line 357 */
} /* line 357 */
  sim_icache_fetch(244 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 359 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 360 */
   __ADD(reg_r0_31, reg_r0_31, reg_r0_30); /* line 361 */
   __AND(reg_r0_19, reg_r0_19, (unsigned int) 255); /* line 362 */
   __ADD(reg_r0_12, reg_r0_12, reg_r0_33); /* line 363 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_28); /* line 364 */
} /* line 364 */
  sim_icache_fetch(250 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_29 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __MULLU(reg_r0_30, reg_r0_22, reg_r0_25); /* line 366 */
   __CMPLT(reg_b0_0, reg_r0_31, 0); /* line 367 */
   __ADD(reg_r0_28, reg_r0_31, (unsigned int) 255); /* line 368 */
   __MULLU(reg_r0_29, reg_r0_20, reg_r0_19); /* line 369 */
   __MULHS(reg_r0_19, reg_r0_20, reg_r0_19); /* line 370 */
   __ADD(reg_r0_12, t__i32_0, reg_r0_12); /* line 371 */
} /* line 371 */
  sim_icache_fetch(256 + t_thisfile.offset, 6);
{
   ...
   __MULHS(reg_r0_25, reg_r0_22, reg_r0_25); /* line 374 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 375 */
   __SLCT(reg_r0_28, reg_b0_0, reg_r0_28, reg_r0_31); /* line 376 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 377 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 378 */
} /* line 378 */
  sim_icache_fetch(262 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_19 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 380 */
   __MULLU(reg_r0_19, reg_r0_23, reg_r0_32); /* line 381 */
   __MULHS(reg_r0_32, reg_r0_23, reg_r0_32); /* line 382 */
   __ADD(reg_r0_29, reg_r0_29, t__i32_0); /* line 383 */
   __MULLU(reg_r0_31, reg_r0_7, reg_r0_4); /* line 384 */
   __MULHS(reg_r0_7, reg_r0_7, reg_r0_4); /* line 385 */
} /* line 385 */
  sim_icache_fetch(268 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_25 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __MULLU(reg_r0_25, reg_r0_10, reg_r0_9); /* line 387 */
   __MULHS(reg_r0_10, reg_r0_10, reg_r0_9); /* line 388 */
   __ADD(reg_r0_30, reg_r0_30, t__i32_0); /* line 389 */
   __CMPLT(reg_b0_0, reg_r0_29, 0); /* line 390 */
   __ADD(reg_r0_4, reg_r0_29, (unsigned int) 255); /* line 391 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_28); /* line 392 */
} /* line 392 */
  sim_icache_fetch(274 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_30, 0); /* line 394 */
   __ADD(reg_r0_9, reg_r0_30, (unsigned int) 255); /* line 395 */
   __ADD(reg_r0_19, reg_r0_19, reg_r0_32); /* line 396 */
   __SLCT(reg_r0_4, t__i32_0, reg_r0_4, reg_r0_29); /* line 397 */
   __ADD(reg_r0_31, reg_r0_31, reg_r0_7); /* line 398 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_24); /* line 399 */
} /* line 399 */
  sim_icache_fetch(280 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_30); /* line 401 */
   __CMPLT(reg_b0_0, reg_r0_19, 0); /* line 402 */
   __ADD(reg_r0_7, reg_r0_19, (unsigned int) 255); /* line 403 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 404 */
   __CMPLT(reg_b0_1, reg_r0_31, 0); /* line 405 */
   __ADD(reg_r0_24, reg_r0_31, (unsigned int) 255); /* line 406 */
} /* line 406 */
  sim_icache_fetch(286 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __ADD(reg_r0_25, reg_r0_25, reg_r0_10); /* line 408 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 409 */
   __MULLU(reg_r0_4, reg_r0_15, reg_r0_11); /* line 410 */
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_19); /* line 411 */
   __SLCT(reg_r0_24, reg_b0_1, reg_r0_24, reg_r0_31); /* line 412 */
   __ADD(reg_r0_13, reg_r0_13, t__i32_0); /* line 413 */
} /* line 413 */
  sim_icache_fetch(292 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 415 */
   __ADD(reg_r0_10, reg_r0_25, (unsigned int) 255); /* line 416 */
   __MULHS(reg_r0_15, reg_r0_15, reg_r0_11); /* line 417 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 418 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 419 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 420 */
} /* line 420 */
  sim_icache_fetch(298 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SLCT(reg_r0_10, reg_b0_0, reg_r0_10, reg_r0_25); /* line 422 */
   __AND(reg_r0_21, reg_r0_21, (unsigned int) 255); /* line 423 */
   __MULLU(reg_r0_7, reg_r0_17, reg_r0_16); /* line 424 */
   __MULHS(reg_r0_17, reg_r0_17, reg_r0_16); /* line 425 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 426 */
   __ADD(reg_r0_9, reg_r0_9, t__i32_0); /* line 427 */
} /* line 427 */
  sim_icache_fetch(304 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 429 */
   __MULLU(reg_r0_11, reg_r0_22, reg_r0_21); /* line 430 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_15); /* line 431 */
   __MULLU(reg_r0_9, reg_r0_20, reg_r0_18); /* line 432 */
   __MULHS(reg_r0_20, reg_r0_20, reg_r0_18); /* line 433 */
   __ADD(reg_r0_13, reg_r0_13, t__i32_0); /* line 434 */
} /* line 434 */
  sim_icache_fetch(310 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __MULHS(reg_r0_22, reg_r0_22, reg_r0_21); /* line 436 */
   __CMPLT(reg_b0_0, reg_r0_4, 0); /* line 437 */
   __ADD(reg_r0_15, reg_r0_4, (unsigned int) 255); /* line 438 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_17); /* line 439 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_24); /* line 440 */
   __ADD(reg_r0_13, reg_r0_27, reg_r0_13); /* line 441 */
} /* line 441 */
  sim_icache_fetch(316 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SLCT(reg_r0_15, reg_b0_0, reg_r0_15, reg_r0_4); /* line 443 */
   __CMPLT(reg_b0_0, reg_r0_7, 0); /* line 444 */
   __ADD(reg_r0_4, reg_r0_7, (unsigned int) 255); /* line 445 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 446 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_20); /* line 447 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 448 */
} /* line 448 */
  sim_icache_fetch(322 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __ADD(reg_r0_11, reg_r0_11, reg_r0_22); /* line 450 */
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 451 */
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_7); /* line 452 */
   __MULLU(reg_r0_16, reg_r0_23, reg_r0_26); /* line 453 */
   __CMPLT(reg_b0_0, reg_r0_9, 0); /* line 454 */
   __ADD(reg_r0_7, reg_r0_9, (unsigned int) 255); /* line 455 */
} /* line 455 */
  sim_icache_fetch(328 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_11, 0); /* line 457 */
   __ADD(reg_r0_9, reg_r0_11, (unsigned int) 255); /* line 458 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 459 */
   __MULHS(reg_r0_23, reg_r0_23, reg_r0_26); /* line 460 */
   __SLCT(reg_r0_7, t__i32_0, reg_r0_7, t__i32_1); /* line 461 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 462 */
} /* line 462 */
  sim_icache_fetch(334 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SLCT(reg_r0_9, reg_b0_0, reg_r0_9, reg_r0_11); /* line 464 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 465 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 466 */
   __ADD(reg_r0_15, reg_r0_15, reg_r0_4); /* line 467 */
} /* line 467 */
  sim_icache_fetch(338 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 469 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_23); /* line 470 */
   __ADD(reg_r0_14, reg_r0_14, reg_r0_7); /* line 471 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_15); /* line 472 */
} /* line 472 */
  sim_icache_fetch(342 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_0, reg_r0_16, 0); /* line 474 */
   __ADD(reg_r0_4, reg_r0_16, (unsigned int) 255); /* line 475 */
} /* line 475 */
  sim_icache_fetch(344 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_16); /* line 477 */
} /* line 477 */
  sim_icache_fetch(345 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 479 */
} /* line 479 */
  sim_icache_fetch(346 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_9, reg_r0_9, reg_r0_4); /* line 481 */
} /* line 481 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_14, reg_r0_14, reg_r0_9); /* line 483 */
} /* line 483 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_14, reg_r0_10, reg_r0_14); /* line 485 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_14, reg_r0_14, 0); /* line 490 */
   __MAX(reg_r0_12, reg_r0_12, 0); /* line 491 */
   __MAX(reg_r0_13, reg_r0_13, 0); /* line 492 */
   __SH2ADD(reg_r0_2, reg_r0_34, reg_r0_36); /* line 493 */
   __ADD(reg_r0_4, reg_r0_34, (unsigned int) 1); /* line 494 */
} /* line 494 */
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 496 */
   __MIN(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 497 */
   __MIN(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 498 */
   __ADD(reg_r0_7, reg_r0_35, (unsigned int) 1); /* line 499 */
} /* line 499 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 501 */
   __SHL(reg_r0_13, reg_r0_13, (unsigned int) 16); /* line 502 */
} /* line 502 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_14, reg_r0_14, reg_r0_13); /* line 504 */
} /* line 504 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_14, reg_r0_14, reg_r0_12); /* line 506 */
} /* line 506 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_14); /* line 508 */
  ...
  sim_icache_fetch(365 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_36, reg_r0_36, (unsigned int) 256); /* line 513 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 64); /* line 514 */
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 1); /* line 515 */
  ...
  sim_icache_fetch(370 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_37); /* line 522 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 523 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(375 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 525 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 526 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 527 */
   __ADD_CYCLES(1);
} /* line 527 */
