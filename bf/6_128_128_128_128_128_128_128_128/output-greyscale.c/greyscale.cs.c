  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 155 */
   __MOV(reg_r0_5, (unsigned int) grey_framebuffer); /* line 156 */
   __MOV(reg_r0_6, (unsigned int) grey_image); /* line 157 */
   __MOV(reg_r0_25, t__i32_0); /* line 158 */
} /* line 158 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 163 */
   __MOV(reg_r0_10, (unsigned int) -55); /* line 164 */
   __MOV(reg_r0_4, reg_r0_5); /* line 165 */
   __MOV(reg_r0_2, reg_r0_6); /* line 166 */
   __MOV(reg_r0_22, reg_r0_3); /* line 167 */
   __MOV(reg_r0_23, reg_r0_5); /* line 168 */
} /* line 168 */
  sim_icache_fetch(74 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_24, reg_r0_6); /* line 170 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L5X3; 
...
l_L6X3: ;/* line 174 */
__LABEL(l_L6X3);
  sim_icache_fetch(76 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __LDW(reg_r0_5, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 175 */
   __LDW(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 176 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 177 */
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 178 */
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 16),0,4)); /* line 179 */
   __LDW(reg_r0_9, mem_trace_ld((reg_r0_2 + (unsigned int) 20),0,4)); /* line 180 */
} /* line 180 */
  sim_icache_fetch(82 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 24),0,4)); /* line 182 */
   __LDW(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 183 */
   __LDW(reg_r0_13, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 184 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 185 */
   __LDWs(reg_r0_14, mem_trace_ld((reg_r0_2 + (unsigned int) 36),0,4)); /* line 186 */
   __LDWs(reg_r0_15, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 187 */
} /* line 187 */
  sim_icache_fetch(88 + t_thisfile.offset, 6);
{
   ...
   __SHRU(reg_r0_16, reg_r0_3, (unsigned int) 8); /* line 191 */
   __SHRU(reg_r0_18, reg_r0_5, (unsigned int) 8); /* line 192 */
  ...
  sim_icache_fetch(94 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __AND(reg_r0_21, reg_r0_6, (unsigned int) 255); /* line 196 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 197 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 198 */
   __SHRU(reg_r0_20, reg_r0_6, (unsigned int) 8); /* line 199 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 200 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 201 */
} /* line 201 */
  sim_icache_fetch(100 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 203 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 204 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 205 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 206 */
   __AND(reg_r0_18, reg_r0_7, (unsigned int) 255); /* line 207 */
   __SHRU(reg_r0_16, reg_r0_7, (unsigned int) 8); /* line 208 */
} /* line 208 */
  sim_icache_fetch(106 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 210 */
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 211 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 212 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 213 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 214 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 215 */
} /* line 215 */
  sim_icache_fetch(112 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 217 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 218 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 219 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 220 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 221 */
   __SHRU(reg_r0_3, reg_r0_8, (unsigned int) 8); /* line 222 */
} /* line 222 */
  sim_icache_fetch(118 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHL(reg_r0_6, reg_r0_17, (unsigned int) 8); /* line 224 */
   __SHL(reg_r0_5, reg_r0_17, (unsigned int) 16); /* line 225 */
   __SHL(reg_r0_20, reg_r0_19, (unsigned int) 8); /* line 226 */
   __SHL(reg_r0_16, reg_r0_19, (unsigned int) 16); /* line 227 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 228 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_7); /* line 229 */
} /* line 229 */
  sim_icache_fetch(124 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_17, reg_r0_17, reg_r0_5); /* line 231 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_16); /* line 232 */
   __SHL(reg_r0_7, reg_r0_21, (unsigned int) 8); /* line 233 */
   __SHL(reg_r0_5, reg_r0_21, (unsigned int) 16); /* line 234 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 235 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 236 */
} /* line 236 */
  sim_icache_fetch(130 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_17, reg_r0_17, reg_r0_6); /* line 238 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_20); /* line 239 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_5); /* line 240 */
   __SHL(reg_r0_6, reg_r0_18, (unsigned int) 8); /* line 241 */
   __SHL(reg_r0_5, reg_r0_18, (unsigned int) 16); /* line 242 */
   __AND(reg_r0_16, reg_r0_8, (unsigned int) 255); /* line 243 */
} /* line 243 */
  sim_icache_fetch(136 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_21, reg_r0_21, reg_r0_7); /* line 245 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_5); /* line 246 */
   __MAX(reg_r0_16, reg_r0_16, reg_r0_3); /* line 247 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 248 */
   __AND(reg_r0_5, reg_r0_9, (unsigned int) 255); /* line 249 */
   __SHRU(reg_r0_3, reg_r0_9, (unsigned int) 8); /* line 250 */
} /* line 250 */
  sim_icache_fetch(142 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_18, reg_r0_18, reg_r0_6); /* line 252 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 253 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 254 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 255 */
   __AND(reg_r0_7, reg_r0_11, (unsigned int) 255); /* line 256 */
   __SHRU(reg_r0_6, reg_r0_11, (unsigned int) 8); /* line 257 */
} /* line 257 */
  sim_icache_fetch(148 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __MAX(reg_r0_16, reg_r0_16, reg_r0_8); /* line 259 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_3); /* line 260 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 261 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 262 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 263 */
   __SHRU(reg_r0_3, reg_r0_12, (unsigned int) 8); /* line 264 */
} /* line 264 */
  sim_icache_fetch(154 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __ZXTB(reg_r0_16, reg_r0_16); /* line 266 */
   __MAX(reg_r0_5, reg_r0_5, reg_r0_9); /* line 267 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_6); /* line 268 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 269 */
   __AND(reg_r0_6, reg_r0_12, (unsigned int) 255); /* line 270 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 271 */
} /* line 271 */
  sim_icache_fetch(160 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHL(reg_r0_9, reg_r0_16, (unsigned int) 8); /* line 273 */
   __SHL(reg_r0_8, reg_r0_16, (unsigned int) 16); /* line 274 */
   __ZXTB(reg_r0_5, reg_r0_5); /* line 275 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_11); /* line 276 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_3); /* line 277 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 278 */
} /* line 278 */
  sim_icache_fetch(166 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_16, reg_r0_16, reg_r0_8); /* line 280 */
   __SHL(reg_r0_8, reg_r0_5, (unsigned int) 8); /* line 281 */
   __SHL(reg_r0_3, reg_r0_5, (unsigned int) 16); /* line 282 */
   __ZXTB(reg_r0_7, reg_r0_7); /* line 283 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 284 */
   __SHRU(reg_r0_11, reg_r0_13, (unsigned int) 8); /* line 285 */
} /* line 285 */
  sim_icache_fetch(172 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_16, reg_r0_16, reg_r0_9); /* line 287 */
   __OR(reg_r0_5, reg_r0_5, reg_r0_3); /* line 288 */
   __SHL(reg_r0_9, reg_r0_7, (unsigned int) 8); /* line 289 */
   __SHL(reg_r0_3, reg_r0_7, (unsigned int) 16); /* line 290 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_12); /* line 291 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 292 */
} /* line 292 */
  sim_icache_fetch(178 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_5, reg_r0_5, reg_r0_8); /* line 294 */
   __OR(reg_r0_7, reg_r0_7, reg_r0_3); /* line 295 */
   __ZXTB(reg_r0_6, reg_r0_6); /* line 296 */
   __AND(reg_r0_3, reg_r0_13, (unsigned int) 255); /* line 297 */
   __SHRU(reg_r0_13, reg_r0_13, (unsigned int) 16); /* line 298 */
   __SHRU(reg_r0_8, reg_r0_14, (unsigned int) 8); /* line 299 */
} /* line 299 */
  sim_icache_fetch(184 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_7, reg_r0_7, reg_r0_9); /* line 301 */
   __SHL(reg_r0_12, reg_r0_6, (unsigned int) 8); /* line 302 */
   __SHL(reg_r0_9, reg_r0_6, (unsigned int) 16); /* line 303 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_11); /* line 304 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 305 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 306 */
} /* line 306 */
  sim_icache_fetch(190 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_6, reg_r0_6, reg_r0_9); /* line 308 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_13); /* line 309 */
   __AND(reg_r0_9, reg_r0_14, (unsigned int) 255); /* line 310 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 311 */
   __AND(reg_r0_13, reg_r0_15, (unsigned int) 255); /* line 312 */
   __SHRU(reg_r0_11, reg_r0_15, (unsigned int) 8); /* line 313 */
} /* line 313 */
  sim_icache_fetch(196 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __OR(reg_r0_6, reg_r0_6, reg_r0_12); /* line 315 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 316 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_8); /* line 317 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 318 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 319 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 320 */
} /* line 320 */
  sim_icache_fetch(202 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SHL(reg_r0_12, reg_r0_3, (unsigned int) 8); /* line 322 */
   __SHL(reg_r0_8, reg_r0_3, (unsigned int) 16); /* line 323 */
   __MAX(reg_r0_9, reg_r0_9, reg_r0_14); /* line 324 */
   __MAX(reg_r0_13, reg_r0_13, reg_r0_11); /* line 325 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 326 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 327 */
} /* line 327 */
  sim_icache_fetch(208 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 329 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 330 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_8); /* line 331 */
   __ZXTB(reg_r0_9, reg_r0_9); /* line 332 */
   __MAX(reg_r0_13, reg_r0_13, reg_r0_15); /* line 333 */
   __ADD(reg_r0_10, reg_r0_10, (unsigned int) 11); /* line 334 */
} /* line 334 */
  sim_icache_fetch(214 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 336 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_18); /* line 337 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_12); /* line 338 */
   __SHL(reg_r0_11, reg_r0_9, (unsigned int) 8); /* line 339 */
   __SHL(reg_r0_8, reg_r0_9, (unsigned int) 16); /* line 340 */
   __ZXTB(reg_r0_13, reg_r0_13); /* line 341 */
} /* line 341 */
  sim_icache_fetch(220 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_16); /* line 343 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_5); /* line 344 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_7); /* line 345 */
   __OR(reg_r0_9, reg_r0_9, reg_r0_8); /* line 346 */
   __SHL(reg_r0_12, reg_r0_13, (unsigned int) 8); /* line 347 */
   __SHL(reg_r0_8, reg_r0_13, (unsigned int) 16); /* line 348 */
} /* line 348 */
  sim_icache_fetch(226 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_6); /* line 350 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_3); /* line 351 */
   __OR(reg_r0_9, reg_r0_9, reg_r0_11); /* line 352 */
   __OR(reg_r0_13, reg_r0_13, reg_r0_8); /* line 353 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(231 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_9); /* line 356 */
   __OR(reg_r0_13, reg_r0_13, reg_r0_12); /* line 357 */
} /* line 357 */
  sim_icache_fetch(233 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_13); /* line 359 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 360 */
  ...
  sim_icache_fetch(236 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_24, (unsigned int) 256); /* line 365 */
   __ADD(reg_r0_5, reg_r0_23, (unsigned int) 256); /* line 366 */
   __ADD(reg_r0_3, reg_r0_22, (unsigned int) 1); /* line 367 */
  ...
  sim_icache_fetch(242 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_25); /* line 374 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 375 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(247 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 377 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 378 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 379 */
   __ADD_CYCLES(1);
} /* line 379 */
