  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   ...
   __MOV(reg_r0_39, t__i32_0); /* line 154 */
} /* line 154 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   ...
   __MOV(reg_r0_36, reg_r0_3); /* line 163 */
   __MOV(reg_r0_37, reg_r0_5); /* line 164 */
   __MOV(reg_r0_38, reg_r0_6); /* line 165 */
} /* line 165 */
  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
  ...
  sim_icache_fetch(91 + t_thisfile.offset, 22);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   ...
   __SHRU(reg_r0_30, reg_r0_11, (unsigned int) 8); /* line 208 */
} /* line 208 */
  sim_icache_fetch(113 + t_thisfile.offset, 22);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 210 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 211 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 212 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 213 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 214 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 215 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 216 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 217 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 218 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 219 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 220 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 221 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 222 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 223 */
   __AND(reg_r0_31, reg_r0_11, (unsigned int) 255); /* line 224 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 225 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 226 */
   __AND(reg_r0_33, reg_r0_12, (unsigned int) 255); /* line 227 */
   __SHRU(reg_r0_32, reg_r0_12, (unsigned int) 8); /* line 228 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 229 */
   __AND(reg_r0_35, reg_r0_14, (unsigned int) 255); /* line 230 */
   __SHRU(reg_r0_34, reg_r0_14, (unsigned int) 8); /* line 231 */
} /* line 231 */
  sim_icache_fetch(135 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 233 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 234 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 235 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 236 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 237 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 238 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_28); /* line 239 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_30); /* line 240 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 241 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 242 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 243 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 244 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 245 */
   __AND(reg_r0_18, reg_r0_15, (unsigned int) 255); /* line 246 */
   __SHRU(reg_r0_16, reg_r0_15, (unsigned int) 8); /* line 247 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 248 */
} /* line 248 */
  sim_icache_fetch(151 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 250 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 251 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 252 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 253 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 254 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 255 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_10); /* line 256 */
   __MAX(reg_r0_31, reg_r0_31, reg_r0_11); /* line 257 */
   __MAX(reg_r0_33, reg_r0_33, reg_r0_32); /* line 258 */
   __MAX(reg_r0_35, reg_r0_35, reg_r0_34); /* line 259 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 260 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 261 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 262 */
} /* line 262 */
  sim_icache_fetch(164 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 264 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 265 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 266 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 267 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 268 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 269 */
   __ZXTB(reg_r0_29, reg_r0_29); /* line 270 */
   __ZXTB(reg_r0_31, reg_r0_31); /* line 271 */
   __MAX(reg_r0_33, reg_r0_33, reg_r0_12); /* line 272 */
   __MAX(reg_r0_35, reg_r0_35, reg_r0_14); /* line 273 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 274 */
} /* line 274 */
  sim_icache_fetch(175 + t_thisfile.offset, 19);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(19);
   __SHL(reg_r0_5, reg_r0_17, (unsigned int) 8); /* line 276 */
   __SHL(reg_r0_3, reg_r0_17, (unsigned int) 16); /* line 277 */
   __SHL(reg_r0_7, reg_r0_19, (unsigned int) 8); /* line 278 */
   __SHL(reg_r0_6, reg_r0_19, (unsigned int) 16); /* line 279 */
   __SHL(reg_r0_9, reg_r0_21, (unsigned int) 8); /* line 280 */
   __SHL(reg_r0_8, reg_r0_21, (unsigned int) 16); /* line 281 */
   __SHL(reg_r0_11, reg_r0_23, (unsigned int) 8); /* line 282 */
   __SHL(reg_r0_10, reg_r0_23, (unsigned int) 16); /* line 283 */
   __SHL(reg_r0_14, reg_r0_25, (unsigned int) 8); /* line 284 */
   __SHL(reg_r0_12, reg_r0_25, (unsigned int) 16); /* line 285 */
   __SHL(reg_r0_20, reg_r0_27, (unsigned int) 8); /* line 286 */
   __SHL(reg_r0_16, reg_r0_27, (unsigned int) 16); /* line 287 */
   __SHL(reg_r0_24, reg_r0_29, (unsigned int) 8); /* line 288 */
   __SHL(reg_r0_22, reg_r0_29, (unsigned int) 16); /* line 289 */
   __SHL(reg_r0_28, reg_r0_31, (unsigned int) 8); /* line 290 */
   __SHL(reg_r0_26, reg_r0_31, (unsigned int) 16); /* line 291 */
   __ZXTB(reg_r0_33, reg_r0_33); /* line 292 */
   __ZXTB(reg_r0_35, reg_r0_35); /* line 293 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_15); /* line 294 */
} /* line 294 */
  sim_icache_fetch(194 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_3); /* line 296 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_6); /* line 297 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_8); /* line 298 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_10); /* line 299 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_12); /* line 300 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_16); /* line 301 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_22); /* line 302 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_26); /* line 303 */
   __SHL(reg_r0_6, reg_r0_33, (unsigned int) 8); /* line 304 */
   __SHL(reg_r0_3, reg_r0_33, (unsigned int) 16); /* line 305 */
   __SHL(reg_r0_10, reg_r0_35, (unsigned int) 8); /* line 306 */
   __SHL(reg_r0_8, reg_r0_35, (unsigned int) 16); /* line 307 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 308 */
} /* line 308 */
  sim_icache_fetch(207 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __OR(reg_r0_17, reg_r0_17, reg_r0_5); /* line 310 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_7); /* line 311 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_9); /* line 312 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_11); /* line 313 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_14); /* line 314 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_20); /* line 315 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_24); /* line 316 */
   __OR(reg_r0_31, reg_r0_31, reg_r0_28); /* line 317 */
   __OR(reg_r0_33, reg_r0_33, reg_r0_3); /* line 318 */
   __OR(reg_r0_35, reg_r0_35, reg_r0_8); /* line 319 */
   __SHL(reg_r0_5, reg_r0_18, (unsigned int) 8); /* line 320 */
   __SHL(reg_r0_3, reg_r0_18, (unsigned int) 16); /* line 321 */
} /* line 321 */
  sim_icache_fetch(219 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 323 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 324 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 325 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 326 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 327 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 328 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_29); /* line 329 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_31); /* line 330 */
   __OR(reg_r0_33, reg_r0_33, reg_r0_6); /* line 331 */
   __OR(reg_r0_35, reg_r0_35, reg_r0_10); /* line 332 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_3); /* line 333 */
} /* line 333 */
  sim_icache_fetch(230 + t_thisfile.offset, 3);
{
   ...
   __OR(reg_r0_18, reg_r0_18, reg_r0_5); /* line 336 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(233 + t_thisfile.offset, 4);
{
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_18); /* line 340 */
  ...
  sim_icache_fetch(237 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_38, (unsigned int) 256); /* line 346 */
   __ADD(reg_r0_5, reg_r0_37, (unsigned int) 256); /* line 347 */
   __ADD(reg_r0_3, reg_r0_36, (unsigned int) 1); /* line 348 */
  ...
  sim_icache_fetch(243 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_39); /* line 355 */
