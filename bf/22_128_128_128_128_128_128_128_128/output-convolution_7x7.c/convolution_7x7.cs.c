  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 22);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   ...
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 134 */
} /* line 134 */
  sim_icache_fetch(49 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
  ...
  sim_icache_fetch(153 + t_thisfile.offset, 22);
{
  ...
  sim_icache_fetch(175 + t_thisfile.offset, 22);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   ...
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 271 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 272 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 273 */
   __MULLU(reg_r0_9, reg_r0_12, reg_r0_11); /* line 274 */
   __MULHS(reg_r0_11, reg_r0_12, reg_r0_11); /* line 275 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 276 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 277 */
   __MULLU(reg_r0_41, reg_r0_14, reg_r0_13); /* line 278 */
   __MULHS(reg_r0_13, reg_r0_14, reg_r0_13); /* line 279 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 280 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 281 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 282 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 283 */
   __MULLU(reg_r0_42, reg_r0_16, reg_r0_15); /* line 284 */
   __MULHS(reg_r0_15, reg_r0_16, reg_r0_15); /* line 285 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 286 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 287 */
   __MULLU(reg_r0_40, reg_r0_7, reg_r0_4); /* line 288 */
   __MULHS(reg_r0_4, reg_r0_7, reg_r0_4); /* line 289 */
} /* line 289 */
  sim_icache_fetch(197 + t_thisfile.offset, 22);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_4 = reg_r0_7 ;
   ...
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 292 */
   __MULLU(reg_r0_47, reg_r0_19, reg_r0_32); /* line 293 */
   __MULHS(reg_r0_32, reg_r0_19, reg_r0_32); /* line 294 */
   __MULLU(reg_r0_10, t__i32_0, reg_r0_25); /* line 295 */
   __MULHS(reg_r0_12, t__i32_0, reg_r0_25); /* line 296 */
   __MULLU(reg_r0_24, t__i32_0, reg_r0_29); /* line 297 */
   __MULHS(reg_r0_29, t__i32_0, reg_r0_29); /* line 298 */
   __MULLU(reg_r0_25, t__i32_1, reg_r0_36); /* line 299 */
   __MULHS(reg_r0_14, t__i32_1, reg_r0_36); /* line 300 */
   __MULLU(reg_r0_45, t__i32_1, reg_r0_30); /* line 301 */
   __MULHS(reg_r0_30, t__i32_1, reg_r0_30); /* line 302 */
   __MULLU(reg_r0_48, reg_r0_21, reg_r0_33); /* line 303 */
   __MULHS(reg_r0_33, reg_r0_21, reg_r0_33); /* line 304 */
   __MULLU(reg_r0_34, t__i32_2, reg_r0_37); /* line 305 */
   __MULHS(reg_r0_16, t__i32_2, reg_r0_37); /* line 306 */
   __MULLU(reg_r0_46, t__i32_2, reg_r0_31); /* line 307 */
   __MULHS(reg_r0_31, t__i32_2, reg_r0_31); /* line 308 */
   __MULLU(reg_r0_49, t__i32_4, t__i32_3); /* line 309 */
   __MULHS(reg_r0_7, t__i32_4, t__i32_3); /* line 310 */
   __MULLU(reg_r0_44, t__i32_4, reg_r0_27); /* line 311 */
   __MULHS(reg_r0_27, t__i32_4, reg_r0_27); /* line 312 */
} /* line 312 */
  sim_icache_fetch(219 + t_thisfile.offset, 17);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __CMPLT(reg_b0_1, reg_r0_35, 0); /* line 314 */
   __ADD(reg_r0_37, reg_r0_35, (unsigned int) 255); /* line 315 */
   __CMPLT(reg_b0_2, reg_r0_26, 0); /* line 316 */
   __ADD(reg_r0_4, reg_r0_26, (unsigned int) 255); /* line 317 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 318 */
   __ADD(reg_r0_36, reg_r0_28, (unsigned int) 255); /* line 319 */
   __MULLU(reg_r0_50, reg_r0_19, reg_r0_38); /* line 320 */
   __MULHS(reg_r0_38, reg_r0_19, reg_r0_38); /* line 321 */
   __MULHS(reg_r0_19, reg_r0_19, reg_r0_18); /* line 322 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_11); /* line 323 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_13); /* line 324 */
   __MULLU(reg_r0_51, reg_r0_21, reg_r0_39); /* line 325 */
   __MULHS(reg_r0_39, reg_r0_21, reg_r0_39); /* line 326 */
   __MULLU(reg_r0_11, reg_r0_21, reg_r0_20); /* line 327 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_20); /* line 328 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_15); /* line 329 */
   __ADD(reg_r0_40, reg_r0_40, t__i32_0); /* line 330 */
} /* line 330 */
  sim_icache_fetch(236 + t_thisfile.offset, 21);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(21);
   __SLCT(reg_r0_37, reg_b0_1, reg_r0_37, reg_r0_35); /* line 332 */
   __SLCT(reg_r0_4, reg_b0_2, reg_r0_4, reg_r0_26); /* line 333 */
   __SLCT(reg_r0_36, reg_b0_0, reg_r0_36, reg_r0_28); /* line 334 */
   __ADD(reg_r0_47, reg_r0_47, reg_r0_32); /* line 335 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_12); /* line 336 */
   __CMPLT(reg_b0_1, reg_r0_9, 0); /* line 337 */
   __ADD(reg_r0_12, reg_r0_9, (unsigned int) 255); /* line 338 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 339 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_14); /* line 340 */
   __CMPLT(reg_b0_2, reg_r0_41, 0); /* line 341 */
   __ADD(reg_r0_13, reg_r0_41, (unsigned int) 255); /* line 342 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_30); /* line 343 */
   __ADD(reg_r0_48, reg_r0_48, reg_r0_33); /* line 344 */
   __ADD(reg_r0_34, reg_r0_34, reg_r0_16); /* line 345 */
   __CMPLT(reg_b0_3, reg_r0_42, 0); /* line 346 */
   __ADD(reg_r0_14, reg_r0_42, (unsigned int) 255); /* line 347 */
   __ADD(reg_r0_46, reg_r0_46, reg_r0_31); /* line 348 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_7); /* line 349 */
   __CMPLT(reg_b0_0, reg_r0_40, 0); /* line 350 */
   __ADD(reg_r0_7, reg_r0_40, (unsigned int) 255); /* line 351 */
   __ADD(reg_r0_44, reg_r0_44, reg_r0_27); /* line 352 */
} /* line 352 */
  sim_icache_fetch(257 + t_thisfile.offset, 22);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_3 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   __SHR(reg_r0_37, reg_r0_37, (unsigned int) 8); /* line 354 */
   __SHR(reg_r0_36, reg_r0_36, (unsigned int) 8); /* line 355 */
   __CMPLT(reg_b0_3, reg_r0_47, 0); /* line 356 */
   __ADD(reg_r0_27, reg_r0_47, (unsigned int) 255); /* line 357 */
   __CMPLT(reg_b0_0, reg_r0_10, 0); /* line 358 */
   __ADD(reg_r0_33, reg_r0_10, (unsigned int) 255); /* line 359 */
   __CMPLT(reg_b0_5, reg_r0_24, 0); /* line 360 */
   __ADD(reg_r0_16, reg_r0_24, (unsigned int) 255); /* line 361 */
   __CMPLT(reg_b0_6, reg_r0_45, 0); /* line 362 */
   __ADD(reg_r0_18, reg_r0_45, (unsigned int) 255); /* line 363 */
   __CMPLT(reg_b0_2, reg_r0_48, 0); /* line 364 */
   __ADD(reg_r0_29, reg_r0_48, (unsigned int) 255); /* line 365 */
   __CMPLT(reg_b0_7, reg_r0_46, 0); /* line 366 */
   __ADD(reg_r0_20, reg_r0_46, (unsigned int) 255); /* line 367 */
   __CMPLT(reg_b0_1, reg_r0_49, 0); /* line 368 */
   __ADD(reg_r0_31, reg_r0_49, (unsigned int) 255); /* line 369 */
   __CMPLT(reg_b0_4, reg_r0_44, 0); /* line 370 */
   __ADD(reg_r0_15, reg_r0_44, (unsigned int) 255); /* line 371 */
   __MFB(reg_r0_26, t__i32_0); /* line 372 */
   __MFB(reg_r0_28, t__i32_1); /* line 373 */
   __MFB(reg_r0_30, t__i32_2); /* line 374 */
   __MFB(reg_r0_32, t__i32_3); /* line 375 */
} /* line 375 */
  sim_icache_fetch(279 + t_thisfile.offset, 21);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(21);
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 377 */
   __ADD(reg_r0_50, reg_r0_50, reg_r0_38); /* line 378 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_19); /* line 379 */
   __SLCT(reg_r0_27, reg_b0_3, reg_r0_27, reg_r0_47); /* line 380 */
   __SLCT(reg_r0_33, reg_b0_0, reg_r0_33, reg_r0_10); /* line 381 */
   __SLCT(reg_r0_16, reg_b0_5, reg_r0_16, reg_r0_24); /* line 382 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 383 */
   __ADD(reg_r0_10, reg_r0_25, (unsigned int) 255); /* line 384 */
   __SLCT(reg_r0_18, reg_b0_6, reg_r0_18, reg_r0_45); /* line 385 */
   __ADD(reg_r0_51, reg_r0_51, reg_r0_39); /* line 386 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_21); /* line 387 */
   __SLCT(reg_r0_29, reg_b0_2, reg_r0_29, reg_r0_48); /* line 388 */
   __CMPLT(reg_b0_1, reg_r0_34, 0); /* line 389 */
   __ADD(reg_r0_24, reg_r0_34, (unsigned int) 255); /* line 390 */
   __SLCT(reg_r0_20, reg_b0_7, reg_r0_20, reg_r0_46); /* line 391 */
   __SLCT(reg_r0_31, t__i32_0, reg_r0_31, reg_r0_49); /* line 392 */
   __SLCT(reg_r0_15, reg_b0_4, reg_r0_15, reg_r0_44); /* line 393 */
   __MTB(reg_b0_5, reg_r0_26); /* line 394 */
   __MTB(reg_b0_4, reg_r0_28); /* line 395 */
   __MTB(reg_b0_3, reg_r0_30); /* line 396 */
   __MTB(reg_b0_2, reg_r0_32); /* line 397 */
} /* line 397 */
  sim_icache_fetch(300 + t_thisfile.offset, 22);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_1 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   __CMPLT(reg_b0_0, reg_r0_50, 0); /* line 399 */
   __ADD(reg_r0_19, reg_r0_50, (unsigned int) 255); /* line 400 */
   __CMPLT(reg_b0_2, reg_r0_43, 0); /* line 401 */
   __ADD(reg_r0_9, reg_r0_43, (unsigned int) 255); /* line 402 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 403 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 404 */
   __SLCT(reg_r0_12, reg_b0_3, reg_r0_12, t__i32_0); /* line 405 */
   __SHR(reg_r0_16, reg_r0_16, (unsigned int) 8); /* line 406 */
   __SLCT(reg_r0_10, t__i32_1, reg_r0_10, reg_r0_25); /* line 407 */
   __SLCT(reg_r0_13, reg_b0_4, reg_r0_13, reg_r0_41); /* line 408 */
   __SHR(reg_r0_18, reg_r0_18, (unsigned int) 8); /* line 409 */
   __CMPLT(reg_b0_1, reg_r0_51, 0); /* line 410 */
   __ADD(reg_r0_21, reg_r0_51, (unsigned int) 255); /* line 411 */
   __CMPLT(reg_b0_3, reg_r0_11, 0); /* line 412 */
   __ADD(reg_r0_25, reg_r0_11, (unsigned int) 255); /* line 413 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 414 */
   __SLCT(reg_r0_24, t__i32_2, reg_r0_24, reg_r0_34); /* line 415 */
   __SLCT(reg_r0_14, reg_b0_5, reg_r0_14, reg_r0_42); /* line 416 */
   __SHR(reg_r0_20, reg_r0_20, (unsigned int) 8); /* line 417 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 418 */
   __SLCT(reg_r0_7, t__i32_3, reg_r0_7, reg_r0_40); /* line 419 */
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 420 */
} /* line 420 */
  sim_icache_fetch(322 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SLCT(reg_r0_19, reg_b0_0, reg_r0_19, reg_r0_50); /* line 422 */
   __SLCT(reg_r0_9, reg_b0_2, reg_r0_9, reg_r0_43); /* line 423 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 424 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 425 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 426 */
   __SLCT(reg_r0_21, reg_b0_1, reg_r0_21, reg_r0_51); /* line 427 */
   __SLCT(reg_r0_25, reg_b0_3, reg_r0_25, reg_r0_11); /* line 428 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 429 */
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 430 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 431 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_15); /* line 432 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_20); /* line 433 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_29); /* line 434 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_18); /* line 435 */
   __ADD(reg_r0_37, reg_r0_37, reg_r0_31); /* line 436 */
} /* line 436 */
  sim_icache_fetch(337 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __SHR(reg_r0_19, reg_r0_19, (unsigned int) 8); /* line 438 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 439 */
   __SHR(reg_r0_21, reg_r0_21, (unsigned int) 8); /* line 440 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 441 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_16); /* line 442 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_27); /* line 443 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_7); /* line 444 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_14); /* line 445 */
   __ADD(reg_r0_12, reg_r0_12, reg_r0_13); /* line 446 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_24); /* line 447 */
   __ADD(reg_r0_33, reg_r0_33, reg_r0_10); /* line 448 */
} /* line 448 */
  sim_icache_fetch(348 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_17, reg_r0_36, reg_r0_17); /* line 450 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_25); /* line 451 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_12); /* line 452 */
   __ADD(reg_r0_19, reg_r0_19, reg_r0_21); /* line 453 */
   __ADD(reg_r0_37, reg_r0_37, reg_r0_33); /* line 454 */
} /* line 454 */
  sim_icache_fetch(353 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_23, reg_r0_9); /* line 456 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_19); /* line 457 */
} /* line 457 */
  sim_icache_fetch(355 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __ADD(reg_r0_23, reg_r0_4, reg_r0_23); /* line 459 */
   __ADD(reg_r0_22, reg_r0_37, reg_r0_22); /* line 460 */
...
l_L9X3: ;/* line 464 */
__LABEL(l_L9X3);
  sim_icache_fetch(358 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_23, reg_r0_23, 0); /* line 465 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 466 */
   __MAX(reg_r0_22, reg_r0_22, 0); /* line 467 */
   __SH2ADD(reg_r0_2, reg_r0_52, reg_r0_54); /* line 468 */
   __ADD(reg_r0_4, reg_r0_52, (unsigned int) 1); /* line 469 */
} /* line 469 */
  sim_icache_fetch(363 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 471 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 472 */
   __MIN(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 473 */
   __ADD(reg_r0_7, reg_r0_53, (unsigned int) 1); /* line 474 */
} /* line 474 */
  sim_icache_fetch(367 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_17, reg_r0_17, (unsigned int) 8); /* line 476 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 16); /* line 477 */
} /* line 477 */
  sim_icache_fetch(369 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_22); /* line 479 */
} /* line 479 */
  sim_icache_fetch(370 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_17); /* line 481 */
} /* line 481 */
  sim_icache_fetch(371 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_23); /* line 483 */
...
l_L7X3: ;/* line 487 */
__LABEL(l_L7X3);
  sim_icache_fetch(373 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_54, reg_r0_54, (unsigned int) 256); /* line 488 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 64); /* line 489 */
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 1); /* line 490 */
  ...
  sim_icache_fetch(378 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_55); /* line 497 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 498 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(383 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 500 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 501 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 502 */
   __ADD_CYCLES(1);
} /* line 502 */
