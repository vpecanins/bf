  ...
  sim_icache_fetch(25 + t_thisfile.offset, 2);
{
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
  ...
  sim_icache_fetch(43 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 44),0,4), 0); /* line 141 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 48),0,4), 0); /* line 142 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 52),0,4), 0); /* line 143 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 56),0,4), 0); /* line 144 */
   __ADD(reg_r0_3, reg_r0_4, (unsigned int) 64); /* line 145 */
} /* line 145 */
  ...
  sim_icache_fetch(61 + t_thisfile.offset, 5);
{
   ...
   __MOV(reg_r0_54, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 154 */
   __MOV(reg_r0_55, reg_r0_5); /* line 155 */
} /* line 155 */
l_L4X3: ;/* line 158 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_22, 0); /* line 171 */
   __MOV(reg_r0_17, 0); /* line 172 */
   __MOV(reg_r0_23, 0); /* line 173 */
   __MOV(reg_r0_52, reg_r0_4); /* line 174 */
   __MOV(reg_r0_53, reg_r0_7); /* line 175 */
} /* line 175 */
...
l_L8X3: ;/* line 180 */
__LABEL(l_L8X3);
  sim_icache_fetch(80 + t_thisfile.offset, 23);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 191 */
   __ADD(reg_r0_15, reg_r0_3, (unsigned int) 5); /* line 192 */
   __SH2ADD(reg_r0_16, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 193 */
   __ADD(reg_r0_4, reg_r0_3, (unsigned int) 6); /* line 194 */
   __SH2ADD(reg_r0_7, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 24)); /* line 195 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 196 */
} /* line 196 */
  sim_icache_fetch(103 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 212 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(120 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __LDW(reg_r0_9, mem_trace_ld(reg_r0_9,0,4)); /* line 215 */
   __ADD(reg_r0_18, reg_r0_5, reg_r0_18); /* line 216 */
   __ADD(reg_r0_11, reg_r0_5, reg_r0_11); /* line 217 */
   __ADD(reg_r0_13, reg_r0_5, reg_r0_13); /* line 218 */
   __ADD(reg_r0_20, reg_r0_5, reg_r0_20); /* line 219 */
   __ADD(reg_r0_15, reg_r0_5, reg_r0_15); /* line 220 */
   __ADD(reg_r0_4, reg_r0_5, reg_r0_4); /* line 221 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 222 */
} /* line 222 */
  sim_icache_fetch(128 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SH2ADD(reg_r0_18, reg_r0_18, (unsigned int) conv7_image); /* line 224 */
   __SH2ADD(reg_r0_11, reg_r0_11, (unsigned int) conv7_image); /* line 225 */
   __SH2ADD(reg_r0_13, reg_r0_13, (unsigned int) conv7_image); /* line 226 */
   __SH2ADD(reg_r0_20, reg_r0_20, (unsigned int) conv7_image); /* line 227 */
  ...
  sim_icache_fetch(149 + t_thisfile.offset, 4);
{
  ...
  sim_icache_fetch(153 + t_thisfile.offset, 16);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   ...
   __SHRU(reg_r0_38, reg_r0_18, (unsigned int) 16); /* line 250 */
   __SHRU(reg_r0_32, reg_r0_18, (unsigned int) 8); /* line 251 */
   __SHRU(reg_r0_25, reg_r0_11, (unsigned int) 16); /* line 252 */
   __SHRU(reg_r0_29, reg_r0_11, (unsigned int) 8); /* line 253 */
   __SHRU(reg_r0_36, reg_r0_13, (unsigned int) 16); /* line 254 */
   __SHRU(reg_r0_30, reg_r0_13, (unsigned int) 8); /* line 255 */
   __SHRU(reg_r0_39, reg_r0_20, (unsigned int) 16); /* line 256 */
   __SHRU(reg_r0_33, reg_r0_20, (unsigned int) 8); /* line 257 */
   __SHRU(reg_r0_37, reg_r0_15, (unsigned int) 16); /* line 258 */
   __SHRU(reg_r0_31, reg_r0_15, (unsigned int) 8); /* line 259 */
   __SHRU(reg_r0_34, reg_r0_4, (unsigned int) 16); /* line 260 */
   __SHRU(reg_r0_27, reg_r0_4, (unsigned int) 8); /* line 261 */
} /* line 261 */
  sim_icache_fetch(169 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_9); /* line 263 */
   __AND(reg_r0_38, reg_r0_38, (unsigned int) 255); /* line 264 */
   __AND(reg_r0_32, reg_r0_32, (unsigned int) 255); /* line 265 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 266 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 267 */
   __AND(reg_r0_29, reg_r0_29, (unsigned int) 255); /* line 268 */
   __AND(reg_r0_36, reg_r0_36, (unsigned int) 255); /* line 269 */
   __AND(reg_r0_13, reg_r0_13, (unsigned int) 255); /* line 270 */
   __AND(reg_r0_30, reg_r0_30, (unsigned int) 255); /* line 271 */
   __AND(reg_r0_39, reg_r0_39, (unsigned int) 255); /* line 272 */
   __AND(reg_r0_33, reg_r0_33, (unsigned int) 255); /* line 273 */
   __AND(reg_r0_37, reg_r0_37, (unsigned int) 255); /* line 274 */
   __AND(reg_r0_31, reg_r0_31, (unsigned int) 255); /* line 275 */
   __AND(reg_r0_34, reg_r0_34, (unsigned int) 255); /* line 276 */
   __AND(reg_r0_4, reg_r0_4, (unsigned int) 255); /* line 277 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 278 */
} /* line 278 */
  sim_icache_fetch(185 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __ADD(reg_r0_35, reg_r0_35, reg_r0_10); /* line 280 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_24); /* line 281 */
   __MULLU(reg_r0_42, reg_r0_19, reg_r0_32); /* line 282 */
   __MULHS(reg_r0_32, reg_r0_19, reg_r0_32); /* line 283 */
   __MULLU(reg_r0_24, reg_r0_12, reg_r0_29); /* line 284 */
   __MULHS(reg_r0_29, reg_r0_12, reg_r0_29); /* line 285 */
   __MULLU(reg_r0_40, reg_r0_14, reg_r0_30); /* line 286 */
   __MULHS(reg_r0_30, reg_r0_14, reg_r0_30); /* line 287 */
   __MULLU(reg_r0_43, reg_r0_21, reg_r0_33); /* line 288 */
   __MULHS(reg_r0_33, reg_r0_21, reg_r0_33); /* line 289 */
   __MULLU(reg_r0_41, reg_r0_16, reg_r0_31); /* line 290 */
   __MULHS(reg_r0_31, reg_r0_16, reg_r0_31); /* line 291 */
   __MULLU(reg_r0_44, reg_r0_7, reg_r0_34); /* line 292 */
   __MULHS(reg_r0_34, reg_r0_7, reg_r0_34); /* line 293 */
   __MULLU(reg_r0_9, reg_r0_7, reg_r0_27); /* line 294 */
   __MULHS(reg_r0_27, reg_r0_7, reg_r0_27); /* line 295 */
} /* line 295 */
  sim_icache_fetch(201 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __CMPLT(reg_b0_1, reg_r0_35, 0); /* line 297 */
   __ADD(reg_r0_45, reg_r0_35, (unsigned int) 255); /* line 298 */
   __CMPLT(reg_b0_0, reg_r0_28, 0); /* line 299 */
   __ADD(reg_r0_10, reg_r0_28, (unsigned int) 255); /* line 300 */
   __MULLU(reg_r0_49, reg_r0_19, reg_r0_38); /* line 301 */
   __MULHS(reg_r0_38, reg_r0_19, reg_r0_38); /* line 302 */
   __MULLU(reg_r0_46, reg_r0_12, reg_r0_25); /* line 303 */
   __MULHS(reg_r0_25, reg_r0_12, reg_r0_25); /* line 304 */
   __MULLU(reg_r0_47, reg_r0_14, reg_r0_36); /* line 305 */
   __MULHS(reg_r0_36, reg_r0_14, reg_r0_36); /* line 306 */
   __MULLU(reg_r0_50, reg_r0_21, reg_r0_39); /* line 307 */
   __MULHS(reg_r0_39, reg_r0_21, reg_r0_39); /* line 308 */
   __MULLU(reg_r0_48, reg_r0_16, reg_r0_37); /* line 309 */
   __MULHS(reg_r0_37, reg_r0_16, reg_r0_37); /* line 310 */
   __MULLU(reg_r0_51, reg_r0_7, reg_r0_4); /* line 311 */
   __MULHS(reg_r0_7, reg_r0_7, reg_r0_4); /* line 312 */
} /* line 312 */
  sim_icache_fetch(217 + t_thisfile.offset, 16);
{
  unsigned int t__i32_0;
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __SLCT(reg_r0_45, reg_b0_1, reg_r0_45, reg_r0_35); /* line 314 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 315 */
   __ADD(reg_r0_4, reg_r0_26, (unsigned int) 255); /* line 316 */
   __SLCT(reg_r0_10, t__i32_0, reg_r0_10, reg_r0_28); /* line 317 */
   __ADD(reg_r0_42, reg_r0_42, reg_r0_32); /* line 318 */
   __MULLU(reg_r0_27, reg_r0_12, reg_r0_11); /* line 319 */
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_11); /* line 320 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_29); /* line 321 */
   __MULLU(reg_r0_11, reg_r0_14, reg_r0_13); /* line 322 */
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_13); /* line 323 */
   __ADD(reg_r0_40, reg_r0_40, reg_r0_30); /* line 324 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_33); /* line 325 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 326 */
   __ADD(reg_r0_41, reg_r0_41, reg_r0_31); /* line 327 */
   __ADD(reg_r0_44, reg_r0_44, reg_r0_34); /* line 328 */
   __ADD(reg_r0_9, reg_r0_9, t__i32_1); /* line 329 */
} /* line 329 */
  sim_icache_fetch(233 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __SHR(reg_r0_45, reg_r0_45, (unsigned int) 8); /* line 331 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 332 */
   __CMPLT(reg_b0_5, reg_r0_42, 0); /* line 333 */
   __ADD(reg_r0_31, reg_r0_42, (unsigned int) 255); /* line 334 */
   __CMPLT(reg_b0_2, reg_r0_24, 0); /* line 335 */
   __ADD(reg_r0_28, reg_r0_24, (unsigned int) 255); /* line 336 */
   __CMPLT(reg_b0_3, reg_r0_40, 0); /* line 337 */
   __ADD(reg_r0_29, reg_r0_40, (unsigned int) 255); /* line 338 */
   __CMPLT(reg_b0_6, reg_r0_43, 0); /* line 339 */
   __ADD(reg_r0_32, reg_r0_43, (unsigned int) 255); /* line 340 */
   __CMPLT(reg_b0_4, reg_r0_41, 0); /* line 341 */
   __ADD(reg_r0_30, reg_r0_41, (unsigned int) 255); /* line 342 */
   __CMPLT(reg_b0_7, reg_r0_44, 0); /* line 343 */
   __ADD(reg_r0_33, reg_r0_44, (unsigned int) 255); /* line 344 */
   __CMPLT(reg_b0_1, reg_r0_9, 0); /* line 345 */
   __ADD(reg_r0_13, reg_r0_9, (unsigned int) 255); /* line 346 */
} /* line 346 */
  sim_icache_fetch(249 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __SLCT(reg_r0_4, reg_b0_0, reg_r0_4, reg_r0_26); /* line 348 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_38); /* line 349 */
   __SLCT(reg_r0_31, reg_b0_5, reg_r0_31, reg_r0_42); /* line 350 */
   __ADD(reg_r0_46, reg_r0_46, reg_r0_25); /* line 351 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_12); /* line 352 */
   __SLCT(reg_r0_28, reg_b0_2, reg_r0_28, reg_r0_24); /* line 353 */
   __ADD(reg_r0_47, reg_r0_47, reg_r0_36); /* line 354 */
   __ADD(reg_r0_11, reg_r0_11, reg_r0_14); /* line 355 */
   __SLCT(reg_r0_29, reg_b0_3, reg_r0_29, reg_r0_40); /* line 356 */
   __ADD(reg_r0_50, reg_r0_50, reg_r0_39); /* line 357 */
   __SLCT(reg_r0_32, reg_b0_6, reg_r0_32, reg_r0_43); /* line 358 */
   __ADD(reg_r0_48, reg_r0_48, reg_r0_37); /* line 359 */
   __SLCT(reg_r0_30, reg_b0_4, reg_r0_30, reg_r0_41); /* line 360 */
   __SLCT(reg_r0_33, reg_b0_7, reg_r0_33, reg_r0_44); /* line 361 */
   __ADD(reg_r0_51, reg_r0_51, reg_r0_7); /* line 362 */
   __SLCT(reg_r0_13, reg_b0_1, reg_r0_13, reg_r0_9); /* line 363 */
} /* line 363 */
  sim_icache_fetch(265 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __CMPLT(reg_b0_3, reg_r0_49, 0); /* line 365 */
   __ADD(reg_r0_14, reg_r0_49, (unsigned int) 255); /* line 366 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 367 */
   __CMPLT(reg_b0_0, reg_r0_46, 0); /* line 368 */
   __ADD(reg_r0_7, reg_r0_46, (unsigned int) 255); /* line 369 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 370 */
   __CMPLT(reg_b0_1, reg_r0_47, 0); /* line 371 */
   __ADD(reg_r0_9, reg_r0_47, (unsigned int) 255); /* line 372 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 373 */
   __CMPLT(reg_b0_4, reg_r0_50, 0); /* line 374 */
   __SHR(reg_r0_32, reg_r0_32, (unsigned int) 8); /* line 375 */
   __CMPLT(reg_b0_2, reg_r0_48, 0); /* line 376 */
   __ADD(reg_r0_12, reg_r0_48, (unsigned int) 255); /* line 377 */
   __SHR(reg_r0_30, reg_r0_30, (unsigned int) 8); /* line 378 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 379 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 380 */
} /* line 380 */
  sim_icache_fetch(281 + t_thisfile.offset, 16);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  ...
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 382 */
   __SLCT(reg_r0_14, reg_b0_3, reg_r0_14, reg_r0_49); /* line 383 */
   __SLCT(reg_r0_7, reg_b0_0, reg_r0_7, reg_r0_46); /* line 384 */
   __CMPLT(reg_b0_1, reg_r0_27, 0); /* line 385 */
   __ADD(reg_r0_25, reg_r0_27, (unsigned int) 255); /* line 386 */
   __SLCT(reg_r0_9, t__i32_0, reg_r0_9, reg_r0_47); /* line 387 */
   __CMPLT(reg_b0_2, reg_r0_11, 0); /* line 388 */
   __ADD(reg_r0_13, reg_r0_50, (unsigned int) 255); /* line 389 */
   __SLCT(reg_r0_12, t__i32_1, reg_r0_12, reg_r0_48); /* line 390 */
   __CMPLT(reg_b0_0, reg_r0_51, 0); /* line 391 */
   __ADD(reg_r0_24, reg_r0_51, (unsigned int) 255); /* line 392 */
   __ADD(reg_r0_10, reg_r0_10, t__i32_2); /* line 393 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_30); /* line 394 */
   __ADD(reg_r0_31, reg_r0_31, reg_r0_32); /* line 395 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_29); /* line 396 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_33); /* line 397 */
} /* line 397 */
  sim_icache_fetch(297 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 399 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 400 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 401 */
   __SLCT(reg_r0_25, reg_b0_1, reg_r0_25, reg_r0_27); /* line 402 */
   __SHR(reg_r0_9, reg_r0_9, (unsigned int) 8); /* line 403 */
   __ADD(reg_r0_26, reg_r0_11, (unsigned int) 255); /* line 404 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 405 */
   __SLCT(reg_r0_13, reg_b0_4, reg_r0_13, reg_r0_50); /* line 406 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 407 */
   __MULLU(reg_r0_27, reg_r0_16, reg_r0_15); /* line 408 */
   __MULHS(reg_r0_16, reg_r0_16, reg_r0_15); /* line 409 */
   __SLCT(reg_r0_24, reg_b0_0, reg_r0_24, reg_r0_51); /* line 410 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_28); /* line 411 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_31); /* line 412 */
} /* line 412 */
  sim_icache_fetch(311 + t_thisfile.offset, 11);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_r0_10 ;
  t__i32_1 = reg_r0_9 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __MULLU(reg_r0_9, reg_r0_19, reg_r0_18); /* line 414 */
   __MULHS(reg_r0_19, reg_r0_19, reg_r0_18); /* line 415 */
   __SHR(reg_r0_25, reg_r0_25, (unsigned int) 8); /* line 416 */
   __SLCT(reg_r0_26, reg_b0_2, reg_r0_26, reg_r0_11); /* line 417 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 418 */
   __MULLU(reg_r0_10, reg_r0_21, reg_r0_20); /* line 419 */
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_20); /* line 420 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 421 */
   __ADD(reg_r0_17, t__i32_0, reg_r0_17); /* line 422 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_12); /* line 423 */
   __ADD(reg_r0_7, reg_r0_7, t__i32_1); /* line 424 */
} /* line 424 */
  sim_icache_fetch(322 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __SHR(reg_r0_26, reg_r0_26, (unsigned int) 8); /* line 426 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_16); /* line 427 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_24); /* line 428 */
   __ADD(reg_r0_14, reg_r0_14, reg_r0_13); /* line 429 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_7); /* line 430 */
} /* line 430 */
  sim_icache_fetch(327 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __ADD(reg_r0_9, reg_r0_9, reg_r0_19); /* line 432 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_21); /* line 433 */
   __CMPLT(reg_b0_0, reg_r0_27, 0); /* line 434 */
   __ADD(reg_r0_7, reg_r0_27, (unsigned int) 255); /* line 435 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_26); /* line 436 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_14); /* line 437 */
} /* line 437 */
  sim_icache_fetch(333 + t_thisfile.offset, 7);
{
  ...
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __CMPLT(reg_b0_0, reg_r0_9, 0); /* line 439 */
   __ADD(reg_r0_11, reg_r0_9, (unsigned int) 255); /* line 440 */
   __CMPLT(reg_b0_1, reg_r0_10, 0); /* line 441 */
   __ADD(reg_r0_12, reg_r0_10, (unsigned int) 255); /* line 442 */
   __SLCT(reg_r0_7, t__i32_0, reg_r0_7, reg_r0_27); /* line 443 */
   __ADD(reg_r0_4, reg_r0_4, reg_r0_25); /* line 444 */
   __ADD(reg_r0_22, reg_r0_45, reg_r0_22); /* line 445 */
} /* line 445 */
  sim_icache_fetch(340 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __SLCT(reg_r0_11, reg_b0_0, reg_r0_11, reg_r0_9); /* line 447 */
   __SLCT(reg_r0_12, reg_b0_1, reg_r0_12, reg_r0_10); /* line 448 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 449 */
} /* line 449 */
  sim_icache_fetch(343 + t_thisfile.offset, 3);
{
   ...
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 452 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_7); /* line 453 */
} /* line 453 */
  sim_icache_fetch(346 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_11, reg_r0_11, reg_r0_12); /* line 455 */
} /* line 455 */
  sim_icache_fetch(347 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_23, reg_r0_23, reg_r0_11); /* line 457 */
} /* line 457 */
  sim_icache_fetch(348 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_4, reg_r0_23); /* line 459 */
  ...
  sim_icache_fetch(350 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_23, reg_r0_23, 0); /* line 464 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 465 */
   __MAX(reg_r0_22, reg_r0_22, 0); /* line 466 */
   __SH2ADD(reg_r0_2, reg_r0_52, reg_r0_54); /* line 467 */
   __ADD(reg_r0_4, reg_r0_52, (unsigned int) 1); /* line 468 */
} /* line 468 */
  sim_icache_fetch(355 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 470 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 471 */
   __MIN(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 472 */
   __ADD(reg_r0_7, reg_r0_53, (unsigned int) 1); /* line 473 */
} /* line 473 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_17, reg_r0_17, (unsigned int) 8); /* line 475 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 16); /* line 476 */
} /* line 476 */
  sim_icache_fetch(361 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_22); /* line 478 */
} /* line 478 */
  sim_icache_fetch(362 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_17); /* line 480 */
} /* line 480 */
  sim_icache_fetch(363 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_23); /* line 482 */
  ...
  sim_icache_fetch(365 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_54, reg_r0_54, (unsigned int) 256); /* line 487 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) 64); /* line 488 */
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 1); /* line 489 */
  ...
  sim_icache_fetch(370 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_55); /* line 496 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 497 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(375 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 499 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 500 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 501 */
   __ADD_CYCLES(1);
} /* line 501 */
