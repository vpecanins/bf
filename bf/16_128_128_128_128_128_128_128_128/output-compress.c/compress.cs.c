...
/* "" */
/* "-dir /home/user/tools/vex-3.43 -fmm=/home/user/workspace/assignment1/configurations/bf/16_128_128_128_128_128_128_128_128/configuration.mm -width 1 -c99inline -ms -mas_g -mas_G -O3 -H3 -o a.out" */
...
unsigned int compress_14715Xoffset[1];
unsigned int compress_14715Xbuf[3];
...
unsigned int compress_14715XBuf[216]; 
unsigned int compress_14715Xrcs_ident[6]; 
  ...
  sim_icache_fetch(11 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_5, (unsigned int) compress_14715XBuf); /* line 35 */
...
extern unsigned int rindex( unsigned int arg0, unsigned int arg1 )
{
  ...
  sim_icache_fetch(44 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __ADD(reg_r0_1, reg_r0_1, (unsigned int) -32); /* line 177 */
   __ADD(reg_r0_10, reg_r0_3, (unsigned int) 3); /* line 178 */
   __ADD(reg_r0_6, reg_r0_3, (unsigned int) 1); /* line 179 */
   __ADD(reg_r0_34, reg_r0_3, (unsigned int) 15); /* line 180 */
   __ADD(reg_r0_32, reg_r0_3, (unsigned int) 14); /* line 181 */
   __ADD(reg_r0_30, reg_r0_3, (unsigned int) 13); /* line 182 */
   __ADD(reg_r0_28, reg_r0_3, (unsigned int) 12); /* line 183 */
   __ADD(reg_r0_26, reg_r0_3, (unsigned int) 11); /* line 184 */
   __ADD(reg_r0_24, reg_r0_3, (unsigned int) 10); /* line 185 */
   __ADD(reg_r0_22, reg_r0_3, (unsigned int) 9); /* line 186 */
   __ADD(reg_r0_20, reg_r0_3, (unsigned int) 8); /* line 187 */
   ...
   __ADD(reg_r0_8, reg_r0_3, (unsigned int) 2); /* line 192 */
} /* line 192 */
  sim_icache_fetch(60 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SXTB(reg_r0_4, reg_r0_4); /* line 194 */
...
l_L0X3: ;/* line 205 */
__LABEL(l_L0X3);
  sim_icache_fetch(69 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
  ...
  sim_icache_fetch(85 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
  ...
  sim_icache_fetch(101 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __CMPNE(reg_b0_0, reg_r0_3, 0); /* line 240 */
   __CMPEQ(reg_b0_1, reg_r0_3, reg_r0_4); /* line 241 */
   __CMPNE(reg_b0_2, reg_r0_7, 0); /* line 242 */
   __CMPEQ(reg_b0_3, reg_r0_7, reg_r0_4); /* line 243 */
   __CMPNE(reg_b0_4, reg_r0_9, 0); /* line 244 */
   __CMPEQ(reg_b0_5, reg_r0_9, reg_r0_4); /* line 245 */
   __CMPNE(reg_b0_6, reg_r0_11, 0); /* line 246 */
   __CMPEQ(reg_b0_7, reg_r0_11, reg_r0_4); /* line 247 */
   __LDBs(reg_r0_3, mem_trace_ld(reg_r0_51,0,1)); /* line 248 */
   __LDBs(reg_r0_7, mem_trace_ld(reg_r0_36,0,1)); /* line 249 */
   __LDBs(reg_r0_9, mem_trace_ld(reg_r0_49,0,1)); /* line 250 */
   __LDBs(reg_r0_11, mem_trace_ld(reg_r0_48,0,1)); /* line 251 */
   __LDBs(reg_r0_52, mem_trace_ld(reg_r0_47,0,1)); /* line 252 */
  ...
  sim_icache_fetch(117 + t_thisfile.offset, 12);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __SLCT(reg_r0_2, reg_b0_1, reg_r0_2, reg_r0_5); /* line 257 */
   __CMPNE(reg_b0_0, reg_r0_13, 0); /* line 258 */
   __CMPEQ(reg_b0_1, reg_r0_13, reg_r0_4); /* line 259 */
   __LDBs(reg_r0_13, mem_trace_ld(reg_r0_43,0,1)); /* line 260 */
  ...
  sim_icache_fetch(188 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_b0_2 ;
   ...
   __CMPNE(reg_b0_2, reg_r0_7, 0); /* line 342 */
   __CMPEQ(reg_b0_3, reg_r0_7, reg_r0_4); /* line 343 */
  ...
  sim_icache_fetch(193 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_b0_4 ;
   ...
   __CMPNE(reg_b0_4, reg_r0_9, 0); /* line 348 */
   __CMPEQ(reg_b0_5, reg_r0_9, reg_r0_4); /* line 349 */
  ...
  sim_icache_fetch(198 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_b0_6 ;
   ...
   __CMPNE(reg_b0_6, reg_r0_11, 0); /* line 354 */
   __CMPEQ(reg_b0_7, reg_r0_11, reg_r0_4); /* line 355 */
  ...
  sim_icache_fetch(204 + t_thisfile.offset, 5);
{
  ...
  t__i32_0 = reg_b0_0 ;
   ...
   __CMPNE(reg_b0_0, reg_r0_52, 0); /* line 361 */
   __CMPEQ(reg_b0_1, reg_r0_52, reg_r0_4); /* line 362 */
  ...
  sim_icache_fetch(221 + t_thisfile.offset, 4);
{
  ...
  t__i32_0 = reg_b0_0 ;
   ...
   __CMPNE(reg_b0_0, reg_r0_13, 0); /* line 382 */
   __CMPEQ(reg_b0_1, reg_r0_13, reg_r0_4); /* line 383 */
   if (!t__i32_0) {    __BRANCHF(t__i32_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L21X3; 
  ...
  sim_icache_fetch(304 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_2, reg_r0_51); /* line 564 */
} /* line 564 */
l_L2X3: ;/* line 567 */
__LABEL(l_L2X3);
  ...
  sim_icache_fetch(698 + t_thisfile.offset, 23);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __STW(mem_trace_st((unsigned int) compress_14715Xoffset,0,4), 0); /* line 1244 */
  ...
  sim_icache_fetch(1751 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 2728 */
  ...
  sim_icache_fetch(1760 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(8);
   __ADD(reg_r0_12, reg_r0_7, (unsigned int) compress_14715Xbuf); /* line 2738 */
   __LDB(reg_r0_10, mem_trace_ld((reg_r0_7 + (unsigned int) compress_14715Xbuf),0,1)); /* line 2739 */
   __ADD(reg_r0_13, reg_r0_7, ((unsigned int) compress_14715Xbuf + (unsigned int) 1)); /* line 2740 */
  ...
  sim_icache_fetch(1779 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STB(mem_trace_st((reg_r0_7 + (unsigned int) compress_14715Xbuf),0,1), reg_r0_2); /* line 2756 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L168X3; 
  ...
  sim_icache_fetch(1786 + t_thisfile.offset, 3);
{
   ...
   __MOV(reg_r0_3, (unsigned int) compress_14715Xbuf); /* line 2766 */
} /* line 2766 */
  ...
  sim_icache_fetch(1791 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 2773 */
  ...
  sim_icache_fetch(1802 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((unsigned int) compress_14715Xoffset,0,4), reg_r0_2); /* line 2783 */
  ...
  sim_icache_fetch(2135 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __STW(mem_trace_st((unsigned int) compress_14715Xoffset,0,4), 0); /* line 3187 */
} /* line 3187 */
l_L170X3: ;/* line 3190 */
__LABEL(l_L170X3);
  sim_icache_fetch(2137 + t_thisfile.offset, 20);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __LDWs(reg_r0_22, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3194 */
   __MOV(reg_r0_10, (unsigned int) 4); /* line 3195 */
   __MOV(reg_r0_11, (unsigned int) 5); /* line 3196 */
   __MOV(reg_r0_12, (unsigned int) 6); /* line 3197 */
   __MOV(reg_r0_13, (unsigned int) 7); /* line 3198 */
   __MOV(reg_r0_14, (unsigned int) 8); /* line 3199 */
   __MOV(reg_r0_15, (unsigned int) 9); /* line 3200 */
   __MOV(reg_r0_16, (unsigned int) 10); /* line 3201 */
  ...
  sim_icache_fetch(2157 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   ...
   __MOV(reg_r0_5, (unsigned int) compress_14715Xbuf); /* line 3211 */
...
l_L175X3: ;/* line 3225 */
__LABEL(l_L175X3);
  sim_icache_fetch(2169 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __ADD(reg_r0_34, reg_r0_9, (unsigned int) 16); /* line 3241 */
} /* line 3241 */
  ...
  sim_icache_fetch(2595 + t_thisfile.offset, 8);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((unsigned int) compress_14715Xoffset,0,4), 0); /* line 3721 */
  ...
  sim_icache_fetch(2637 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_4, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3776 */
   __LDWs(reg_r0_3, mem_trace_ld((unsigned int) bytes_out,0,4)); /* line 3777 */
   __LDWs(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3778 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(2649 + t_thisfile.offset, 3);
{
   ...
   __STW(mem_trace_st((unsigned int) compress_14715Xoffset,0,4), 0); /* line 3790 */
} /* line 3790 */
...
l_L179X3: ;/* line 3801 */
__LABEL(l_L179X3);
  sim_icache_fetch(2657 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __MOV(reg_r0_5, (unsigned int) compress_14715Xbuf); /* line 3817 */
} /* line 3817 */
  ...
  sim_icache_fetch(2675 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3823 */
  ...
  sim_icache_fetch(2693 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3847 */
  ...
  sim_icache_fetch(2711 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3871 */
  ...
  sim_icache_fetch(2729 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3895 */
  ...
  sim_icache_fetch(2747 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3919 */
  ...
  sim_icache_fetch(2765 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3943 */
  ...
  sim_icache_fetch(2783 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3967 */
  ...
  sim_icache_fetch(2801 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 3991 */
  ...
  sim_icache_fetch(2819 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4015 */
  ...
  sim_icache_fetch(2837 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4039 */
  ...
  sim_icache_fetch(2855 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4063 */
  ...
  sim_icache_fetch(2873 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4087 */
  ...
  sim_icache_fetch(2891 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4111 */
  ...
  sim_icache_fetch(2909 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4135 */
  ...
  sim_icache_fetch(2927 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4159 */
  ...
  sim_icache_fetch(2945 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __LDW(reg_r0_2, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4183 */
  ...
  sim_icache_fetch(2965 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4212 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(2974 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4224 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(2983 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4236 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(2992 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4248 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3001 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4260 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3010 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4272 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3019 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4284 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3028 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4296 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3037 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4308 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3046 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4320 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3055 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4332 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3064 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4344 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3073 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4356 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3082 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4368 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3091 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4380 */
   __INC_NOP_CNT((unsigned int) 1);
  ...
  sim_icache_fetch(3100 + t_thisfile.offset, 5);
{
   ...
   __LDW(reg_r0_5, mem_trace_ld((unsigned int) compress_14715Xoffset,0,4)); /* line 4392 */
   __INC_NOP_CNT((unsigned int) 1);
...
extern unsigned int decompress(  )
{
  ...
  sim_icache_fetch(3109 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __ADD(reg_r0_1, reg_r0_1, (unsigned int) -32); /* line 4415 */
   __MOV(reg_r0_7, (unsigned int) 252); /* line 4416 */
   __MOV(reg_r0_8, (unsigned int) 251); /* line 4417 */
   __MOV(reg_r0_9, (unsigned int) 250); /* line 4418 */
   __MOV(reg_r0_10, (unsigned int) 249); /* line 4419 */
   __MOV(reg_r0_11, (unsigned int) 248); /* line 4420 */
   __MOV(reg_r0_12, (unsigned int) 247); /* line 4421 */
   __MOV(reg_r0_13, (unsigned int) 246); /* line 4422 */
   __MOV(reg_r0_14, (unsigned int) 245); /* line 4423 */
   __MOV(reg_r0_15, (unsigned int) 244); /* line 4424 */
   __MOV(reg_r0_16, (unsigned int) 243); /* line 4425 */
   __MOV(reg_r0_17, (unsigned int) 242); /* line 4426 */
   __MOV(reg_r0_18, (unsigned int) 241); /* line 4427 */
   __MOV(reg_r0_19, (unsigned int) 240); /* line 4428 */
   __MOV(reg_r0_21, (unsigned int) 511); /* line 4429 */
   __MOV(reg_r0_20, (unsigned int) 9); /* line 4430 */
} /* line 4430 */
  sim_icache_fetch(3126 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __STW(mem_trace_st((unsigned int) n_bits,0,4), reg_r0_20); /* line 4432 */
   __STW(mem_trace_st((unsigned int) maxcode,0,4), reg_r0_21); /* line 4433 */
   __MOV(reg_r0_2, (unsigned int) 255); /* line 4434 */
   __MOV(reg_r0_3, ((unsigned int) codetab + (unsigned int) 480)); /* line 4435 */
   __MOV(reg_r0_4, ((unsigned int) htab + (unsigned int) 240)); /* line 4436 */
   __MOV(reg_r0_5, (unsigned int) 254); /* line 4437 */
   __MOV(reg_r0_6, (unsigned int) 253); /* line 4438 */
   __MOV(reg_r0_38, reg_l0_0); /* line 4439 */
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_l0_0); /* line 4440 */
} /* line 4440 */
l_L198X3: ;/* line 4443 */
__LABEL(l_L198X3);
  sim_icache_fetch(3139 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __CMPGE(reg_b0_0, reg_r0_2, 0); /* line 4444 */
   __ADD(reg_r0_20, reg_r0_3, (unsigned int) -32); /* line 4445 */
   __ADD(reg_r0_34, reg_r0_16, (unsigned int) -16); /* line 4446 */
   __ADD(reg_r0_33, reg_r0_15, (unsigned int) -16); /* line 4447 */
   __ADD(reg_r0_32, reg_r0_14, (unsigned int) -16); /* line 4448 */
   __ADD(reg_r0_31, reg_r0_13, (unsigned int) -16); /* line 4449 */
   __ADD(reg_r0_30, reg_r0_12, (unsigned int) -16); /* line 4450 */
   __ADD(reg_r0_29, reg_r0_11, (unsigned int) -16); /* line 4451 */
   __ADD(reg_r0_28, reg_r0_10, (unsigned int) -16); /* line 4452 */
   __ADD(reg_r0_27, reg_r0_9, (unsigned int) -16); /* line 4453 */
   __ADD(reg_r0_26, reg_r0_8, (unsigned int) -16); /* line 4454 */
   __ADD(reg_r0_25, reg_r0_7, (unsigned int) -16); /* line 4455 */
   __ADD(reg_r0_24, reg_r0_6, (unsigned int) -16); /* line 4456 */
   __ADD(reg_r0_23, reg_r0_5, (unsigned int) -16); /* line 4457 */
   __ADD(reg_r0_22, reg_r0_4, (unsigned int) -16); /* line 4458 */
   __ADD(reg_r0_21, reg_r0_2, (unsigned int) -16); /* line 4459 */
} /* line 4459 */
  sim_icache_fetch(3155 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_37, reg_r0_19, (unsigned int) -16); /* line 4461 */
   __ADD(reg_r0_36, reg_r0_18, (unsigned int) -16); /* line 4462 */
  ...
  sim_icache_fetch(3159 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STH(mem_trace_st((reg_r0_3 + (unsigned int) 20),0,2), 0); /* line 4476 */
   __ADD(reg_r0_8, reg_r0_26, (unsigned int) -16); /* line 4477 */
   __ADD(reg_r0_7, reg_r0_25, (unsigned int) -16); /* line 4478 */
   __ADD(reg_r0_6, reg_r0_24, (unsigned int) -16); /* line 4479 */
   __ADD(reg_r0_5, reg_r0_23, (unsigned int) -16); /* line 4480 */
   __ADD(reg_r0_2, reg_r0_21, (unsigned int) -16); /* line 4481 */
} /* line 4481 */
  sim_icache_fetch(3175 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STH(mem_trace_st((reg_r0_3 + (unsigned int) 10),0,2), 0); /* line 4492 */
   __STB(mem_trace_st((reg_r0_4 + (unsigned int) 5),0,1), reg_r0_14); /* line 4493 */
   __ADD(reg_r0_13, reg_r0_31, (unsigned int) -16); /* line 4494 */
   __ADD(reg_r0_12, reg_r0_30, (unsigned int) -16); /* line 4495 */
   __ADD(reg_r0_11, reg_r0_29, (unsigned int) -16); /* line 4496 */
   __ADD(reg_r0_10, reg_r0_28, (unsigned int) -16); /* line 4497 */
   __ADD(reg_r0_9, reg_r0_27, (unsigned int) -16); /* line 4498 */
} /* line 4498 */
  sim_icache_fetch(3191 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STH(mem_trace_st(reg_r0_3,0,2), 0); /* line 4508 */
   __STB(mem_trace_st(reg_r0_4,0,1), reg_r0_19); /* line 4509 */
   __ADD(reg_r0_3, reg_r0_20, (unsigned int) -32); /* line 4510 */
   __ADD(reg_r0_18, reg_r0_36, (unsigned int) -16); /* line 4511 */
   __ADD(reg_r0_17, reg_r0_35, (unsigned int) -16); /* line 4512 */
   __ADD(reg_r0_16, reg_r0_34, (unsigned int) -16); /* line 4513 */
   __ADD(reg_r0_15, reg_r0_33, (unsigned int) -16); /* line 4514 */
   __ADD(reg_r0_14, reg_r0_32, (unsigned int) -16); /* line 4515 */
} /* line 4515 */
  sim_icache_fetch(3207 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 30),0,2), 0); /* line 4517 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 15),0,1), reg_r0_21); /* line 4518 */
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 28),0,2), 0); /* line 4519 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 14),0,1), reg_r0_23); /* line 4520 */
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 26),0,2), 0); /* line 4521 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 13),0,1), reg_r0_24); /* line 4522 */
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 24),0,2), 0); /* line 4523 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 12),0,1), reg_r0_25); /* line 4524 */
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 22),0,2), 0); /* line 4525 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 11),0,1), reg_r0_26); /* line 4526 */
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 20),0,2), 0); /* line 4527 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 10),0,1), reg_r0_27); /* line 4528 */
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 18),0,2), 0); /* line 4529 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 9),0,1), reg_r0_28); /* line 4530 */
   __ADD(reg_r0_19, reg_r0_37, (unsigned int) -16); /* line 4531 */
   __ADD(reg_r0_4, reg_r0_22, (unsigned int) -16); /* line 4532 */
} /* line 4532 */
  sim_icache_fetch(3223 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 3),0,1), reg_r0_34); /* line 4545 */
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 4),0,2), 0); /* line 4546 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 2),0,1), reg_r0_35); /* line 4547 */
   __STH(mem_trace_st((reg_r0_20 + (unsigned int) 2),0,2), 0); /* line 4548 */
   __STB(mem_trace_st((reg_r0_22 + (unsigned int) 1),0,1), reg_r0_36); /* line 4549 */
} /* line 4549 */
  sim_icache_fetch(3239 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
  ...
  sim_icache_fetch(3292 + t_thisfile.offset, 1);
{
  ...
  sim_icache_fetch(3293 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STH(mem_trace_st(reg_r0_3,0,2), 0); /* line 4639 */
} /* line 4639 */
  sim_icache_fetch(3309 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
...
l_L225X3: ;/* line 4832 */
__LABEL(l_L225X3);
  sim_icache_fetch(3469 + t_thisfile.offset, 25);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __ADD(reg_r0_25, reg_r0_16, (unsigned int) -16); /* line 4848 */
} /* line 4848 */
  sim_icache_fetch(3494 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __MOV(reg_r0_37, reg_r0_20); /* line 4850 */
...
l_L224X3: ;/* line 5524 */
__LABEL(l_L224X3);
  sim_icache_fetch(4056 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __ADD(reg_r0_6, reg_r0_5, (unsigned int) -1); /* line 5540 */
} /* line 5540 */
  sim_icache_fetch(4073 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, reg_r0_5); /* line 5542 */
   __ADD(reg_r0_21, reg_r0_5, (unsigned int) 1); /* line 5543 */
} /* line 5543 */
  ...
  sim_icache_fetch(4617 + t_thisfile.offset, 11);
{
  ...
  sim_icache_fetch(4628 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) 60),0,4), reg_r0_6); /* line 6438 */
} /* line 6438 */
  sim_icache_fetch(4644 + t_thisfile.offset, 2);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_0, reg_r0_4, (unsigned int) 128); /* line 6440 */
   if (t__i32_0) {    __BRANCH(t__i32_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L279X3; 
  ...
  sim_icache_fetch(4646 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -64),0,4), reg_r0_6); /* line 6443 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -60),0,4), reg_r0_6); /* line 6444 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -56),0,4), reg_r0_6); /* line 6445 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -52),0,4), reg_r0_6); /* line 6446 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -48),0,4), reg_r0_6); /* line 6447 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -44),0,4), reg_r0_6); /* line 6448 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -40),0,4), reg_r0_6); /* line 6449 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -36),0,4), reg_r0_6); /* line 6450 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -32),0,4), reg_r0_6); /* line 6451 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -28),0,4), reg_r0_6); /* line 6452 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -24),0,4), reg_r0_6); /* line 6453 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -20),0,4), reg_r0_6); /* line 6454 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -16),0,4), reg_r0_6); /* line 6455 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -12),0,4), reg_r0_6); /* line 6456 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -8),0,4), reg_r0_6); /* line 6457 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -4),0,4), reg_r0_6); /* line 6458 */
} /* line 6458 */
  sim_icache_fetch(4662 + t_thisfile.offset, 2);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_1, reg_r0_4, (unsigned int) 144); /* line 6460 */
   if (t__i32_0) {    __BRANCH(t__i32_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L280X3; 
  ...
  sim_icache_fetch(4664 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -128),0,4), reg_r0_6); /* line 6463 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -124),0,4), reg_r0_6); /* line 6464 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -120),0,4), reg_r0_6); /* line 6465 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -116),0,4), reg_r0_6); /* line 6466 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -112),0,4), reg_r0_6); /* line 6467 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -108),0,4), reg_r0_6); /* line 6468 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -104),0,4), reg_r0_6); /* line 6469 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -100),0,4), reg_r0_6); /* line 6470 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -96),0,4), reg_r0_6); /* line 6471 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -92),0,4), reg_r0_6); /* line 6472 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -88),0,4), reg_r0_6); /* line 6473 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -84),0,4), reg_r0_6); /* line 6474 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -80),0,4), reg_r0_6); /* line 6475 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -76),0,4), reg_r0_6); /* line 6476 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -72),0,4), reg_r0_6); /* line 6477 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -68),0,4), reg_r0_6); /* line 6478 */
} /* line 6478 */
  sim_icache_fetch(4680 + t_thisfile.offset, 2);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_2 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_2, reg_r0_4, (unsigned int) 160); /* line 6480 */
   if (t__i32_0) {    __BRANCH(t__i32_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L281X3; 
  ...
  sim_icache_fetch(4682 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -192),0,4), reg_r0_6); /* line 6483 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -188),0,4), reg_r0_6); /* line 6484 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -184),0,4), reg_r0_6); /* line 6485 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -180),0,4), reg_r0_6); /* line 6486 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -176),0,4), reg_r0_6); /* line 6487 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -172),0,4), reg_r0_6); /* line 6488 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -168),0,4), reg_r0_6); /* line 6489 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -164),0,4), reg_r0_6); /* line 6490 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -160),0,4), reg_r0_6); /* line 6491 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -156),0,4), reg_r0_6); /* line 6492 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -152),0,4), reg_r0_6); /* line 6493 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -148),0,4), reg_r0_6); /* line 6494 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -144),0,4), reg_r0_6); /* line 6495 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -140),0,4), reg_r0_6); /* line 6496 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -136),0,4), reg_r0_6); /* line 6497 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -132),0,4), reg_r0_6); /* line 6498 */
} /* line 6498 */
  sim_icache_fetch(4698 + t_thisfile.offset, 3);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_b0_3 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __CMPLT(reg_b0_3, reg_r0_4, (unsigned int) 176); /* line 6500 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) -208); /* line 6501 */
   if (t__i32_0) {    __BRANCH(t__i32_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L282X3; 
  ...
  sim_icache_fetch(4701 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -256),0,4), reg_r0_6); /* line 6504 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -252),0,4), reg_r0_6); /* line 6505 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -248),0,4), reg_r0_6); /* line 6506 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -244),0,4), reg_r0_6); /* line 6507 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -240),0,4), reg_r0_6); /* line 6508 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -236),0,4), reg_r0_6); /* line 6509 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -232),0,4), reg_r0_6); /* line 6510 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -228),0,4), reg_r0_6); /* line 6511 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -224),0,4), reg_r0_6); /* line 6512 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -220),0,4), reg_r0_6); /* line 6513 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -216),0,4), reg_r0_6); /* line 6514 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -212),0,4), reg_r0_6); /* line 6515 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -208),0,4), reg_r0_6); /* line 6516 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -204),0,4), reg_r0_6); /* line 6517 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -200),0,4), reg_r0_6); /* line 6518 */
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -196),0,4), reg_r0_6); /* line 6519 */
} /* line 6519 */
  sim_icache_fetch(4717 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   if (reg_b0_4) {    __BRANCH(reg_b0_4);
  ...
  sim_icache_fetch(4718 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -260),0,4), reg_r0_6); /* line 6538 */
} /* line 6538 */
  sim_icache_fetch(4750 + t_thisfile.offset, 1);
{
  ...
  sim_icache_fetch(4751 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -324),0,4), reg_r0_6); /* line 6557 */
} /* line 6557 */
  sim_icache_fetch(4783 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   if (reg_b0_6) {    __BRANCH(reg_b0_6);
  ...
  sim_icache_fetch(4784 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -388),0,4), reg_r0_6); /* line 6576 */
} /* line 6576 */
  sim_icache_fetch(4816 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   if (reg_b0_7) {    __BRANCH(reg_b0_7);
  ...
  sim_icache_fetch(4817 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -452),0,4), reg_r0_6); /* line 6595 */
} /* line 6595 */
  sim_icache_fetch(4849 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   if (reg_b0_0) {    __BRANCH(reg_b0_0);
  ...
  sim_icache_fetch(4850 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -516),0,4), reg_r0_6); /* line 6614 */
} /* line 6614 */
  sim_icache_fetch(4882 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   if (reg_b0_1) {    __BRANCH(reg_b0_1);
  ...
  sim_icache_fetch(4883 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -580),0,4), reg_r0_6); /* line 6633 */
} /* line 6633 */
  sim_icache_fetch(4915 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   if (reg_b0_2) {    __BRANCH(reg_b0_2);
  ...
  sim_icache_fetch(4916 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -644),0,4), reg_r0_6); /* line 6652 */
} /* line 6652 */
  sim_icache_fetch(4948 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   if (reg_b0_3) {    __BRANCH(reg_b0_3);
  ...
  sim_icache_fetch(4949 + t_thisfile.offset, 31);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   ...
   __STW(mem_trace_st((reg_r0_2 + (unsigned int) -716),0,4), reg_r0_6); /* line 6669 */
   __ADD(reg_r0_8, reg_r0_8, (unsigned int) -208); /* line 6670 */
   __ADD(reg_r0_7, reg_r0_7, (unsigned int) -832); /* line 6671 */
} /* line 6671 */
  sim_icache_fetch(4980 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
