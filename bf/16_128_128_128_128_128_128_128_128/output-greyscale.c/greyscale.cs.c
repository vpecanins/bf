  ...
  sim_icache_fetch(61 + t_thisfile.offset, 6);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 152 */
   __MOV(reg_r0_5, (unsigned int) grey_framebuffer); /* line 153 */
   __MOV(reg_r0_6, (unsigned int) grey_image); /* line 154 */
   __MOV(reg_r0_36, t__i32_0); /* line 155 */
} /* line 155 */
  ...
  sim_icache_fetch(68 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 160 */
   __MOV(reg_r0_13, (unsigned int) -55); /* line 161 */
   __MOV(reg_r0_4, reg_r0_5); /* line 162 */
   __MOV(reg_r0_2, reg_r0_6); /* line 163 */
   __MOV(reg_r0_33, reg_r0_3); /* line 164 */
   __MOV(reg_r0_34, reg_r0_5); /* line 165 */
   __MOV(reg_r0_35, reg_r0_6); /* line 166 */
} /* line 166 */
  ...
  sim_icache_fetch(76 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __LDW(reg_r0_5, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 172 */
   __LDW(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 173 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 174 */
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 175 */
   __LDW(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 16),0,4)); /* line 176 */
   __LDW(reg_r0_9, mem_trace_ld((reg_r0_2 + (unsigned int) 20),0,4)); /* line 177 */
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 24),0,4)); /* line 178 */
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_2 + (unsigned int) 28),0,4)); /* line 179 */
   __LDW(reg_r0_12, mem_trace_ld((reg_r0_2 + (unsigned int) 32),0,4)); /* line 180 */
   __CMPLT(reg_b0_0, reg_r0_13, 0); /* line 181 */
   __LDWs(reg_r0_14, mem_trace_ld((reg_r0_2 + (unsigned int) 36),0,4)); /* line 182 */
   __LDWs(reg_r0_15, mem_trace_ld((reg_r0_2 + (unsigned int) 40),0,4)); /* line 183 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 44); /* line 184 */
   __ADD(reg_r0_13, reg_r0_13, (unsigned int) 11); /* line 185 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 186 */
   __ADD_CYCLES(1);
} /* line 186 */
  sim_icache_fetch(91 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __AND(reg_r0_17, reg_r0_3, (unsigned int) 255); /* line 188 */
   __AND(reg_r0_19, reg_r0_5, (unsigned int) 255); /* line 189 */
   __AND(reg_r0_21, reg_r0_6, (unsigned int) 255); /* line 190 */
   __SHRU(reg_r0_16, reg_r0_3, (unsigned int) 8); /* line 191 */
   __SHRU(reg_r0_18, reg_r0_5, (unsigned int) 8); /* line 192 */
   __SHRU(reg_r0_20, reg_r0_6, (unsigned int) 8); /* line 193 */
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 194 */
   __SHRU(reg_r0_5, reg_r0_5, (unsigned int) 16); /* line 195 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 196 */
   __AND(reg_r0_23, reg_r0_7, (unsigned int) 255); /* line 197 */
   __SHRU(reg_r0_22, reg_r0_7, (unsigned int) 8); /* line 198 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 199 */
   __AND(reg_r0_25, reg_r0_8, (unsigned int) 255); /* line 200 */
   __SHRU(reg_r0_24, reg_r0_8, (unsigned int) 8); /* line 201 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 202 */
   __SHRU(reg_r0_26, reg_r0_9, (unsigned int) 8); /* line 203 */
} /* line 203 */
  sim_icache_fetch(107 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 205 */
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 206 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 207 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 208 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 209 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 210 */
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 211 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 212 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 213 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 214 */
   __AND(reg_r0_27, reg_r0_9, (unsigned int) 255); /* line 215 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 216 */
   __SHRU(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 217 */
   __AND(reg_r0_29, reg_r0_10, (unsigned int) 255); /* line 218 */
   __SHRU(reg_r0_28, reg_r0_10, (unsigned int) 8); /* line 219 */
   __SHRU(reg_r0_10, reg_r0_10, (unsigned int) 16); /* line 220 */
} /* line 220 */
  sim_icache_fetch(123 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_16); /* line 222 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_18); /* line 223 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_20); /* line 224 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_22); /* line 225 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_24); /* line 226 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_26); /* line 227 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 228 */
   __AND(reg_r0_28, reg_r0_28, (unsigned int) 255); /* line 229 */
   __AND(reg_r0_10, reg_r0_10, (unsigned int) 255); /* line 230 */
   __AND(reg_r0_18, reg_r0_11, (unsigned int) 255); /* line 231 */
   __SHRU(reg_r0_16, reg_r0_11, (unsigned int) 8); /* line 232 */
   __SHRU(reg_r0_11, reg_r0_11, (unsigned int) 16); /* line 233 */
   __AND(reg_r0_22, reg_r0_12, (unsigned int) 255); /* line 234 */
   __SHRU(reg_r0_20, reg_r0_12, (unsigned int) 8); /* line 235 */
   __SHRU(reg_r0_12, reg_r0_12, (unsigned int) 16); /* line 236 */
   __SHRU(reg_r0_24, reg_r0_14, (unsigned int) 8); /* line 237 */
} /* line 237 */
  sim_icache_fetch(139 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __MAX(reg_r0_17, reg_r0_17, reg_r0_3); /* line 239 */
   __MAX(reg_r0_19, reg_r0_19, reg_r0_5); /* line 240 */
   __MAX(reg_r0_21, reg_r0_21, reg_r0_6); /* line 241 */
   __MAX(reg_r0_23, reg_r0_23, reg_r0_7); /* line 242 */
   __MAX(reg_r0_25, reg_r0_25, reg_r0_8); /* line 243 */
   __MAX(reg_r0_27, reg_r0_27, reg_r0_9); /* line 244 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_28); /* line 245 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 246 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 247 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 248 */
   __AND(reg_r0_12, reg_r0_12, (unsigned int) 255); /* line 249 */
   __AND(reg_r0_3, reg_r0_14, (unsigned int) 255); /* line 250 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 251 */
   __SHRU(reg_r0_14, reg_r0_14, (unsigned int) 16); /* line 252 */
   __AND(reg_r0_6, reg_r0_15, (unsigned int) 255); /* line 253 */
   __SHRU(reg_r0_5, reg_r0_15, (unsigned int) 8); /* line 254 */
} /* line 254 */
  sim_icache_fetch(155 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __ZXTB(reg_r0_17, reg_r0_17); /* line 256 */
   __ZXTB(reg_r0_19, reg_r0_19); /* line 257 */
   __ZXTB(reg_r0_21, reg_r0_21); /* line 258 */
   __ZXTB(reg_r0_23, reg_r0_23); /* line 259 */
   __ZXTB(reg_r0_25, reg_r0_25); /* line 260 */
   __ZXTB(reg_r0_27, reg_r0_27); /* line 261 */
   __MAX(reg_r0_29, reg_r0_29, reg_r0_10); /* line 262 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_16); /* line 263 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_20); /* line 264 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_24); /* line 265 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 266 */
   __AND(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 267 */
   __SHRU(reg_r0_15, reg_r0_15, (unsigned int) 16); /* line 268 */
} /* line 268 */
  sim_icache_fetch(168 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __SHL(reg_r0_8, reg_r0_17, (unsigned int) 8); /* line 270 */
   __SHL(reg_r0_7, reg_r0_17, (unsigned int) 16); /* line 271 */
   __SHL(reg_r0_10, reg_r0_19, (unsigned int) 8); /* line 272 */
   __SHL(reg_r0_9, reg_r0_19, (unsigned int) 16); /* line 273 */
   __SHL(reg_r0_20, reg_r0_21, (unsigned int) 8); /* line 274 */
   __SHL(reg_r0_16, reg_r0_21, (unsigned int) 16); /* line 275 */
   __SHL(reg_r0_26, reg_r0_23, (unsigned int) 8); /* line 276 */
   __SHL(reg_r0_24, reg_r0_23, (unsigned int) 16); /* line 277 */
   __SHL(reg_r0_30, reg_r0_25, (unsigned int) 8); /* line 278 */
   __SHL(reg_r0_28, reg_r0_25, (unsigned int) 16); /* line 279 */
   __SHL(reg_r0_32, reg_r0_27, (unsigned int) 8); /* line 280 */
   __SHL(reg_r0_31, reg_r0_27, (unsigned int) 16); /* line 281 */
   __ZXTB(reg_r0_29, reg_r0_29); /* line 282 */
   __MAX(reg_r0_18, reg_r0_18, reg_r0_11); /* line 283 */
   __MAX(reg_r0_22, reg_r0_22, reg_r0_12); /* line 284 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_14); /* line 285 */
} /* line 285 */
  sim_icache_fetch(184 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __OR(reg_r0_17, reg_r0_17, reg_r0_7); /* line 287 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_9); /* line 288 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_16); /* line 289 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_24); /* line 290 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_28); /* line 291 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_31); /* line 292 */
   __SHL(reg_r0_9, reg_r0_29, (unsigned int) 8); /* line 293 */
   __SHL(reg_r0_7, reg_r0_29, (unsigned int) 16); /* line 294 */
   __ZXTB(reg_r0_18, reg_r0_18); /* line 295 */
   __ZXTB(reg_r0_22, reg_r0_22); /* line 296 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 297 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_5); /* line 298 */
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 299 */
} /* line 299 */
  sim_icache_fetch(197 + t_thisfile.offset, 14);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __OR(reg_r0_17, reg_r0_17, reg_r0_8); /* line 301 */
   __OR(reg_r0_19, reg_r0_19, reg_r0_10); /* line 302 */
   __OR(reg_r0_21, reg_r0_21, reg_r0_20); /* line 303 */
   __OR(reg_r0_23, reg_r0_23, reg_r0_26); /* line 304 */
   __OR(reg_r0_25, reg_r0_25, reg_r0_30); /* line 305 */
   __OR(reg_r0_27, reg_r0_27, reg_r0_32); /* line 306 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_7); /* line 307 */
   __SHL(reg_r0_7, reg_r0_18, (unsigned int) 8); /* line 308 */
   __SHL(reg_r0_5, reg_r0_18, (unsigned int) 16); /* line 309 */
   __SHL(reg_r0_10, reg_r0_22, (unsigned int) 8); /* line 310 */
   __SHL(reg_r0_8, reg_r0_22, (unsigned int) 16); /* line 311 */
   __SHL(reg_r0_12, reg_r0_3, (unsigned int) 8); /* line 312 */
   __SHL(reg_r0_11, reg_r0_3, (unsigned int) 16); /* line 313 */
   __MAX(reg_r0_6, reg_r0_6, reg_r0_15); /* line 314 */
} /* line 314 */
  sim_icache_fetch(211 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __STW(mem_trace_st(reg_r0_4,0,4), reg_r0_17); /* line 316 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 4),0,4), reg_r0_19); /* line 317 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 8),0,4), reg_r0_21); /* line 318 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 12),0,4), reg_r0_23); /* line 319 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 16),0,4), reg_r0_25); /* line 320 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 20),0,4), reg_r0_27); /* line 321 */
   __OR(reg_r0_29, reg_r0_29, reg_r0_9); /* line 322 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_5); /* line 323 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_8); /* line 324 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_11); /* line 325 */
   __ZXTB(reg_r0_6, reg_r0_6); /* line 326 */
} /* line 326 */
  sim_icache_fetch(222 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 24),0,4), reg_r0_29); /* line 328 */
   __OR(reg_r0_18, reg_r0_18, reg_r0_7); /* line 329 */
   __OR(reg_r0_22, reg_r0_22, reg_r0_10); /* line 330 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_12); /* line 331 */
   __SHL(reg_r0_7, reg_r0_6, (unsigned int) 8); /* line 332 */
   __SHL(reg_r0_5, reg_r0_6, (unsigned int) 16); /* line 333 */
} /* line 333 */
  sim_icache_fetch(228 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 28),0,4), reg_r0_18); /* line 335 */
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 32),0,4), reg_r0_22); /* line 336 */
   __OR(reg_r0_6, reg_r0_6, reg_r0_5); /* line 337 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(232 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 36),0,4), reg_r0_3); /* line 340 */
   __OR(reg_r0_6, reg_r0_6, reg_r0_7); /* line 341 */
} /* line 341 */
  sim_icache_fetch(234 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_4 + (unsigned int) 40),0,4), reg_r0_6); /* line 343 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 44); /* line 344 */
  ...
  sim_icache_fetch(237 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_6, reg_r0_35, (unsigned int) 256); /* line 349 */
   __ADD(reg_r0_5, reg_r0_34, (unsigned int) 256); /* line 350 */
   __ADD(reg_r0_3, reg_r0_33, (unsigned int) 1); /* line 351 */
  ...
  sim_icache_fetch(243 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_36); /* line 358 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 359 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(248 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 361 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 362 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 363 */
   __ADD_CYCLES(1);
} /* line 363 */
