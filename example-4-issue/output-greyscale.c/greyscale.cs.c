...
/* "" */
/* "-dir /home/user/tools/vex-3.43 -fmm=/home/user/workspace/assignment1/configurations/example-4-issue/configuration.mm -width 1 -c99inline -ms -mas_g -mas_G -O3 -o a.out" */
  ...
  sim_icache_fetch(20 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __LDW(reg_r0_16, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 102 */
} /* line 102 */
  ...
  sim_icache_fetch(22 + t_thisfile.offset, 2);
{
   ...
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 4); /* line 108 */
} /* line 108 */
  ...
  sim_icache_fetch(27 + t_thisfile.offset, 4);
{
   ...
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 117 */
  ...
  sim_icache_fetch(31 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_6, (unsigned int) grey_framebuffer); /* line 122 */
   __MOV(reg_r0_7, (unsigned int) grey_image); /* line 123 */
} /* line 123 */
  sim_icache_fetch(35 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_3, (unsigned int) -64); /* line 125 */
} /* line 125 */
l_L4X3: ;/* line 128 */
__LABEL(l_L4X3);
  sim_icache_fetch(36 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 129 */
   __MOV(reg_r0_4, (unsigned int) -64); /* line 130 */
   __MOV(reg_r0_5, reg_r0_6); /* line 131 */
   __MOV(reg_r0_2, reg_r0_7); /* line 132 */
} /* line 132 */
  sim_icache_fetch(40 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MOV(reg_r0_13, reg_r0_3); /* line 134 */
   __MOV(reg_r0_14, reg_r0_6); /* line 135 */
   __MOV(reg_r0_15, reg_r0_7); /* line 136 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L5X3; 
  ...
  sim_icache_fetch(44 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __CMPLT(reg_b0_0, reg_r0_4, 0); /* line 141 */
   __LDWs(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 142 */
   __LDWs(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 4),0,4)); /* line 143 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 4); /* line 144 */
} /* line 144 */
  sim_icache_fetch(48 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __LDWs(reg_r0_7, mem_trace_ld((reg_r0_2 + (unsigned int) 8),0,4)); /* line 146 */
   __LDWs(reg_r0_8, mem_trace_ld((reg_r0_2 + (unsigned int) 12),0,4)); /* line 147 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 16); /* line 148 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L7X3; 
  ...
  sim_icache_fetch(52 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __AND(reg_r0_10, reg_r0_3, (unsigned int) 255); /* line 151 */
   __SHRU(reg_r0_9, reg_r0_3, (unsigned int) 8); /* line 152 */
   __SHRU(reg_r0_3, reg_r0_3, (unsigned int) 16); /* line 153 */
   __SHRU(reg_r0_11, reg_r0_6, (unsigned int) 8); /* line 154 */
} /* line 154 */
  sim_icache_fetch(56 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 156 */
   __AND(reg_r0_3, reg_r0_3, (unsigned int) 255); /* line 157 */
   __AND(reg_r0_12, reg_r0_6, (unsigned int) 255); /* line 158 */
   __AND(reg_r0_11, reg_r0_11, (unsigned int) 255); /* line 159 */
} /* line 159 */
  sim_icache_fetch(60 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MAX(reg_r0_10, reg_r0_10, reg_r0_9); /* line 161 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_11); /* line 162 */
   __SHRU(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 163 */
   __SHRU(reg_r0_9, reg_r0_7, (unsigned int) 8); /* line 164 */
} /* line 164 */
  sim_icache_fetch(64 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MAX(reg_r0_10, reg_r0_10, reg_r0_3); /* line 166 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 167 */
   __AND(reg_r0_3, reg_r0_7, (unsigned int) 255); /* line 168 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 169 */
} /* line 169 */
  sim_icache_fetch(68 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ZXTB(reg_r0_10, reg_r0_10); /* line 171 */
   __MAX(reg_r0_12, reg_r0_12, reg_r0_6); /* line 172 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_9); /* line 173 */
   __SHRU(reg_r0_7, reg_r0_7, (unsigned int) 16); /* line 174 */
} /* line 174 */
  sim_icache_fetch(72 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __SHL(reg_r0_9, reg_r0_10, (unsigned int) 8); /* line 176 */
   __SHL(reg_r0_6, reg_r0_10, (unsigned int) 16); /* line 177 */
   __ZXTB(reg_r0_12, reg_r0_12); /* line 178 */
   __AND(reg_r0_7, reg_r0_7, (unsigned int) 255); /* line 179 */
} /* line 179 */
  sim_icache_fetch(76 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_10, reg_r0_10, reg_r0_6); /* line 181 */
   __SHL(reg_r0_11, reg_r0_12, (unsigned int) 8); /* line 182 */
   __SHL(reg_r0_6, reg_r0_12, (unsigned int) 16); /* line 183 */
   __MAX(reg_r0_3, reg_r0_3, reg_r0_7); /* line 184 */
} /* line 184 */
  sim_icache_fetch(80 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_10, reg_r0_10, reg_r0_9); /* line 186 */
   __OR(reg_r0_12, reg_r0_12, reg_r0_6); /* line 187 */
   __ZXTB(reg_r0_3, reg_r0_3); /* line 188 */
   __SHRU(reg_r0_6, reg_r0_8, (unsigned int) 8); /* line 189 */
} /* line 189 */
  sim_icache_fetch(84 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __OR(reg_r0_12, reg_r0_12, reg_r0_11); /* line 191 */
   __SHL(reg_r0_9, reg_r0_3, (unsigned int) 8); /* line 192 */
   __SHL(reg_r0_7, reg_r0_3, (unsigned int) 16); /* line 193 */
   __AND(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 194 */
} /* line 194 */
  sim_icache_fetch(88 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st(reg_r0_5,0,4), reg_r0_10); /* line 196 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_7); /* line 197 */
   __AND(reg_r0_7, reg_r0_8, (unsigned int) 255); /* line 198 */
   __SHRU(reg_r0_8, reg_r0_8, (unsigned int) 16); /* line 199 */
} /* line 199 */
  sim_icache_fetch(92 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __STW(mem_trace_st((reg_r0_5 + (unsigned int) 4),0,4), reg_r0_12); /* line 201 */
   __OR(reg_r0_3, reg_r0_3, reg_r0_9); /* line 202 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_6); /* line 203 */
   __AND(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 204 */
} /* line 204 */
  sim_icache_fetch(96 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st((reg_r0_5 + (unsigned int) 8),0,4), reg_r0_3); /* line 206 */
   __MAX(reg_r0_7, reg_r0_7, reg_r0_8); /* line 207 */
} /* line 207 */
  sim_icache_fetch(98 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ZXTB(reg_r0_7, reg_r0_7); /* line 209 */
} /* line 209 */
  sim_icache_fetch(99 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_6, reg_r0_7, (unsigned int) 8); /* line 211 */
   __SHL(reg_r0_3, reg_r0_7, (unsigned int) 16); /* line 212 */
} /* line 212 */
  sim_icache_fetch(101 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_7, reg_r0_7, reg_r0_3); /* line 214 */
} /* line 214 */
  sim_icache_fetch(102 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_7, reg_r0_7, reg_r0_6); /* line 216 */
} /* line 216 */
  sim_icache_fetch(103 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_5 + (unsigned int) 12),0,4), reg_r0_7); /* line 218 */
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 16); /* line 219 */
...
l_L7X3: ;/* line 223 */
__LABEL(l_L7X3);
  sim_icache_fetch(106 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_6, reg_r0_14, (unsigned int) 256); /* line 224 */
   __ADD(reg_r0_3, reg_r0_13, (unsigned int) 1); /* line 225 */
} /* line 225 */
  sim_icache_fetch(109 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_7, reg_r0_15, (unsigned int) 256); /* line 227 */
  ...
  sim_icache_fetch(112 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_16); /* line 234 */
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 235 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(117 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 237 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 238 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 239 */
   __ADD_CYCLES(1);
} /* line 239 */
...
static sim_fileinfo_t t_thisfile = {"greyscale.s", 128, 0, 0, 0, 2};
